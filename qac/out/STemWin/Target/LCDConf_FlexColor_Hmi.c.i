...
/*
 * C:/CodeInspection/DisplayUnit/Middlewares/ST/STemWin/inc/GUIDRV_FlexColor.h
 */
/*   121 */ typedef struct {
/*   125 */    int FirstSEG;
/*   126 */    int FirstCOM;
/*   127 */    int Orientation;
/*   128 */    unsigned short RegEntryMode;
/*   129 */    int NumDummyReads;
/*   130 */ } CONFIG_FLEXCOLOR;
/*   139 */ extern const GUI_DEVICE_API GUIDRV_Win_API;
/*   141 */ extern const GUI_DEVICE_API GUIDRV_FlexColor_API;
/*   165 */ void GUIDRV_FlexColor_SetFunc66702 (GUI_DEVICE * pDevice);
/*   166 */ void GUIDRV_FlexColor_SetFunc66708 (GUI_DEVICE * pDevice);
/*   167 */ void GUIDRV_FlexColor_SetFunc66709 (GUI_DEVICE * pDevice);
/*   168 */ void GUIDRV_FlexColor_SetFunc66712 (GUI_DEVICE * pDevice);
/*   169 */ void GUIDRV_FlexColor_SetFunc66714 (GUI_DEVICE * pDevice);
/*   170 */ void GUIDRV_FlexColor_SetFunc66715 (GUI_DEVICE * pDevice);
/*   171 */ void GUIDRV_FlexColor_SetFunc66718 (GUI_DEVICE * pDevice);
/*   172 */ void GUIDRV_FlexColor_SetFunc66719 (GUI_DEVICE * pDevice);
/*   173 */ void GUIDRV_FlexColor_SetFunc66720 (GUI_DEVICE * pDevice);
/*   174 */ void GUIDRV_FlexColor_SetFunc66721 (GUI_DEVICE * pDevice);
/*   175 */ void GUIDRV_FlexColor_SetFunc66722 (GUI_DEVICE * pDevice);
/*   176 */ void GUIDRV_FlexColor_SetFunc66723 (GUI_DEVICE * pDevice);
/*   177 */ void GUIDRV_FlexColor_SetFunc66772 (GUI_DEVICE * pDevice);
/*   182 */ void GUIDRV_FlexColor_SetMode16bppC0B8 (GUI_DEVICE * pDevice);
/*   183 */ void GUIDRV_FlexColor_SetMode16bppC1B8 (GUI_DEVICE * pDevice);
/*   184 */ void GUIDRV_FlexColor_SetMode16bppC0B16(GUI_DEVICE * pDevice);
/*   185 */ void GUIDRV_FlexColor_SetMode16bppC1B16(GUI_DEVICE * pDevice);
/*   190 */ void GUIDRV_FlexColor_SetMode18bppC0B9 (GUI_DEVICE * pDevice);
/*   191 */ void GUIDRV_FlexColor_SetMode18bppC1B9 (GUI_DEVICE * pDevice);
/*   192 */ void GUIDRV_FlexColor_SetMode18bppC0B18(GUI_DEVICE * pDevice);
/*   193 */ void GUIDRV_FlexColor_SetMode18bppC1B18(GUI_DEVICE * pDevice);
/*   198 */ void GUIDRV_FlexColor_SetMode24bppC0B8 (GUI_DEVICE * pDevice);
/*   203 */ void GUIDRV_FlexColor_SetFunc(GUI_DEVICE * pDevice, GUI_PORT_API * pHW_API, void (* pfFunc)(GUI_DEVICE *), void (* pfMode)(GUI_DEVICE *));
/*   204 */ void GUIDRV_FlexColor_Config (GUI_DEVICE * pDevice, CONFIG_FLEXCOLOR * pConfig);
/*   209 */ void GUIDRV_FlexColor_SetInterface66712_B9 (GUI_DEVICE * pDevice, int Type);
/*   210 */ void GUIDRV_FlexColor_SetInterface66712_B18(GUI_DEVICE * pDevice, int Type);
/*   217 */ void GUIDRV_FlexColor_SetReadFunc66709_B16(GUI_DEVICE * pDevice, int Func);
/*   218 */ void GUIDRV_FlexColor_SetReadFunc66712_B9 (GUI_DEVICE * pDevice, int Func);
/*   219 */ void GUIDRV_FlexColor_SetReadFunc66712_B16(GUI_DEVICE * pDevice, int Func);
/*   222 */ void GUIDRV_FlexColor_SetReadFunc66720_B16(GUI_DEVICE * pDevice, int Func);
/*   223 */ void GUIDRV_FlexColor_SetReadFunc66772_B8 (GUI_DEVICE * pDevice, int Func);
/*   224 */ void GUIDRV_FlexColor_SetReadFunc66772_B16(GUI_DEVICE * pDevice, int Func);
/*
...
/*
 * C:/CodeInspection/DisplayUnit/STemWin/Target/LCDConf_FlexColor_Hmi.c
 */
/*    73 */ static void LcdWriteReg(unsigned short Data);
/*    74 */ static void LcdWriteData(unsigned short Data);
/*    75 */ static void LcdWriteDataMultiple(const unsigned short pData[], int NumItems);
/*    76 */ static void LcdReadDataMultiple(unsigned short pData[], int NumItems);
/*   179 */ static void LcdWriteReg(unsigned short Data)
/*   180 */ {
/*   182 */    CPU_Command_Write(Data);
/*   183 */ }
/*   192 */ static void LcdWriteData(unsigned short Data)
/*   193 */ {
/*   195 */    CPU_Data_Write(Data);
/*   196 */ }
/*   205 */ static void LcdWriteDataMultiple(const unsigned short pData[], int NumItems)
/*   206 */ {
/*   212 */    int i=0;
/*   213 */    unsigned short pD;
/*   215 */    while (NumItems--)
/*   216 */    {
/*   218 */       pD = pData[i];
/*   219 */       CPU_Data_Write( pD );
/*   220 */       i++;
/*   221 */    }
/*   222 */ }
/*   231 */ static void LcdReadDataMultiple(unsigned short pData[], int NumItems)
/*   232 */ {
/*   238 */    int i=0;
/*   240 */    while (NumItems--)
/*   241 */    {
/*   243 */       pData[i++] = CPU_Data_Read();
/*   244 */    }
/*   245 */ }
/*   374 */ void LCD_X_Config(void) {
/*   375 */    GUI_DEVICE * pDevice;
/*   376 */    CONFIG_FLEXCOLOR Config = {0};
/*   377 */    GUI_PORT_API PortAPI = {0};
/*   382 */    pDevice = GUI_DEVICE_CreateAndLink(&GUIDRV_FlexColor_API, &LCD_API_ColorConv_565, 0, 0);
/*   389 */    (void)LCD_SetSizeEx (0, 320 , 480);
/*   390 */    (void)LCD_SetVSizeEx(0, 320, 480);
/*   406 */    Config.Orientation = (1 << 0) | (1 << 1) | (1 << 2);
/*   408 */    GUIDRV_FlexColor_Config(pDevice, &Config);
/*   414 */    PortAPI.pfWrite16_A0 = &LcdWriteReg;
/*   415 */    PortAPI.pfWrite16_A1 = &LcdWriteData;
/*   416 */    PortAPI.pfWriteM16_A1 = &LcdWriteDataMultiple;
/*   417 */    PortAPI.pfReadM16_A1 = &LcdReadDataMultiple;
/*   418 */    GUIDRV_FlexColor_SetFunc(pDevice, &PortAPI, &GUIDRV_FlexColor_SetFunc66709, &GUIDRV_FlexColor_SetMode16bppC0B16);
/*   421 */ }
/*   445 */ int LCD_X_DisplayDriver(unsigned LayerIndex, unsigned Cmd, void * pData)
/*   446 */ {
/*   447 */    int r;
/*   451 */    switch (Cmd) {
/*   452 */    case 0x01:
