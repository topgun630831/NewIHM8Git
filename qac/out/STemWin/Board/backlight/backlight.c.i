...
/*
 * C:/CodeInspection/DisplayUnit/STemWin/Board/backlight/backlight.c
 */
/*    13 */ void User_Pwm_Setup(void)
/*    14 */ {
/*    15 */    TIM_MasterConfigTypeDef sMasterConfig;
/*    16 */    TIM_OC_InitTypeDef sConfigOC;
/*    17 */    htim4.Instance = ((TIM_TypeDef *) (0x40000000U + 0x0800U));
/*    18 */    htim4.Init.Prescaler = (420-1);
/*    19 */    htim4.Init.CounterMode = 0x00000000U;
/*    20 */    htim4.Init.Period = (2000-1);
/*    21 */    htim4.Init.ClockDivision = ((0x2U << (8U)));
/*    22 */    if (HAL_TIM_PWM_Init(&htim4) != HAL_OK)
/*    23 */    {
/*    24 */       _Error_Handler("C:/CodeInspection/DisplayUnit/STemWin/Board/backlight/backlight.c", 24);
/*    25 */    }
/*    27 */    sMasterConfig.MasterOutputTrigger = 0x00000000U;
/*    28 */    sMasterConfig.MasterSlaveMode = 0x00000000U;
/*    29 */    if (HAL_TIMEx_MasterConfigSynchronization(&htim4, &sMasterConfig) != HAL_OK)
/*    30 */    {
/*    31 */       _Error_Handler("C:/CodeInspection/DisplayUnit/STemWin/Board/backlight/backlight.c", 31);
/*    32 */    }
/*    34 */    sConfigOC.OCMode = ((0x2U << (4U)) | (0x4U << (4U)));
/*    35 */    sConfigOC.Pulse = 0;
/*    36 */    sConfigOC.OCPolarity = 0x00000000U;
/*    37 */    sConfigOC.OCFastMode = 0x00000000U;
/*    38 */    if (HAL_TIM_PWM_ConfigChannel(&htim4, &sConfigOC, 0x00000008U) != HAL_OK)
/*    39 */    {
/*    40 */       _Error_Handler("C:/CodeInspection/DisplayUnit/STemWin/Board/backlight/backlight.c", 40);
/*    41 */    }
/*    43 */    HAL_TIM_MspPostInit(&htim4);
/*    65 */ }
/*    68 */ void BacklightBrghtness(const unsigned short brightness, const unsigned short flag)
/*    69 */ {
/*    70 */    uint32_t value = 1900 - (brightness * 16);
/*    72 */    if(flag == 1)
/*    73 */    {
/*    74 */       value = 5000;
/*    75 */    }
/*    76 */    (void)HAL_TIM_PWM_Stop(&htim4, 0x00000008U);
/*    77 */    TIM_OC_InitTypeDef sConfigOC;
/*    78 */    sConfigOC.OCMode = ((0x2U << (4U)) | (0x4U << (4U)));
/*    79 */    sConfigOC.Pulse = value;
/*    80 */    sConfigOC.OCPolarity = 0x00000000U;
/*    81 */    sConfigOC.OCFastMode = 0x00000000U;
/*    82 */    (void)HAL_TIM_PWM_ConfigChannel(&htim4, &sConfigOC, 0x00000008U);
/*    83 */    (void)HAL_TIM_PWM_Start(&htim4, 0x00000008U);
/*    84 */ }
/*    86 */ 
