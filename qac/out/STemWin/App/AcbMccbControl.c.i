...
/*
 * C:/CodeInspection/DisplayUnit/STemWin/App/AcbMccbControl.c
 */
/*    50 */ static unsigned char AcbMccbcbStatus;
/*    51 */ static unsigned char bUpdateFirst;
/*    53 */ static void AcbMccbControlSend(void);
/*    54 */ static int ControlCheck(void);
/*    55 */ static void AcbMccbIoValueDisp(void);
/*    56 */ static void AcbMccbControlDisp(void);
/*    58 */ static GUI_COLOR colorOffFillColor[3] = {
/*    59 */    0x494949,
/*    60 */    0x2a4324,
/*    61 */    0x393967
/*    62 */ };
/*    64 */ static GUI_COLOR colorOffTextColor[3] = {
/*    65 */    0x6f6f6f,
/*    66 */    0x5b6b58,
/*    67 */    0x646467
/*    68 */ };
/*    70 */ static void AcbMccbControlSend(void)
/*    71 */ {
/*    72 */    if(StatusSend() == STATUS_SEND_ING)
/*    73 */    {
/*    74 */       return;
/*    75 */    }
/*    76 */    if(ConnectSetting[gDeviceIndex].DeviceType == DEVICE_ACB)
/*    77 */    {
/*    78 */       ModbusSendFrame(ConnectSetting[gDeviceIndex].Address, INPUT_REGISTER, 183, 26);
/*    79 */    }
/*    80 */    else
/*    81 */    {
/*    82 */       if(ConnectSetting[gDeviceIndex].DeviceType == DEVICE_MCCB)
/*    83 */       {
/*    84 */          ModbusSendFrame(ConnectSetting[gDeviceIndex].Address, INPUT_REGISTER, 204, 5);
/*    85 */       }
/*    86 */    }
/*    87 */ }
/*    89 */ static unsigned char nDoSetting[3];
/*    90 */ static unsigned char nRemote;
/*    91 */ static unsigned char nTrio;
/*    92 */ static int ControlCheck(void)
/*    93 */ {
/*    94 */    int ret = 0;
/*    95 */    unsigned short comp=0;
/*    97 */    if(AcbMccbcbStatus == 0)
/*    98 */    {
/*    99 */       comp = 2;
/*   100 */    }
/*   101 */    else
/*   102 */    if(AcbMccbcbStatus == 1)
/*   103 */    {
/*   104 */       comp = 3;
/*   105 */    }
/*   106 */    else
/*   107 */    if(AcbMccbcbStatus == 2)
/*   108 */    {
/*   109 */       if(ConnectSetting[gDeviceIndex].DeviceType == DEVICE_MCCB)
/*   110 */       {
/*   111 */          ret = 1;
/*   112 */       }
/*   113 */    }
...
/*   117 */    {
/*   118 */       (void)printf("i=%d, nDoSetting=%d\n", i, nDoSetting[i]);
/*   119 */       if(nDoSetting[i] == comp)
/*   120 */       {
/*   121 */          ret = 1;
/*   122 */       }
/*   123 */    }
/*   124 */    return ret;
/*   125 */ }
/*   127 */ static void AcbMccbIoValueDisp(void)
/*   128 */ {
/*   129 */    unsigned short nDioStatus[2];
/*   130 */    static const unsigned short IoStatus_Offset[IO_STATUS_COUNT] =
/*   131 */    {
/*   132 */       0,
/*   133 */       1,
/*   134 */       0,
...
/*   137 */       1
/*   138 */    };
/*   139 */    static const unsigned short IoStatus_bit[IO_STATUS_COUNT] =
/*   140 */    {
/*   141 */       0x8000,
/*   142 */       0x8000,
/*   143 */       0x4000,
...
/*   146 */       0x0004
/*   147 */    };
/*   148 */    static GUI_COLOR colorOnFillColor[3] =
/*   149 */    {
/*   150 */       0x373533,
/*   151 */       0x0fce00,
/*   152 */       0x000000FF
/*   153 */    };
/*   155 */    nDioStatus[INDEX_0] = ModbusGetUint16(207);
/*   156 */    nDioStatus[INDEX_1] = ModbusGetUint16(208);
/*   157 */    if(ModbusGetUint16(206) & 0x8000)
/*   158 */    {
/*   159 */       nRemote = 1;
/*   160 */    }
/*   161 */    else
...
/*   163 */       nRemote = 0;
/*   164 */    }
/*   165 */    nDoSetting[INDEX_0] = ModbusGetUint8_U(204);
/*   166 */    nDoSetting[INDEX_1] = ModbusGetUint8_L(204);
/*   167 */    nDoSetting[INDEX_2] = ModbusGetUint8_U(205);
/*   169 */    nTrio = INDEX_0;
/*   172 */    LanguageSelect(FONT20B);
/*   173 */    GUI_SetColor(0x00000000);
/*   175 */    unsigned char status = (ModbusGetUint16(208) >> 8) & 0x003;
/*   176 */    if(ConnectSetting[gDeviceIndex].DeviceType == DEVICE_ACB)
/*   177 */    {
/*   178 */       nTrio = (ModbusGetUint16(183) >> 12) & 0x007;
/*   179 */       (void)printf("nTrio=%d\n", nTrio);
/*   180 */       if(nTrio != INDEX_7)
/*   181 */       {
/*   182 */          status = (ModbusGetUint16(184) >> 8) & 0x003;
/*   183 */          nDoSetting[INDEX_0] = INDEX_2;
/*   184 */          nDoSetting[INDEX_1] = INDEX_3;
/*   186 */          if(ModbusGetUint16(183) & 0x0400)
/*   187 */          {
/*   188 */             nRemote = 1;
/*   189 */          }
/*   190 */          else
...
/*   196 */    else
/*   197 */    {
/*   198 */       nDoSetting[INDEX_2] = 0;
/*   199 */    }
/*   200 */    if((bUpdateFirst == 1) || (AcbMccbcbStatus != status))
/*   201 */    {
/*   202 */       AcbMccbcbStatus = status;
/*   203 */       if(ConnectSetting[gDeviceIndex].DeviceType == DEVICE_MCCB)
/*   204 */       {
/*   205 */          GUI_FillRectEx(&rectMccbBox);
/*   206 */          for(unsigned char i = 0; i < INDEX_3; i++)
/*   207 */          {
/*   208 */             if(i == AcbMccbcbStatus)
/*   209 */             {
/*   210 */                GUI_SetColor(colorOnFillColor[i]);
/*   211 */                GUI_FillRectEx(&rectMccbStatus[i]);
/*   213 */                GUI_SetBkColor(colorOnFillColor[i]);
/*   214 */                GUI_SetColor(0x00FFFFFF);
/*   215 */             }
/*   216 */             else
/*   217 */             {
/*   218 */                GUI_SetColor(colorOffFillColor[i]);
/*   219 */                GUI_FillRectEx(&rectMccbStatus[i]);
/*   221 */                GUI_SetBkColor(colorOffFillColor[i]);
/*   222 */                GUI_SetColor(colorOffTextColor[i]);
/*   223 */             }
/*   224 */             LanguageSelect(FONT20B);
/*   225 */             GUI_DispStringInRect(_accb_status[SettingValue[SETUP_LANGUAGE]][i], &rectMccbStatus[i], (2<<0) | (3<<2));
/*   227 */          }
/*   228 */       }
/*   229 */       else
/*   230 */       {
/*   231 */          GUI_FillRectEx(&rectAcbBox);
/*   232 */          for(unsigned char i = 0; i < INDEX_2; i++)
/*   233 */          {
/*   234 */             if(i == AcbMccbcbStatus)
/*   235 */             {
/*   236 */                GUI_SetColor(colorOnFillColor[i]);
/*   237 */                GUI_FillRectEx(&rectAcbStatus[i]);
/*   239 */                GUI_SetBkColor(colorOnFillColor[i]);
/*   240 */                GUI_SetColor(0x00FFFFFF);
/*   241 */             }
/*   242 */             else
/*   243 */             {
/*   244 */                GUI_SetColor(colorOffFillColor[i]);
/*   245 */                GUI_FillRectEx(&rectAcbStatus[i]);
/*   247 */                GUI_SetBkColor(colorOffFillColor[i]);
/*   248 */                GUI_SetColor(colorOffTextColor[i]);
/*   249 */             }
/*   250 */             LanguageSelect(FONT20B);
/*   251 */             GUI_DispStringInRect(_accb_status[SettingValue[SETUP_LANGUAGE]][i], &rectAcbStatus[i], (2<<0) | (3<<2));
/*   253 */          }
/*   254 */       }
/*   255 */    }
/*   256 */    bUpdateFirst = 0;
/*   258 */    GUI_RECT rect;
/*   259 */    rect.x0 = 10;
/*   260 */    rect.x1 = (10 + 227) - 1;
/*   261 */    rect.y0 = 44 + 68;
/*   262 */    rect.y1 = (rect.y0 + 62) - 1;
/*   264 */    GUI_RECT rectDescLocal;
/*   265 */    rectDescLocal.x0 = 10 + 22;
/*   266 */    rectDescLocal.x1 = 145 - 1;
/*   267 */    rectDescLocal.y0 = 44 + 68;
/*   268 */    rectDescLocal.y1 = (rectDescLocal.y0 + 62) - 1;
/*   270 */    GUI_RECT rectOnOff;
/*   271 */    rectOnOff.x0 = 10 + 145;
/*   272 */    rectOnOff.x1 = (rectOnOff.x0 + 80) - 1;
/*   273 */    rectOnOff.y0 = 44 + 2 + 68;
/*   274 */    rectOnOff.y1 = (rectOnOff.y0 + 58) - 1;
/*   276 */    char *disableStatus = "-";
/*   278 */    for(int i = 0; i < IO_STATUS_COUNT; i++)
/*   279 */    {
/*   280 */       GUI_SetColor(0x494440);
/*   281 */       GUI_DrawRectEx(&rect);
/*   284 */       if(((ConnectSetting[gDeviceIndex].DeviceType == DEVICE_MCCB) &&
/*   285 */               (((i == ZSI_IN) && (gAmpareFrame[gDeviceIndex] <= 250))
/*   286 */                   || (i == ERMS)
/*   287 */                   || (i == DO3))))
/*   288 */       {
/*   289 */          GUI_SetBkColor(0x1c1b1a);
/*   290 */          GUI_SetColor(0x494949);
/*   291 */          LanguageSelect(FONT20);
/*   292 */          GUI_DispStringInRect(_acacbmccb_iostatus_text[i], &rectDescLocal, (0) | (3<<2));
/*   294 */          GUI_SetColor(0x494949);
/*   295 */          GUI_FillRectEx(&rectOnOff);
/*   296 */          GUI_SetColor(0xc8c8c8);
/*   297 */          GUI_SetBkColor(0x494949);
/*   298 */          GUI_DispStringInRect(disableStatus, &rectOnOff, (2<<0) | (3<<2));
/*   299 */       }
/*   300 */       else
/*   301 */       {
/*   302 */          GUI_SetBkColor(0x1c1b1a);
/*   303 */          GUI_SetColor(0xc8c8c8);
/*   304 */          LanguageSelect(FONT20);
/*   305 */          GUI_DispStringInRect(_acacbmccb_iostatus_text[i], &rectDescLocal, (0) | (3<<2));
/*   306 */          if(nDioStatus[IoStatus_Offset[i]] & IoStatus_bit[i])
/*   307 */          {
/*   308 */             GUI_SetColor(0x0fce00);
/*   309 */             GUI_SetBkColor(0x0fce00);
/*   310 */             GUI_FillRectEx(&rectOnOff);
/*   311 */             GUI_SetColor(0x00FFFFFF);
/*   312 */             LanguageSelect(FONT20B);
/*   313 */             GUI_DispStringInRect(_aconoff_text[SettingValue[SETUP_LANGUAGE]][1], &rectOnOff, (2<<0) | (3<<2));
/*   314 */          }
/*   315 */          else
/*   316 */          {
/*   317 */             GUI_SetColor(0x494949);
/*   318 */             GUI_SetBkColor(0x494949);
/*   319 */             GUI_FillRectEx(&rectOnOff);
/*   320 */             GUI_SetColor(0x00FFFFFF);
/*   321 */             LanguageSelect(FONT20B);
/*   322 */             GUI_DispStringInRect(_aconoff_text[SettingValue[SETUP_LANGUAGE]][0], &rectOnOff, (2<<0) | (3<<2));
/*   323 */          }
/*   324 */       }
/*   325 */       if(i == ERMS)
/*   326 */       {
/*   327 */          rect.x0 += 232;
/*   328 */          rect.x1 += 232;
/*   329 */          rectDescLocal.x0 += 232;
/*   330 */          rectDescLocal.x1 += 232;
/*   331 */          rectOnOff.x0 += 232;
/*   332 */          rectOnOff.x1 += 232;
/*   334 */          rect.y0 = 44 + 68;
/*   335 */          rect.y1 = (rect.y0 + 62) - 1;
/*   336 */          rectDescLocal.y0 = 44 + 68;
/*   337 */          rectDescLocal.y1 = (rectDescLocal.y0 + 62) - 1;
/*   338 */          rectOnOff.y0 = 44 + 2 + 68;
/*   339 */          rectOnOff.y1 = (rectOnOff.y0 + 58) - 1;
/*   340 */       }
/*   341 */       else
/*   342 */       {
/*   343 */          rect.y0 += 68;
/*   344 */          rect.y1 += 68;
/*   346 */          rectDescLocal.y0 += 68;
/*   347 */          rectDescLocal.y1 += 68;
/*   349 */          rectOnOff.y0 += 68;
/*   350 */          rectOnOff.y1 += 68;
/*   351 */       }
/*   352 */    }
/*   353 */ }
/*   355 */ static void AcbMccbControlDisp(void)
/*   356 */ {
/*   357 */    GUI_SetBkColor(0x1c1b1a);
/*   358 */    (void)GUI_SetPenSize(2);
/*   359 */    (void)GUI_SetFont(&GUI_Font20_ASCII);
/*   361 */    GUI_ClearRect(0, 34, 480-1, 320-1);
/*   363 */    GUI_RECT rect;
/*   364 */    rect.x0 = 10;
/*   365 */    rect.x1 = (10 + 232 + 227) - 1;
/*   366 */    rect.y0 = 44;
/*   367 */    rect.y1 = 44 + 62;
/*   369 */    GUI_RECT rectDescLocal;
/*   370 */    rectDescLocal.x0 = 10 + 22;
/*   371 */    rectDescLocal.x1 = (rectDescLocal.x0 + 227) - 1;
/*   372 */    rectDescLocal.y0 = 44;
/*   373 */    rectDescLocal.y1 = (rectDescLocal.y0 + 62) - 1;
/*   375 */    if(gCommStatus[gDeviceIndex] == COMM_OK)
/*   376 */    {
/*   377 */       GUI_SetColor(0xd07b18);
/*   378 */       GUI_FillRectEx(&rect);
/*   380 */       GUI_SetBkColor(0xd07b18);
/*   381 */       GUI_SetColor(0x00FFFFFF);
/*   382 */       LanguageSelect(FONT20B);
/*   383 */    }
/*   384 */    else
/*   385 */    {
/*   386 */       GUI_SetColor(0x1c1b1a);
/*   387 */       GUI_FillRectEx(&rect);
/*   390 */       GUI_SetColor(0x494949);
/*   392 */       GUI_SetColor(0x494440);
/*   393 */       GUI_DrawRectEx(&rect);
/*   394 */       LanguageSelect(FONT20);
/*   395 */    }
/*   399 */    GUI_DispStringInRect(_acacbmccb_cbstatus_control_text[SettingValue[SETUP_LANGUAGE]], &rectDescLocal, (0) | (3<<2));
/*   401 */    GUI_SetColor(0x00000000);
/*   403 */    if(ConnectSetting[gDeviceIndex].DeviceType == DEVICE_MCCB)
/*   404 */    {
/*   405 */       GUI_FillRectEx(&rectMccbBox);
/*   406 */       for(int i = 0; i < INDEX_3; i++)
/*   407 */       {
/*   408 */          GUI_SetColor(colorOffFillColor[i]);
/*   409 */          GUI_FillRectEx(&rectMccbStatus[i]);
/*   411 */          GUI_SetBkColor(colorOffFillColor[i]);
/*   412 */          GUI_SetColor(colorOffTextColor[i]);
/*   413 */          GUI_DispStringInRect(_accb_status[SettingValue[SETUP_LANGUAGE]][i], &rectMccbStatus[i], (2<<0) | (3<<2));
/*   415 */       }
/*   416 */    }
/*   417 */    else
/*   418 */    {
/*   419 */       GUI_FillRectEx(&rectAcbBox);
/*   420 */       for(int i = 0; i < INDEX_2; i++)
/*   421 */       {
/*   422 */          GUI_SetColor(colorOffFillColor[i]);
/*   423 */          GUI_FillRectEx(&rectAcbStatus[i]);
/*   425 */          GUI_SetBkColor(colorOffFillColor[i]);
/*   426 */          GUI_SetColor(colorOffTextColor[i]);
/*   427 */          GUI_DispStringInRect(_accb_status[SettingValue[SETUP_LANGUAGE]][i], &rectAcbStatus[i], (2<<0) | (3<<2));
/*   429 */       }
/*   430 */    }
/*   431 */    rect.x0 = 10;
/*   432 */    rect.x1 = (10 + 227) - 1;
/*   433 */    rect.y0 = 44 + 68;
/*   434 */    rect.y1 = (rect.y0 + 62) - 1;
/*   436 */    rectDescLocal.x0 = 10 + 22;
/*   437 */    rectDescLocal.x1 = 145 - 1;
/*   438 */    rectDescLocal.y0 = 44 + 68;
/*   439 */    rectDescLocal.y1 = (rectDescLocal.y0 + 62) - 1;
/*   441 */    GUI_RECT rectOnOff;
/*   442 */    rectOnOff.x0 = 10 + 145;
/*   443 */    rectOnOff.x1 = (rectOnOff.x0 + 80) - 1;
/*   444 */    rectOnOff.y0 = 44 + 2 + 68;
/*   445 */    rectOnOff.y1 = (rectOnOff.y0 + 58) - 1;
/*   447 */    char *disableStatus = "-";
/*   449 */    for(int i = 0; i < IO_STATUS_COUNT; i++)
/*   450 */    {
/*   451 */       GUI_SetColor(0x494440);
/*   452 */       GUI_DrawRectEx(&rect);
/*   454 */       GUI_SetBkColor(0x1c1b1a);
/*   455 */       GUI_SetColor(0x494949);
/*   456 */       LanguageSelect(FONT20);
/*   457 */       GUI_DispStringInRect(_acacbmccb_iostatus_text[i], &rectDescLocal, (0) | (3<<2));
/*   459 */       GUI_SetColor(0x494949);
/*   460 */       GUI_FillRectEx(&rectOnOff);
/*   461 */       GUI_SetColor(0xc8c8c8);
/*   462 */       GUI_SetBkColor(0x494949);
/*   463 */       if(ConnectSetting[gDeviceIndex].DeviceType == DEVICE_MCCB)
/*   464 */       {
/*   465 */          LanguageSelect(FONT20B);
/*   466 */       }
/*   467 */       else
/*   468 */       {
/*   469 */          LanguageSelect(FONT20);
/*   470 */       }
/*   471 */       GUI_DispStringInRect(disableStatus, &rectOnOff, (2<<0) | (3<<2));
/*   473 */       if(i == ERMS)
/*   474 */       {
/*   475 */          rect.x0 += 232;
/*   476 */          rect.x1 += 232;
/*   477 */          rectDescLocal.x0 += 232;
/*   478 */          rectDescLocal.x1 += 232;
/*   479 */          rectOnOff.x0 += 232;
/*   480 */          rectOnOff.x1 += 232;
/*   482 */          rect.y0 = 44 + 68;
/*   483 */          rect.y1 = (rect.y0 + 62) - 1;
/*   484 */          rectDescLocal.y0 = 44 + 68;
/*   485 */          rectDescLocal.y1 = (rectDescLocal.y0 + 62) - 1;
/*   486 */          rectOnOff.y0 = 44 + 2 + 68;
/*   487 */          rectOnOff.y1 = (rectOnOff.y0 + 58) - 1;
/*   488 */       }
/*   489 */       else
/*   490 */       {
/*   491 */          rect.y0 += 68;
/*   492 */          rect.y1 += 68;
/*   494 */          rectDescLocal.y0 += 68;
/*   495 */          rectDescLocal.y1 += 68;
/*   497 */          rectOnOff.y0 += 68;
/*   498 */          rectOnOff.y1 += 68;
/*   499 */       }
/*   500 */    }
/*   501 */ }
/*   527 */ void AcbMccbControl(void)
/*   528 */ {
/*   529 */    unsigned char bRecvData;
/*   530 */    int flagBreak = 0;
/*   531 */    bRecvData = 0;
/*   532 */    bUpdateFirst = 1;
/*   533 */    AcbMccbControlDisp();
/*   534 */    gStatusSendEnd = STATUS_SEND_ING;
/*   535 */    statusSendStep = 0;
/*   536 */    nSendStep = 0;
/*   537 */    AcbMccbControlSend();
/*   538 */    int bCommError = gCommStatus[gDeviceIndex];
/*   539 */    while (1)
/*   540 */    {
/*   541 */       E_KEY key = GetKey();
/*   543 */       if(key == TIME_OUT)
/*   544 */       {
/*   545 */          gStatusSendEnd = STATUS_SEND_ING;
/*   546 */          nSendStep = 0;
/*   547 */          AcbMccbControlSend();
/*   548 */       }
/*   549 */       else
/*   550 */       if(key == KEY_ENTER)
/*   551 */       {
/*   552 */          if(bRecvData == 1)
/*   553 */          {
/*   554 */             int flag = ControlCheck();
/*   555 */             (void)printf("nRemote=%d, flag=%d\n", nRemote, flag);
/*   556 */             if((nRemote == 1) && (flag == 1))
/*   557 */             {
/*   558 */                char buf[60];
/*   559 */                unsigned char status = AcbMccbcbStatus;
/*   560 */                unsigned short address=12;
/*   562 */                if(ConnectSetting[gDeviceIndex].DeviceType == DEVICE_MCCB)
/*   563 */                {
/*   564 */                   if(status == 2)
/*   565 */                   {
/*   566 */                      status = 0;
...
/*   574 */                else
/*   575 */                {
/*   576 */                   if(nTrio != INDEX_7)
/*   577 */                   {
/*   578 */                      address = 40;
/*   579 */                   }
/*   580 */                }
/*   581 */                (void)sprintf(buf, _acacbMccbcontrol_confirm_text[SettingValue[SETUP_LANGUAGE]], _accb_control_status[SettingValue[SETUP_LANGUAGE]][AcbMccbcbStatus]);
/*   582 */                ControlSet(status, address, 0, buf, 1);
/*   583 */             }
/*   584 */             else
/*   585 */             {
/*   586 */                ControlErrorMessage(_acCBSetting_invalid_text[SettingValue[SETUP_LANGUAGE]]);
/*   587 */             }
/*   588 */             bUpdateFirst = 1;
/*   589 */             DispStatus();
/*   590 */             AcbMccbControlDisp();
/*   591 */             AcbMccbControlSend();
/*   592 */             gCommOldStatus[gDeviceIndex] = -1;
/*   593 */             CommTimerInit();
/*   594 */          }
/*   595 */       }
/*   596 */       else
/*   597 */       if(key == KEY_SETUP)
/*   598 */       {
/*   599 */          if(Setup() == SETUP_CHANGED)
/*   600 */          {
/*   601 */             flagBreak = 1;
/*   602 */          }
/*   603 */          AcbMccbControlDisp();
/*   604 */          gCommOldStatus[gDeviceIndex] = -1;
/*   605 */          AcbMccbControlSend();
/*   606 */       }
/*   607 */       else
/*   608 */       if(key == DATA_RECV)
/*   609 */       {
/*   610 */          (void)printf("DATA_RECV gStatusSendEnd=%d\n",gStatusSendEnd);
/*   611 */          if(bCommError == COMM_ERROR)
/*   612 */          {
/*   613 */             AcbMccbControlDisp();
/*   614 */             bCommError = COMM_OK;
/*   615 */          }
/*   616 */          if(gStatusSendEnd == STATUS_SEND_ING)
/*   617 */          {
/*   618 */             StatusRecv();
/*   619 */             AcbMccbControlSend();
/*   620 */          }
/*   621 */          else
/*   622 */          {
/*   623 */             AcbMccbIoValueDisp();
/*   624 */             g_bRecvAllDone = 1;
/*   625 */             nSendStep = 0;
/*   626 */             statusSendStep = 0;
/*   627 */             gStatusSendEnd = STATUS_SEND_ING;
/*   628 */             bRecvData = 1;
/*   629 */          }
/*   630 */       }
/*   631 */       else
/*   632 */       if(key == KEY_CANCEL)
/*   633 */       {
/*   634 */          flagBreak = 1;
/*   635 */       }
/*   636 */       else
/*   637 */       if(key == KEY_COMM_ERROR)
/*   638 */       {
/*   640 */          (void)printf("COMM Error!!! gStatusSendEnd=%d, statusSendStep=%d, nSendStep=%d\n",gStatusSendEnd,statusSendStep,nSendStep);
/*   641 */          if(StatusRecvErrorProcess() == STATUS_SEND_ING)
/*   642 */          {
/*   643 */             nSendStep = 0;
/*   644 */          }
/*   645 */          else
/*   646 */          {
/*   647 */             AcbMccbControlSend();
/*   648 */             g_bRecvAllDone = 1;
/*   649 */             (void)printf("All done!!!\n");
/*   650 */             gStatusSendEnd = STATUS_SEND_ING;
/*   651 */             statusSendStep = 0;
/*   652 */             nSendStep = 0;
/*   653 */          }
/*   672 */       }
/*   673 */       else
/*   674 */       if(key == COMM_STAT_ERROR)
/*   675 */       {
/*   676 */          bUpdateFirst = 1;
/*   677 */          (void)printf("COMM_STAT_ERROR\n\n");
/*   678 */          bCommError = COMM_ERROR;
/*   679 */          AcbMccbControlDisp();
/*   680 */       }
/*   681 */       else {}
/*   682 */       if(flagBreak == 1)
/*   683 */       {
