...
/*
 * C:/CodeInspection/DisplayUnit/STemWin/App/AcbMccbInfo.c
 */
/*    38 */ static void InfoSend(int menu);
/*    39 */ static void InfoValueDisp(int pos, int count);
/*    40 */ static void InfoInitDisp(int pos);
/*    41 */ static void InfoDisp(int pos);
/*    58 */ static void InfoSend(int menu)
/*    59 */ {
/*    60 */    if(StatusSend() == STATUS_SEND_ING)
/*    61 */    {
/*    62 */       return;
/*    63 */    }
/*    64 */    (void)printf("InfoSend() nSendStep=%d\n", nSendStep);
/*    65 */    if(menu == 0)
/*    66 */    {
/*    67 */       if(nSendStep == 0)
/*    68 */       {
/*    69 */          ModbusSendFrameDeviceIdentofocation3(ConnectSetting[gDeviceIndex].Address, 1, 0);
/*    70 */       }
/*    71 */       else
/*    72 */       {
/*    73 */          ModbusSendFrameDeviceIdentofocation3(ConnectSetting[gDeviceIndex].Address, INDEX_3, 0x80);
/*    74 */       }
/*    75 */    }
/*    76 */    else
/*    77 */    {
/*    78 */       if(ConnectSetting[gDeviceIndex].DeviceType == DEVICE_ACB)
/*    79 */       {
/*    80 */          ModbusSendFrame(ConnectSetting[gDeviceIndex].Address, INPUT_REGISTER, 1759, 11);
/*    81 */       }
/*    82 */       else
/*    83 */       if(ConnectSetting[gDeviceIndex].DeviceType == DEVICE_MCCB)
/*    84 */       {
/*    85 */          ModbusSendFrame(ConnectSetting[gDeviceIndex].Address, INPUT_REGISTER, 1201, 11);
/*    86 */       }
/*    87 */       else {}
/*    88 */    }
/*    89 */ }
/*    93 */ void InfoMenu(int menu, int pos, int count)
/*    94 */ {
/*    95 */    GUI_SetBkColor(0x1c1b1a);
/*    96 */    GUI_ClearRect(0, 34, 480-1, 320-1);
/*    98 */    GUI_RECT rect;
/*    99 */    rect.x0 = 50;
/*   100 */    rect.x1 = (50 + 460) - 1;
/*   101 */    rect.y0 = 45;
/*   102 */    rect.y1 = (45 + 88) - 1;
/*   104 */    int y0 = 45;
...
/*   107 */       if(i == pos)
/*   108 */       {
/*   109 */          GUI_SetColor(0xd07b18);
/*   110 */       }
/*   111 */       else
/*   112 */       {
/*   113 */          GUI_SetColor(0x2f2c2a);
/*   114 */       }
/*   115 */       GUI_FillRect(10, y0, (10 + 460) - 1, (y0 + 88) - 1);
/*   117 */       if(i == pos)
/*   118 */       {
/*   119 */          LanguageSelect(FONT24B);
/*   120 */          GUI_SetColor(0x00FFFFFF);
/*   121 */          GUI_SetBkColor(0xd07b18);
/*   122 */       }
/*   123 */       else
/*   124 */       {
/*   125 */          LanguageSelect(FONT24);
/*   126 */          GUI_SetColor(0xc8c8c8);
/*   127 */          GUI_SetBkColor(0x2f2c2a);
/*   128 */       }
/*   130 */       GUI_DispStringInRect(_acinfo_menu_text[SettingValue[SETUP_LANGUAGE]][menu][i], &rect, (0) | (3<<2));
/*   131 */       rect.y0 += 88 + 1;
/*   132 */       rect.y1 += 88 + 1;
/*   133 */       y0 += 88 + 1;;
/*   134 */    }
/*   135 */ }
/*   136 */ static void InfoValueDisp(int pos, int count)
/*   137 */ {
/*   138 */    char buf[INDEX_6][60];
/*   139 */    unsigned short wValue;
/*   140 */    uint32_t dValue;
/*   142 */    (void)printf("InfoValueDisp() nSendStep=%d\n", nSendStep);
/*   144 */    GUI_SetBkColor(0x1c1b1a);
/*   146 */    if(pos == 0)
/*   147 */    {
/*   148 */       if(nSendStep == 0)
/*   149 */       {
...
/*   155 */       else
/*   156 */       {
/*   157 */          (void)sprintf(buf[0], "%s", VendorName);
/*   159 */          ModbusGetId3();
/*   160 */          (void)sprintf(buf[1], "%s(%s)", gProductName[gDeviceIndex], productCode);
/*   161 */          (void)sprintf(buf[INDEX_2], "%s", hardwarVersion);
/*   162 */          (void)sprintf(buf[INDEX_3], "%s", softwareVersion);
/*   163 */          (void)sprintf(buf[INDEX_4], "%s", ModbusVersion);
/*   164 */          (void)sprintf(buf[INDEX_5], "%s", serialNo);
/*   165 */          nSendStep = 0;
/*   166 */       }
/*   167 */    }
/*   168 */    else if(pos == 1)
/*   169 */    {
/*   170 */       if(ConnectSetting[gDeviceIndex].DeviceType == DEVICE_ACB)
/*   171 */       {
/*   172 */          dValue = (ModbusGetUint32(1759));
/*   173 */          (void)sprintf(buf[INDEX_0], "%dh", dValue);
/*   174 */          dValue = (ModbusGetUint32(1761));
/*   175 */          (void)sprintf(buf[INDEX_1], "%dh", dValue);
/*   176 */          dValue = (ModbusGetUint32(1763));
/*   177 */          (void)sprintf(buf[INDEX_2], "%d", dValue);
/*   178 */          dValue += (ModbusGetUint32(1765));
/*   179 */          (void)sprintf(buf[INDEX_3], "%d", dValue);
/*   180 */          dValue = (ModbusGetUint32(1767));
/*   181 */          (void)sprintf(buf[INDEX_4], "%d", dValue);
/*   182 */          wValue = (ModbusGetUint16(1769));
/*   183 */          (void)sprintf(buf[INDEX_5], "%d", wValue);
/*   184 */          int len = strlen(buf[INDEX_5]);
/*   185 */          buf[INDEX_5][len++] = '%';
/*   186 */          buf[INDEX_5][len] = 0;
/*   187 */       }
/*   188 */       else
/*   189 */       if(ConnectSetting[gDeviceIndex].DeviceType == DEVICE_MCCB)
/*   190 */       {
/*   191 */          dValue = (ModbusGetUint32(1201));
/*   192 */          (void)sprintf(buf[INDEX_0], "%dh", dValue);
/*   193 */          dValue = (ModbusGetUint32(1203));
/*   194 */          (void)sprintf(buf[INDEX_1], "%dh", dValue);
/*   195 */          dValue = (ModbusGetUint32(1207));
/*   196 */          (void)sprintf(buf[INDEX_2], "%d", dValue);
/*   197 */          dValue = (ModbusGetUint32(1205));
/*   198 */          (void)sprintf(buf[INDEX_3], "%d", dValue);
/*   199 */          dValue = (ModbusGetUint32(1209));
/*   200 */          (void)sprintf(buf[INDEX_4], "%d", dValue);
/*   201 */          wValue = (ModbusGetUint16(1211));
/*   202 */          (void)sprintf(buf[INDEX_5], "%d", wValue);
/*   203 */          int len = strlen(buf[INDEX_5]);
/*   204 */          buf[INDEX_5][len++] = '%';
/*   205 */          buf[INDEX_5][len] = 0;
/*   206 */       }
/*   207 */       else {}
/*   208 */       nSendStep = 0;
/*   209 */    }
/*   210 */    else {}
/*   212 */    GUI_SetColor(0x00FFFFFF);
/*   213 */    GUI_RECT rect;
/*   214 */    GUI_RECT rect2;
/*   215 */    rect.x0 = ((10 + 150) + 50);
/*   216 */    rect.y0 = 46 + INDEX_2;
/*   217 */    rect.x1 = ((340 + 100) - 1);
/*   218 */    rect.y1 = (46 + 44) - INDEX_4;
/*   220 */    rect2.x0 = ((10 + 150) + 50) - INDEX_80;
/*   221 */    rect2.y0 = 46 + INDEX_2;
/*   222 */    rect2.x1 = ((340 + 100) - 1);
/*   223 */    rect2.y1 = (46 + 44) - INDEX_4;
/*   225 */    (void)GUI_SetFont(&GUI_Font20B_ASCII);
/*   226 */    for(int i = 0 ; i < count; i++)
/*   227 */    {
/*   228 */       if((pos == 0) && (i == 1))
/*   229 */       {
/*   230 */          GUI_ClearRectEx(&rect2);
/*   231 */          GUI_DispStringInRect(buf[i], &rect2, (1<<0) | (3<<2));
/*   232 */       }
/*   233 */       else
/*   234 */       {
/*   235 */          GUI_ClearRectEx(&rect);
/*   236 */          GUI_DispStringInRect(buf[i], &rect, (1<<0) | (3<<2));
/*   237 */       }
/*   238 */       rect.y0 += 44;
/*   239 */       rect.y1 += 44;
/*   240 */       rect2.y0 += 44;
...
/*   242 */    }
/*   243 */ }
/*   244 */ static void InfoInitDisp(int pos)
/*   245 */ {
/*   246 */    int count = 6;
/*   248 */    GUI_SetBkColor(0x1c1b1a);
/*   249 */    (void)GUI_SetFont(&GUI_Font20_ASCII);
/*   251 */    (void)GUI_SetPenSize(2);
/*   252 */    GUI_SetColor(0x494440);
/*   254 */    GUI_ClearRect(0, 34, 480-1, 320-1);
/*   255 */    GUI_DrawRect(10, 45, (10 + 460)-1, (45 + (44 * count )) - 1);
/*   257 */    for(int i = 0; i < (count-1); i++)
/*   258 */    {
/*   259 */       if((pos == INDEX_1) && (i == INDEX_2))
/*   260 */       {
/*   261 */          continue;
/*   262 */       }
/*   263 */       int y0 = 45 + ((i + 1) * 44);
/*   264 */       GUI_DrawHLine(y0, 10+INDEX_2, (10 + 460)-1);
/*   265 */    }
/*   267 */    GUI_SetColor(0xc8c8c8);
/*   268 */    GUI_RECT rect;
/*   269 */    rect.x0 = 41;
/*   270 */    rect.y0 = 46;
/*   271 */    rect.x1 = (41 + 150 + INDEX_20) - 1;
/*   272 */    rect.y1 = (46 + 44) - 1;
/*   274 */    LanguageSelect(FONT20);
/*   275 */    for(int i = 0 ; i < count; i++)
/*   276 */    {
/*   277 */       GUI_DispStringInRect(_acinfo_label_text[SettingValue[SETUP_LANGUAGE]][pos][i], &rect, (0) | (3<<2));
/*   278 */       rect.y0 += 44;
/*   279 */       rect.y1 += 44;
/*   280 */    }
/*   281 */ }
/*   283 */ static void InfoDisp(int pos)
/*   284 */ {
/*   285 */    int flagBreak = 0;
/*   286 */    int count = 6;
/*   287 */    InfoInitDisp(pos);
/*   289 */    nSendStep = 0;
/*   291 */    InfoSend(pos);
/*   293 */    while (1)
/*   294 */    {
/*   295 */       E_KEY key = GetKey();
/*   297 */       if(key == TIME_OUT)
/*   298 */       {
/*   299 */          gStatusSendEnd = STATUS_SEND_ING;
/*   300 */          nSendStep = 0;
/*   301 */          InfoSend(pos);
/*   302 */       }
/*   303 */       else
/*   304 */       if(key == KEY_SETUP)
/*   305 */       {
/*   306 */          if(Setup() == SETUP_CHANGED)
/*   307 */          {
/*   308 */             flagBreak = 1;
/*   309 */          }
/*   310 */          InfoInitDisp(pos);
/*   311 */          gCommOldStatus[gDeviceIndex] = -1;
/*   312 */       }
/*   313 */       else
/*   314 */       if(key == DATA_RECV)
/*   315 */       {
/*   316 */          (void)printf("DATA_RECV gStatusSendEnd=%d\n",gStatusSendEnd);
/*   317 */          if(gStatusSendEnd == STATUS_SEND_ING)
/*   318 */          {
/*   319 */             StatusRecv();
/*   320 */             InfoSend(pos);
/*   321 */          }
...
/*   329 */             else
/*   330 */             {
/*   331 */                g_bRecvAllDone = 1;
/*   332 */                nSendStep = 0;
/*   333 */                statusSendStep = 0;
/*   334 */                gStatusSendEnd = STATUS_SEND_ING;
/*   335 */             }
/*   336 */          }
/*   337 */       }
/*   338 */       else
/*   339 */       if(key == KEY_CANCEL)
/*   340 */       {
/*   341 */          flagBreak = 1;
/*   342 */       }
/*   343 */       else
/*   344 */       if(key == KEY_COMM_ERROR)
/*   345 */       {
/*   346 */          if(gStatusSendEnd == STATUS_SEND_END)
/*   347 */          {
/*   348 */             nSendStep++;
/*   349 */          }
/*   350 */          (void)printf("COMM Error!!! gStatusSendEnd=%d, statusSendStep=%d, nSendStep=%d\n",gStatusSendEnd,statusSendStep,nSendStep);
/*   351 */          if(StatusRecvErrorProcess() == STATUS_SEND_ING)
/*   352 */          {
/*   353 */             nSendStep = 0;
/*   354 */          }
/*   355 */          else
/*   356 */          {
/*   357 */             int stepMax = INDEX_2;
/*   358 */             if(pos == 1)
/*   359 */             {
/*   360 */                stepMax = 1;
/*   361 */             }
/*   363 */             if(nSendStep < stepMax)
/*   364 */             {
/*   365 */                InfoSend(pos);
/*   366 */             }
/*   367 */             else
/*   368 */             {
/*   369 */                g_bRecvAllDone = 1;
/*   370 */                (void)printf("All done!!!\n");
/*   371 */                gStatusSendEnd = STATUS_SEND_ING;
/*   372 */                statusSendStep = 0;
/*   373 */                nSendStep = 0;
/*   374 */             }
/*   375 */          }
/*   376 */       }
/*   377 */       else
/*   378 */       if(key == COMM_STAT_ERROR)
/*   379 */       {
/*   380 */          InfoInitDisp(pos);
/*   381 */       }
/*   382 */       else {}
/*   384 */       if(flagBreak == 1)
/*   385 */       {
...
/*   389 */    }
/*   390 */ }
/*   404 */ void AcbMccbInfomation(void)
/*   405 */ {
/*   406 */    int flagBreak = 0;
/*   407 */    nMenuPos = 0;
/*   409 */    InfoMenu(0, nMenuPos, 2);
/*   411 */    GUI_SetBkColor(0x1c1b1a);
/*   412 */    (void)GUI_SetPenSize(2);
/*   413 */    GUI_SetColor(0x494440);
/*   414 */    gStatusSendEnd = STATUS_SEND_ING;
/*   415 */    (void)StatusSend();
/*   417 */    while (1)
/*   418 */    {
/*   419 */       E_KEY key = GetKey();
/*   421 */       if(key == TIME_OUT)
/*   422 */       {
/*   423 */          gStatusSendEnd = STATUS_SEND_ING;
/*   424 */          (void)StatusSend();
/*   425 */       }
/*   426 */       else
/*   427 */       if(key == KEY_SETUP)
/*   428 */       {
/*   429 */          if(Setup() == SETUP_CHANGED)
/*   430 */          {
/*   431 */             flagBreak = 1;
/*   432 */          }
/*   433 */          InfoMenu(0, nMenuPos, 2);
/*   434 */       }
/*   435 */       else
/*   436 */       if(key == KEY_UP)
/*   437 */       {
...
/*   457 */             nMenuPos = 0;
/*   458 */          }
/*   459 */          InfoMenu(0, nMenuPos, 2);
/*   460 */       }
/*   461 */       else
/*   462 */       if(key == KEY_ENTER)
/*   463 */       {
/*   464 */          InfoSend(nMenuPos);
/*   465 */          InfoDisp(nMenuPos);
/*   466 */          InfoMenu(0, nMenuPos, 2);
/*   467 */       }
/*   468 */       else
/*   469 */       if(key == DATA_RECV)
/*   470 */       {
/*   471 */          StatusRecv();
/*   472 */          if(gStatusSendEnd == STATUS_SEND_ING)
/*   473 */          {
/*   474 */             (void)StatusSend();
/*   475 */          }
/*   476 */          else
/*   477 */          {
/*   478 */             g_bRecvAllDone = 1;
/*   479 */             nSendStep = 0;
/*   480 */             statusSendStep = 0;
/*   481 */             gStatusSendEnd = STATUS_SEND_ING;
/*   482 */          }
/*   483 */       }
/*   484 */       else
/*   485 */       if(key == KEY_CANCEL)
/*   486 */       {
/*   487 */          flagBreak = 1;
/*   488 */       }
/*   489 */       else
/*   490 */       if(key == KEY_COMM_ERROR)
/*   491 */       {
/*   492 */          (void)printf("COMM Error!! gStatusSendEnd=%d, statusSendStep=%d\n",gStatusSendEnd,statusSendStep);
/*   493 */          if(StatusRecvErrorProcess() == STATUS_SEND_ING)
/*   494 */          {
/*   495 */             nSendStep = 0;
/*   496 */          }
/*   497 */          else
/*   498 */          {
/*   499 */             g_bRecvAllDone = 1;
/*   500 */             (void)printf("All done!!!\n");
/*   501 */             gStatusSendEnd = STATUS_SEND_ING;
/*   502 */             statusSendStep = 0;
/*   503 */             nSendStep = 0;
/*   504 */          }
/*   505 */       }
/*   506 */       else
/*   507 */       if(key == COMM_STAT_ERROR)
/*   508 */       {
/*   510 */       }
/*   511 */       else {}
/*   512 */       if(flagBreak == 1)
