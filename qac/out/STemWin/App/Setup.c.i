...
/*
 * C:/CodeInspection/DisplayUnit/STemWin/App/Setup.c
 */
/*    29 */ static void DeviceDescroptionSend(unsigned short device);
/*    30 */ static void DeviceDescriptionDisp(unsigned short device);
/*    31 */ static void DisplayConnectSettingMenu(int pos, unsigned short device, unsigned char flag);
/*    32 */ static void DisplayConnectSetting(void);
/*    33 */ static void DisplaySettingMenu(int page, int pos, int flag);
/*    34 */ static void SettingMenuExec(int nPage, int nPos);
/*    35 */ static void DisplaySetting(void);
/*    36 */ static void SetupDeviceInfoValueDisp(void);
/*    37 */ static void DisplayDeviceDisp(void);
/*    38 */ static void SetInfoMenu(int menu, int pos, int count, int flag);
/*    40 */ static char deviceDescription[60];
/*    42 */ static void FactoryRest(void);
/*    43 */ static void FactoryResetInitDisp(void);
/*    44 */ static void DisplayDeviceDispValue(void);
/*    53 */ static void DeviceDescroptionSend(unsigned short device)
/*    54 */ {
/*    55 */    (void)sprintf(deviceDescription, "");
/*    56 */    unsigned short address;
/*    57 */    if(ConnectSetting[device-1].DeviceType == DEVICE_MLINK)
/*    58 */    {
/*    59 */       address = 2501;
/*    60 */    }
/*    61 */    else
/*    62 */    if((ConnectSetting[device-1].DeviceType == DEVICE_ACB) || (ConnectSetting[device-1].DeviceType == DEVICE_MCCB))
/*    63 */    {
/*    64 */       address = 1;
/*    65 */    }
/*    66 */    else
...
/*    68 */       return;
/*    69 */    }
/*    70 */    ModbusSendFrame(ConnectSetting[device-1].Address, HOLDING_REGISTER, address, 16);
/*    71 */ }
/*    73 */ static void DeviceDescriptionDisp(unsigned short device)
/*    74 */ {
/*    86 */    unsigned short address = 1;
/*    87 */    if(ConnectSetting[device-1].DeviceType == DEVICE_MLINK)
/*    88 */    {
/*    89 */       address = 2501;
/*    90 */    }
/*    91 */    char buf[60];
/*    92 */    ModbusGetString(address, INDEX_32, buf);
/*    94 */    if(strlen(buf) > INDEX_16)
/*    95 */    {
/*    96 */       buf[INDEX_16] = '.';
/*    97 */       buf[INDEX_17] = '.';
/*    98 */       buf[INDEX_18] = '.';
/*    99 */       buf[INDEX_19] = 0;
/*   100 */    }
/*   102 */    (void)sprintf(deviceDescription, "%s", buf);
/*   105 */ }
/*   107 */ static void DisplayConnectSettingMenu(int pos, unsigned short device, unsigned char flag)
/*   108 */ {
/*   109 */    int count = 6-1;
/*   111 */    GUI_SetBkColor(0x1c1b1a);
/*   112 */    (void)GUI_SetFont(&GUI_Font20_ASCII);
/*   114 */    (void)GUI_SetPenSize(2);
/*   115 */    GUI_SetColor(0x494440);
/*   117 */    if(flag)
/*   118 */    {
/*   119 */       GUI_ClearRect(0, 0, 480-1, 320-1);
/*   121 */       GUI_SetColor(0x2a2826);
/*   122 */       GUI_FillRect(10, 10, (10 + 460) - 1, (10 + (50 * count )) - 1);
/*   123 */    }
/*   125 */    int y0 = 10;
/*   127 */    GUI_RECT rect;
/*   128 */    rect.x0 = 30;
/*   129 */    rect.y0 = 10;
/*   130 */    rect.x1 = ((30 + 245) - 1);
/*   131 */    rect.y1 = (10 + 50) - 1;
/*   133 */    GUI_RECT rect2;
/*   134 */    rect2.x0 = 280;
/*   135 */    rect2.y0 = 10;
/*   136 */    rect2.x1 = ((280 + 180) - 1);
/*   137 */    rect2.y1 = (10 + 50) - 1;
/*   139 */    char buf[20];
/*   140 */    for(int i = 0 ; i < count; i++)
/*   141 */    {
/*   142 */       if(i == pos)
/*   143 */       {
/*   144 */          GUI_SetColor(0xd07b18);
/*   145 */       }
/*   146 */       else
/*   147 */       {
/*   148 */          GUI_SetColor(0x2f2c2a);
/*   149 */       }
/*   150 */       GUI_FillRect(10, y0, (10 + 460) - 1, (y0 + 50) - 1);
/*   152 */       if(i == pos)
/*   153 */       {
/*   155 */          LanguageSelect(FONT20B);
/*   156 */          GUI_SetColor(0x00FFFFFF);
/*   157 */          GUI_SetBkColor(0xd07b18);
/*   158 */       }
/*   159 */       else
/*   160 */       {
/*   162 */          LanguageSelect(FONT20);
/*   163 */          GUI_SetColor(0xc8c8c8);
/*   164 */          GUI_SetBkColor(0x2f2c2a);
/*   165 */       }
/*   167 */       GUI_DispStringInRect(_acsetup_disp_conn_label_text[SettingValue[SETUP_LANGUAGE]][i], &rect, (0) | (3<<2));
/*   169 */       (void)GUI_SetFont(&GUI_Font20B_ASCII);
/*   170 */       GUI_SetColor(0x00FFFFFF);
/*   171 */       if(i == INDEX_0)
/*   172 */       {
/*   173 */          (void)sprintf(buf, "%d", SettingValue[SETUP_DEVICE_COUNT]);
/*   174 */       }
/*   175 */       else
/*   176 */       if(i == INDEX_1)
/*   177 */       {
/*   178 */          (void)sprintf(buf, "%d", device);
/*   179 */       }
/*   180 */       else
/*   181 */       if(i == INDEX_2)
/*   182 */       {
/*   183 */          (void)sprintf(buf, "%03d", ConnectSetting[device-1].Address);
/*   184 */       }
/*   185 */       else
/*   186 */       if(i == INDEX_3)
/*   187 */       {
/*   188 */          if(ConnectSetting[device-1].DeviceType < DEVICE_NO)
/*   189 */          {
/*   190 */             (void)sprintf(buf, "%s", _acsetup_type[ConnectSetting[device-1].DeviceType]);
/*   191 */          }
/*   192 */          else
/*   193 */          {
/*   194 */             (void)sprintf(buf, "NotDefined");
/*   195 */          }
/*   196 */       }
/*   197 */       else
/*   198 */       if(i == INDEX_4)
/*   199 */       {
/*   201 */          (void)sprintf(buf, "%s", deviceDescription);
/*   202 */       }
/*   203 */       else {}
/*   204 */       GUI_DispStringInRect(buf, &rect2, (0) | (3<<2));
/*   206 */       rect.y0 += 50;
/*   207 */       rect.y1 += 50;
/*   208 */       rect2.y0 += 50;
/*   209 */       rect2.y1 += 50;
...
/*   211 */    }
/*   212 */ }
/*   214 */ static void DisplayConnectSetting(void)
/*   215 */ {
/*   216 */    int nPos = 0;
/*   217 */    unsigned short device = 1;
/*   219 */    DisplayConnectSettingMenu(nPos, device, 1);
/*   220 */    DeviceDescroptionSend(device);
/*   221 */    while (1)
/*   222 */    {
/*   223 */       E_KEY key = GetKey();
/*   225 */       if(key == KEY_UP)
/*   226 */       {
/*   227 */          if(nPos > 0)
/*   228 */          {
...
/*   233 */             nPos = 6 - INDEX_3;
/*   234 */          }
/*   235 */          DisplayConnectSettingMenu(nPos, device, 0);
/*   236 */       }
/*   237 */       else
/*   238 */       if(key == KEY_DOWN)
/*   239 */       {
/*   240 */          if(nPos < (6 - INDEX_3))
/*   241 */          {
/*   242 */             nPos++;
/*   243 */          }
/*   244 */          else
...
/*   246 */             nPos = 0;
/*   247 */          }
/*   248 */          DisplayConnectSettingMenu(nPos, device, 0);
/*   249 */       }
/*   250 */       else
/*   251 */       if(key == KEY_ENTER)
/*   252 */       {
/*   253 */          if(nPos == INDEX_0)
/*   254 */          {
/*   255 */             if(SettingInput(&SettingValue[SETUP_DEVICE_COUNT], 1, 8,0) == 1)
/*   256 */             {
/*   257 */                for(int i = SettingValue[SETUP_DEVICE_COUNT]; i < 8; i++)
/*   258 */                {
/*   259 */                   ConnectSetting[i].DeviceType = DEVICE_NO;
/*   260 */                   gFaultEventReaded[i] = 0;
/*   261 */                }
/*   262 */                FlashWrite();
/*   263 */                gDeviceCount = SettingValue[SETUP_DEVICE_COUNT];
/*   264 */             }
/*   265 */             if(device > SettingValue[SETUP_DEVICE_COUNT])
/*   266 */             {
/*   267 */                device = SettingValue[SETUP_DEVICE_COUNT];
/*   268 */                gFaultEventReaded[device-1] = 0;
/*   269 */                FlashWrite();
/*   270 */             }
/*   271 */          }
/*   272 */          else
/*   273 */          if(nPos == INDEX_1)
/*   274 */          {
/*   275 */             (void)SettingInput(&device, 1, SettingValue[SETUP_DEVICE_COUNT], 0);
/*   276 */             DeviceDescroptionSend(device);
/*   277 */          }
/*   278 */          else
/*   279 */          if(nPos == INDEX_2)
/*   280 */          {
/*   281 */             if(SettingInput(&ConnectSetting[device-1].Address, 1, 247, 0) == 1)
/*   282 */             {
/*   283 */                gFaultEventReaded[device-1] = 0;
/*   284 */                FlashWrite();
/*   285 */             }
/*   286 */             DeviceDescroptionSend(device);
/*   287 */          }
/*   288 */          else
/*   289 */          if(nPos == INDEX_3)
/*   290 */          {
/*   292 */             if(SettingInputString((unsigned short*)(&ConnectSetting[device-1].DeviceType), 3, _acsetup_type, 0) == 1)
/*   293 */             {
/*   294 */                gFaultEventReaded[device-1] = 0;
/*   295 */                FlashWrite();
/*   296 */             }
/*   297 */             DeviceDescroptionSend(device);
/*   298 */          }
/*   299 */          else
/*   300 */          if(nPos == INDEX_4)
/*   301 */          {
...
/*   303 */          }
/*   304 */          else {}
/*   309 */          DisplayConnectSettingMenu(nPos, device, 1);
/*   310 */       }
/*   311 */       else
/*   312 */       if(key == DATA_RECV)
/*   313 */       {
/*   314 */          DeviceDescriptionDisp(device);
/*   316 */       }
/*   317 */       else
/*   318 */       if(key == KEY_CANCEL)
/*   319 */       {
/*   320 */          break;
/*   321 */       }
/*   322 */       else {}
/*   323 */    }
/*   324 */ }
/*   326 */ static void DisplaySettingMenu(int page, int pos, int flag)
/*   327 */ {
/*   328 */    int count = 6-1;
/*   329 */    int offset = 0;
/*   330 */    int startY = 10 + (page * 50);
/*   332 */    GUI_SetBkColor(0x1c1b1a);
/*   333 */    (void)GUI_SetFont(&GUI_Font20_ASCII);
/*   335 */    (void)GUI_SetPenSize(2);
/*   336 */    GUI_SetColor(0x494440);
/*   338 */    if(flag)
/*   339 */    {
/*   340 */       GUI_ClearRect(0, 0, 480-1, 320-1);
/*   342 */       GUI_SetColor(0x2a2826);
/*   343 */       GUI_FillRect(10, startY, (10 + 460) - 1, (startY + (50 * count )) - 1);
/*   344 */    }
/*   346 */    int y0 = 10;
/*   348 */    GUI_RECT rect;
/*   349 */    rect.x0 = 41;
/*   350 */    rect.y0 = 10;
/*   351 */    rect.x1 = (41 + 150) - 1;
/*   352 */    rect.y1 = (10 + 50) - 1;
/*   354 */    GUI_RECT rect2;
/*   355 */    rect2.x0 = 210;
/*   356 */    rect2.y0 = 10;
/*   357 */    rect2.x1 = ((210 + 265) - 1);
/*   358 */    rect2.y1 = (10 + 50) - 1;
/*   360 */    if(page == 1)
/*   361 */    {
/*   362 */       GUI_SetColor(0x00FFFFFF);
/*   363 */       GUI_FillPolygon(UP_POINT, INDEX_3, 240, y0);
/*   364 */       rect.y0 += 50;
/*   365 */       rect.y1 += 50;
/*   366 */       rect2.y0 += 50;
/*   367 */       rect2.y1 += 50;
...
/*   370 */       offset = INDEX_5;
/*   371 */    }
/*   373 */    GUI_SetColor(0xc8c8c8);
/*   374 */    (void)GUI_SetFont(&GUI_Font20_ASCII);
/*   375 */    PCF2127_readTime(1);
/*   377 */    for(int i = 0 ; i < count; i++)
/*   378 */    {
/*   379 */       if(i == pos)
/*   380 */       {
/*   381 */          GUI_SetColor(0xd07b18);
/*   382 */       }
/*   383 */       else
/*   384 */       {
/*   385 */          GUI_SetColor(0x2f2c2a);
/*   386 */       }
/*   387 */       GUI_FillRect(10, y0, (10 + 460) - 1, (y0 + 50) - 1);
/*   389 */       if(i == pos)
/*   390 */       {
/*   391 */          LanguageSelect(FONT20B);
/*   392 */          GUI_SetColor(0x00FFFFFF);
/*   393 */          GUI_SetBkColor(0xd07b18);
/*   394 */       }
/*   395 */       else
/*   396 */       {
/*   397 */          LanguageSelect(FONT20);
/*   398 */          GUI_SetColor(0xc8c8c8);
/*   399 */          GUI_SetBkColor(0x2f2c2a);
/*   400 */       }
/*   401 */       GUI_DispStringInRect(_acsetup_disp_setting_label_text[SettingValue[SETUP_LANGUAGE]][offset + i], &rect, (0) | (3<<2));
/*   402 */       LanguageSelect(FONT20B);
/*   403 */       GUI_SetColor(0x00FFFFFF);
/*   405 */       int index = offset + i;
/*   406 */       char buf[60];
/*   408 */       if(index == INDEX_0)
/*   409 */       {
/*   410 */          (void)sprintf(buf, _acsetup_disp_setting_value_text[SettingValue[SETUP_LANGUAGE]][index], gDateTime.Year, gDateTime.Month, gDateTime.Day, gDateTime.Hour, gDateTime.Min, gDateTime.Sec);
/*   411 */       }
/*   412 */       else
/*   413 */       if(index == INDEX_1)
/*   414 */       {
/*   415 */          (void)sprintf(buf, _acsetup_disp_setting_value_text[SettingValue[SETUP_LANGUAGE]][index], SettingValue[SETUP_BRIGHTNESS]);
/*   416 */       }
/*   417 */       else
/*   418 */       if(index == INDEX_2)
/*   419 */       {
/*   420 */          if(SettingValue[SETUP_SAVING_MODE] == 0)
/*   421 */          {
/*   422 */             (void)sprintf(buf, _acsetup_disp_setting_value_text_not[SettingValue[SETUP_LANGUAGE]][index], _acNotUsed[SettingValue[SETUP_LANGUAGE]]);
/*   423 */          }
/*   424 */          else
/*   425 */          {
/*   426 */             (void)sprintf(buf, _acsetup_disp_setting_value_text[SettingValue[SETUP_LANGUAGE]][index], SettingValue[SETUP_SAVING_MODE]);
/*   427 */          }
/*   428 */       }
/*   429 */       else
/*   430 */       if(index == INDEX_3)
/*   431 */       {
/*   432 */          if(SettingValue[SETUP_SCREEN_SWITCHING] == 0)
/*   433 */          {
/*   434 */             (void)sprintf(buf, _acsetup_disp_setting_value_text_not[SettingValue[SETUP_LANGUAGE]][index], _acNotUsed[SettingValue[SETUP_LANGUAGE]]);
/*   435 */          }
/*   436 */          else
/*   437 */          {
/*   438 */             (void)sprintf(buf, _acsetup_disp_setting_value_text[SettingValue[SETUP_LANGUAGE]][index], SettingValue[SETUP_SCREEN_SWITCHING]);
/*   439 */          }
/*   440 */       }
/*   441 */       else
/*   442 */       if(index == INDEX_4)
/*   443 */       {
/*   444 */          if(SettingValue[SETUP_RETURN_TO_SCREEN] == 0)
/*   445 */          {
/*   446 */             (void)sprintf(buf, _acsetup_disp_setting_value_text_not[SettingValue[SETUP_LANGUAGE]][index], _acNotUsed[SettingValue[SETUP_LANGUAGE]]);
/*   447 */          }
/*   448 */          else
/*   449 */          {
/*   450 */             (void)sprintf(buf, _acsetup_disp_setting_value_text[SettingValue[SETUP_LANGUAGE]][index], SettingValue[SETUP_RETURN_TO_SCREEN]);
/*   451 */          }
/*   452 */       }
/*   453 */       else
/*   454 */       if(index == INDEX_5)
/*   455 */       {
/*   456 */          (void)sprintf(buf, _acsetup_disp_setting_value_text[SettingValue[SETUP_LANGUAGE]][index], _acsetup_language[SettingValue[SETUP_LANGUAGE]]);
/*   457 */          if(SettingValue[SETUP_LANGUAGE] == CHINESE)
/*   458 */          {
/*   459 */             (void)GUI_SetFont(&GUI_FontLSFont20n_);
/*   460 */          }
/*   461 */          else
/*   462 */          if(SettingValue[SETUP_LANGUAGE] == RUSSIAN)
/*   463 */          {
/*   464 */             (void)GUI_SetFont(&GUI_Fontcyrillic20_20x20);
/*   465 */          }
/*   466 */          else
/*   467 */          {
/*   468 */             (void)GUI_SetFont(&GUI_Font20B_ASCII);
/*   469 */          }
/*   470 */       }
/*   471 */       else
/*   472 */       if(index == INDEX_6)
/*   473 */       {
/*   474 */          (void)sprintf(buf, _acsetup_disp_setting_value_text[SettingValue[SETUP_LANGUAGE]][index]);
/*   475 */       }
/*   476 */       else
/*   477 */       if(index == INDEX_7)
/*   478 */       {
/*   479 */          (void)sprintf(buf, _acsetup_disp_setting_value_text[SettingValue[SETUP_LANGUAGE]][index], _acsetup_speed[SettingValue[SETUP_SPEED]]);
/*   480 */       }
/*   481 */       else
/*   482 */       if(index == INDEX_8)
/*   483 */       {
/*   484 */          if(SettingValue[SETUP_GATEWAY_USE] != 1)
/*   485 */          {
/*   486 */             SettingValue[SETUP_GATEWAY_USE] = 0;
/*   487 */          }
/*   488 */          (void)sprintf(buf, _acsetup_disp_setting_value_text[SettingValue[SETUP_LANGUAGE]][index], _acsetup_gateway_use[SettingValue[SETUP_LANGUAGE]][SettingValue[SETUP_GATEWAY_USE]]);
/*   489 */       }
/*   490 */       else
/*   491 */       {
/*   492 */          buf[0] = 0;
/*   493 */       }
/*   494 */       GUI_DispStringInRect(buf, &rect2, (0) | (3<<2));
/*   497 */       rect.y0 += 50;
/*   498 */       rect.y1 += 50;
/*   499 */       rect2.y0 += 50;
/*   500 */       rect2.y1 += 50;
...
/*   503 */    if(page == 0)
/*   504 */    {
/*   505 */       GUI_SetColor(0x00FFFFFF);
/*   506 */       GUI_FillPolygon(DOWN_POINT, INDEX_3, 240, y0);
/*   507 */    }
/*   508 */ }
/*   510 */ static void FactoryResetInitDisp(void)
/*   511 */ {
/*   512 */    GUI_RECT rect;
/*   514 */    (void)GUI_SetPenSize(2);
/*   515 */    GUI_SetColor(0xd07b18);
/*   516 */    GUI_SetBkColor(0x2f2c2a);
/*   518 */    GUI_ClearRect(25, 18, ((430 + 25) - 1), ((280 + 18) - 1));
/*   519 */    GUI_DrawRect(25, 18, ((430 + 25) - 1), ((280 + 18) - 1));
/*   521 */    GUI_SetColor(0x00FFFFFF);
/*   522 */    LanguageSelect(FONT24);
/*   523 */    rect.x0 = 107 - INDEX_20;
/*   524 */    rect.y0 = 50;
/*   525 */    rect.x1 = ((107 + 266) - 1) + INDEX_20;
/*   526 */    rect.y1 = ((50 + 60) - 1);
/*   527 */    GUI_DispStringInRect(_aFactoryReset_confirm_text[SettingValue[SETUP_LANGUAGE]], &rect, (2<<0) | (3<<2));
/*   529 */    MLinkButtonDisp(2);
/*   530 */ }
/*   532 */ static void FactoryRest(void)
/*   533 */ {
/*   534 */    int flagBreak;
/*   535 */    int nPos = 0;
/*   536 */    char password[4+1];
/*   538 */    (void)sprintf(password, "0000");
/*   539 */    FactoryResetInitDisp();
/*   540 */    PasswordDisp(nPos, password[nPos]);
/*   542 */    while (1)
/*   543 */    {
/*   544 */       E_KEY key = GetKey();
/*   546 */       if(key == KEY_UP)
/*   547 */       {
/*   548 */          if(nPos < 4)
/*   549 */          {
/*   550 */             if(password[nPos] < '9')
/*   551 */             {
/*   552 */                password[nPos]++;
/*   553 */             }
/*   554 */             else
...
/*   556 */                password[nPos] = '0';
/*   557 */             }
/*   558 */             PasswordDisp(nPos, password[nPos]);
/*   559 */          }
/*   560 */          else
/*   561 */          if(nPos == (4 + 1))
/*   562 */          {
/*   563 */             MLinkButtonDisp(0);
/*   564 */             nPos = 4;
/*   565 */          }
/*   566 */          else {}
/*   567 */       }
...
/*   579 */                password[nPos] = '9';
/*   580 */             }
/*   581 */             PasswordDisp(nPos, password[nPos]);
/*   582 */          }
/*   583 */          else
/*   584 */          if(nPos == 4)
/*   585 */          {
/*   586 */             MLinkButtonDisp(1);
/*   587 */             nPos = 4 + 1;
/*   588 */          }
/*   589 */          else {}
/*   590 */       }
/*   591 */       else
/*   592 */       if(key == KEY_ENTER)
/*   593 */       {
/*   594 */          if(nPos < 4)
/*   595 */          {
/*   596 */             nPos++;
/*   597 */             PasswordDisp(nPos, password[nPos]);
/*   598 */             if(nPos == 4)
/*   599 */             {
/*   600 */                MLinkButtonDisp(0);
/*   601 */             }
/*   602 */          }
/*   603 */          else
/*   604 */          if(nPos == 4)
/*   605 */          {
/*   606 */             unsigned short iPassword = atoi(password);
/*   607 */             if(iPassword != SettingValue[SETUP_PASSWORD])
/*   608 */             {
/*   609 */                if(QuestionMessage() == 0)
/*   610 */                {
/*   611 */                   flagBreak = 1;
/*   612 */                }
/*   613 */                nPos = 0;
/*   614 */                FactoryResetInitDisp();
/*   615 */                PasswordDisp(nPos, password[nPos]);
/*   616 */                MLinkButtonDisp(2);
/*   617 */             }
/*   618 */             else
/*   619 */             {
/*   620 */                int nSpeed = SettingValue[SETUP_SPEED];
/*   621 */                for(int i = 0; i < 8; i++)
/*   622 */                {
/*   623 */                   gFaultEventReaded[i] = 0;
/*   624 */                   ConnectSetting[i].DeviceType = DEVICE_NO;
/*   625 */                   ConnectSetting[i].Address = i + 1;
/*   626 */                   gCommStatus[i] = COMM_ERROR;
/*   627 */                }
/*   628 */                for(int i = 0; i < SETUP_COUNT; i++)
/*   629 */                {
/*   630 */                   SettingValue[i] = DefaultSettingValue[i];
/*   631 */                }
/*   632 */                FlashWrite();
/*   633 */                flagBreak = 1;
/*   634 */                gDeviceCount = 1;
/*   635 */                if(SettingValue[SETUP_SPEED] != nSpeed)
/*   636 */                {
...
/*   659 */    }
/*   660 */ }
/*   662 */ static void SettingMenuExec(int nPage, int nPos)
/*   663 */ {
/*   664 */    if(nPage == INDEX_0)
/*   665 */    {
/*   666 */       if(nPos == INDEX_0)
/*   667 */       {
/*   668 */          gbSettingTime = 1;
...
/*   673 */       if(nPos == INDEX_1)
/*   674 */       {
/*   675 */          if(SettingInput(&SettingValue[SETUP_BRIGHTNESS], 0, 100, 0) == 1)
/*   676 */          {
/*   677 */             FlashWrite();
/*   678 */             BacklightBrghtness(SettingValue[SETUP_BRIGHTNESS], 0);
/*   679 */          }
/*   680 */       }
/*   681 */       else
/*   682 */       if(nPos == INDEX_2)
/*   683 */       {
/*   684 */          if(SettingInput(&SettingValue[SETUP_SAVING_MODE], 10, 120, 1) == 1)
/*   685 */          {
/*   686 */             uint32_t timer = HAL_GetTick();
/*   687 */             gSavingModeCounter = timer + (SettingValue[SETUP_SAVING_MODE] * 1000);
/*   688 */             FlashWrite();
/*   689 */          }
/*   690 */       }
/*   691 */       else
/*   692 */       if(nPos == INDEX_3)
/*   693 */       {
/*   694 */          if(SettingInput(&SettingValue[SETUP_SCREEN_SWITCHING], 10, 60, 1) == 1)
/*   695 */          {
/*   696 */             uint32_t timer = HAL_GetTick();
/*   697 */             gScreenSwitchingCounter = timer + (SettingValue[SETUP_SCREEN_SWITCHING] * 1000);
/*   698 */             FlashWrite();
/*   699 */          }
/*   700 */       }
/*   701 */       else
/*   702 */       if(nPos == INDEX_4)
/*   703 */       {
/*   704 */          if(SettingInput(&SettingValue[SETUP_RETURN_TO_SCREEN], 10, 60, 1) == 1)
/*   705 */          {
/*   706 */             uint32_t timer = HAL_GetTick();
/*   707 */             gReturnToScreen = timer + (SettingValue[SETUP_RETURN_TO_SCREEN] * 1000);
/*   708 */             FlashWrite();
/*   709 */          }
/*   710 */       }
/*   711 */       else {}
/*   712 */    }
/*   713 */    else
/*   714 */    if(nPage == INDEX_1)
/*   715 */    {
/*   716 */       if(nPos == INDEX_0)
/*   717 */       {
/*   718 */          if(SettingInputString(&SettingValue[SETUP_LANGUAGE], 2, _acsetup_language, 1) == 1)
/*   719 */          {
/*   720 */             FlashWrite();
/*   721 */          }
/*   722 */       }
...
/*   732 */       if(nPos == INDEX_2)
/*   733 */       {
/*   734 */          if(SettingInputString(&SettingValue[SETUP_SPEED], 4, _acsetup_speed, 0) == 1)
/*   735 */          {
/*   736 */             FlashWrite();
...
/*   741 */       if(nPos == INDEX_3)
/*   742 */       {
/*   743 */          if(SettingInputString(&SettingValue[SETUP_GATEWAY_USE], 2, _acsetup_gateway_use[SettingValue[SETUP_LANGUAGE]], 0) == 1)
/*   744 */          {
/*   745 */             FlashWrite();
/*   746 */          }
/*   747 */       }
...
/*   755 */    else {}
/*   756 */ }
/*   758 */ static void DisplaySetting(void)
/*   759 */ {
/*   760 */    int nPage = 0;
/*   761 */    int nPos = 0;
/*   762 */    DisplaySettingMenu(nPage, nPos, 1);
/*   763 */    while (1)
/*   764 */    {
/*   765 */       E_KEY key = GetKey();
/*   767 */       if(key == SECOND_TIMER)
/*   768 */       {
/*   769 */          (void)printf("SECOND_TIMER\n\n\n\n");
/*   770 */          if(nPage == 0)
/*   771 */          {
/*   772 */             PCF2127_readTime(1);
/*   773 */             if(nPos == 0)
/*   774 */             {
/*   775 */                GUI_SetColor(0xd07b18);
/*   776 */             }
/*   777 */             else
/*   778 */             {
/*   779 */                GUI_SetColor(0x2f2c2a);
/*   780 */             }
/*   783 */             if(nPos == 0)
/*   784 */             {
/*   785 */                GUI_SetColor(0x00FFFFFF);
/*   786 */                GUI_SetBkColor(0xd07b18);
/*   787 */             }
/*   788 */             else
/*   789 */             {
/*   790 */                GUI_SetColor(0xc8c8c8);
/*   791 */                GUI_SetBkColor(0x2f2c2a);
/*   792 */             }
/*   793 */             LanguageSelect(FONT20B);
/*   794 */             GUI_SetColor(0x00FFFFFF);
/*   796 */             char buf[60];
/*   798 */             (void)sprintf(buf, _acsetup_disp_setting_value_text[SettingValue[SETUP_LANGUAGE]][0], gDateTime.Year, gDateTime.Month, gDateTime.Day, gDateTime.Hour, gDateTime.Min, gDateTime.Sec);
/*   799 */             GUI_RECT rect2;
/*   800 */             rect2.x0 = 210;
/*   801 */             rect2.y0 = 10;
/*   802 */             rect2.x1 = ((210 + 265) - 1);
/*   803 */             rect2.y1 = (10 + 50) - 1;
/*   805 */             GUI_DispStringInRect(buf, &rect2, (0) | (3<<2));
/*   806 */          }
/*   807 */       }
/*   808 */       else
/*   809 */       if(key == KEY_UP)
...
/*   814 */             {
/*   815 */                nPos--;
/*   816 */                DisplaySettingMenu(nPage, nPos, 0);
/*   817 */             }
/*   818 */             else
/*   819 */             {
/*   820 */                nPage = 1;
/*   821 */                nPos = INDEX_4;
/*   822 */                DisplaySettingMenu(nPage, nPos, 1);
/*   823 */             }
/*   824 */          }
/*   825 */          else
/*   826 */          if(nPage == 1)
...
/*   829 */             {
/*   830 */                nPos--;
/*   831 */                DisplaySettingMenu(nPage, nPos, 0);
/*   832 */             }
/*   833 */             else
/*   835 */             {
/*   836 */                nPos = INDEX_4;
/*   837 */                nPage = 0;
/*   838 */                DisplaySettingMenu(nPage, nPos, 1);
/*   839 */             }
/*   840 */          }
/*   841 */          else {}
/*   842 */       }
...
/*   849 */             {
/*   850 */                nPos++;
/*   851 */                DisplaySettingMenu(nPage, nPos, 0);
/*   852 */             }
/*   853 */             else
/*   854 */             if(nPos == INDEX_4)
/*   855 */             {
/*   856 */                nPage = 1;
/*   857 */                nPos = 0;
/*   858 */                DisplaySettingMenu(nPage, nPos, 1);
/*   859 */             }
/*   860 */             else {}
/*   861 */          }
/*   862 */          else
...
/*   866 */             {
/*   867 */                nPos++;
/*   868 */                DisplaySettingMenu(nPage, nPos, 0);
/*   869 */             }
/*   870 */             else
/*   871 */             if(nPos == INDEX_4)
/*   872 */             {
/*   873 */                nPos = 0;
/*   874 */                nPage = 0;
/*   875 */                DisplaySettingMenu(nPage, nPos, 1);
/*   876 */             }
/*   877 */             else {}
/*   878 */          }
/*   879 */          else {}
/*   880 */       }
/*   881 */       else
/*   882 */       if(key == KEY_ENTER)
/*   883 */       {
/*   884 */          SettingMenuExec(nPage, nPos);
/*   885 */          DisplaySettingMenu(nPage, nPos, 1);
/*   886 */       }
/*   887 */       else
/*   888 */       if(key == KEY_CANCEL)
/*   889 */       {
/*   890 */          break;
/*   891 */       }
/*   892 */       else {}
/*   893 */    }
/*   894 */ }
/*   907 */ static void SetupDeviceInfoValueDisp(void)
/*   908 */ {
/*   910 */    GUI_SetColor(0x00FFFFFF);
/*   911 */    GUI_RECT rect;
/*   912 */    rect.x0 = 340-100;
/*   913 */    rect.y0 = 10;
/*   914 */    rect.x1 = (340 + 100) - 1;
/*   915 */    rect.y1 = (10 + 50) - 1;
/*   916 */    (void)GUI_SetFont(&GUI_Font20B_ASCII);
/*   917 */    for(int i = 0 ; i < 6; i++)
/*   918 */    {
/*   919 */       if(i == INDEX_5)
/*   920 */       {
/*   921 */          LanguageSelect(FONT20B);
/*   922 */          GUI_SetColor(0x00FFFFFF);
/*   923 */          unsigned short status = RTCBatteryStatus();
/*   924 */          if(status)
/*   925 */          {
/*   926 */             GUI_SetColor(0x00deff);
/*   927 */             GUI_DispStringInRect(_acbat_status[SettingValue[SETUP_LANGUAGE]][1], &rect, (1<<0) | (3<<2));
/*   928 */          }
/*   929 */          else
/*   930 */          {
/*   931 */             GUI_DispStringInRect(_acbat_status[SettingValue[SETUP_LANGUAGE]][0], &rect, (1<<0) | (3<<2));
/*   932 */          }
/*   933 */       }
/*   934 */       else
/*   935 */       {
/*   936 */          if( i == INDEX_2)
/*   937 */          {
/*   938 */             GUI_DispStringInRect(_acHardwareVersion, &rect, (1<<0) | (3<<2));
/*   939 */          }
/*   940 */          else
/*   941 */          {
/*   942 */             GUI_DispStringInRect(_acinfo_value_text[i], &rect, (1<<0) | (3<<2));
/*   943 */          }
/*   944 */       }
/*   945 */       rect.y0 += 50;
/*   946 */       rect.y1 += 50;
/*   947 */    }
/*   948 */ }
/*   950 */ static void DisplayDeviceDispValue(void)
/*   951 */ {
/*   952 */    int count = 6;
/*   955 */    GUI_SetBkColor(0x1c1b1a);
/*   956 */    (void)GUI_SetFont(&GUI_Font20_ASCII);
/*   958 */    (void)GUI_SetPenSize(2);
/*   959 */    GUI_SetColor(0x494440);
/*   961 */    GUI_ClearRect(0, 0, 480-1, 320-1);
/*   962 */    GUI_DrawRect(10, 10, (10 + 460) - 1, (10 + (50 * count )) - 1);
/*   965 */    for(int i = 0; i < (count-1); i++)
/*   966 */    {
/*   967 */       int y0 = 10 + ((i + 1) * 50);
/*   968 */       GUI_DrawHLine(y0, 10+INDEX_2, (10 + 460) - 1);
/*   969 */    }
/*   971 */    GUI_SetColor(0xc8c8c8);
/*   972 */    GUI_RECT rect;
/*   973 */    rect.x0 = 41;
/*   974 */    rect.y0 = 10;
/*   975 */    rect.x1 = (41 + 150) - 1;
/*   976 */    rect.y1 = (10 + 50)- 1;
/*   979 */    LanguageSelect(FONT20);
/*   980 */    for(int i = 0 ; i < count; i++)
/*   981 */    {
/*   982 */       GUI_DispStringInRect(_acsetupinfo_label_text[SettingValue[SETUP_LANGUAGE]][i], &rect, (0) | (3<<2));
/*   983 */       rect.y0 += 50;
/*   984 */       rect.y1 += 50;
/*   985 */    }
/*   986 */    SetupDeviceInfoValueDisp();
/*   987 */ }
/*   989 */ static void DisplayDeviceDisp(void)
/*   990 */ {
/*   991 */    DisplayDeviceDispValue();
/*   993 */    GUI_RECT rect;
/*   994 */    rect.x0 = 41;
/*   995 */    rect.y0 = 10;
/*   996 */    rect.x1 = (41 + 150) - 1;
/*   997 */    rect.y1 = (10 + 50)- 1;
/*   998 */    while (1)
/*   999 */    {
/*  1000 */       E_KEY key = GetKey();
/*  1001 */       if(key == TIME_OUT)
/*  1002 */       {
/*  1004 */          rect.x0 = 340-100;
/*  1005 */          rect.y0 = 10 + (50*INDEX_5)+1;
/*  1006 */          rect.x1 = (340 + 100) - 1;
/*  1007 */          rect.y1 = (10 + (50*INDEX_6)) - INDEX_2;
/*  1009 */          LanguageSelect(FONT20B);
/*  1010 */          unsigned short status = RTCBatteryStatus();
/*  1011 */          GUI_ClearRect(rect.x0, rect.y0, rect.x1, rect.y1);
/*  1012 */          if(status)
/*  1013 */          {
/*  1014 */             GUI_SetColor(0x00deff);
/*  1015 */             GUI_DispStringInRect(_acbat_status[SettingValue[SETUP_LANGUAGE]][1], &rect, (1<<0) | (3<<2));
/*  1016 */          }
/*  1017 */          else
/*  1018 */          {
/*  1019 */             GUI_SetColor(0x00FFFFFF);
/*  1020 */             GUI_DispStringInRect(_acbat_status[SettingValue[SETUP_LANGUAGE]][0], &rect, (1<<0) | (3<<2));
/*  1021 */          }
/*  1022 */       }
/*  1023 */       else
/*  1024 */       if(key == KEY_CANCEL)
/*  1025 */       {
/*  1026 */          break;
/*  1027 */       }
/*  1028 */       else {}
/*  1029 */    }
/*  1030 */ }
/*  1032 */ static void SetInfoMenu(int menu, int pos, int count, int flag)
/*  1033 */ {
/*  1034 */    GUI_SetBkColor(0x1c1b1a);
/*  1036 */    if(flag)
/*  1037 */    {
/*  1038 */       GUI_ClearRect(0, 0, 480-1, 320-1);
/*  1039 */    }
/*  1040 */    GUI_RECT rect;
/*  1041 */    rect.x0 = 50;
/*  1042 */    rect.x1 = (50 + 460) - 1;
/*  1043 */    rect.y0 = 10;
/*  1044 */    rect.y1 = (10 + 99) - 1;
/*  1046 */    int y0 = 10;
/*  1047 */    for(int i = 0; i < count; i++)
/*  1048 */    {
/*  1049 */       if(i == pos)
/*  1050 */       {
/*  1051 */          GUI_SetColor(0xd07b18);
/*  1052 */       }
/*  1053 */       else
/*  1054 */       {
/*  1055 */          GUI_SetColor(0x2f2c2a);
/*  1056 */       }
/*  1057 */       GUI_FillRect(10, y0, (10 + 460) - 1, (y0 + 99) - 1);
/*  1059 */       if(i == pos)
/*  1060 */       {
/*  1062 */          LanguageSelect(FONT24B);
/*  1063 */          GUI_SetColor(0x00FFFFFF);
/*  1064 */          GUI_SetBkColor(0xd07b18);
/*  1065 */       }
/*  1066 */       else
/*  1067 */       {
/*  1069 */          LanguageSelect(FONT24);
/*  1070 */          GUI_SetColor(0xc8c8c8);
/*  1071 */          GUI_SetBkColor(0x2f2c2a);
/*  1072 */       }
/*  1074 */       GUI_DispStringInRect(_acinfo_menu_text[SettingValue[SETUP_LANGUAGE]][menu][i], &rect, (0) | (3<<2));
/*  1075 */       rect.y0 += 99 + 1;
/*  1076 */       rect.y1 += 99 + 1;
/*  1077 */       y0 += 99 + 1;;
/*  1078 */    }
/*  1079 */ }
/*  1083 */ E_SETUP_RETURN Setup(void)
/*  1084 */ {
/*  1085 */    E_SETUP_RETURN ret = SETUP_NOCHANGED;
/*  1086 */    int nPos = 0;
/*  1088 */    SetInfoMenu(2, nPos, 3, 1);
/*  1090 */    GUI_SetBkColor(0x1c1b1a);
/*  1091 */    (void)GUI_SetPenSize(2);
/*  1092 */    GUI_SetColor(0x494440);
/*  1094 */    g_nStatusNoUpdate = 1;
/*  1096 */    E_DEVICE_TYPE deviceType = ConnectSetting[gDeviceIndex].DeviceType;
/*  1098 */    while (1)
/*  1099 */    {
/*  1100 */       E_KEY key = GetKey();
/*  1102 */       if(key == KEY_UP)
/*  1103 */       {
/*  1104 */          if(nPos > 0)
/*  1105 */          {
...
/*  1123 */             nPos = 0;
/*  1124 */          }
/*  1125 */          SetInfoMenu(2, nPos, 3, 0);
/*  1126 */       }
/*  1127 */       else
/*  1128 */       if(key == KEY_ENTER)
/*  1129 */       {
/*  1130 */          if(nPos == INDEX_0)
/*  1131 */          {
/*  1132 */             DisplayDeviceDisp();
/*  1133 */          }
/*  1134 */          else
/*  1135 */          if(nPos == INDEX_1)
/*  1136 */          {
/*  1137 */             DisplaySetting();
/*  1138 */          }
/*  1139 */          else
/*  1140 */          if(nPos == INDEX_2)
/*  1141 */          {
/*  1142 */             DisplayConnectSetting();
/*  1143 */          }
/*  1144 */          else {}
/*  1145 */          SetInfoMenu(2, nPos, 3, 1);
/*  1146 */       }
/*  1147 */       else
/*  1148 */       if(key == KEY_CANCEL)
/*  1149 */       {
/*  1150 */          DispStatus();
/*  1151 */          g_nStatusNoUpdate = 0;
/*  1152 */          if(SettingValue[SETUP_DEVICE_COUNT] <= gDeviceIndex)
/*  1153 */          {
/*  1154 */             gDeviceIndex = SettingValue[SETUP_DEVICE_COUNT] - 1;
/*  1155 */          }
/*  1156 */          if(deviceType != ConnectSetting[gDeviceIndex].DeviceType)
/*  1157 */          {
/*  1158 */             ret = SETUP_CHANGED;
/*  1159 */          }
/*  1160 */          gCommOldStatus[gDeviceIndex] = -1;
/*  1161 */          break;
/*  1162 */       }
/*  1163 */       else {}
/*  1164 */    }
/*  1165 */    g_bRecvAllDone = 1;
/*  1166 */    CommTimerInit();
/*  1167 */    return ret;
/*  1168 */ }
/*  1172 */ 
