...
/*
 * C:/CodeInspection/DisplayUnit/STemWin/App/SettingInput.c
 */
/*    29 */ static void InputDisp(int value, int pos, int not_used);
/*    30 */ static void InputDispString(const int value, const int pos, const char * const text[], int muti_lan);
/*    32 */ static void InputDisp(int value, int pos, int not_used)
/*    33 */ {
/*    35 */    GUI_RECT rect;
/*    36 */    GUI_SetBkColor(0x2f2c2a);
/*    37 */    GUI_ClearRect((240 - 80), (96 - INDEX_17), (((240 - 80) + (80*2)) - 1), ((96 + 50) - 2) + INDEX_17);
/*    39 */    LanguageSelect(FONT24B);
/*    41 */    rect.x0 = (240 - 80);
/*    42 */    rect.y0 = 96;
/*    43 */    rect.x1 = (((240 - 80) + (80*2)) - 1);
/*    44 */    rect.y1 = ((96 + 50) - 2);
/*    46 */    char buf[60];
/*    48 */    if(pos >= 1)
/*    49 */    {
/*    50 */       if((not_used == 1) && (value == 0))
/*    51 */       {
/*    52 */          (void)sprintf(buf, "%s", _acNotUsed[SettingValue[SETUP_LANGUAGE]]);
/*    53 */       }
/*    54 */       else
/*    55 */       {
/*    56 */          (void)sprintf(buf, "%d", value);
/*    57 */       }
/*    58 */       GUI_DispStringInRect(buf, &rect, (2<<0) | (3<<2));
/*    59 */       return;
/*    60 */    }
/*    62 */    GUI_SetColor(0x00FFFFFF);
/*    63 */    GUI_SetBkColor(0x00000000);
/*    64 */    GUI_ClearRect(rect.x0, rect.y0, rect.x1, rect.y1);
/*    66 */    if((not_used == 1) && (value == 0))
/*    67 */    {
/*    68 */       (void)sprintf(buf, "%s", _acNotUsed[SettingValue[SETUP_LANGUAGE]]);
/*    69 */    }
/*    70 */    else
/*    71 */    {
/*    72 */       (void)sprintf(buf, "%d", value);
/*    73 */    }
/*    75 */    GUI_DispStringInRect(buf, &rect, (2<<0) | (3<<2));
/*    77 */    (void)GUI_BMP_Draw(_acUp, (((240 - 80) + 80) - 25), 96 - INDEX_17);
/*    78 */    (void)GUI_BMP_Draw(_acDown, (((240 - 80) + 80) - 25), ((96 + 50) - 2) + 1);
/*    79 */ }
/*    82 */ int SettingInput(unsigned short *orgValue, int const min, int const max, int const not_used)
/*    83 */ {
/*    84 */    int flagBreak = 0;
/*    85 */    int nPos = 0;
/*    86 */    int ret = 0;
/*    87 */    unsigned short value = *orgValue;
/*    89 */    GUI_SetBkColor(0x2f2c2a);
/*    91 */    (void)GUI_SetPenSize(2);
/*    92 */    GUI_SetColor(0xd07b18);
/*    94 */    GUI_ClearRect(25, 18, ((430 + 25) - 1), ((280 + 18) - 1));
/*    95 */    GUI_DrawRect(25, 18, ((430 + 25) - 1), ((280 + 18) - 1));
/*    97 */    InputDisp(value, nPos, not_used);
/*    98 */    ButtonDisp(2);
/*   100 */    while (1)
/*   101 */    {
/*   102 */       E_KEY key = GetKey();
/*   104 */       if(key == KEY_UP)
/*   105 */       {
/*   106 */          if(nPos < 1)
/*   107 */          {
...
/*   123 */                   value++;
/*   124 */                }
/*   125 */                InputDisp(value, nPos, not_used);
/*   126 */             }
/*   127 */             else
/*   128 */             {
/*   129 */                if(not_used == 1)
...
/*   135 */                   value = min;
/*   136 */                }
/*   137 */                InputDisp(value, nPos, not_used);
/*   138 */             }
/*   139 */          }
/*   140 */          else
/*   141 */          if(nPos == (1 + 1))
...
/*   154 */             {
/*   155 */                value--;
/*   156 */                InputDisp(value, nPos, not_used);
/*   157 */             }
/*   158 */             else
/*   159 */             {
/*   160 */                if(not_used == 1)
...
/*   173 */                   value = max;
/*   174 */                }
/*   175 */                InputDisp(value, nPos, not_used);
/*   176 */             }
/*   177 */          }
/*   178 */          else
/*   179 */          if(nPos == 1)
...
/*   190 */          {
/*   191 */             nPos++;
/*   192 */             InputDisp(value, nPos, not_used);
/*   193 */             ButtonDisp(0);
/*   194 */          }
/*   195 */          else
/*   196 */          if(nPos == 1)
...
/*   220 */    return ret;
/*   221 */ }
/*   223 */ static void InputDispString(const int value, const int pos, const char * const text[], int muti_lan)
/*   224 */ {
/*   226 */    GUI_RECT rect;
/*   227 */    GUI_SetBkColor(0x2f2c2a);
/*   228 */    GUI_ClearRect(160, 96 - INDEX_17, ((160 + 160) - 1), ((96 + 50) - 2) + INDEX_17);
/*   231 */    LanguageSelect(FONT24B);
/*   232 */    rect.x0 = 160;
/*   233 */    rect.y0 = 96;
/*   234 */    rect.x1 = ((160 + 160) - 1);
/*   235 */    rect.y1 = ((96 + 50) - 2);
/*   237 */    if(pos >= 1)
/*   238 */    {
/*   239 */       if(muti_lan == 1)
/*   240 */       {
/*   241 */          if(value == CHINESE)
/*   242 */          {
/*   243 */             (void)GUI_SetFont(&GUI_FontLSfont_24x24);
/*   244 */          }
/*   245 */          else
/*   246 */          if(value == RUSSIAN)
/*   247 */          {
/*   248 */             (void)GUI_SetFont(&GUI_Fontcyrillic_24x24);
/*   249 */          }
/*   250 */          else
/*   251 */          {
/*   252 */             (void)GUI_SetFont(&GUI_Font32B_ASCII);
/*   253 */          }
/*   254 */       }
/*   255 */       GUI_DispStringInRect(text[value], &rect, (2<<0) | (3<<2));
/*   256 */       return;
/*   257 */    }
/*   258 */    GUI_SetColor(0x00FFFFFF);
/*   259 */    GUI_SetBkColor(0x00000000);
/*   260 */    GUI_ClearRect(rect.x0, rect.y0, rect.x1, rect.y1);
/*   262 */    if(muti_lan == 1)
/*   263 */    {
/*   264 */       if(value == CHINESE)
/*   265 */       {
/*   266 */          (void)GUI_SetFont(&GUI_FontLSfont_24x24);
/*   267 */       }
/*   268 */       else
/*   269 */       if(value == RUSSIAN)
/*   270 */       {
/*   271 */          (void)GUI_SetFont(&GUI_Fontcyrillic_24x24);
/*   272 */       }
/*   273 */       else
/*   274 */       {
/*   275 */          (void)GUI_SetFont(&GUI_Font32B_ASCII);
/*   276 */       }
/*   277 */    }
/*   278 */    GUI_DispStringInRect(text[value], &rect, (2<<0) | (3<<2));
/*   280 */    (void)GUI_BMP_Draw(_acUp, (((240 - 80) + 80) - 25), 96 - INDEX_17);
/*   281 */    (void)GUI_BMP_Draw(_acDown, (((240 - 80) + 80) - 25), ((96 + 50) - 2) + 1);
/*   282 */ }
/*   285 */ int SettingInputString(unsigned short* orgValue, int const max, const char* const text[], int multi_lan)
/*   286 */ {
/*   287 */    int flagBreak = 0;
/*   288 */    int nPos = 0;
/*   289 */    int ret = 0;
/*   290 */    unsigned short value = *orgValue;
/*   292 */    if(value >= max)
/*   293 */    {
/*   294 */       value = 0;
/*   295 */    }
/*   296 */    GUI_SetBkColor(0x2f2c2a);
/*   298 */    (void)GUI_SetPenSize(2);
/*   299 */    GUI_SetColor(0xd07b18);
/*   301 */    GUI_ClearRect(25, 18, ((430 + 25) - 1), ((280 + 18) - 1));
/*   302 */    GUI_DrawRect(25, 18, ((430 + 25) - 1), ((280 + 18) - 1));
/*   304 */    InputDispString(value, nPos, text, multi_lan);
/*   305 */    ButtonDisp(2);
/*   306 */    while (1)
/*   307 */    {
/*   308 */       E_KEY key = GetKey();
/*   310 */       if(key == KEY_UP)
/*   311 */       {
/*   312 */          if(nPos < 1)
/*   313 */          {
...
/*   320 */                value = 0;
/*   321 */             }
/*   322 */             InputDispString(value, nPos, text, multi_lan);
/*   323 */          }
/*   324 */          else
/*   325 */          if(nPos == (1 + 1))
/*   326 */          {
...
/*   343 */                value = max - 1;
/*   344 */             }
/*   345 */             InputDispString(value, nPos, text, multi_lan);
/*   346 */          }
/*   347 */          else
/*   348 */          if(nPos == 1)
/*   349 */          {
...
/*   354 */       }
/*   355 */       else
/*   356 */       if(key == KEY_ENTER)
/*   357 */       {
/*   358 */          if(nPos < 1)
/*   359 */          {
/*   360 */             nPos++;
/*   361 */             InputDispString(value, nPos, text, multi_lan);
/*   362 */             ButtonDisp(0);
/*   363 */          }
/*   364 */          else
/*   365 */          if(nPos == 1)
