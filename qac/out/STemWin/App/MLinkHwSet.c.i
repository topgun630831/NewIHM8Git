...
/*
 * C:/CodeInspection/DisplayUnit/STemWin/App/MLinkHwSet.c
 */
/*    29 */ static void MlinkHwSetSend(void);
/*    30 */ static void MlinkHwSetDisp(void);
/*    31 */ static void MLinkSetInitDisp(void);
/*    33 */ static void MlinkHwSetSend(void)
/*    34 */ {
/*    35 */    if(StatusSend() == STATUS_SEND_ING)
/*    36 */    {
/*    37 */       return;
/*    38 */    }
/*    39 */    if(nSendStep == INDEX_0)
/*    40 */    {
/*    41 */       ModbusSendFrame(ConnectSetting[gDeviceIndex].Address, HOLDING_REGISTER, 2002, 1);
/*    42 */    }
/*    43 */    else
/*    44 */    if(nSendStep == INDEX_1)
/*    45 */    {
/*    46 */       ModbusSendFrame(ConnectSetting[gDeviceIndex].Address, INPUT_REGISTER, 1003, INDEX_1);
/*    47 */    }
/*    53 */    else {}
/*    54 */ }
/*    56 */ static void MlinkHwSetDisp(void)
/*    57 */ {
/*    58 */    static unsigned short nBaudrate;
/*    59 */    static unsigned short nAddress;
/*    61 */    (void)printf("MlinkHwSetDisp=%d\n", nSendStep);
/*    62 */    if(nSendStep == INDEX_0)
/*    63 */    {
/*    64 */       nBaudrate = ModbusGetUint16(2002)-1;
/*    65 */       (void)printf("nBaudrate=%d\n", nBaudrate);
/*    66 */       nSendStep = INDEX_1;
/*    67 */       return;
/*    68 */    }
/*    69 */    else {}
/*    71 */    char buf[INDEX_3][20];
/*    73 */    nAddress = ModbusGetUint16(1003);
/*    74 */    (void)printf("nAddress=%d\n", nAddress);
/*    75 */    (void)sprintf(buf[INDEX_0], "%3d", nAddress);
/*    76 */    if(nBaudrate < 4)
/*    77 */    {
/*    78 */       (void)sprintf(buf[INDEX_1], "%s", _acsetup_speed[nBaudrate]);
/*    79 */    }
/*    80 */    if((mLinkMode[gDeviceIndex] >= 1) && (mLinkMode[gDeviceIndex] <= INDEX_3))
/*    81 */    {
/*    82 */       (void)sprintf(buf[INDEX_2], _aclocal_remote[SettingValue[SETUP_LANGUAGE]][INDEX_1]);
/*    83 */    }
/*    84 */    else
/*    85 */    {
/*    86 */       (void)sprintf(buf[INDEX_2], _aclocal_remote[SettingValue[SETUP_LANGUAGE]][INDEX_0]);
/*    87 */    }
/*    89 */    GUI_SetColor(0x00FFFFFF);
/*    90 */    GUI_RECT rect;
/*    91 */    rect.x0 = 340;
/*    92 */    rect.y0 = 46;
/*    93 */    rect.x1 = (340 + 100) - 1;
/*    94 */    rect.y1 = (46 + 44) - 1;
/*    96 */    (void)GUI_SetFont(&GUI_Font20B_ASCII);
/*    97 */    GUI_SetBkColor(0x1c1b1a);
/*    98 */    for(int i = 0 ; i < (6-INDEX_3); i++)
/*    99 */    {
/*   100 */       GUI_ClearRect(rect.x0, rect.y0+1, rect.x1, rect.y1-INDEX_2);
/*   101 */       if(i == INDEX_2)
/*   102 */       {
/*   103 */          LanguageSelect(FONT20B);
/*   104 */       }
/*   105 */       GUI_DispStringInRect(buf[i], &rect, (1<<0) | (3<<2));
/*   106 */       rect.y0 += 44;
/*   107 */       rect.y1 += 44;
/*   108 */    }
/*   109 */    gStatusSendEnd = STATUS_SEND_ING;
/*   110 */    statusSendStep = -1;
/*   111 */    nSendStep = 0;
/*   112 */ }
/*   114 */ static void MLinkSetInitDisp(void)
/*   115 */ {
/*   116 */    GUI_SetBkColor(0x1c1b1a);
/*   118 */    LanguageSelect(FONT20);
/*   120 */    (void)GUI_SetPenSize(2);
/*   121 */    GUI_SetColor(0x494440);
/*   123 */    GUI_ClearRect(0, 34, 480-1, 320-1);
/*   124 */    GUI_DrawRect(10, 45, (10 + 460) - 1, (45 + (44 * INDEX_3 )) - 1);
/*   126 */    for(int i = 0; i < (6-INDEX_4); i++)
/*   127 */    {
/*   128 */       int y0 = 45 + ((i + 1) * 44);
/*   129 */       GUI_DrawHLine(y0, 10+INDEX_2, (10 + 460) - 1);
/*   130 */    }
/*   132 */    GUI_SetColor(0xc8c8c8);
/*   133 */    GUI_RECT rect;
/*   134 */    rect.x0 = 41;
/*   135 */    rect.y0 = 46;
/*   136 */    rect.x1 = (41 + 150) - 1;
/*   137 */    rect.y1 = (46 + 44) - 1;
/*   139 */    for(int i = 0 ; i < (6-INDEX_3); i++)
/*   140 */    {
/*   141 */       GUI_DispStringInRect(_acmlink_hwset_label_text[SettingValue[SETUP_LANGUAGE]][i], &rect, (0) | (3<<2));
/*   142 */       rect.y0 += 44;
/*   143 */       rect.y1 += 44;
/*   144 */    }
/*   145 */ }
/*   148 */ void MLinkHwSet(void)
/*   149 */ {
/*   150 */    int flagBreak = 0;
/*   151 */    MLinkSetInitDisp();
/*   152 */    MlinkHwSetSend();
/*   154 */    while (1)
/*   155 */    {
/*   156 */       E_KEY key = GetKey();
/*   158 */       if(key == TIME_OUT)
/*   159 */       {
/*   160 */          gStatusSendEnd = STATUS_SEND_ING;
/*   161 */          nSendStep = 0;
/*   162 */          statusSendStep = 0;
/*   163 */          MlinkHwSetSend();
/*   164 */       }
/*   165 */       else
/*   166 */       if(key == KEY_SETUP)
/*   167 */       {
/*   168 */          if(Setup() == SETUP_CHANGED)
/*   169 */          {
/*   170 */             flagBreak = 1;
/*   171 */          }
/*   172 */          else {}
/*   173 */          MLinkSetInitDisp();
/*   174 */          gCommOldStatus[gDeviceIndex] = -1;
/*   175 */       }
/*   176 */       else
/*   177 */       if(key == DATA_RECV)
/*   178 */       {
/*   179 */          if(gStatusSendEnd == STATUS_SEND_ING)
/*   180 */          {
/*   181 */             StatusRecv();
/*   182 */             MlinkHwSetSend();
/*   183 */          }
...
/*   191 */             else
/*   192 */             {
/*   193 */                g_bRecvAllDone = 1;
/*   194 */                (void)printf("g_bRecvAllDone=0\n");
/*   195 */             }
/*   196 */          }
/*   197 */       }
/*   198 */       else
/*   199 */       if(key == KEY_CANCEL)
/*   200 */       {
/*   201 */          flagBreak = 1;
/*   202 */       }
/*   203 */       else
/*   204 */       if(key == KEY_COMM_ERROR)
/*   205 */       {
/*   206 */          (void)printf("COMM Error!! gStatusSendEnd=%d, statusSendStep=%d\n",gStatusSendEnd,statusSendStep);
/*   207 */          if(StatusRecvErrorProcess() == STATUS_SEND_ING)
/*   208 */          {
/*   209 */             nSendStep = 0;
/*   210 */          }
/*   211 */          else
/*   212 */          {
/*   213 */             if(nSendStep < INDEX_1)
/*   214 */             {
/*   215 */                MlinkHwSetSend();
/*   216 */             }
/*   217 */             else
/*   218 */             {
/*   219 */                g_bRecvAllDone = 1;
/*   221 */                (void)printf("All done!!!\n");
/*   222 */                gStatusSendEnd = STATUS_SEND_ING;
/*   223 */                statusSendStep = 0;
/*   224 */                nSendStep = 0;
/*   225 */             }
/*   231 */          }
/*   232 */       }
/*   233 */       else
/*   234 */       if(key == COMM_STAT_ERROR)
/*   235 */       {
/*   236 */          MLinkSetInitDisp();
/*   237 */       }
/*   238 */       else {}
/*   239 */       if(flagBreak == 1)
/*   240 */       {
