...
/*
 * C:/CodeInspection/DisplayUnit/STemWin/App/MLinkOverview.c
 */
/*    58 */ void DispMLinkStatus(void)
/*    59 */ {
/*    60 */    (void)GUI_SetPenSize(1);
/*    61 */    GUI_SetColor(0x2f2c2a);
/*    62 */    GUI_SetBkColor(0x2f2c2a);
/*    63 */    GUI_ClearRect(0, 0, 480-1, 34);
/*    64 */    GUI_SetColor(0x605a54);
/*    65 */    for(int i = 0; i < INDEX_3; i++)
/*    66 */    {
/*    67 */       GUI_DrawVLine(_ichstatus_line_x[i], 0, 34);
/*    68 */    }
/*    69 */    GUI_SetColor(0x00FFFFFF);
/*    70 */    gCommOldStatus[gDeviceIndex] = -1;
/*    72 */ }
/*    75 */ unsigned char doStatus[8][4];
/*    76 */ unsigned char diStatus[8][6];
/*    79 */ void MLinkOverviewValue(int flag)
/*    80 */ {
/*    81 */    static unsigned char diSetup[6];
/*    82 */    static float aiValue;
/*    84 */    if(gCommStatus[gDeviceIndex] == COMM_ERROR)
/*    85 */    {
/*    86 */       return;
/*    87 */    }
/*    88 */    char buf[60];
...
/*    92 */       if(nSendStep == 0)
/*    93 */       {
/*    94 */          aiValue = ModbusGetFloat(219);
/*    95 */          (void)printf("aiValue=%f\n", aiValue);
/*    96 */          return;
/*    97 */       }
/*    98 */       else
/*    99 */       {
/*   100 */          unsigned short address = 2031;
/*   101 */          for(unsigned short i = 0; i < 6; i++)
/*   102 */          {
/*   103 */             diSetup[i] = ModbusGetUint16(address++);
/*   104 */          }
/*   105 */          statusSendStep = 0;
/*   106 */          nSendStep = 0;
/*   107 */       }
/*   108 */    }
/*   110 */    (void)GUI_SetFont(&GUI_Font24B_1);
/*   111 */    GUI_SetColor(0x00FFFFFF);
/*   112 */    GUI_SetBkColor(0x1c1b1a);
/*   114 */    GUI_RECT rect;
/*   115 */    rect.x0 = 300;
/*   116 */    rect.x1 = ((300 + 100) - 1);
/*   117 */    rect.y0 = 218+INDEX_5;
/*   118 */    rect.y1 = ((218 + 62) - 1)-INDEX_5;
/*   119 */    (void)sprintf(buf, "%4.2f", aiValue);
/*   120 */    GUI_ClearRectEx(&rect);
/*   121 */    GUI_DispStringInRect(buf, &rect, (1<<0) | (3<<2));
/*   123 */    (void)GUI_SetPenSize(2);
/*   125 */    rect.x0 = 89;
/*   126 */    rect.x1 = ((89 + 60) - 1);
/*   127 */    rect.y0 = 74;
/*   128 */    rect.y1 = ((74 + 62) - 1);
...
/*   130 */    {
/*   131 */       if((diSetup[i] != 0) && (diStatus[gDeviceIndex][i] == 1))
/*   132 */       {
/*   133 */          GUI_SetBkColor(0x0fce00);
/*   134 */          GUI_SetColor(0x0fce00);
/*   135 */       }
/*   136 */       else
/*   137 */       {
/*   138 */          GUI_SetBkColor(0x494949);
/*   139 */          GUI_SetColor(0x494949);
/*   140 */       }
/*   141 */       GUI_FillRectEx(&rect);
/*   143 */       GUI_SetColor(0x494440);
/*   144 */       GUI_DrawRectEx(&rect);
/*   146 */       if(diSetup[i] == 0)
/*   147 */       {
...
/*   150 */       else
/*   151 */       {
/*   152 */          (void)sprintf(buf, "%d", i + 1);
/*   153 */       }
/*   154 */       GUI_SetColor(0x00FFFFFF);
/*   155 */       GUI_DispStringInRect(buf, &rect, (2<<0) | (3<<2));
/*   156 */       rect.x0 += 60;
/*   157 */       rect.x1 += 60;
/*   158 */    }
/*   160 */    rect.y0 += 72;
...
/*   164 */    rect.x1 = ((89 + 60) - 1);
/*   166 */    int do_count = 4;
/*   167 */    if(mLinkMode[gDeviceIndex] == INDEX_5)
/*   168 */    {
/*   169 */       do_count = 0;
/*   170 */    }
/*   171 */    else
/*   172 */    if(mLinkMode[gDeviceIndex] == INDEX_3)
/*   173 */    {
/*   174 */       do_count = INDEX_2;
/*   175 */    }
/*   176 */    else {}
...
/*   180 */       if(i < do_count)
/*   181 */       {
/*   182 */          (void)sprintf(buf, "%d", i + 1);
/*   183 */       }
/*   184 */       else
/*   185 */       {
/*   186 */          (void)sprintf(buf, "-");
/*   187 */       }
/*   188 */       if((doStatus[gDeviceIndex][i] == 1) && (i < 4) && (i < do_count))
/*   189 */       {
/*   190 */          GUI_SetBkColor(0x0fce00);
/*   191 */          GUI_SetColor(0x0fce00);
/*   192 */       }
/*   193 */       else
/*   194 */       {
/*   195 */          GUI_SetBkColor(0x494949);
/*   196 */          GUI_SetColor(0x494949);
/*   197 */       }
/*   198 */       GUI_FillRectEx(&rect);
/*   200 */       GUI_SetColor(0x494440);
/*   201 */       GUI_DrawRectEx(&rect);
/*   203 */       GUI_SetColor(0x00FFFFFF);
/*   204 */       GUI_DispStringInRect(buf, &rect, (2<<0) | (3<<2));
/*   206 */       rect.x0 += 60;
/*   207 */       rect.x1 += 60;
/*   208 */    }
/*   209 */    (void)printf("g_bRecvAllDone.......\n");
/*   210 */    g_bRecvAllDone = 1;
/*   211 */ }
/*   215 */ void MLinkOverview(void)
/*   216 */ {
/*   217 */    GUI_SetBkColor(0x1c1b1a);
/*   218 */    GUI_ClearRect(0, 34, 480-1, 320-1);
/*   221 */    GUI_SetBkColor(0x1c1b1a);
/*   222 */    (void)GUI_SetFont(&GUI_Font24B_1);
/*   224 */    (void)GUI_SetPenSize(2);
/*   226 */    int y0 = 74;
/*   227 */    int y1 = ((74 + 62) - 1);
/*   229 */    GUI_RECT rect = {
/*   230 */       10,
...
/*   237 */    {
/*   238 */       GUI_SetColor(0x494440);
/*   239 */       GUI_DrawRect(10, y0, ((10 + 440) - 1), y1);
/*   240 */       GUI_DrawVLine(89, y0, y1);
/*   241 */       GUI_SetColor(0xc8c8c8);
/*   242 */       GUI_DispStringInRect(_acmlink_overview_label_text[i], &rect, (2<<0) | (3<<2));
/*   243 */       y0 += 72;
/*   244 */       y1 += 72;
/*   245 */       rect.y0 = y0;
/*   246 */       rect.y1 = y1;
/*   247 */    }
/*   249 */    GUI_SetColor(0xa5a5a5);
/*   250 */    LanguageSelect(FONT20B);
/*   252 */    rect.y0 = 218;
/*   253 */    rect.y1 = ((218 + 62) - 1);
/*   254 */    rect.x0 = 408;
/*   255 */    rect.x1 = ((408 + 30) - 1);
/*   256 */    GUI_DispStringInRect(_acmlink_overview_unit_text[0], &rect, (0) | (3<<2));
/*   257 */ }
/*   259 */ 
