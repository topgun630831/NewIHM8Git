...
/*
 * C:/CodeInspection/DisplayUnit/STemWin/App/MLinkEvent.c
 */
/*    37 */ static void MLinkEventInitDisp(void);
/*    55 */ void CountDisp(int total, int index)
/*    56 */ {
/*    57 */    char buf[20];
/*    58 */    (void)sprintf(buf, "%d/%d", index, total);
/*    60 */    (void)printf("\n\n\n\n\n\ntotal=%d, cur=%d\n",total, index);
/*    62 */    GUI_SetColor(0x00FFFFFF);
/*    63 */    (void)GUI_SetFont(&GUI_Font20B_ASCII);
/*    64 */    GUI_SetBkColor(0x1c1b1a);
/*    65 */    GUI_RECT rect;
/*    66 */    rect.x0 = (360 + 30);
/*    67 */    rect.y0 = 57;
/*    68 */    rect.x1 = (360 + 100);
/*    69 */    rect.y1 = ((57 + 24) - 1);
/*    70 */    GUI_ClearRectEx(&rect);
/*    71 */    GUI_DispStringInRect(buf, &rect, (1<<0) | (1<<2));
/*    73 */ }
/*    75 */ static void MLinkEventInitDisp(void)
/*    76 */ {
/*    77 */    GUI_SetBkColor(0x1c1b1a);
/*    79 */    (void)GUI_SetPenSize(2);
/*    80 */    GUI_SetColor(0x494440);
/*    82 */    GUI_ClearRect(0, 34, 480-1, 320-1);
/*    83 */    GUI_DrawRect(10, 88, (10 + 460) - 1, ((88 + 222) - 1));
/*    86 */    (void)printf("\n\n\n\n\n\ntotal=%d, cur=%d\n",nEventTotal, nCurrIndex);
/*    87 */    if(gCommStatus[gDeviceIndex] == COMM_OK)
/*    88 */    {
/*    89 */       if(nEventTotal == 0)
/*    90 */       {
/*    91 */          nCurrIndex = 0;
/*    92 */       }
/*    93 */       CountDisp(nEventTotal, nCurrIndex);
/*    94 */    }
/*    96 */    GUI_SetColor(0xc8c8c8);
/*    97 */    GUI_RECT rect;
/*    98 */    rect.x0 = 36;
/*    99 */    rect.y0 = 57;
/*   100 */    rect.x1 = ((36 + 154) - 1);
/*   101 */    rect.y1 = ((57 + 24) - 1);
/*   102 */    (void)GUI_SetFont(&GUI_Font24_ASCII);
/*   103 */    GUI_DispStringInRect("Event", &rect, (0) | (3<<2));
/*   116 */ }
/*   119 */ void MLinkEvent(void)
/*   120 */ {
/*   121 */    int bCommError = gCommStatus[gDeviceIndex];
/*   122 */    int flagBreak = 0;
/*   123 */    nMenuPos = 0;
/*   124 */    nCurrIndex = 1;
/*   125 */    nEventIndex = gSystemEventIndex[gDeviceIndex];
/*   126 */    nEventTotal = gSystemEventTotalCount[gDeviceIndex];
/*   129 */    (void)printf("nEventTotal = %d\n", nEventTotal);
/*   130 */    MLinkEventInitDisp();
/*   131 */    if(nEventTotal != 0)
/*   132 */    {
/*   133 */       bEventSend = 1;
/*   134 */       EventSend(1);
/*   135 */    }
/*   150 */    while (1)
/*   151 */    {
/*   152 */       E_KEY key = GetKey();
/*   154 */       if(key == TIME_OUT)
/*   155 */       {
/*   156 */          gStatusSendEnd = STATUS_SEND_ING;
/*   157 */          statusSendStep = 0;
/*   158 */          EventSend(0);
/*   159 */       }
/*   160 */       else
/*   161 */       if(key == KEY_SETUP)
/*   162 */       {
/*   163 */          if(Setup() == SETUP_CHANGED)
/*   164 */          {
/*   165 */             flagBreak = 1;
/*   166 */          }
/*   167 */          MLinkEventInitDisp();
/*   168 */          gCommOldStatus[gDeviceIndex] = -1;
/*   169 */          (void)EventSend(1);
/*   170 */       }
/*   171 */       else
/*   172 */       if(key == KEY_UP)
/*   173 */       {
/*   174 */          if(nEventTotal == 0)
/*   175 */          {
/*   176 */             continue;
/*   177 */          }
/*   178 */          if(nCurrIndex < nEventTotal)
/*   179 */          {
/*   180 */             nCurrIndex++;
/*   181 */          }
/*   182 */          else
...
/*   186 */          bEventSend = 1;
/*   187 */          EventSend(1);
/*   188 */          CountDisp(nEventTotal, nCurrIndex);
/*   189 */       }
/*   190 */       else
/*   191 */       if(key == KEY_DOWN)
/*   192 */       {
/*   193 */          if(nEventTotal == 0)
/*   194 */          {
/*   195 */             continue;
/*   196 */          }
/*   197 */          if(nCurrIndex > 1)
...
/*   201 */          else
/*   202 */          {
/*   203 */             nCurrIndex = nEventTotal;
/*   204 */          }
/*   205 */          bEventSend = 1;
/*   206 */          EventSend(1);
/*   207 */          CountDisp(nEventTotal, nCurrIndex);
/*   208 */       }
/*   209 */       else
/*   210 */       if(key == DATA_RECV)
/*   211 */       {
/*   212 */          if(bCommError == COMM_ERROR)
/*   213 */          {
/*   214 */             bCommError = COMM_OK;
/*   215 */             nEventTotal = gSystemEventTotalCount[gDeviceIndex];
/*   216 */             nCurrIndex = 1;
/*   217 */             gStatusSendEnd = STATUS_SEND_END;
/*   218 */             bEventSend = 1;
/*   219 */             if(nEventTotal != 0)
/*   220 */             {
/*   221 */                gStatusSendEnd = STATUS_SEND_END;
/*   222 */                (void)EventSend(1);
/*   223 */                continue;
/*   224 */             }
/*   225 */             else
/*   226 */             {
/*   227 */                MLinkEventInitDisp();
/*   228 */             }
/*   229 */          }
/*   230 */          if(gStatusSendEnd == STATUS_SEND_ING)
/*   231 */          {
/*   232 */             StatusRecv();
/*   233 */             if(gStatusSendEnd == STATUS_SEND_ING)
/*   234 */             {
/*   235 */                (void)EventSend(0);
/*   236 */             }
/*   237 */             else
/*   238 */             {
/*   239 */                (void)printf("All done!!!\n");
/*   240 */                g_bRecvAllDone = 1;
/*   241 */                nSendStep = 0;
/*   242 */                statusSendStep = 0;
/*   243 */                gStatusSendEnd = STATUS_SEND_ING;
/*   244 */             }
/*   245 */          }
/*   246 */          else
/*   247 */          {
/*   248 */             (void)printf("All done!!!\n");
/*   249 */             EventDataRecv();
/*   250 */             g_bRecvAllDone = 1;
/*   251 */             nSendStep = 0;
/*   252 */             statusSendStep = 0;
/*   253 */             gStatusSendEnd = STATUS_SEND_ING;
/*   254 */          }
/*   272 */       }
/*   273 */       else
/*   274 */       if(key == KEY_COMM_ERROR)
/*   275 */       {
/*   276 */          (void)printf("COMM Error!!! gStatusSendEnd=%d, statusSendStep=%d, nSendStep=%d\n",gStatusSendEnd,statusSendStep,nSendStep);
/*   277 */          if(StatusRecvErrorProcess() == STATUS_SEND_ING)
/*   278 */          {
/*   279 */             nSendStep = 0;
/*   280 */          }
/*   281 */          else
/*   282 */          {
/*   283 */             g_bRecvAllDone = 1;
/*   284 */             (void)printf("All done!!!\n");
/*   285 */             gStatusSendEnd = STATUS_SEND_ING;
/*   286 */             statusSendStep = 0;
/*   287 */             nSendStep = 0;
/*   288 */          }
/*   289 */       }
/*   290 */       else
/*   291 */       if(key == COMM_STAT_ERROR)
/*   292 */       {
/*   293 */          bCommError = COMM_ERROR;
/*   294 */          nEventTotal = 0;
/*   295 */          MLinkEventInitDisp();
/*   296 */       }
/*   297 */       else
/*   298 */       if(key == KEY_CANCEL)
/*   299 */       {
/*   300 */          flagBreak = 1;
/*   301 */       }
/*   302 */       else {}
