...
/*
 * C:/CodeInspection/DisplayUnit/STemWin/App/PasswordChange.c
 */
/*    37 */ static void PasswordButtonDisp(int button);
/*    38 */ static void PasswordChangeDisp(int pos, const char oldPassword[4+1], const char newPassword[4+1]);
/*    41 */ static void PasswordButtonDisp(int button)
/*    42 */ {
/*    43 */    GUI_RECT rect;
/*    44 */    rect.x0 = 88;
/*    45 */    rect.y0 = 218;
/*    46 */    rect.x1 = (88 + 142) - 1;
/*    47 */    rect.y1 = (218 + 55) - 1;
/*    48 */    LanguageSelect(FONT24);
/*    49 */    for(int i = 0; i < 2; i++)
/*    50 */    {
/*    51 */       if(i == button)
/*    52 */       {
/*    53 */          GUI_SetColor(0xd07b18);
/*    54 */          GUI_SetBkColor(0xd07b18);
/*    55 */       }
/*    56 */       else
/*    57 */       {
/*    58 */          GUI_SetColor(0x4c4945);
/*    59 */          GUI_SetBkColor(0x4c4945);
/*    60 */       }
/*    62 */       GUI_FillRoundedRect(rect.x0, rect.y0, rect.x1, rect.y1, INDEX_2);
/*    63 */       if(i == button)
/*    64 */       {
/*    65 */          GUI_SetColor(0x00FFFFFF);
/*    66 */       }
/*    67 */       else
/*    68 */       {
/*    69 */          GUI_SetColor(0xa1a1a1);
/*    70 */       }
/*    72 */       GUI_DispStringInRect(_apassword_button_text[SettingValue[SETUP_LANGUAGE]][i], &rect, (2<<0) | (3<<2));
/*    73 */       rect.x0 += 142 + 20;
/*    74 */       rect.x1 += 142 + 20;
/*    75 */    }
/*    76 */ }
/*    79 */ int QuestionMessage(void)
/*    80 */ {
/*    81 */    int flagBreak = 0;
/*    82 */    int nPos = 0;
/*    83 */    int ret = 0;
/*    84 */    GUI_RECT rect;
/*    86 */    GUI_SetBkColor(0x2f2c2a);
/*    88 */    (void)GUI_SetPenSize(2);
/*    89 */    GUI_SetColor(0xd07b18);
/*    91 */    GUI_ClearRect(25, 18, ((430 + 25) - 1), ((280 + 18) - 1));
/*    92 */    GUI_DrawRect(25, 18, ((430 + 25) - 1), ((280 + 18) - 1));
/*    94 */    GUI_SetColor(0x00FFFFFF);
/*    96 */    LanguageSelect(FONT24);
/*    97 */    rect.x0 = 50;
/*    98 */    rect.y0 = 50;
/*    99 */    rect.x1 = ((50 + 380) - 1);
/*   100 */    rect.y1 = ((133 + 60) - 1);
/*   101 */    GUI_DispStringInRect(_acpassword_question_text[SettingValue[SETUP_LANGUAGE]], &rect, (2<<0) | (3<<2));
/*   103 */    PasswordButtonDisp(0);
/*   105 */    while (1)
/*   106 */    {
/*   107 */       E_KEY key = GetKey();
/*   109 */       if(key == KEY_UP)
/*   110 */       {
/*   111 */          if(nPos == 1)
/*   112 */          {
/*   113 */             PasswordButtonDisp(0);
/*   114 */             nPos = 0;
/*   115 */          }
/*   116 */       }
/*   117 */       else
...
/*   120 */          if(nPos == 0)
/*   121 */          {
/*   122 */             PasswordButtonDisp(1);
/*   123 */             nPos = 1;
/*   124 */          }
/*   125 */       }
/*   126 */       else
/*   127 */       if(key == KEY_ENTER)
/*   128 */       {
/*   129 */          if(nPos == 0)
/*   130 */          {
/*   131 */             ret = 1;
...
/*   152 */    return ret;
/*   153 */ }
/*   155 */ static void PasswordChangeDisp(int pos, const char oldPassword[4+1], const char newPassword[4+1])
/*   156 */ {
/*   157 */    GUI_RECT rect;
/*   158 */    GUI_SetBkColor(0x2f2c2a);
/*   161 */    GUI_SetBkColor(0x2f2c2a);
/*   162 */    GUI_ClearRect(88,
/*   163 */        ((55 + 10) + 5) - INDEX_17,
/*   164 */        ((88 + 142) + 20) + (36 * INDEX_4),
/*   165 */        ((((((((55 + 10) + 5) + 45) - 1)) + 30 + 5) + 45) - 1) + INDEX_17);
/*   167 */    GUI_SetColor(0xc8c8c8);
/*   169 */    LanguageSelect(FONT20B);
/*   170 */    rect.x0 = 88-INDEX_20;
/*   171 */    rect.y0 = ((55 + 10) + 5);
/*   172 */    rect.x1 = (88 + 142);
/*   173 */    rect.y1 = ((((55 + 10) + 5) + 45) - 1);
/*   174 */    GUI_DispStringInRect(_acsetup_password_text[SettingValue[SETUP_LANGUAGE]][0], &rect, (1<<0) | (3<<2));
/*   175 */    rect.y0 = ((((((55 + 10) + 5) + 45) - 1)) + 30 + 5);
/*   176 */    rect.y1 = ((((((((55 + 10) + 5) + 45) - 1)) + 30 + 5) + 45) - 1);
/*   177 */    GUI_DispStringInRect(_acsetup_password_text[SettingValue[SETUP_LANGUAGE]][1], &rect, (1<<0) | (3<<2));
/*   180 */    rect.x0 = ((88 + 142) + 20);
/*   181 */    rect.y0 = ((55 + 10) + 5);
/*   182 */    rect.x1 = (((88 + 142) + 20) + 36) - 1;
/*   183 */    rect.y1 = ((((55 + 10) + 5) + 45) - 1);
/*   184 */    for(int i = 0; i < 8; i++)
/*   185 */    {
/*   186 */       GUI_DispStringInRect(_acpassword_input_text, &rect, (2<<0) | (3<<2));
/*   187 */       rect.x0 += 36;
/*   188 */       rect.x1 += 36;
/*   189 */       if(i == INDEX_3)
/*   190 */       {
/*   191 */          rect.x0 = ((88 + 142) + 20);
/*   192 */          rect.x1 = (((88 + 142) + 20) + 36) - 1;
/*   193 */          rect.y0 = ((((((55 + 10) + 5) + 45) - 1)) + 30 + 5);
/*   194 */          rect.y1 = ((((((((55 + 10) + 5) + 45) - 1)) + 30 + 5) + 45) - 1);
/*   195 */       }
/*   196 */    }
/*   198 */    if(pos >= 8)
/*   199 */    {
/*   200 */       return;
/*   201 */    }
/*   203 */    char buf[INDEX_2];
/*   204 */    int offset;
/*   205 */    if(pos < INDEX_4)
/*   206 */    {
/*   207 */       offset = pos;
/*   208 */       buf[0] = oldPassword[pos];
/*   209 */       rect.y0 = ((55 + 10) + 5);
/*   210 */       rect.y1 = ((((55 + 10) + 5) + 45) - 1);
/*   211 */    }
/*   212 */    else
/*   213 */    {
/*   214 */       offset = pos - INDEX_4;
/*   215 */       buf[0] = newPassword[pos-INDEX_4];
/*   216 */       rect.y0 = ((((((55 + 10) + 5) + 45) - 1)) + 30 + 5);
/*   217 */       rect.y1 = ((((((((55 + 10) + 5) + 45) - 1)) + 30 + 5) + 45) - 1);
/*   218 */    }
/*   219 */    buf[1] = 0;
/*   221 */    rect.x0 = ((88 + 142) + 20) + (36 * offset);
/*   222 */    rect.x1 = (rect.x0 + 36) - 1;
/*   224 */    GUI_SetColor(0x00FFFFFF);
/*   225 */    GUI_SetBkColor(0x00000000);
/*   226 */    GUI_ClearRect(rect.x0, rect.y0, rect.x1, rect.y1);
/*   227 */    GUI_DispStringInRect(buf, &rect, (2<<0) | (3<<2));
/*   229 */    int x = rect.x0 - INDEX_7;
/*   230 */    (void)GUI_BMP_Draw(_acUp, x, rect.y0 - INDEX_17);
/*   231 */    (void)GUI_BMP_Draw(_acDown, x, rect.y1);
/*   232 */ }
/*   235 */ int PasswordChange(void)
/*   236 */ {
/*   237 */    int flagBreak = 0;
/*   238 */    int nPos = 0;
/*   239 */    int ret = 0;
/*   240 */    char oldPassword[4+1];
/*   241 */    char newPassword[4+1];
/*   243 */    (void)sprintf(oldPassword, "0000");
/*   244 */    (void)sprintf(newPassword, "0000");
/*   246 */    GUI_SetBkColor(0x2f2c2a);
/*   248 */    (void)GUI_SetPenSize(2);
/*   249 */    GUI_SetColor(0xd07b18);
/*   251 */    GUI_ClearRect(25, 18, ((430 + 25) - 1), ((280 + 18) - 1));
/*   252 */    GUI_DrawRect(25, 18, ((430 + 25) - 1), ((280 + 18) - 1));
/*   254 */    GUI_SetColor(0x00FFFFFF);
/*   256 */    PasswordChangeDisp(nPos, oldPassword, newPassword);
/*   257 */    ButtonDisp(2);
/*   259 */    while (1)
/*   260 */    {
/*   261 */       E_KEY key = GetKey();
/*   262 */       int index;
/*   264 */       if(key == KEY_UP)
/*   265 */       {
/*   266 */          if(nPos < 8)
...
/*   269 */             {
/*   270 */                index = nPos;
/*   271 */                if(oldPassword[index] < '9')
/*   272 */                {
/*   273 */                   oldPassword[index]++;
/*   274 */                }
/*   275 */                else
/*   276 */                {
/*   277 */                   oldPassword[index] = '0';
/*   278 */                }
/*   279 */                PasswordChangeDisp(nPos, oldPassword, newPassword);
/*   280 */             }
/*   281 */             else
/*   282 */             {
/*   283 */                index = nPos - INDEX_4;
/*   284 */                if(newPassword[index] < '9')
/*   285 */                {
/*   286 */                   newPassword[index]++;
/*   287 */                }
/*   288 */                else
/*   289 */                {
/*   290 */                   newPassword[index] = '0';
/*   291 */                }
/*   292 */                PasswordChangeDisp(nPos, oldPassword, newPassword);
/*   293 */             }
/*   294 */          }
/*   295 */          else
/*   296 */          if(nPos == (8 + 1))
...
/*   309 */             {
/*   310 */                index = nPos;
/*   311 */                if(oldPassword[index] > '0')
/*   312 */                {
/*   313 */                   oldPassword[index]--;
/*   314 */                }
/*   315 */                else
/*   316 */                {
/*   317 */                   oldPassword[index] = '9';
/*   318 */                }
/*   319 */                PasswordChangeDisp(nPos, oldPassword, newPassword);
/*   320 */             }
/*   321 */             else
/*   322 */             {
/*   323 */                index = nPos - INDEX_4;
/*   324 */                if(newPassword[index] > '0')
/*   325 */                {
/*   326 */                   newPassword[index]--;
/*   327 */                }
/*   328 */                else
/*   329 */                {
/*   330 */                   newPassword[index] = '9';
/*   331 */                }
/*   332 */                PasswordChangeDisp(nPos, oldPassword, newPassword);
/*   333 */             }
/*   334 */          }
/*   335 */          else
/*   336 */          if(nPos == 8)
...
/*   342 */       }
/*   343 */       else
/*   344 */       if(key == KEY_ENTER)
/*   345 */       {
/*   346 */          if(nPos < 8)
/*   347 */          {
/*   348 */             nPos++;
/*   349 */             PasswordChangeDisp(nPos, oldPassword, newPassword);
/*   350 */             if(nPos == 8)
/*   351 */             {
/*   352 */                ButtonDisp(0);
/*   353 */             }
...
/*   356 */          if(nPos == 8)
/*   357 */          {
/*   358 */             unsigned short password = atoi(oldPassword);
/*   359 */             if(password != SettingValue[SETUP_PASSWORD])
/*   360 */             {
/*   361 */                if(QuestionMessage() == 0)
/*   362 */                {
/*   363 */                   flagBreak = 1;
/*   364 */                }
/*   365 */                nPos = 0;
/*   366 */                PasswordChangeDisp(nPos, oldPassword, newPassword);
/*   367 */                ButtonDisp(2);
/*   368 */             }
/*   369 */             else
/*   370 */             {
/*   371 */                SettingValue[SETUP_PASSWORD] = atoi(newPassword);
/*   372 */                ret = 1;
/*   373 */                flagBreak = 1;
/*   374 */             }
/*   375 */          }
