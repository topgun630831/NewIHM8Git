...
/*
 * C:/CodeInspection/DisplayUnit/STemWin/App/AcbMccbRelaySet.c
 */
/*    35 */ static void RelaySetSend(void);
/*    36 */ static void RelaySetValueDisp(void);
/*    37 */ static void AcbMccbRelaySetInitDisp(void);
/*    40 */ static void RelaySetSend(void)
/*    41 */ {
/*    42 */    if(StatusSend() == STATUS_SEND_ING)
/*    43 */    {
/*    44 */       return;
/*    45 */    }
/*    47 */    (void)printf("RelaySetSend() nSendStep=%d\n", nSendStep);
/*    49 */    unsigned short len = 60;
/*    50 */    if(ConnectSetting[gDeviceIndex].DeviceType == DEVICE_ACB)
/*    51 */    {
/*    52 */       if(nSendStep == 0)
/*    53 */       {
/*    54 */          ModbusSendFrame(ConnectSetting[gDeviceIndex].Address, HOLDING_REGISTER, 50, 1);
/*    55 */       }
/*    56 */       else
/*    57 */       {
/*    58 */          ModbusSendFrame(ConnectSetting[gDeviceIndex].Address, HOLDING_REGISTER, 61+gGroupOffset[gDeviceIndex], len);
/*    59 */       }
/*    60 */    }
/*    61 */    else
/*    62 */    if(ConnectSetting[gDeviceIndex].DeviceType == DEVICE_MCCB)
/*    63 */    {
/*    64 */       len = 44;
/*    65 */       ModbusSendFrame(ConnectSetting[gDeviceIndex].Address, HOLDING_REGISTER, 61+gGroupOffset[gDeviceIndex], len);
/*    66 */    }
/*    67 */    else {}
/*    68 */ }
/*    70 */ static void RelaySetValueDisp(void)
/*    71 */ {
/*    72 */    if((ConnectSetting[gDeviceIndex].DeviceType == DEVICE_ACB) && (nSendStep == 0))
/*    73 */    {
/*    74 */       unsigned short group = ModbusGetUint16(50);
/*    75 */       if(group == 1)
/*    76 */       {
/*    77 */          gGroupOffset[gDeviceIndex] = 200;
/*    78 */       }
/*    79 */       else
/*    80 */       {
/*    81 */          gGroupOffset[gDeviceIndex] = 0;
/*    82 */       }
/*    83 */       nSendStep = 1;
/*    84 */       return;
/*    85 */    }
/*    86 */    nSendStep = 0;
/*    87 */    char ampare[6-1][20];
/*    88 */    char Sec[6-1][20];
/*    90 */    unsigned char used = ModbusGetUint8_U(61+gGroupOffset[gDeviceIndex]);
/*    91 */    float l = (float)ModbusGetUint16(64+gGroupOffset[gDeviceIndex]);
/*    92 */    float t;
/*    93 */    if(ConnectSetting[gDeviceIndex].DeviceType == DEVICE_MCCB)
/*    94 */    {
/*    95 */       t = (float)ModbusGetUint16(65)/1000.0;
/*    96 */    }
/*    97 */    else
/*    98 */    {
/*    99 */       t = (float)ModbusGetUint16(65+gGroupOffset[gDeviceIndex])/100.0;
/*   100 */    }
/*   101 */    if(used == INDEX_5)
/*   102 */    {
/*   103 */       (void)sprintf(ampare[0], "-");
/*   104 */       (void)sprintf(Sec[0], "-");
/*   105 */    }
/*   106 */    else
/*   107 */    {
/*   108 */       (void)sprintf(ampare[0], "%.1f A", l);
/*   109 */       (void)sprintf(Sec[0], "%.2f s", t);
/*   110 */    }
/*   111 */    unsigned short nPhaseProtect;
/*   112 */    if(ConnectSetting[gDeviceIndex].DeviceType == DEVICE_MCCB)
/*   113 */    {
/*   114 */       used = 1;
/*   115 */       nPhaseProtect = ModbusGetUint16(104);
/*   116 */       if(nPhaseProtect <= 1)
/*   117 */       {
/*   118 */          used = INDEX_5;
/*   119 */       }
/*   120 */    }
/*   121 */    else
/*   122 */    {
/*   123 */       used = ModbusGetUint8_U(116+gGroupOffset[gDeviceIndex]);
/*   124 */    }
/*   125 */    if(used == INDEX_5)
/*   126 */    {
/*   127 */       (void)sprintf(ampare[1], "-");
/*   128 */       (void)sprintf(Sec[1], "-");
/*   129 */    }
/*   130 */    else
/*   131 */    {
/*   132 */       if(ConnectSetting[gDeviceIndex].DeviceType == DEVICE_MCCB)
/*   133 */       {
/*   134 */          if(nPhaseProtect == INDEX_3)
/*   135 */          {
/*   136 */             l = l * 0.5;
/*   137 */          }
/*   138 */          else
/*   139 */          {
/*   140 */          }
/*   141 */          (void)sprintf(ampare[1], "%.1f A", l);
/*   142 */          (void)sprintf(Sec[1], "%.2f s", t);
/*   143 */          if(nPhaseProtect == INDEX_4)
/*   144 */          {
/*   145 */             (void)sprintf(ampare[1], "OSN");
/*   146 */          }
/*   147 */          else
/*   148 */          {
/*   149 */          }
...
/*   151 */       else
/*   152 */       {
/*   153 */          (void)sprintf(ampare[1], "%.1f A", (l * ((float)ModbusGetUint16((119+gGroupOffset[gDeviceIndex]))/100.0)));
/*   154 */          (void)sprintf(Sec[1], "%.2f s", (float)ModbusGetUint16(120+(gGroupOffset[gDeviceIndex]))/100.0);
/*   155 */       }
/*   156 */    }
/*   157 */    used = ModbusGetUint8_U(67+gGroupOffset[gDeviceIndex]);
/*   158 */    if(used == INDEX_5)
/*   159 */    {
/*   160 */       (void)sprintf(ampare[INDEX_2], "-");
/*   161 */       (void)sprintf(Sec[INDEX_2], "-");
/*   162 */    }
/*   163 */    else
/*   164 */    {
/*   165 */       (void)sprintf(ampare[INDEX_2], "%.1f A", (float)ModbusGetUint16(71+gGroupOffset[gDeviceIndex]));
/*   166 */       if(ConnectSetting[gDeviceIndex].DeviceType == DEVICE_MCCB)
/*   167 */       {
/*   168 */          (void)sprintf(Sec[INDEX_2], "%.2f s", (float)ModbusGetUint16(72+gGroupOffset[gDeviceIndex])/1000.0);
/*   169 */       }
/*   170 */       else
/*   171 */       {
/*   172 */          (void)sprintf(Sec[INDEX_2], "%.2f s", (float)ModbusGetUint16(72+gGroupOffset[gDeviceIndex])/100.0);
/*   173 */       }
/*   174 */    }
/*   175 */    used = ModbusGetUint8_U(87+gGroupOffset[gDeviceIndex]);
/*   176 */    if(used == INDEX_5)
/*   177 */    {
/*   178 */       (void)sprintf(ampare[INDEX_3], "-");
/*   179 */    }
/*   180 */    else
/*   181 */    {
/*   182 */       if(ConnectSetting[gDeviceIndex].DeviceType == DEVICE_MCCB)
/*   183 */       {
/*   184 */          (void)sprintf(ampare[INDEX_3], "%.1f A", (float)ModbusGetUint16(90+gGroupOffset[gDeviceIndex]));
/*   185 */       }
/*   186 */       else
/*   187 */       {
/*   188 */          (void)sprintf(ampare[INDEX_3], "%.1f A", (float)ModbusGetUint16(90+gGroupOffset[gDeviceIndex]) * 10);
/*   189 */       }
/*   190 */    }
/*   191 */    Sec[INDEX_3][0] = 0;
/*   192 */    used = ModbusGetUint8_U(94+gGroupOffset[gDeviceIndex]);
/*   193 */    if(used == INDEX_5)
/*   194 */    {
/*   195 */       (void)sprintf(ampare[INDEX_4], "-");
/*   196 */       (void)sprintf(Sec[INDEX_4], "-");
/*   197 */    }
/*   198 */    else
/*   199 */    {
/*   200 */       if(ConnectSetting[gDeviceIndex].DeviceType == DEVICE_MCCB)
/*   201 */       {
/*   202 */          (void)sprintf(ampare[INDEX_4], "%.1f A", (float)ModbusGetUint16(98+gGroupOffset[gDeviceIndex])/10.0);
/*   203 */          (void)sprintf(Sec[INDEX_4], "%.2f s", (float)ModbusGetUint16(99+gGroupOffset[gDeviceIndex])/1000.0);
/*   204 */       }
/*   205 */       else
/*   206 */       {
/*   207 */          (void)sprintf(ampare[INDEX_4], "%.1f A", (float)ModbusGetUint16(98+gGroupOffset[gDeviceIndex]));
/*   208 */          (void)sprintf(Sec[INDEX_4], "%.2f s", (float)ModbusGetUint16(99+gGroupOffset[gDeviceIndex])/100.0);
/*   209 */       }
/*   210 */    }
/*   212 */    GUI_SetColor(0x00FFFFFF);
/*   213 */    (void)GUI_SetFont(&GUI_Font20B_ASCII);
/*   214 */    GUI_SetBkColor(0x1c1b1a);
/*   216 */    GUI_RECT rect;
/*   217 */    rect.x0 = 200 - 30 ;
/*   218 */    rect.y0 = 45+1;
/*   219 */    rect.x1 = (rect.x0 + 110) - 1;
/*   220 */    rect.y1 = (45 + 44) - INDEX_2;
/*   221 */    for(int i = 0 ; i < (6-1); i++)
/*   222 */    {
/*   223 */       GUI_ClearRectEx(&rect);
/*   224 */       GUI_DispStringInRect(ampare[i], &rect, (1<<0) | (3<<2));
/*   225 */       rect.y0 += 44;
/*   226 */       rect.y1 += 44;
/*   227 */    }
/*   229 */    rect.x0 = 350;
/*   230 */    rect.y0 = 45+1;
/*   231 */    rect.x1 = (350 + 110) - 1;
/*   232 */    rect.y1 = (45 + 44) - INDEX_2;
/*   233 */    for(int i = 0 ; i < (6-1); i++)
/*   234 */    {
/*   235 */       GUI_ClearRectEx(&rect);
/*   236 */       GUI_DispStringInRect(Sec[i], &rect, (1<<0) | (3<<2));
/*   237 */       rect.y0 += 44;
/*   238 */       rect.y1 += 44;
/*   239 */    }
/*   240 */ }
/*   245 */ static void AcbMccbRelaySetInitDisp(void)
/*   246 */ {
/*   247 */    GUI_SetBkColor(0x1c1b1a);
/*   249 */    (void)GUI_SetPenSize(2);
/*   250 */    GUI_SetColor(0x494440);
/*   252 */    GUI_ClearRect(0, 34, 480-1, 320-1);
/*   253 */    GUI_DrawRect(130, 45, ((130+340)-1), (45 + (44 * 5)));
/*   255 */    for(int i = 0; i < (6-INDEX_2); i++)
/*   256 */    {
/*   257 */       int y0 = 45 + ((i + 1) * 44);
/*   258 */       GUI_DrawHLine(y0, 130, ((130+340)-1));
/*   259 */    }
/*   260 */    GUI_DrawVLine(300, 45, (45 + (44 * 5)));
/*   262 */    GUI_SetColor(0xc8c8c8);
/*   264 */    GUI_RECT rect;
/*   265 */    for(int i = 0; i < INDEX_3; i++)
/*   266 */    {
/*   267 */       if(i == INDEX_0)
/*   268 */       {
/*   269 */          LanguageSelect(FONT20);
/*   270 */          if(SettingValue[SETUP_LANGUAGE] == CHINESE)
/*   271 */          {
/*   272 */             rect.x0 = 5;
/*   273 */             rect.x1 = (5 + 130) - 1;
/*   274 */          }
...
/*   282 */       if(i == INDEX_1)
/*   283 */       {
/*   284 */          (void)GUI_SetFont(&GUI_Font20_ASCII);
/*   285 */          rect.x0 = 150;
/*   286 */          rect.x1 = (150 + 40) - 1;
/*   287 */       }
/*   288 */       else
/*   289 */       if(i == INDEX_2)
/*   290 */       {
/*   291 */          (void)GUI_SetFont(&GUI_Font20_ASCII);
/*   292 */          rect.x0 = 320;
/*   293 */          rect.x1 = (320 + 40) - 1;
/*   294 */       }
/*   295 */       else {}
/*   296 */       rect.y0 = 45;
/*   297 */       rect.y1 = (45 + 44) - 1;
/*   299 */       for(int j= 0 ; j < (6-1); j++)
/*   300 */       {
/*   301 */          GUI_DispStringInRect(_acrelayset_label_text[SettingValue[SETUP_LANGUAGE]][i][j], &rect, (0) | (3<<2));
/*   302 */          rect.y0 += 44;
/*   303 */          rect.y1 += 44;
/*   304 */       }
/*   305 */    }
/*   306 */ }
/*   309 */ void AcbMccbRelaySet(void)
/*   310 */ {
/*   311 */    int flagBreak = 0;
/*   312 */    AcbMccbRelaySetInitDisp();
/*   314 */    nSendStep = 0;
/*   315 */    RelaySetSend();
/*   316 */    while (1)
/*   317 */    {
/*   318 */       E_KEY key = GetKey();
/*   320 */       if(key == TIME_OUT)
/*   321 */       {
/*   322 */          gStatusSendEnd = STATUS_SEND_ING;
/*   323 */          statusSendStep = 0;
/*   324 */          nSendStep = 0;
/*   325 */          RelaySetSend();
/*   326 */       }
/*   327 */       else
/*   328 */       if(key == KEY_SETUP)
/*   329 */       {
/*   330 */          if(Setup() == SETUP_CHANGED)
/*   331 */          {
/*   332 */             flagBreak = 1;
/*   333 */          }
/*   334 */          AcbMccbRelaySetInitDisp();
/*   335 */          gCommOldStatus[gDeviceIndex] = -1;
/*   336 */       }
/*   337 */       else
/*   338 */       if(key == DATA_RECV)
/*   339 */       {
/*   340 */          if(gStatusSendEnd == STATUS_SEND_ING)
/*   341 */          {
/*   342 */             nSendStep = 0;
/*   343 */             StatusRecv();
/*   344 */             RelaySetSend();
...
/*   354 */             else
/*   355 */             {
/*   356 */                g_bRecvAllDone = 1;
/*   358 */                (void)printf("All done!!!\n");
/*   359 */                gStatusSendEnd = STATUS_SEND_ING;
/*   360 */                statusSendStep = 0;
/*   361 */                nSendStep = 0;
/*   362 */             }
/*   363 */          }
/*   364 */       }
/*   365 */       else
/*   366 */       if(key == KEY_CANCEL)
/*   367 */       {
/*   368 */          flagBreak = 1;
/*   369 */       }
/*   370 */       else
/*   371 */       if(key == KEY_COMM_ERROR)
/*   372 */       {
/*   373 */          (void)printf("COMM Error!!! gStatusSendEnd=%d, statusSendStep=%d, nSendStep=%d\n",gStatusSendEnd,statusSendStep,nSendStep);
/*   374 */          if(gStatusSendEnd == STATUS_SEND_END)
/*   375 */          {
/*   376 */             nSendStep++;
/*   377 */          }
/*   378 */          if(StatusRecvErrorProcess() == STATUS_SEND_ING)
/*   379 */          {
/*   380 */             nSendStep = 0;
/*   381 */          }
/*   382 */          else
/*   383 */          {
/*   384 */             int nStepMax;
/*   385 */             if(ConnectSetting[gDeviceIndex].DeviceType == DEVICE_MCCB)
/*   386 */             {
/*   387 */                nStepMax = 1;
/*   388 */             }
/*   389 */             else
/*   390 */             {
/*   391 */                nStepMax = INDEX_2;
/*   392 */             }
/*   394 */             if(nSendStep < nStepMax)
/*   395 */             {
/*   396 */                RelaySetSend();
/*   397 */             }
/*   398 */             else
/*   399 */             {
/*   400 */                g_bRecvAllDone = 1;
/*   402 */                (void)printf("All done!!!\n");
/*   403 */                gStatusSendEnd = STATUS_SEND_ING;
/*   404 */                statusSendStep = 0;
/*   405 */                nSendStep = 0;
/*   406 */             }
/*   407 */          }
/*   408 */       }
/*   409 */       else
/*   410 */       if(key == COMM_STAT_ERROR)
/*   411 */       {
/*   412 */          AcbMccbRelaySetInitDisp();
/*   413 */       }
/*   414 */       else {}
/*   415 */       if(flagBreak == 1)
/*   416 */       {
