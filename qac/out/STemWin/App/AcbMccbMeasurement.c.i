...
/*
 * C:/CodeInspection/DisplayUnit/STemWin/App/AcbMccbMeasurement.c
 */
/*    31 */ static void AcbMccbMeasurementSend(void);
/*    32 */ static void DemandMakeString(unsigned short index, int pos, const char* baseUnit );
/*    33 */ static void AcbMccbValueDispDemand(void);
/*    34 */ static void AcbMccbMeasurementRecv(void);
/*    35 */ static void AcbMccbMeasurementMenu(int pos);
/*    36 */ static void AcbMccbValueDispVIP(void);
/*    37 */ static void AcbMccbMeasurementDispVIP(void);
/*    38 */ static void AcbMccbValueDispEnergy(void);
/*    39 */ static void AcbMccbMeasurementDispEnergy(void);
/*    40 */ static void AcbMccbValueDispPQ(void);
/*    41 */ static void AcbMccbMeasurementDispPQ(void);
/*    42 */ static void AcbMccbMeasurementDispDemand(void);
/*    43 */ static void AcbMccbMeasurementDisp(int pos, int clear);
/*    44 */ static void AcbMccbValueDisp(int pos);
/*    45 */ static double localFloor(double value);
/*    46 */ static void BaseDisp3(double value, char* mks, const char*baseUnit, char unit[10], char result[20]);
/*    47 */ static void DispFormat3(double value, const char* baseUnit, char unit[10], char result[20]);
/*    49 */ static float VI[2][4];
/*    50 */ static float P[5];
/*    51 */ static double Energy[5];
/*    52 */ static float PQ1[2];
/*    53 */ static float PQ2[3][3];
/*    54 */ static float Angle[2][4];
/*    56 */ static unsigned short nPfDisplay;
/*    57 */ static int gLocalPols;
/*    60 */ static void BaseDisp3(double value, char* mks, const char*baseUnit, char unit[10], char result[20])
/*    61 */ {
/*    62 */    (void)sprintf(unit, "%s%s", mks, baseUnit);
/*    63 */    (void)sprintf(result, "%6.3f", value);
/*    64 */ }
/*    66 */ static double localFloor(double value)
/*    67 */ {
/*    68 */    value = floor(value * 1000);
/*    69 */    value = value / 1000;
/*    70 */    return value;
/*    71 */ }
/*    73 */ static void DispFormat3(double value, const char* baseUnit, char unit[10], char result[20])
/*    74 */ {
/*    75 */    double v = fabs(value);
/*    77 */    v =localFloor(v);
/*    78 */    if(v < 1000)
/*    79 */    {
/*    80 */       BaseDisp3(v, "", baseUnit, unit, result);
/*    81 */       return;
/*    82 */    }
/*    83 */    v = (v / 1000);
/*    84 */    v =localFloor(v);
/*    85 */    if(v < 1000)
/*    86 */    {
/*    87 */       BaseDisp3(v, "k", baseUnit, unit, result);
/*    88 */       return;
/*    89 */    }
/*    90 */    v = (v / 1000);
/*    91 */    v =localFloor(v);
/*    92 */    BaseDisp3(v, "M", baseUnit, unit, result);
/*    93 */ }
/*    95 */ static void AcbMccbMeasurementSend(void)
/*    96 */ {
/*    97 */    (void)printf("AcbMccbMeasurementSend nSendStep = %d\n", nSendStep);
/*    98 */    if(StatusSend() == STATUS_SEND_ING)
/*    99 */    {
/*   100 */       return;
/*   101 */    }
/*   102 */    if(nMenuPos == INDEX_3)
/*   103 */    {
/*   104 */       if(ConnectSetting[gDeviceIndex].DeviceType == DEVICE_ACB)
/*   105 */       {
/*   106 */          ModbusSendFrame(ConnectSetting[gDeviceIndex].Address, INPUT_REGISTER, 1771, 42);
/*   107 */       }
/*   108 */       else
/*   109 */       {
/*   110 */          ModbusSendFrame(ConnectSetting[gDeviceIndex].Address, INPUT_REGISTER, 1213, 42);
/*   111 */       }
/*   112 */       return;
/*   113 */    }
/*   114 */    if(nSendStep == INDEX_0)
/*   115 */    {
/*   116 */       if(ConnectSetting[gDeviceIndex].DeviceType == DEVICE_ACB)
/*   117 */       {
/*   118 */          ModbusSendFrame(ConnectSetting[gDeviceIndex].Address, HOLDING_REGISTER, 54, 1);
/*   119 */       }
/*   120 */       else
/*   121 */       {
/*   122 */          ModbusSendFrame(ConnectSetting[gDeviceIndex].Address, HOLDING_REGISTER, 30, 1);
/*   123 */       }
/*   124 */    }
/*   125 */    else
/*   126 */    if(nSendStep == INDEX_1)
/*   127 */    {
/*   128 */       ModbusSendFrame(ConnectSetting[gDeviceIndex].Address, INPUT_REGISTER, 215, 70);
/*   129 */    }
/*   130 */    else
/*   131 */    if(nSendStep == INDEX_2)
/*   132 */    {
/*   133 */       ModbusSendFrame(ConnectSetting[gDeviceIndex].Address, INPUT_REGISTER, 303, 64);
/*   134 */    }
/*   135 */    else {}
/*   136 */ }
/*   138 */ static void DemandMakeString(unsigned short index, int pos, const char* baseUnit )
/*   139 */ {
/*   140 */    char value[30];
/*   141 */    char unit[10];
/*   142 */    DispFormat(ModbusGetFloat(index), baseUnit, unit, value);
/*   143 */    index += INDEX_2;
/*   144 */    unsigned char year = ModbusGetUint8_L(index);
/*   145 */    index++;
/*   146 */    unsigned char mon = ModbusGetUint8_U(index);
/*   147 */    unsigned char day = ModbusGetUint8_L(index);
/*   148 */    index++;
/*   149 */    unsigned char hour = ModbusGetUint8_U(index);
/*   150 */    unsigned char min = ModbusGetUint8_L(index);
/*   152 */    GUI_RECT rect;
/*   153 */    GUI_RECT rectUnit;
/*   154 */    GUI_RECT rectDateLocal;
/*   155 */    rect.x0 = ((120 + 40) + 10);
/*   156 */    rect.y0 = 45 + (44 * pos) + 1;
/*   157 */    rect.x1 = (((120 + 40) + 10) + 80);
/*   158 */    rect.y1 = (45 + (44 * (pos+1))) - INDEX_2;
/*   160 */    rectUnit.x0 = ((((120 + 40) + 10) + 80) + 10);
/*   161 */    rectUnit.y0 = rect.y0;
/*   162 */    rectUnit.x1 = (((((120 + 40) + 10) + 80) + 10) + 40);
/*   163 */    rectUnit.y1 = rect.y1;
/*   165 */    rectDateLocal.x0 = ((((((120 + 40) + 10) + 80) + 10) + 40) + 5);
/*   166 */    rectDateLocal.y0 = rect.y0;
/*   167 */    rectDateLocal.x1 = (((((((120 + 40) + 10) + 80) + 10) + 40) + 5) + 130);
/*   168 */    rectDateLocal.y1 = rect.y1;
/*   170 */    GUI_ClearRect(rect.x0, rect.y0, rect.x1, rect.y1);
/*   171 */    GUI_DispStringInRect(value, &rect, (1<<0) | (3<<2));
/*   173 */    GUI_ClearRect(rectUnit.x0, rectUnit.y0, rectUnit.x1, rectUnit.y1);
/*   174 */    GUI_DispStringInRect(unit, &rectUnit, (0) | (3<<2));
/*   176 */    (void)sprintf(value, "%02d-%02d-%02d %02d:%02d", year, mon, day, hour, min);
/*   178 */    GUI_ClearRect(rectDateLocal.x0, rectDateLocal.y0, rectDateLocal.x1, rectDateLocal.y1);
/*   179 */    GUI_DispStringInRect(value, &rectDateLocal, (0) | (3<<2));
/*   180 */ }
/*   182 */ static void AcbMccbValueDispDemand(void)
/*   183 */ {
/*   184 */    int cnt = INDEX_6;
/*   185 */    unsigned short index = 1213;
/*   187 */    if(ConnectSetting[gDeviceIndex].DeviceType == DEVICE_ACB)
/*   188 */    {
/*   189 */       index = 1771;
/*   190 */    }
/*   192 */    GUI_SetColor(0x00FFFFFF);
/*   193 */    (void)GUI_SetFont(&GUI_Font20B_ASCII);
/*   194 */    GUI_SetBkColor(0x1c1b1a);
/*   196 */    if(gDeviceTypeAll[gDeviceIndex] == 0)
/*   197 */    {
/*   198 */       cnt = INDEX_3;
/*   199 */    }
/*   201 */    for(int i = 0; i < cnt; i++)
/*   202 */    {
/*   203 */       DemandMakeString(index, i, _acmeasurementDemand_unit[i]);
/*   204 */       index += INDEX_7;
/*   205 */    }
/*   206 */ }
/*   208 */ static void AcbMccbMeasurementRecv(void)
/*   209 */ {
/*   210 */    unsigned short index;
/*   212 */    (void)printf("\n\n\n AcbMccbMeasurementRecv(%d)\n", nSendStep);
/*   213 */    if(nMenuPos == INDEX_3)
/*   214 */    {
/*   215 */       AcbMccbValueDispDemand();
/*   216 */       nSendStep = 0;
/*   217 */       gStatusSendEnd = STATUS_SEND_ING;
/*   218 */       return;
/*   219 */    }
/*   221 */    if(nSendStep == INDEX_0)
/*   222 */    {
/*   223 */       if(ConnectSetting[gDeviceIndex].DeviceType == DEVICE_ACB)
/*   224 */       {
/*   225 */          index = 54;
/*   226 */       }
/*   227 */       else
...
/*   229 */          index = 30;
/*   230 */       }
/*   231 */       nPfDisplay = ModbusGetUint16(index);
/*   232 */       (void)printf("\n\n\n\nPfDisplay = %d\n\n\n\n\n", nPfDisplay);
/*   233 */       nSendStep = 1;
/*   234 */    }
/*   235 */    else
/*   236 */    if(nSendStep == INDEX_1)
/*   237 */    {
/*   238 */       if(gPols[gDeviceIndex] == 3)
/*   239 */       {
/*   240 */          index = 237;
/*   241 */       }
/*   242 */       else
...
/*   244 */          index = 231;
/*   245 */       }
/*   246 */       for(int i = 0 ; i < INDEX_3; i++)
/*   247 */       {
/*   248 */          VI[0][i] = ModbusGetFloat(index);
/*   249 */          index += INDEX_2;
/*   250 */       }
/*   251 */       index = 215;
/*   252 */       for(int i = 0 ; i < INDEX_4; i++)
/*   253 */       {
/*   254 */          VI[INDEX_1][i] = ModbusGetFloat(index);
/*   256 */          index += INDEX_2;
/*   257 */       }
/*   258 */       index = 251;
/*   259 */       for(int i = 0 ; i < INDEX_3; i++)
/*   260 */       {
/*   261 */          P[i] = ModbusGetFloat(index);
/*   262 */          index += INDEX_2;
/*   263 */       }
/*   264 */       (void)printf("[va] = %f\n", ModbusGetFloat(269));
/*   265 */       Energy[INDEX_0] = ModbusGetFloat(265) + (ModbusGetUint32(267) * 1000000000);
/*   266 */       Energy[INDEX_1] = ModbusGetFloat(269) + (ModbusGetUint32(271) * 1000000000);
/*   267 */       Energy[INDEX_2] = ModbusGetFloat(273) + (ModbusGetUint32(275) * 1000000000);
/*   268 */       Energy[INDEX_3] = ModbusGetFloat(277) + (ModbusGetUint32(279) * 1000000000);
/*   269 */       Energy[INDEX_4] = ModbusGetFloat(281) + (ModbusGetUint32(283) * 1000000000);
/*   271 */       PQ1[INDEX_0] = ModbusGetFloat(257);
/*   272 */       PQ1[INDEX_1] = ModbusGetFloat(249);
/*   273 */       nSendStep = INDEX_2;
/*   274 */    }
/*   275 */    else
/*   276 */    if(nSendStep == INDEX_2)
/*   277 */    {
/*   278 */       index = 321;
/*   279 */       if(gPols[gDeviceIndex] == 3)
/*   280 */       {
/*   281 */          index = 327;
/*   282 */       }
/*   283 */       else
...
/*   285 */          index = 321;
/*   286 */       }
/*   287 */       for(int i = 0; i < INDEX_3; i++)
/*   288 */       {
/*   289 */          PQ2[INDEX_0][i] = ModbusGetFloat(index);
/*   290 */          index += INDEX_2;
/*   291 */       }
/*   292 */       index = 333;
/*   293 */       for(int i = 0; i < INDEX_3; i++)
/*   294 */       {
/*   295 */          PQ2[INDEX_1][i] = ModbusGetFloat(index);
/*   296 */          index += INDEX_2;
/*   297 */       }
/*   298 */       if(ConnectSetting[gDeviceIndex].DeviceType == DEVICE_ACB)
/*   299 */       {
/*   300 */          index = 339;
/*   301 */       }
/*   302 */       else
...
/*   304 */          index = 361;
/*   305 */       }
/*   306 */       for(int i = 0; i < INDEX_3; i++)
/*   307 */       {
/*   308 */          PQ2[INDEX_2][i] = ModbusGetFloat(index);
/*   309 */          index += INDEX_2;
/*   310 */       }
/*   312 */       if(ConnectSetting[gDeviceIndex].DeviceType == DEVICE_ACB)
/*   313 */       {
/*   314 */          if(gPols[gDeviceIndex] == 3)
/*   315 */          {
/*   316 */             index = 351;
/*   317 */          }
/*   318 */          else
...
/*   332 */          }
/*   333 */       }
/*   334 */       for(int i = 0; i < INDEX_3; i++)
/*   335 */       {
/*   336 */          Angle[INDEX_0][i] = ModbusGetFloat(index);
/*   337 */          index += INDEX_2;
/*   338 */       }
/*   339 */       if(ConnectSetting[gDeviceIndex].DeviceType == DEVICE_ACB)
/*   340 */       {
/*   341 */          index = 357;
/*   342 */       }
/*   343 */       else
...
/*   345 */          index = 351;
/*   346 */       }
/*   347 */       for(int i = 0; i < INDEX_4; i++)
/*   348 */       {
/*   349 */          Angle[INDEX_1][i] = ModbusGetFloat(index);
/*   350 */          index += INDEX_2;
/*   351 */       }
/*   377 */       nSendStep = 0;
/*   378 */    }
/*   379 */    else {}
/*   380 */ }
/*   382 */ static void AcbMccbMeasurementMenu(int pos)
/*   383 */ {
/*   384 */    GUI_RECT rect;
/*   385 */    rect.x0 = 30;
/*   386 */    rect.x1 = 105;
...
/*   393 */       if(i == pos)
/*   394 */       {
/*   395 */          GUI_SetColor(0xd07b18);
/*   396 */       }
/*   397 */       else
/*   398 */       {
/*   399 */          GUI_SetColor(0x2f2c2a);
/*   400 */       }
/*   401 */       GUI_FillRect(10, y0, (10 + 120) - 1, (y0 + 66) - 1);
/*   403 */       if(i == pos)
/*   404 */       {
/*   405 */          GUI_SetColor(0x00FFFFFF);
/*   406 */          GUI_SetBkColor(0xd07b18);
/*   408 */          LanguageSelect(FONT20B);
/*   409 */       }
/*   410 */       else
/*   411 */       {
/*   412 */          GUI_SetColor(0xc8c8c8);
/*   413 */          GUI_SetBkColor(0x2f2c2a);
/*   415 */          LanguageSelect(FONT20);
/*   416 */       }
/*   418 */       GUI_DispStringInRect(_acmeasurement_menu_text[SettingValue[SETUP_LANGUAGE]][i], &rect, (0) | (3<<2));
/*   419 */       rect.y0 += 66 + 1;
/*   420 */       rect.y1 += 66 + 1;
/*   421 */       y0 += 66 + 1;;
/*   422 */    }
/*   423 */ }
/*   425 */ static void AcbMccbValueDispVIP(void)
/*   426 */ {
/*   427 */    (void)printf("gPols[gDeviceIndex] = %d\n", gPols[gDeviceIndex]);
/*   428 */    if(gCommStatus[gDeviceIndex] == COMM_ERROR)
/*   429 */    {
/*   430 */       return;
/*   431 */    }
/*   432 */    if(gLocalPols != gPols[gDeviceIndex])
/*   433 */    {
/*   434 */       GUI_SetBkColor(0x1c1b1a);
/*   435 */       GUI_ClearRect(120, 45, ((120+340)-1), 320-1);
/*   436 */       AcbMccbMeasurementDispVIP();
/*   437 */    }
/*   438 */    char buf[20];
/*   439 */    GUI_SetColor(0x00FFFFFF);
/*   440 */    (void)GUI_SetFont(&GUI_Font20B_ASCII);
/*   441 */    GUI_SetBkColor(0x1c1b1a);
/*   443 */    GUI_RECT rect;
/*   444 */    GUI_RECT rectUnit;
/*   445 */    GUI_RECT rectAngle;
/*   446 */    rect.x0 = (((120 + 5) + 40) -5);
/*   447 */    rect.y0 = 45+1;
/*   448 */    rect.x1 = ((((120 + 5) + 40) -5) + 58);
/*   449 */    rect.y1 = (45 + 44) - INDEX_2;
/*   451 */    rectUnit.x0 = (((((120 + 5) + 40) -5) + 58) + 1);
/*   452 */    rectUnit.y0 = 45+1;
/*   453 */    rectUnit.x1 = ((((((120 + 5) + 40) -5) + 58) + 1) + 28);
/*   454 */    rectUnit.y1 = (45 + 44) - INDEX_2;
/*   456 */    rectAngle.x0 = (((((((((120 + 5) + 40) -5) + 58) + 1) + 28)) + 8) + 1) + INDEX_3;
/*   457 */    rectAngle.y0 = 45+1;
/*   458 */    rectAngle.x1 = ((((((((((120 + 5) + 40) -5) + 58) + 1) + 28)) + 8) + 1) + 30) + INDEX_3;
/*   459 */    rectAngle.y1 = (45 + 44) - INDEX_2;
/*   461 */    int x = (((((((120 + 5) + 40) -5) + 58) + 1) + 28));
/*   462 */    int y = 45;
/*   464 */    if(gDeviceTypeAll[gDeviceIndex] == 1)
/*   465 */    {
/*   466 */       for(int i = 0 ; i < (6-INDEX_3); i++)
/*   467 */       {
/*   468 */          char value[20];
/*   469 */          char unit[10];
/*   470 */          DispFormat(VI[0][i], "V", unit, value);
/*   472 */          GUI_ClearRect(rect.x0, rect.y0, rect.x1, rect.y1);
/*   473 */          GUI_DispStringInRect(value, &rect, (1<<0) | (3<<2));
/*   474 */          GUI_ClearRect(rectUnit.x0, rectUnit.y0, rectUnit.x1, rectUnit.y1);
/*   475 */          GUI_DispStringInRect(unit, &rectUnit, (0) | (3<<2));
/*   477 */          (void)sprintf(buf, "%3.0f", Angle[0][i]);
/*   478 */          GUI_ClearRect(rectAngle.x0, rectAngle.y0, rectAngle.x1, rectAngle.y1);
/*   479 */          GUI_DispStringInRect(buf, &rectAngle, (0) | (3<<2));
/*   481 */          GUI_SetColor(0x00FFFFFF);
/*   482 */          GUI_DrawPolyLine(cPtAngle, 3, x, y);
/*   484 */          rect.y0 += 44;
/*   485 */          rect.y1 += 44;
/*   486 */          rectUnit.y0 += 44;
/*   487 */          rectUnit.y1 += 44;
...
/*   492 */       }
/*   493 */    }
/*   494 */    rect.x0 = ((120 + 40) + 5);
/*   495 */    rect.y0 = 45+1 + (44 * (6-INDEX_3));
/*   496 */    rect.x1 = (((120 + 40) + 5) + 70);
/*   497 */    rect.y1 = 45 + (44 - INDEX_2) + (44 * (6-INDEX_3));
/*   499 */    rectUnit.x0 = ((((120 + 40) + 5) + 70) + 5);
/*   500 */    rectUnit.y0 = 45+1 + (44 * (6-INDEX_3));
/*   501 */    rectUnit.x1 = (((((120 + 40) + 5) + 70) + 5) + 40);
/*   502 */    rectUnit.y1 = (rectUnit.y0 + 44) - INDEX_2;
/*   504 */    if(gDeviceTypeAll[gDeviceIndex] == 1)
/*   505 */    {
/*   506 */       for(int i = 0 ; i < INDEX_3; i++)
/*   507 */       {
/*   508 */          char value[20];
/*   509 */          char unit[10];
/*   511 */          DispFormat(P[i], _acPQS_unit[i], unit, value);
/*   513 */          GUI_ClearRect(rect.x0, rect.y0, rect.x1, rect.y1);
/*   514 */          GUI_DispStringInRect(value, &rect, (1<<0) | (3<<2));
/*   515 */          GUI_ClearRect(rectUnit.x0, rectUnit.y0, rectUnit.x1, rectUnit.y1);
/*   516 */          GUI_DispStringInRect(unit, &rectUnit, (0) | (3<<2));
/*   518 */          rect.y0 += 44;
/*   519 */          rect.y1 += 44;
/*   520 */          rectUnit.y0 += 44;
/*   521 */          rectUnit.y1 += 44;
...
/*   523 */       }
/*   524 */    }
/*   525 */    rect.x0 = (((120+(340/2)) + 40) - 5);
/*   526 */    rect.y0 = 45+1;
/*   527 */    rect.x1 = ((((120+(340/2)) + 40) - 5) + 58);
/*   528 */    rect.y1 = (45 + 44) - INDEX_2;
/*   530 */    rectUnit.x0 = (((((120+(340/2)) + 40) - 5) + 58) + 1);
/*   531 */    rectUnit.y0 = 45+1;
/*   532 */    rectUnit.x1 = ((((((120+(340/2)) + 40) - 5) + 58) + 1) + 28);
/*   533 */    rectUnit.y1 = (45 + 44) - INDEX_2;
/*   535 */    rectAngle.x0 = (((((((((120+(340/2)) + 40) - 5) + 58) + 1) + 28)) + 8) + 1) + INDEX_4;
/*   536 */    rectAngle.y0 = 45+1;
/*   537 */    rectAngle.x1 = ((((((((((120+(340/2)) + 40) - 5) + 58) + 1) + 28)) + 8) + 1) + 30) + INDEX_4;
/*   538 */    rectAngle.y1 = (45 + 44) - INDEX_2;
/*   540 */    x = (((((((120+(340/2)) + 40) - 5) + 58) + 1) + 28));
/*   541 */    y = 45;
/*   543 */    for(int i = 0 ; i < gPols[gDeviceIndex]; i++)
/*   544 */    {
/*   545 */       char value[20];
/*   546 */       char unit[10];
/*   547 */       DispFormat(VI[1][i], "A", unit, value);
/*   548 */       GUI_ClearRect(rect.x0, rect.y0, rect.x1, rect.y1);
/*   549 */       GUI_DispStringInRect(value, &rect, (1<<0) | (3<<2));
/*   550 */       GUI_ClearRect(rectUnit.x0, rectUnit.y0, rectUnit.x1, rectUnit.y1);
/*   551 */       GUI_DispStringInRect(unit, &rectUnit, (0) | (3<<2));
/*   553 */       (void)sprintf(buf, "%3.0f", Angle[1][i]);
/*   554 */       GUI_ClearRect(rectAngle.x0, rectAngle.y0, rectAngle.x1, rectAngle.y1);
/*   555 */       GUI_DispStringInRect(buf, &rectAngle, (0) | (3<<2));
/*   557 */       GUI_DrawPolyLine(cPtAngle, 3, x, y);
/*   559 */       rect.y0 += 44;
/*   560 */       rect.y1 += 44;
/*   561 */       rectUnit.y0 += 44;
/*   562 */       rectUnit.y1 += 44;
...
/*   566 */    }
/*   567 */ }
/*   569 */ static void AcbMccbMeasurementDispVIP(void)
/*   570 */ {
/*   571 */    GUI_SetBkColor(0x1c1b1a);
/*   572 */    (void)GUI_SetPenSize(2);
/*   573 */    GUI_SetColor(0x494440);
/*   574 */    GUI_DrawRect(120, 45, ((120+340)-1), 45 + (INDEX_6 * 44));
/*   576 */    gLocalPols = gPols[gDeviceIndex];
/*   578 */    for(int i = 0; i < (6-1); i++)
/*   579 */    {
/*   580 */       int y0 = 45 + ((i + 1) * 44);
/*   581 */       GUI_DrawHLine(y0, 120, ((120+340)-1));
/*   582 */    }
/*   583 */    GUI_DrawVLine((120+(340/2)), 45, 45 + (INDEX_6* 44));
/*   585 */    (void)GUI_SetFont(&GUI_Font20_ASCII);
/*   587 */    GUI_RECT rect;
/*   588 */    rect.x0 = (120 + 5);
/*   589 */    rect.x1 = ((120 + 5) + 40) - 1;
/*   590 */    rect.y0 = 45;
/*   591 */    rect.y1 = (45 + 44) - 1;
/*   593 */    if(gDeviceTypeAll[gDeviceIndex] == 1)
/*   594 */    {
/*   595 */       GUI_SetColor(0xc8c8c8);
/*   596 */    }
/*   597 */    else
/*   598 */    {
/*   599 */       GUI_SetColor(0x2b2a2a);
/*   600 */    }
/*   601 */    for(int j= 0 ; j < 6; j++)
/*   602 */    {
/*   603 */       if(gPols[gDeviceIndex] == 3)
/*   604 */       {
/*   605 */          GUI_DispStringInRect(_acmeasurementVI_LNLL_label_text[1][j], &rect, (0) | (3<<2));
/*   606 */       }
/*   607 */       else
/*   608 */       {
/*   609 */          GUI_DispStringInRect(_acmeasurementVI_LNLL_label_text[0][j], &rect, (0) | (3<<2));
/*   610 */       }
/*   611 */       rect.y0 += 44;
/*   612 */       rect.y1 += 44;
/*   613 */    }
/*   614 */    rect.x0 = ((120+(340/2)) + 5);
/*   615 */    rect.x1 = (((120+(340/2)) + 5) + 40) - 1;
/*   616 */    rect.y0 = 45;
/*   617 */    rect.y1 = (45 + 44) - 1;
/*   618 */    GUI_SetColor(0xc8c8c8);
/*   619 */    for(int j= 0 ; j < gPols[gDeviceIndex]; j++)
/*   620 */    {
/*   621 */       GUI_DispStringInRect(_acmeasurementVI_A_label_text[j], &rect, (0) | (3<<2));
/*   622 */       rect.y0 += 44;
/*   623 */       rect.y1 += 44;
/*   624 */    }
/*   625 */ }
/*   627 */ static void AcbMccbValueDispEnergy(void)
/*   628 */ {
/*   629 */    if(gCommStatus[gDeviceIndex] == COMM_ERROR)
/*   630 */    {
/*   631 */       return;
/*   632 */    }
/*   633 */    if(gDeviceTypeAll[gDeviceIndex] == 0)
/*   634 */    {
/*   635 */       return;
/*   636 */    }
/*   637 */    GUI_SetColor(0x00FFFFFF);
/*   638 */    (void)GUI_SetFont(&GUI_Font20B_ASCII);
/*   639 */    GUI_SetBkColor(0x1c1b1a);
/*   641 */    GUI_RECT rect;
/*   642 */    GUI_RECT rectUnit;
/*   643 */    rect.x0 = ((120 + 40) + 10);
/*   644 */    rect.x1 = ((120+(340/2)) + 90);
/*   645 */    rect.y0 = 45 + 1;
/*   646 */    rect.y1 = (45 + 44) - INDEX_2;
/*   647 */    rectUnit.x0 = (((120+(340/2)) + 90) + 5);
/*   648 */    rectUnit.x1 = ((((120+(340/2)) + 90) + 5) + 60);
/*   649 */    rectUnit.y0 = 45 + 1;
/*   650 */    rectUnit.y1 = (45 + 44) - INDEX_2;
/*   651 */    for(int i = 0 ; i < (6-1); i++)
/*   652 */    {
/*   653 */       char buf[20];
/*   654 */       char unit[10];
/*   656 */       DispFormat3(Energy[i], _acmeasurementEnergy_unit[i], unit, buf);
/*   657 */       GUI_ClearRect(rect.x0, rect.y0, rect.x1, rect.y1);
/*   658 */       GUI_DispStringInRect(buf, &rect, (1<<0) | (3<<2));
/*   659 */       GUI_ClearRect(rectUnit.x0, rectUnit.y0, rectUnit.x1, rectUnit.y1);
/*   660 */       GUI_DispStringInRect(unit, &rectUnit, (0) | (3<<2));
/*   661 */       rect.y0 += 44;
/*   662 */       rect.y1 += 44;
/*   663 */       rectUnit.y0 += 44;
/*   664 */       rectUnit.y1 += 44;
/*   665 */    }
/*   666 */ }
/*   668 */ static void AcbMccbMeasurementDispEnergy(void)
/*   669 */ {
/*   670 */    GUI_SetBkColor(0x1c1b1a);
/*   671 */    GUI_SetColor(0x494440);
/*   672 */    GUI_DrawRect(120, 45, ((120+340)-1), 45 + (INDEX_5 * 44));
/*   674 */    for(int i = 0; i < (6-INDEX_2); i++)
/*   675 */    {
/*   676 */       int y0 = 45 + ((i + 1) * 44);
/*   677 */       GUI_DrawHLine(y0, 120, ((120+340)-1));
/*   678 */    }
/*   680 */    (void)GUI_SetFont(&GUI_Font20_ASCII);
/*   682 */    GUI_RECT rect;
/*   683 */    rect.x0 = (120 + 10);
/*   684 */    rect.x1 = (((120 + 10) + 40) - 1);
/*   685 */    rect.y0 = 45;
/*   686 */    rect.y1 = (45 + 44) - 1;
/*   688 */    if(gDeviceTypeAll[gDeviceIndex] == 1)
/*   689 */    {
/*   690 */       GUI_SetColor(0xc8c8c8);
/*   691 */    }
/*   692 */    else
/*   693 */    {
/*   694 */       GUI_SetColor(0x2b2a2a);
/*   695 */    }
/*   697 */    for(int j= 0 ; j < (6-1); j++)
/*   698 */    {
/*   699 */       GUI_DispStringInRect(_acmeasurementEnergy_label_text[j], &rect, (0) | (3<<2));
/*   700 */       rect.y0 += 44;
/*   701 */       rect.y1 += 44;
/*   702 */    }
/*   703 */ }
/*   705 */ static void AcbMccbValueDispPQ(void)
/*   706 */ {
/*   707 */    static int displayFlag[INDEX_2][INDEX_3][INDEX_3] = {
/*   708 */       { {0, 0, 0 },
/*   709 */          {1, 1, 1 },
/*   710 */          {1, 1, 1 }
/*   711 */       },
...
/*   715 */       }
/*   716 */    };
/*   719 */    if(gCommStatus[gDeviceIndex] == COMM_ERROR)
/*   720 */    {
/*   721 */       return;
/*   722 */    }
/*   724 */    if(gLocalPols != gPols[gDeviceIndex])
/*   725 */    {
/*   726 */       GUI_SetBkColor(0x1c1b1a);
/*   727 */       GUI_ClearRect(120, 45, ((120+340)-1), 320-1);
/*   728 */       AcbMccbMeasurementDispPQ();
/*   729 */    }
/*   731 */    char buf[20];
/*   733 */    GUI_SetColor(0x00FFFFFF);
/*   734 */    (void)GUI_SetFont(&GUI_Font20B_ASCII);
/*   735 */    GUI_SetBkColor(0x1c1b1a);
/*   737 */    GUI_RECT rect;
/*   738 */    GUI_RECT rectUnit;
/*   739 */    rect.x0 = ((120 + 40) + 10);
/*   740 */    rect.x1 = ((120+(340/2)) + 90);
/*   741 */    rect.y0 = 45 + 1;
/*   742 */    rect.y1 = (45 + 44) - INDEX_2;
/*   743 */    rectUnit.x0 = (((120+(340/2)) + 90) + 5);
/*   744 */    rectUnit.x1 = ((((120+(340/2)) + 90) + 5) + 60);
/*   745 */    rectUnit.y0 = 45 + 1;
/*   746 */    rectUnit.y1 = (45 + 44) - INDEX_2;
/*   747 */    for(int i = 0 ; i < INDEX_2; i++)
/*   748 */    {
/*   749 */       if(i == 0)
/*   750 */       {
/*   751 */          (void)sprintf(buf, "%4.1f", PQ1[i]);
/*   752 */       }
/*   753 */       else
/*   754 */       {
/*   755 */          if(gDeviceTypeAll[gDeviceIndex] == 1)
/*   756 */          {
/*   757 */             float val = fabs(PQ1[i]);
/*   767 */             if(nPfDisplay == 1)
/*   768 */             {
/*   769 */                if(PQ1[i] >= 0)
/*   770 */                {
/*   771 */                   (void)sprintf(buf, "Lag %4.1f", val);
/*   772 */                }
/*   773 */                else
/*   774 */                {
/*   775 */                   (void)sprintf(buf, "Lead %4.1f", val);
/*   776 */                }
/*   777 */             }
/*   778 */             else
/*   779 */             if(nPfDisplay == 2)
...
/*   781 */                if(PQ1[i] >= 0)
/*   782 */                {
/*   783 */                   (void)sprintf(buf, "Forward %4.1f", val);
/*   784 */                }
/*   785 */                else
/*   786 */                {
/*   787 */                   (void)sprintf(buf, "Reverse %4.1f", val);
/*   788 */                }
/*   789 */             }
/*   790 */             else
/*   791 */             if(nPfDisplay == 3)
...
/*   793 */                if(PQ1[i] >= 0)
/*   794 */                {
/*   795 */                   (void)sprintf(buf, "Lead %4.1f", val);
/*   796 */                }
/*   797 */                else
/*   798 */                {
/*   799 */                   (void)sprintf(buf, "Lag %4.1f", val);
/*   800 */                }
/*   801 */             }
/*   802 */             else
/*   803 */             {
/*   804 */                (void)sprintf(buf, "%4.1f", PQ1[i]);
/*   805 */             }
/*   806 */          }
/*   807 */       }
/*   808 */       if((i == 0) || (gDeviceTypeAll[gDeviceIndex] == 1))
/*   809 */       {
/*   810 */          GUI_ClearRect(rect.x0, rect.y0, rect.x1, rect.y1);
/*   811 */          GUI_DispStringInRect(buf, &rect, (1<<0) | (3<<2));
/*   812 */          GUI_ClearRect(rectUnit.x0, rectUnit.y0, rectUnit.x1, rectUnit.y1);
/*   813 */          GUI_DispStringInRect(_acmeasurementPQ_unit_text[i], &rectUnit, (0) | (3<<2));
/*   814 */       }
/*   815 */       rect.y0 += 44;
/*   816 */       rect.y1 += 44;
/*   817 */       rectUnit.y0 += 44;
/*   818 */       rectUnit.y1 += 44;
/*   819 */    }
/*   820 */    for(int i = 0; i < INDEX_3; i++)
/*   821 */    {
/*   822 */       for(int j = 0; j < INDEX_3; j++)
/*   823 */       {
/*   825 */          if(displayFlag[gDeviceTypeAll[gDeviceIndex]][i][j] == 1)
/*   826 */          {
/*   827 */             rect.x0 = PQ_VALUE_X[j][0];
/*   828 */             rect.x1 = PQ_VALUE_X[j][1];
/*   829 */             rectUnit.x0 = PQ_UNIT_X[j][0];
/*   830 */             rectUnit.x1 = PQ_UNIT_X[j][1];
/*   831 */             GUI_ClearRect(rect.x0, rect.y0, rect.x1, rect.y1);
/*   832 */             (void)sprintf(buf, "%3.0f", PQ2[i][j]);
/*   833 */             GUI_DispStringInRect(buf, &rect, (1<<0) | (3<<2));
/*   834 */             GUI_ClearRect(rectUnit.x0, rectUnit.y0, rectUnit.x1, rectUnit.y1);
/*   835 */             GUI_DispStringInRect(_acmeasurementPQ_unit_text[INDEX_2], &rectUnit, (0) | (3<<2));
/*   836 */          }
/*   837 */       }
/*   838 */       rect.y0 += 44;
/*   839 */       rect.y1 += 44;
...
/*   842 */    }
/*   843 */ }
/*   845 */ static void AcbMccbMeasurementDispPQ(void)
/*   846 */ {
/*   847 */    GUI_SetColor(0x494440);
/*   848 */    GUI_SetBkColor(0x1c1b1a);
/*   849 */    GUI_DrawRect(120, 45, ((120+340)-1), 45 + (INDEX_5 * 44));
/*   851 */    gLocalPols = gPols[gDeviceIndex];
/*   853 */    for(int i = 0; i < (6-1); i++)
/*   854 */    {
/*   855 */       if(i == INDEX_2)
/*   856 */       {
/*   857 */          continue;
/*   858 */       }
/*   859 */       int y0 = 45 + ((i + 1) * 44);
/*   860 */       GUI_DrawHLine(y0, 120, ((120+340)-1));
/*   861 */    }
/*   863 */    GUI_SetColor(0xc8c8c8);
/*   864 */    (void)GUI_SetFont(&GUI_Font20_ASCII);
/*   866 */    GUI_RECT rect;
/*   867 */    rect.x0 = (120 + 10);
/*   868 */    rect.x1 = (((120 + 10) + 40) - 1);
/*   869 */    rect.y0 = 45;
/*   870 */    rect.y1 = (45 + 44) - 1;
/*   872 */    for(int j = 0 ; j < (6-1); j++)
/*   873 */    {
/*   874 */       if((j == INDEX_1) && (gDeviceTypeAll[gDeviceIndex] == 0))
/*   875 */       {
/*   876 */          GUI_SetColor(0x2b2a2a);
/*   877 */       }
/*   878 */       else
/*   879 */       {
/*   880 */          GUI_SetColor(0xc8c8c8);
/*   881 */       }
/*   882 */       GUI_DispStringInRect(_acmeasurementPQ_label_text[j], &rect, (0) | (3<<2));
/*   883 */       rect.y0 += 44;
/*   884 */       rect.y1 += 44;
/*   885 */    }
/*   886 */    rect.y0 = 45 + (44 * INDEX_2) ;
/*   887 */    rect.y1 = (45 + (44 * INDEX_3)) - 1;
/*   888 */    if(gDeviceTypeAll[gDeviceIndex] == 1)
/*   889 */    {
/*   890 */       GUI_SetColor(0xc8c8c8);
/*   891 */    }
/*   892 */    else
/*   893 */    {
/*   894 */       GUI_SetColor(0x2b2a2a);
/*   895 */    }
/*   896 */    for(int i = 0; i < INDEX_3; i++)
/*   897 */    {
/*   898 */       rect.x0 = PQ_LABEL_X[i][0];
/*   899 */       rect.x1 = PQ_LABEL_X[i][1];
/*   900 */       int pos = 0;
/*   901 */       if(gPols[gDeviceIndex] == 3)
/*   902 */       {
/*   903 */          pos = 1;
/*   904 */       }
/*   905 */       GUI_DispStringInRect(_acmeasurementVI_LNLL_label_text[pos][i], &rect, (1<<0) | (3<<2));
/*   906 */    }
/*   907 */    rect.y0 += 44;
/*   908 */    rect.y1 += 44;
/*   909 */    for(int i = 0; i < INDEX_3; i++)
/*   910 */    {
/*   914 */       GUI_SetColor(0xc8c8c8);
/*   915 */       rect.x0 = PQ_LABEL_X[i][0];
/*   916 */       rect.x1 = PQ_LABEL_X[i][1];
/*   917 */       GUI_DispStringInRect(_acmeasurementPQ_I_text[i], &rect, (1<<0) | (3<<2));
/*   918 */    }
/*   919 */    rect.y0 += 44;
/*   920 */    rect.y1 += 44;
/*   921 */    for(int i = 0; i < INDEX_3; i++)
/*   922 */    {
/*   926 */       GUI_SetColor(0xc8c8c8);
/*   927 */       rect.x0 = PQ_LABEL_X[i][0];
/*   928 */       rect.x1 = PQ_LABEL_X[i][1];
/*   929 */       GUI_DispStringInRect(_acmeasurementPQ_I_text[i], &rect, (1<<0) | (3<<2));
/*   930 */    }
/*   931 */ }
/*   933 */ static void AcbMccbMeasurementDispDemand(void)
/*   934 */ {
/*   935 */    GUI_SetColor(0x494440);
/*   936 */    GUI_SetBkColor(0x1c1b1a);
/*   937 */    GUI_DrawRect(120, 45, ((120+340)-1), 45 + (6 * 44));
/*   939 */    for(int i = 0; i < (6 - 1); i++)
/*   940 */    {
/*   941 */       int y0 = 45 + ((i + 1) * 44);
/*   942 */       GUI_DrawHLine(y0, 120, ((120+340)-1));
/*   943 */    }
/*   945 */    GUI_SetColor(0xc8c8c8);
/*   946 */    (void)GUI_SetFont(&GUI_Font20_ASCII);
/*   948 */    GUI_RECT rect;
/*   949 */    rect.x0 = (120 + 10);
/*   950 */    rect.x1 = (((120 + 10) + 40) - 1);
/*   951 */    rect.y0 = 45;
/*   952 */    rect.y1 = (45 + 44) - 1;
/*   954 */    for(int j = 0 ; j < 6; j++)
/*   955 */    {
/*   956 */       if((j > INDEX_2) && (gDeviceTypeAll[gDeviceIndex] == 0))
/*   957 */       {
/*   958 */          GUI_SetColor(0x2b2a2a);
/*   959 */       }
/*   960 */       GUI_DispStringInRect(_acmeasurementDemand_label_text[j], &rect, (0) | (3<<2));
/*   961 */       rect.y0 += 44;
/*   962 */       rect.y1 += 44;
/*   963 */    }
/*   965 */ }
/*   967 */ static void AcbMccbMeasurementDisp(int pos, int clear)
/*   968 */ {
/*   969 */    (void)GUI_SetPenSize(2);
/*   970 */    GUI_SetBkColor(0x1c1b1a);
/*   971 */    GUI_SetColor(0x494440);
/*   973 */    if(clear)
/*   974 */    {
/*   975 */       GUI_ClearRect(0, 34, 480-1, 320-1);
/*   976 */    }
/*   978 */    AcbMccbMeasurementMenu(pos);
/*   980 */    GUI_SetBkColor(0x1c1b1a);
/*   981 */    GUI_ClearRect(120, 45, ((120+340)-1), 320-1);
/*   982 */    if(pos == INDEX_0)
/*   983 */    {
/*   984 */       AcbMccbMeasurementDispVIP();
/*   985 */    }
/*   986 */    else
/*   987 */    if(pos == INDEX_1)
/*   988 */    {
/*   989 */       AcbMccbMeasurementDispEnergy();
/*   990 */    }
/*   991 */    else
/*   992 */    if(pos == INDEX_2)
/*   993 */    {
/*   994 */       AcbMccbMeasurementDispPQ();
/*   995 */    }
/*   996 */    else
/*   997 */    if(pos == INDEX_3)
/*   998 */    {
/*   999 */       AcbMccbMeasurementDispDemand();
/*  1000 */    }
/*  1001 */    else {}
/*  1002 */ }
/*  1004 */ static void AcbMccbValueDisp(int pos)
/*  1005 */ {
/*  1006 */    if(pos == INDEX_0)
/*  1007 */    {
/*  1008 */       AcbMccbValueDispVIP();
/*  1009 */    }
/*  1010 */    else
/*  1011 */    if(pos == INDEX_1)
/*  1012 */    {
/*  1013 */       AcbMccbValueDispEnergy();
/*  1014 */    }
/*  1015 */    else
/*  1016 */    if(pos == INDEX_2)
/*  1017 */    {
/*  1018 */       AcbMccbValueDispPQ();
/*  1019 */    }
/*  1020 */    else {}
/*  1021 */ }
/*  1034 */ void AcbMccbMeasurement(void)
/*  1035 */ {
/*  1036 */    int flagBreak = 0;
/*  1037 */    nSendStep = 0;
/*  1038 */    nMenuPos = 0;
/*  1040 */    GUI_SetBkColor(0x1c1b1a);
/*  1041 */    (void)GUI_SetFont(&GUI_Font20_ASCII);
/*  1043 */    if(gCommStatus[gDeviceIndex] == COMM_ERROR)
/*  1044 */    {
/*  1045 */       gPols[gDeviceIndex] = INDEX_3;
/*  1046 */       gDeviceTypeAll[gDeviceIndex] = 1;
/*  1047 */    }
/*  1048 */    AcbMccbMeasurementDisp(nMenuPos, 1);
/*  1050 */    AcbMccbMeasurementSend();
/*  1052 */    while (1)
/*  1053 */    {
/*  1054 */       E_KEY key = GetKey();
/*  1056 */       if(key == TIME_OUT)
/*  1057 */       {
/*  1058 */          gStatusSendEnd = STATUS_SEND_ING;
/*  1059 */          statusSendStep = 0;
/*  1060 */          nSendStep = 0;
/*  1061 */          AcbMccbMeasurementSend();
/*  1062 */       }
/*  1063 */       else
/*  1064 */       if(key == KEY_SETUP)
/*  1065 */       {
/*  1066 */          if(Setup() == SETUP_CHANGED)
/*  1067 */          {
/*  1068 */             flagBreak = 1;
/*  1069 */          }
/*  1070 */          GUI_ClearRect(0, 34, 480-1, 320-1);
/*  1071 */          AcbMccbMeasurementDisp(nMenuPos, 1);
/*  1072 */          gCommOldStatus[gDeviceIndex] = -1;
/*  1073 */       }
/*  1074 */       else
/*  1075 */       if(key == KEY_UP)
/*  1076 */       {
...
/*  1083 */             nMenuPos = 4 - 1;
/*  1084 */          }
/*  1085 */          AcbMccbMeasurementDisp(nMenuPos, 0);
/*  1086 */          AcbMccbValueDisp(nMenuPos);
/*  1087 */          if(nMenuPos == INDEX_3)
/*  1088 */          {
/*  1089 */             AcbMccbMeasurementSend();
/*  1090 */             nSendStep = 0;
/*  1091 */          }
/*  1092 */       }
/*  1093 */       else
/*  1094 */       if(key == KEY_DOWN)
/*  1095 */       {
/*  1096 */          if(nMenuPos < (4-1))
/*  1097 */          {
/*  1098 */             nMenuPos++;
/*  1099 */          }
/*  1100 */          else
...
/*  1102 */             nMenuPos = 0;
/*  1103 */          }
/*  1104 */          AcbMccbMeasurementDisp(nMenuPos, 0);
/*  1105 */          AcbMccbValueDisp(nMenuPos);
/*  1106 */          if(nMenuPos == INDEX_3)
/*  1107 */          {
/*  1108 */             AcbMccbMeasurementSend();
/*  1109 */             nSendStep = 0;
/*  1110 */          }
/*  1111 */       }
/*  1112 */       else
/*  1113 */       if(key == DATA_RECV)
/*  1114 */       {
/*  1115 */          if(gStatusSendEnd == STATUS_SEND_ING)
/*  1116 */          {
/*  1117 */             StatusRecv();
/*  1118 */             AcbMccbMeasurementSend();
/*  1119 */          }
/*  1120 */          else
/*  1121 */          {
/*  1122 */             AcbMccbMeasurementRecv();
/*  1123 */             AcbMccbValueDisp(nMenuPos);
/*  1124 */             (void)printf("nMenuPos=%d, nSendStep=%d\n", nMenuPos, nSendStep);
/*  1125 */             if(nSendStep != 0)
/*  1126 */             {
/*  1127 */                AcbMccbMeasurementSend();
/*  1128 */             }
/*  1129 */             else
/*  1130 */             {
/*  1131 */                g_bRecvAllDone = 1;
/*  1132 */                nSendStep = 0;
/*  1133 */                statusSendStep = 0;
/*  1134 */                gStatusSendEnd = STATUS_SEND_ING;
/*  1135 */             }
/*  1136 */          }
/*  1137 */       }
/*  1138 */       else
/*  1139 */       if(key == KEY_COMM_ERROR)
/*  1140 */       {
/*  1141 */          if(gStatusSendEnd == STATUS_SEND_END)
/*  1142 */          {
/*  1143 */             nSendStep++;
/*  1144 */          }
/*  1145 */          (void)printf("COMM Error!!! gStatusSendEnd=%d, statusSendStep=%d, nSendStep=%d\n",gStatusSendEnd,statusSendStep,nSendStep);
/*  1146 */          if(StatusRecvErrorProcess() == STATUS_SEND_ING)
/*  1147 */          {
/*  1148 */             nSendStep = 0;
/*  1149 */          }
/*  1150 */          else
/*  1151 */          {
/*  1152 */             if(nSendStep < INDEX_3)
/*  1153 */             {
/*  1154 */                AcbMccbMeasurementSend();
/*  1155 */             }
/*  1156 */             else
/*  1157 */             {
/*  1158 */                g_bRecvAllDone = 1;
/*  1159 */                (void)printf("All done!!!\n");
/*  1160 */                gStatusSendEnd = STATUS_SEND_ING;
/*  1161 */                statusSendStep = 0;
/*  1162 */                nSendStep = 0;
/*  1163 */             }
/*  1164 */          }
/*  1165 */       }
/*  1166 */       else
/*  1167 */       if(key == KEY_CANCEL)
/*  1168 */       {
/*  1169 */          flagBreak = 1;
/*  1170 */       }
/*  1171 */       else
/*  1172 */       if(key == COMM_STAT_ERROR)
/*  1173 */       {
/*  1174 */          gPols[gDeviceIndex] = INDEX_3;
/*  1175 */          gDeviceTypeAll[gDeviceIndex] = 1;
/*  1176 */          AcbMccbMeasurementDisp(nMenuPos, 1);
/*  1177 */       }
/*  1178 */       else {}
/*  1179 */       if(flagBreak == 1)
/*  1180 */       {
