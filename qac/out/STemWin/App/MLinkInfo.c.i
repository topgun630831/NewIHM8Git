...
/*
 * C:/CodeInspection/DisplayUnit/STemWin/App/MLinkInfo.c
 */
/*    29 */ static void BaseDispU32(uint32_t value, char* mks, const char* baseUnit, char result[20]);
/*    30 */ static void DispFormatU32(uint32_t value, const char* baseUnit, char result[20]);
/*    31 */ static void DeviceInfoSend(void);
/*    32 */ static void OperationInfoSend(void);
/*    33 */ static void DeviceInfoValueDisp(void);
/*    34 */ static void DeviceInitDisp(void);
/*    35 */ static void OperationInfoValueDisp(void);
/*    36 */ static void OperationDisp(void);
/*    37 */ static void OperationInitDisp(void);
/*    38 */ static void MlinkDeviceDisp(void);
/*    42 */ static void BaseDispU32(uint32_t value, char* mks, const char* baseUnit, char result[20])
/*    43 */ {
/*    44 */    (void)sprintf(result, "(%d%s%s)", value, mks, baseUnit);
/*    45 */ }
/*    47 */ static void DispFormatU32(uint32_t value, const char* baseUnit, char result[20])
/*    48 */ {
/*    49 */    uint32_t v = abs(value);
/*    50 */    if(v < 1000)
/*    51 */    {
/*    52 */       BaseDispU32(value, "", baseUnit, result);
/*    53 */       return;
/*    54 */    }
/*    55 */    value = value / 1000;
/*    56 */    v = (v / 1000);
/*    57 */    if(v < 10000)
/*    58 */    {
/*    59 */       BaseDispU32(value, "k", baseUnit, result);
/*    60 */       return;
/*    61 */    }
/*    62 */    value = value / 1000;
/*    63 */    v = (v / 1000);
/*    64 */    if(v < 10000)
/*    65 */    {
/*    66 */       BaseDispU32(value, "M", baseUnit, result);
/*    67 */       return;
/*    68 */    }
/*    69 */    value = value / 1000;
/*    70 */    v = (v / 1000);
/*    71 */    if(v < 10000)
/*    72 */    {
/*    73 */       BaseDispU32(value, "G", baseUnit, result);
/*    74 */       return;
/*    75 */    }
/*    76 */    value = value / 1000;
/*    77 */    v = (v / 1000);
/*    78 */    if(v < 10000)
/*    79 */    {
/*    80 */       BaseDispU32(value, "T", baseUnit, result);
/*    81 */       return;
/*    82 */    }
/*    83 */    value = value / 1000;
/*    84 */    v = (v / 1000);
/*    85 */    BaseDispU32(value, "P", baseUnit, result);
/*    86 */ }
/*    88 */ static void DeviceInfoSend(void)
/*    89 */ {
/*    90 */    if(StatusSend() == STATUS_SEND_ING)
/*    91 */    {
/*    92 */       return;
/*    93 */    }
/*    94 */    if(nSendStep == 0)
/*    95 */    {
/*    96 */       ModbusSendFrame(ConnectSetting[gDeviceIndex].Address, INPUT_REGISTER, 1301, 109);
/*    97 */    }
/*    98 */ }
/*   100 */ static void OperationInfoSend(void)
/*   101 */ {
/*   102 */    if(StatusSend() == STATUS_SEND_ING)
/*   103 */    {
/*   104 */       return;
/*   105 */    }
/*   106 */    if(nSendStep == INDEX_0)
/*   107 */    {
/*   108 */       ModbusSendFrame(ConnectSetting[gDeviceIndex].Address, HOLDING_REGISTER, 2031, 18);
/*   109 */    }
/*   110 */    else
/*   111 */    if(nSendStep == INDEX_1)
/*   112 */    {
/*   113 */       ModbusSendFrame(ConnectSetting[gDeviceIndex].Address, INPUT_REGISTER, 1101, 8);
/*   114 */    }
/*   115 */    else
/*   116 */    if(nSendStep == INDEX_2)
/*   117 */    {
/*   118 */       ModbusSendFrame(ConnectSetting[gDeviceIndex].Address, INPUT_REGISTER, 1121, 12);
/*   119 */    }
/*   120 */    else {}
/*   121 */ }
/*   123 */ static void DeviceInfoValueDisp(void)
/*   124 */ {
/*   125 */    char buf[6][60];
/*   126 */    char productName[60];
/*   129 */    ModbusGetString(1335, INDEX_32, productName);
/*   130 */    ModbusGetString(1394, INDEX_12, productCode);
/*   133 */    ModbusGetString(1301, INDEX_4, buf[INDEX_0]);
/*   135 */    (void)sprintf(buf[1], "%s(%s)", productName, productCode);
/*   136 */    ModbusGetString(1400, INDEX_10, buf[INDEX_2]);
/*   137 */    ModbusGetString(1405, INDEX_10, buf[INDEX_3]);
/*   138 */    ModbusGetString(1320, INDEX_10, buf[INDEX_4]);
/*   139 */    ModbusGetString(1383, INDEX_22, buf[INDEX_5]);
/*   141 */    GUI_SetColor(0x00FFFFFF);
/*   142 */    GUI_SetBkColor(0x1c1b1a);
/*   150 */    GUI_RECT rect;
/*   151 */    GUI_RECT rect2;
/*   152 */    rect.x0 = ((10 + 150) + 50);
/*   153 */    rect.y0 = 46 + INDEX_2;
/*   154 */    rect.x1 = ((340 + 100) - 1);
/*   155 */    rect.y1 = (46 + 44) - INDEX_4;
/*   157 */    rect2.x0 = ((10 + 150) + 50) - INDEX_80;
/*   158 */    rect2.y0 = 46 + INDEX_2;
/*   159 */    rect2.x1 = ((340 + 100) - 1);
/*   160 */    rect2.y1 = (46 + 44) - INDEX_4;
/*   162 */    (void)GUI_SetFont(&GUI_Font20B_ASCII);
/*   163 */    for(int i = 0 ; i < 6; i++)
/*   164 */    {
/*   167 */       if(i == 1)
/*   168 */       {
/*   169 */          GUI_ClearRectEx(&rect2);
/*   170 */          GUI_DispStringInRect(buf[i], &rect2, (1<<0) | (3<<2));
/*   171 */       }
/*   172 */       else
/*   173 */       {
/*   174 */          GUI_ClearRectEx(&rect);
/*   175 */          GUI_DispStringInRect(buf[i], &rect, (1<<0) | (3<<2));
/*   176 */       }
/*   177 */       rect.y0 += 44;
/*   178 */       rect.y1 += 44;
/*   179 */       rect2.y0 += 44;
...
/*   181 */    }
/*   182 */ }
/*   184 */ static void DeviceInitDisp(void)
/*   185 */ {
/*   186 */    int count = 6;
/*   188 */    GUI_SetBkColor(0x1c1b1a);
/*   189 */    (void)GUI_SetFont(&GUI_Font20_ASCII);
/*   191 */    (void)GUI_SetPenSize(2);
/*   192 */    GUI_SetColor(0x494440);
/*   194 */    GUI_ClearRect(0, 34, 480-1, 320-1);
/*   195 */    GUI_DrawRect(10, 45, (10 + 460) - 1, (45 + (44 * count )) - 1);
/*   197 */    for(int i = 0; i < (count-1); i++)
/*   198 */    {
/*   199 */       int y0 = 45 + ((i + 1) * 44);
/*   200 */       GUI_DrawHLine(y0, 10+INDEX_2, (10 + 460)-1);
/*   201 */    }
/*   203 */    GUI_SetColor(0xc8c8c8);
/*   204 */    GUI_RECT rect;
/*   205 */    rect.x0 = 41;
/*   206 */    rect.y0 = 46;
/*   207 */    rect.x1 = 41 + 150 + INDEX_10;
/*   208 */    rect.y1 = (46 + 44) - 1;
/*   211 */    LanguageSelect(FONT20);
/*   212 */    for(int i = 0 ; i < count; i++)
/*   213 */    {
/*   214 */       GUI_DispStringInRect(_acinfo_label_text[SettingValue[SETUP_LANGUAGE]][0][i], &rect, (0) | (3<<2));
/*   215 */       rect.y0 += 44;
/*   216 */       rect.y1 += 44;
/*   217 */    }
/*   218 */ }
/*   220 */ static void MlinkDeviceDisp(void)
/*   221 */ {
/*   222 */    int flagBreak = 0;
/*   223 */    nSendStep = 0;
/*   224 */    DeviceInitDisp();
...
/*   227 */    while (1)
/*   228 */    {
/*   229 */       E_KEY key = GetKey();
/*   231 */       if(key == TIME_OUT)
/*   232 */       {
/*   233 */          gStatusSendEnd = STATUS_SEND_ING;
/*   234 */          statusSendStep = 0;
/*   235 */          DeviceInfoSend();
/*   236 */       }
/*   237 */       else
/*   238 */       if(key == KEY_SETUP)
/*   239 */       {
/*   240 */          if(Setup() == SETUP_CHANGED)
/*   241 */          {
/*   242 */             flagBreak = 1;
/*   243 */          }
/*   244 */          DeviceInitDisp();
/*   245 */       }
/*   246 */       else
/*   247 */       if(key == DATA_RECV)
/*   248 */       {
/*   249 */          if(gStatusSendEnd == STATUS_SEND_ING)
/*   250 */          {
/*   251 */             StatusRecv();
/*   252 */             DeviceInfoSend();
/*   253 */          }
/*   254 */          else
/*   255 */          {
/*   256 */             DeviceInfoValueDisp();
/*   257 */             g_bRecvAllDone = 1;
/*   258 */             nSendStep = 0;
/*   259 */             statusSendStep = 0;
/*   260 */             gStatusSendEnd = STATUS_SEND_ING;
/*   261 */          }
/*   262 */       }
/*   265 */       else
/*   266 */       if(key == KEY_CANCEL)
/*   267 */       {
/*   268 */          flagBreak = 1;
/*   269 */       }
/*   270 */       else
/*   271 */       if(key == KEY_COMM_ERROR)
/*   272 */       {
/*   273 */          (void)printf("COMM Error!!! gStatusSendEnd=%d, statusSendStep=%d, nSendStep=%d\n",gStatusSendEnd,statusSendStep,nSendStep);
/*   274 */          if(StatusRecvErrorProcess() == STATUS_SEND_ING)
/*   275 */          {
/*   276 */             nSendStep = 0;
/*   277 */          }
/*   278 */          else
/*   279 */          {
/*   281 */             g_bRecvAllDone = 1;
/*   282 */             nSendStep = 0;
/*   283 */             statusSendStep = 0;
/*   284 */             gStatusSendEnd = STATUS_SEND_ING;
/*   285 */          }
/*   286 */       }
/*   287 */       else
/*   288 */       if(key == COMM_STAT_ERROR)
/*   289 */       {
/*   290 */          DeviceInitDisp();
/*   291 */       }
/*   292 */       else {}
...
/*   298 */    }
/*   299 */ }
/*   301 */ static void OperationInfoValueDisp(void)
/*   302 */ {
/*   303 */    static unsigned short DiType[6];
/*   304 */    static float DiConstant[6];
/*   305 */    static char const* _acPulse_unit[5] = {
/*   306 */       "",
/*   307 */       "Wh",
/*   308 */       "Varh",
/*   309 */       "VAh",
/*   310 */       ""
/*   311 */    };
/*   313 */    if(nSendStep == INDEX_0)
/*   314 */    {
/*   315 */       int index = 2031;
/*   316 */       int constantIndex = 2037;
/*   317 */       for(int i = 0; i < 6; i++)
/*   318 */       {
/*   319 */          unsigned short value = ModbusGetUint16(index++);
/*   320 */          DiType[i] = 0;
/*   321 */          if(value == PulseWh)
/*   322 */          {
/*   323 */             DiType[i] = INDEX_1;
/*   324 */          }
/*   325 */          else
/*   326 */          if(value == PulseVarh)
/*   327 */          {
/*   328 */             DiType[i] = INDEX_2;
/*   329 */          }
/*   330 */          else
/*   331 */          if(value == PulseVAh)
/*   332 */          {
/*   333 */             DiType[i] = INDEX_3;
/*   334 */          }
/*   335 */          else
/*   336 */          if(value == Pulse)
/*   337 */          {
/*   338 */             DiType[i] = INDEX_4;
/*   339 */          }
/*   340 */          else {}
/*   341 */          DiConstant[i] = ModbusGetFloat(constantIndex);
/*   343 */          constantIndex += INDEX_2;
/*   344 */       }
/*   345 */       nSendStep = 1;
/*   346 */       OperationInfoSend();
/*   347 */       return;
/*   348 */    }
/*   350 */    GUI_SetColor(0x00FFFFFF);
/*   351 */    (void)GUI_SetFont(&GUI_Font20B_ASCII);
/*   352 */    GUI_SetBkColor(0x1c1b1a);
/*   354 */    GUI_RECT rect;
/*   355 */    GUI_RECT rect2;
/*   356 */    GUI_RECT rect3;
/*   368 */    rect.y0 = 95-1;
/*   369 */    rect.y1 = (rect.y0 + 21) - INDEX_2;
/*   372 */    rect3.y0 = rect.y0;
/*   373 */    rect3.y1 = rect.y1;
/*   374 */    rect2.y0 = rect.y0 + 24;
/*   375 */    rect2.y1 = rect2.y0 + 20;
/*   377 */    rect.x0 = 90;
/*   378 */    rect.x1 = (rect.x0 + 60) - 1;
/*   379 */    rect2.x0 = 90;
/*   380 */    rect2.x1 = (rect2.x0 + 60) - 1;
/*   381 */    rect3.x0 = 390;
/*   382 */    rect3.x1 = (rect3.x0 + 60) - 1;
/*   384 */    if(nSendStep == INDEX_1)
/*   385 */    {
/*   386 */       unsigned short addr = 1101;
/*   387 */       for(int i = 0 ; i < 4; i++)
/*   388 */       {
/*   389 */          char buf[20];
/*   390 */          (void)sprintf(buf, "%d", ModbusGetUint32(addr));
/*   391 */          GUI_ClearRectEx(&rect3);
/*   392 */          GUI_DispStringInRect(buf, &rect3, (1<<0) | (3<<2));
/*   393 */          rect3.y0 += 60;
/*   394 */          rect3.y1 += 60;
/*   396 */          addr += INDEX_2;
/*   397 */       }
/*   398 */       nSendStep = INDEX_2;
/*   399 */       OperationInfoSend();
/*   400 */       return;
/*   401 */    }
/*   402 */    else
/*   403 */    if(nSendStep == INDEX_2)
/*   404 */    {
...
/*   408 */       {
/*   409 */          char buf[20];
/*   410 */          uint32_t value = ModbusGetUint32(addr);
/*   411 */          (void)sprintf(buf, "%d", value);
/*   412 */          (void)GUI_SetFont(&GUI_Font20B_ASCII);
/*   413 */          GUI_ClearRectEx(&rect);
/*   414 */          GUI_DispStringInRect(buf, &rect, (1<<0) | (3<<2));
/*   415 */          if(DiType[i] != 0)
/*   416 */          {
/*   417 */             uint32_t energy = (uint32_t)((float)value * DiConstant[i]);
/*   418 */             DispFormatU32(energy, _acPulse_unit[DiType[i]], buf);
/*   419 */             (void)GUI_SetFont(&GUI_Font16_ASCII);
/*   420 */             GUI_ClearRectEx(&rect2);
/*   421 */             GUI_DispStringInRect(buf, &rect2, (1<<0) | (0));
/*   422 */          }
/*   423 */          addr += INDEX_2;
/*   424 */          if( i == INDEX_2)
/*   425 */          {
/*   426 */             rect.x0 = 240;
/*   427 */             rect.x1 = (rect.x0 + 60) - 1;
/*   428 */             rect.y0 = 95-1;
/*   429 */             rect.y1 = (rect.y0 + 21) - INDEX_2;
/*   431 */             rect2.x0 = 240;
/*   432 */             rect2.x1 = (rect2.x0 + 60) - 1;
/*   433 */             rect2.y0 = rect.y0 + 24;
/*   434 */             rect2.y1 = rect2.y0 + 20;
/*   435 */          }
/*   436 */          else
/*   437 */          {
/*   438 */             rect.y0 += 60;
...
/*   446 */    nSendStep = 0;
/*   447 */ }
/*   449 */ static void OperationInitDisp(void)
/*   450 */ {
/*   451 */    int count = 6;
/*   453 */    GUI_SetBkColor(0x1c1b1a);
/*   455 */    LanguageSelect(FONT20);
/*   457 */    (void)GUI_SetPenSize(2);
/*   458 */    GUI_SetColor(0x494440);
/*   460 */    GUI_ClearRect(0, 34, 480-1, 320-1);
/*   461 */    GUI_DrawRect(10, 45, (10 + 460) - 1, (45 + (44 * count )) - 1);
/*   463 */    GUI_RECT rect;
/*   464 */    rect.x0 = 21;
/*   465 */    rect.y0 = 58;
/*   466 */    rect.x1 = (21 + 280) - 1;
/*   467 */    rect.y1 = (58 + 21) - 1;
/*   469 */    GUI_SetColor(0xc8c8c8);
/*   470 */    GUI_DispStringInRect(_acmlink_info_title_text[SettingValue[SETUP_LANGUAGE]], &rect, (0) | (3<<2));
/*   472 */    (void)GUI_SetFont(&GUI_Font20_ASCII);
/*   473 */    rect.y0 = 95;
/*   474 */    rect.y1 = rect.y0 + 21;
/*   476 */    GUI_RECT rect2;
/*   477 */    GUI_RECT rect3;
/*   479 */    rect.x0 = 21;
/*   480 */    rect.x1 = (rect.x0 + 60) - 1;
/*   481 */    rect2.x0 = 170;
/*   482 */    rect2.x1 = (rect2.x0 + 60) - 1;
/*   483 */    rect3.x0 = 320;
/*   484 */    rect3.x1 = (rect3.x0 + 60) - 1;
/*   486 */    rect2.y0 = rect3.y0 = rect.y0;
/*   487 */    rect2.y1 = rect3.y1 = rect.y1;
/*   488 */    for(int i = 0; i < INDEX_4; i++)
/*   489 */    {
/*   490 */       GUI_DispStringInRect(_acmlink_info_label_text[INDEX_0][i], &rect, (0) | (0));
/*   491 */       GUI_DispStringInRect(_acmlink_info_label_text[INDEX_1][i], &rect2, (0) | (0));
/*   492 */       GUI_DispStringInRect(_acmlink_info_label_text[INDEX_2][i], &rect3, (0) | (0));
/*   494 */       rect.y0 += 60;
/*   495 */       rect.y1 += 60;
/*   496 */       rect2.y0 += 60;
/*   497 */       rect2.y1 += 60;
...
/*   500 */    }
/*   501 */ }
/*   503 */ static void OperationDisp(void)
/*   504 */ {
/*   505 */    int flagBreak = 0;
/*   506 */    nSendStep = 0;
/*   508 */    OperationInitDisp();
/*   509 */    OperationInfoSend();
/*   511 */    while (1)
/*   512 */    {
/*   513 */       E_KEY key = GetKey();
/*   515 */       if(key == TIME_OUT)
/*   516 */       {
/*   517 */          gStatusSendEnd = STATUS_SEND_ING;
/*   518 */          statusSendStep = 0;
/*   519 */          OperationInfoSend();
/*   520 */       }
/*   521 */       else
/*   522 */       if(key == KEY_SETUP)
/*   523 */       {
/*   524 */          if(Setup() == SETUP_CHANGED)
/*   525 */          {
/*   526 */             flagBreak = 1;
/*   527 */          }
/*   528 */          OperationInitDisp();
/*   529 */       }
/*   530 */       else
/*   531 */       if(key == DATA_RECV)
/*   532 */       {
/*   533 */          if(gStatusSendEnd == STATUS_SEND_ING)
/*   534 */          {
/*   535 */             StatusRecv();
/*   536 */             OperationInfoSend();
/*   537 */          }
/*   538 */          else
/*   539 */          {
/*   540 */             OperationInfoValueDisp();
/*   541 */             if(nSendStep != 0)
/*   542 */             {
/*   543 */                OperationInfoSend();
/*   544 */             }
/*   545 */             else
/*   546 */             {
/*   547 */                g_bRecvAllDone = 1;
/*   548 */                nSendStep = 0;
/*   549 */                statusSendStep = 0;
/*   550 */                gStatusSendEnd = STATUS_SEND_ING;
/*   551 */             }
/*   552 */          }
/*   553 */       }
/*   554 */       else
/*   555 */       if(key == KEY_CANCEL)
/*   556 */       {
/*   557 */          flagBreak = 1;
/*   558 */       }
/*   559 */       else
/*   560 */       if(key == KEY_COMM_ERROR)
/*   561 */       {
/*   562 */          if(gStatusSendEnd == STATUS_SEND_END)
/*   563 */          {
/*   564 */             nSendStep++;
/*   565 */          }
/*   566 */          (void)printf("COMM Error!!! gStatusSendEnd=%d, statusSendStep=%d, nSendStep=%d\n",gStatusSendEnd,statusSendStep,nSendStep);
/*   567 */          if(StatusRecvErrorProcess() == STATUS_SEND_ING)
/*   568 */          {
/*   569 */             nSendStep = 0;
/*   570 */          }
/*   571 */          else
/*   572 */          {
/*   573 */             if(nSendStep < INDEX_3)
/*   574 */             {
/*   575 */                OperationInfoSend();
/*   576 */             }
/*   577 */             else
/*   578 */             {
/*   579 */                g_bRecvAllDone = 1;
/*   580 */                (void)printf("All done!!!\n");
/*   581 */                nSendStep = 0;
/*   582 */                statusSendStep = 0;
/*   583 */                gStatusSendEnd = STATUS_SEND_ING;
/*   584 */             }
/*   585 */          }
/*   586 */       }
/*   587 */       else
/*   588 */       if(key == COMM_STAT_ERROR)
/*   589 */       {
/*   590 */          OperationInitDisp();
/*   591 */       }
/*   592 */       else {}
/*   594 */       if(flagBreak == 1)
/*   595 */       {
...
/*   598 */    }
/*   599 */ }
/*   614 */ void MLinkInfomation(void)
/*   615 */ {
/*   616 */    int flagBreak = 0;
/*   617 */    nMenuPos = 0;
/*   619 */    InfoMenu(0, nMenuPos, 2);
/*   621 */    GUI_SetBkColor(0x1c1b1a);
/*   622 */    (void)GUI_SetPenSize(2);
/*   623 */    GUI_SetColor(0x494440);
/*   624 */    gStatusSendEnd = STATUS_SEND_ING;
/*   625 */    (void)StatusSend();
/*   627 */    while (1)
/*   628 */    {
/*   629 */       E_KEY key = GetKey();
/*   631 */       if(key == TIME_OUT)
/*   632 */       {
/*   633 */          gStatusSendEnd = STATUS_SEND_ING;
/*   634 */          statusSendStep = 0;
/*   635 */          (void)StatusSend();
/*   636 */       }
/*   637 */       else
/*   638 */       if(key == KEY_SETUP)
/*   639 */       {
/*   640 */          if(Setup() == SETUP_CHANGED)
/*   641 */          {
/*   642 */             flagBreak = 1;
/*   643 */          }
/*   644 */          InfoMenu(0, nMenuPos, 2);
/*   645 */          gCommOldStatus[gDeviceIndex] = -1;
/*   646 */       }
/*   647 */       else
/*   648 */       if(key == KEY_UP)
/*   649 */       {
...
/*   660 */          {
/*   661 */             nMenuPos++;
/*   662 */             InfoMenu(0, nMenuPos, 2);
/*   663 */          }
/*   664 */       }
/*   665 */       else
/*   666 */       if(key == KEY_ENTER)
/*   667 */       {
/*   668 */          if(nMenuPos == 0)
/*   669 */          {
/*   670 */             MlinkDeviceDisp();
...
/*   676 */          }
/*   677 */          else {}
/*   678 */          InfoMenu(0, nMenuPos, 2);
/*   679 */       }
/*   680 */       else
/*   681 */       if(key == DATA_RECV)
/*   682 */       {
/*   683 */          StatusRecv();
/*   684 */          if(gStatusSendEnd == STATUS_SEND_ING)
/*   685 */          {
/*   686 */             (void)StatusSend();
/*   687 */          }
/*   688 */          else
/*   689 */          {
/*   690 */             g_bRecvAllDone = 1;
/*   691 */             nSendStep = 0;
/*   692 */             statusSendStep = 0;
/*   693 */             gStatusSendEnd = STATUS_SEND_ING;
/*   694 */          }
/*   695 */       }
/*   696 */       else
/*   697 */       if(key == KEY_CANCEL)
/*   698 */       {
/*   699 */          flagBreak = 1;
/*   700 */       }
/*   701 */       else
/*   702 */       if(key == KEY_COMM_ERROR)
/*   703 */       {
/*   704 */          (void)printf("COMM Error!!! gStatusSendEnd=%d, statusSendStep=%d, nSendStep=%d\n",gStatusSendEnd,statusSendStep,nSendStep);
/*   705 */          if(StatusRecvErrorProcess() == STATUS_SEND_ING)
/*   706 */          {
/*   707 */             nSendStep = 0;
/*   708 */          }
/*   709 */          else
/*   710 */          {
/*   711 */             g_bRecvAllDone = 1;
/*   712 */             (void)printf("All done!!!\n");
/*   713 */             gStatusSendEnd = STATUS_SEND_ING;
/*   714 */             statusSendStep = 0;
/*   715 */             nSendStep = 0;
/*   716 */          }
/*   717 */       }
/*   718 */       else
/*   719 */       if(key == COMM_STAT_ERROR)
/*   720 */       {
/*   722 */       }
/*   723 */       else {}
/*   725 */       if(flagBreak == 1)
