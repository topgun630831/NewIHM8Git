...
/*
 * C:/CodeInspection/DisplayUnit/STemWin/App/MenuDLG.c
 */
/*    26 */ static void EnglishInitButton(GUI_HWIN hWin);
/*    27 */ static void ChineseInitButton(GUI_HWIN hWin);
/*    28 */ static void RussianInitButton(GUI_HWIN hWin);
/*    29 */ static void _cbDialog(WM_MESSAGE * pMsg);
/*    30 */ static void MenuDisp(int pos, int stat);
/*    31 */ static void AcbMccbMenu(int nPos);
/*    32 */ static void MlinkMenu(int nPos);
/*    34 */ static GUI_HWIN ButtonItem[6];
/*    70 */ static void EnglishInitButton(GUI_HWIN hWin)
/*    71 */ {
/*    72 */    GUI_HWIN hItem;
/*    73 */    WINDOW_SetBkColor(hWin, (0x1c1b1a));
/*    74 */    hItem = WM_GetDialogItem(hWin, (0x800 + 0x01));
/*    75 */    (void)BUTTON_SetText(hItem, "");
/*    76 */    BUTTON_SetBitmap(hItem, 0, &bmbtn_hwset_normal);
/*    77 */    BUTTON_SetBitmap(hItem, 1, &bmbtn_hwset_selected);
/*    79 */    ButtonItem[0] = hItem;
/*    81 */    hItem = WM_GetDialogItem(hWin, (0x800 + 0x02));
/*    82 */    (void)BUTTON_SetText(hItem, "");
/*    83 */    if(ConnectSetting[gDeviceIndex].DeviceType == DEVICE_MLINK)
/*    84 */    {
/*    85 */       BUTTON_SetBitmap(hItem, 0, &bmbtn_IOstatus_normal);
/*    86 */       BUTTON_SetBitmap(hItem, 1, &bmbtn_IOstatus_selected);
/*    87 */       ButtonItem[2] = hItem;
/*    88 */    }
/*    89 */    else
/*    90 */    {
/*    91 */       BUTTON_SetBitmap(hItem, 0, &bmbtn_measurement_normal);
/*    92 */       BUTTON_SetBitmap(hItem, 1, &bmbtn_measurement_selected);
/*    93 */       ButtonItem[2] = hItem;
/*    94 */    }
/*    95 */    hItem = WM_GetDialogItem(hWin, (0x800 + 0x03));
/*    96 */    (void)BUTTON_SetText(hItem, "");
/*    97 */    BUTTON_SetBitmap(hItem, 0, &bmbtn_systeminfo_normal);
/*    98 */    BUTTON_SetBitmap(hItem, 1, &bmbtn_systeminfo_selected);
/*    99 */    ButtonItem[4] = hItem;
/*   101 */    hItem = WM_GetDialogItem(hWin, (0x800 + 0x04));
/*   102 */    (void)BUTTON_SetText(hItem, "");
/*   103 */    if(ConnectSetting[gDeviceIndex].DeviceType == DEVICE_MLINK)
/*   104 */    {
/*   105 */       BUTTON_SetBitmap(hItem, 0, &bmbtn_IOset_normal);
/*   106 */       BUTTON_SetBitmap(hItem, 1, &bmbtn_IOset_selected);
/*   107 */       ButtonItem[1] = hItem;
/*   108 */    }
/*   109 */    else
/*   110 */    {
/*   111 */       BUTTON_SetBitmap(hItem, 0, &bmbtn_relayset_normal);
/*   112 */       BUTTON_SetBitmap(hItem, 1, &bmbtn_relayset_selected);
/*   113 */       ButtonItem[1] = hItem;
/*   114 */    }
/*   116 */    hItem = WM_GetDialogItem(hWin, (0x800 + 0x05));
/*   117 */    (void)BUTTON_SetText(hItem, "");
/*   118 */    BUTTON_SetBitmap(hItem, 0, &bmbtn_events_normal);
/*   119 */    BUTTON_SetBitmap(hItem, 1, &bmbtn_events_selected);
/*   120 */    ButtonItem[3] = hItem;
/*   122 */    hItem = WM_GetDialogItem(hWin, (0x800 + 0x06));
/*   123 */    (void)BUTTON_SetText(hItem, "");
/*   124 */    if(ConnectSetting[gDeviceIndex].DeviceType == DEVICE_MLINK)
/*   125 */    {
/*   126 */       BUTTON_SetBitmap(hItem, 0, &bmcontrol_normal);
/*   127 */       BUTTON_SetBitmap(hItem, 1, &bmcontrol_selected);
/*   128 */       ButtonItem[5] = hItem;
/*   129 */    }
/*   130 */    else
/*   131 */    {
/*   132 */       BUTTON_SetBitmap(hItem, 0, &bmacbmccb_control_btn_normal);
/*   133 */       BUTTON_SetBitmap(hItem, 1, &bmacbmcc_control_btn_selected);
/*   134 */       ButtonItem[5] = hItem;
/*   135 */    }
/*   136 */ }
/*   138 */ static void ChineseInitButton(GUI_HWIN hWin)
/*   139 */ {
/*   140 */    GUI_HWIN hItem;
/*   141 */    WINDOW_SetBkColor(hWin, (0x1c1b1a));
/*   142 */    hItem = WM_GetDialogItem(hWin, (0x800 + 0x01));
/*   143 */    (void)BUTTON_SetText(hItem, "");
/*   144 */    BUTTON_SetBitmap(hItem, 0, &bmbtn_hwset_normal_ch);
/*   145 */    BUTTON_SetBitmap(hItem, 1, &bmbtn_hwset_selected_ch);
/*   147 */    ButtonItem[0] = hItem;
/*   149 */    hItem = WM_GetDialogItem(hWin, (0x800 + 0x02));
/*   150 */    (void)BUTTON_SetText(hItem, "");
/*   151 */    if(ConnectSetting[gDeviceIndex].DeviceType == DEVICE_MLINK)
/*   152 */    {
/*   153 */       BUTTON_SetBitmap(hItem, 0, &bmbtn_IOstatus_normal_ch);
/*   154 */       BUTTON_SetBitmap(hItem, 1, &bmbtn_IOstatus_selected_ch);
/*   155 */       ButtonItem[2] = hItem;
/*   156 */    }
/*   157 */    else
/*   158 */    {
/*   159 */       BUTTON_SetBitmap(hItem, 0, &bmbtn_measurement_normal_ch);
/*   160 */       BUTTON_SetBitmap(hItem, 1, &bmbtn_measurement_selected_ch);
/*   161 */       ButtonItem[2] = hItem;
/*   162 */    }
/*   163 */    hItem = WM_GetDialogItem(hWin, (0x800 + 0x03));
/*   164 */    (void)BUTTON_SetText(hItem, "");
/*   165 */    BUTTON_SetBitmap(hItem, 0, &bmbtn_systeminfo_normal_ch);
/*   166 */    BUTTON_SetBitmap(hItem, 1, &bmbtn_systeminfo_selected_ch);
/*   167 */    ButtonItem[4] = hItem;
/*   169 */    hItem = WM_GetDialogItem(hWin, (0x800 + 0x04));
/*   170 */    (void)BUTTON_SetText(hItem, "");
/*   171 */    if(ConnectSetting[gDeviceIndex].DeviceType == DEVICE_MLINK)
/*   172 */    {
/*   173 */       BUTTON_SetBitmap(hItem, 0, &bmbtn_IOset_normal_ch);
/*   174 */       BUTTON_SetBitmap(hItem, 1, &bmbtn_IOset_selected_ch);
/*   175 */       ButtonItem[1] = hItem;
/*   176 */    }
/*   177 */    else
/*   178 */    {
/*   179 */       BUTTON_SetBitmap(hItem, 0, &bmbtn_relayset_normal_ch);
/*   180 */       BUTTON_SetBitmap(hItem, 1, &bmbtn_relayset_selected_ch);
/*   181 */       ButtonItem[1] = hItem;
/*   182 */    }
/*   184 */    hItem = WM_GetDialogItem(hWin, (0x800 + 0x05));
/*   185 */    (void)BUTTON_SetText(hItem, "");
/*   186 */    BUTTON_SetBitmap(hItem, 0, &bmbtn_events_normal_ch);
/*   187 */    BUTTON_SetBitmap(hItem, 1, &bmbtn_events_selected_ch);
/*   188 */    ButtonItem[3] = hItem;
/*   190 */    hItem = WM_GetDialogItem(hWin, (0x800 + 0x06));
/*   191 */    (void)BUTTON_SetText(hItem, "");
/*   192 */    if(ConnectSetting[gDeviceIndex].DeviceType == DEVICE_MLINK)
/*   193 */    {
/*   194 */       BUTTON_SetBitmap(hItem, 0, &bmcontrol_btn_normal_ch);
/*   195 */       BUTTON_SetBitmap(hItem, 1, &bmcontrol_btn_selected_ch);
/*   196 */       ButtonItem[5] = hItem;
/*   197 */    }
/*   198 */    else
/*   199 */    {
/*   201 */       BUTTON_SetBitmap(hItem, 0, &bmacbmccb_control_normal_ch);
/*   202 */       BUTTON_SetBitmap(hItem, 1, &bmacbmccb_control_selected_ch);
/*   203 */       ButtonItem[5] = hItem;
/*   204 */    }
/*   205 */ }
/*   207 */ static void RussianInitButton(GUI_HWIN hWin)
/*   208 */ {
/*   209 */    GUI_HWIN hItem;
/*   210 */    WINDOW_SetBkColor(hWin, (0x1c1b1a));
/*   211 */    hItem = WM_GetDialogItem(hWin, (0x800 + 0x01));
/*   212 */    (void)BUTTON_SetText(hItem, "");
/*   213 */    BUTTON_SetBitmap(hItem, 0, &bmbtn_hwset_normal);
/*   214 */    BUTTON_SetBitmap(hItem, 1, &bmbtn_hwset_selected);
/*   216 */    ButtonItem[0] = hItem;
/*   218 */    hItem = WM_GetDialogItem(hWin, (0x800 + 0x02));
/*   219 */    (void)BUTTON_SetText(hItem, "");
/*   220 */    if(ConnectSetting[gDeviceIndex].DeviceType == DEVICE_MLINK)
/*   221 */    {
/*   222 */       BUTTON_SetBitmap(hItem, 0, &bmbtn_IOstatus_normal);
/*   223 */       BUTTON_SetBitmap(hItem, 1, &bmbtn_IOstatus_selected);
/*   224 */       ButtonItem[2] = hItem;
/*   225 */    }
/*   226 */    else
/*   227 */    {
/*   228 */       BUTTON_SetBitmap(hItem, 0, &bmbtn_measurement_normal);
/*   229 */       BUTTON_SetBitmap(hItem, 1, &bmbtn_measurement_selected);
/*   230 */       ButtonItem[2] = hItem;
/*   231 */    }
/*   232 */    hItem = WM_GetDialogItem(hWin, (0x800 + 0x03));
/*   233 */    (void)BUTTON_SetText(hItem, "");
/*   234 */    BUTTON_SetBitmap(hItem, 0, &bmbtn_systeminfo_normal);
/*   235 */    BUTTON_SetBitmap(hItem, 1, &bmbtn_systeminfo_selected);
/*   236 */    ButtonItem[4] = hItem;
/*   238 */    hItem = WM_GetDialogItem(hWin, (0x800 + 0x04));
/*   239 */    (void)BUTTON_SetText(hItem, "");
/*   240 */    if(ConnectSetting[gDeviceIndex].DeviceType == DEVICE_MLINK)
/*   241 */    {
/*   242 */       BUTTON_SetBitmap(hItem, 0, &bmbtn_IOset_normal);
/*   243 */       BUTTON_SetBitmap(hItem, 1, &bmbtn_IOset_selected);
/*   244 */       ButtonItem[1] = hItem;
/*   245 */    }
/*   246 */    else
/*   247 */    {
/*   248 */       BUTTON_SetBitmap(hItem, 0, &bmbtn_relayset_normal);
/*   249 */       BUTTON_SetBitmap(hItem, 1, &bmbtn_relayset_selected);
/*   250 */       ButtonItem[1] = hItem;
/*   251 */    }
/*   253 */    hItem = WM_GetDialogItem(hWin, (0x800 + 0x05));
/*   254 */    (void)BUTTON_SetText(hItem, "");
/*   255 */    BUTTON_SetBitmap(hItem, 0, &bmbtn_events_normal);
/*   256 */    BUTTON_SetBitmap(hItem, 1, &bmbtn_events_selected);
/*   257 */    ButtonItem[3] = hItem;
/*   259 */    hItem = WM_GetDialogItem(hWin, (0x800 + 0x06));
/*   260 */    (void)BUTTON_SetText(hItem, "");
/*   261 */    if(ConnectSetting[gDeviceIndex].DeviceType == DEVICE_MLINK)
/*   262 */    {
/*   263 */       BUTTON_SetBitmap(hItem, 0, &bmcontrol_normal);
/*   264 */       BUTTON_SetBitmap(hItem, 1, &bmcontrol_selected);
/*   265 */       ButtonItem[5] = hItem;
/*   266 */    }
/*   267 */    else
/*   268 */    {
/*   269 */       BUTTON_SetBitmap(hItem, 0, &bmacbmccb_control_btn_normal);
/*   270 */       BUTTON_SetBitmap(hItem, 1, &bmacbmcc_control_btn_selected);
/*   271 */       ButtonItem[5] = hItem;
/*   272 */    }
/*   273 */ }
/*   280 */ static void _cbDialog(WM_MESSAGE * pMsg)
/*   281 */ {
/*   285 */    switch (pMsg->MsgId)
/*   286 */    {
/*   287 */    case 29:
/*   288 */       {
/*   289 */          if(SettingValue[SETUP_LANGUAGE] == CHINESE)
/*   290 */          {
/*   291 */             ChineseInitButton(pMsg->hWin);
/*   292 */          }
/*   293 */          else
/*   294 */          if(SettingValue[SETUP_LANGUAGE] == RUSSIAN)
/*   295 */          {
/*   296 */             RussianInitButton(pMsg->hWin);
/*   297 */          }
/*   298 */          else
/*   299 */          {
/*   300 */             EnglishInitButton(pMsg->hWin);
/*   301 */          }
/*   302 */          MenuDisp(0, 1);
/*   304 */          break;
/*   305 */       }
/*   306 */    default:
/*   307 */       {
/*   308 */          WM_DefaultProc(pMsg);
/*   309 */          break;
/*   310 */       }
/*   311 */    }
/*   312 */ }
/*   314 */ static void MenuDisp(int pos, int stat)
/*   315 */ {
/*   321 */    BUTTON_SetPressed(ButtonItem[pos], stat);
/*   323 */ }
/*   331 */ static void AcbMccbMenu(int nPos)
/*   332 */ {
/*   333 */    if(nPos == 0)
/*   334 */    {
/*   335 */       AcbMccbHwSet();
...
/*   338 */    if(nPos == 2)
/*   339 */    {
/*   340 */       AcbMccbMeasurement();
/*   341 */    }
/*   342 */    else
/*   343 */    if(nPos == 4)
/*   344 */    {
/*   345 */       AcbMccbInfomation();
/*   346 */    }
/*   347 */    else
/*   348 */    if(nPos == 1)
/*   349 */    {
...
/*   359 */    {
/*   360 */       AcbMccbControl();
/*   361 */       (void)printf("AcbMccbControl end....\n");
/*   362 */    }
/*   363 */    else {}
/*   364 */ }
/*   366 */ static void MlinkMenu(int nPos)
/*   367 */ {
/*   368 */    int flagBreak = 0;
/*   369 */    if(nPos == 0)
/*   370 */    {
...
/*   375 */    {
/*   376 */       MLinkOverview();
/*   377 */       gCommOldStatus[gDeviceIndex] = -1;
/*   378 */       gStatusSendEnd = STATUS_SEND_ING;
/*   379 */       OverviewSend();
/*   380 */       while(1)
/*   381 */       {
/*   382 */          E_KEY key = GetKey();
/*   384 */          if(key == TIME_OUT)
/*   385 */          {
/*   386 */             gStatusSendEnd = STATUS_SEND_ING;
/*   387 */             nSendStep = 0;
/*   388 */             statusSendStep = 0;
/*   389 */             OverviewSend();
/*   390 */          }
/*   391 */          else
/*   392 */          if(key == KEY_SETUP)
/*   393 */          {
/*   394 */             if(Setup() == SETUP_CHANGED)
/*   395 */             {
/*   396 */                flagBreak = 1;
/*   397 */             }
/*   398 */             MLinkOverview();
/*   399 */          }
/*   400 */          else
/*   401 */          if(key == DATA_RECV)
/*   402 */          {
/*   403 */             if(gStatusSendEnd == STATUS_SEND_ING)
/*   404 */             {
/*   405 */                StatusRecv();
/*   406 */                OverviewSend();
/*   407 */             }
...
/*   419 */                   OverViewValue(1);
/*   420 */                   nSendStep = 0;
/*   421 */                   gStatusSendEnd = STATUS_SEND_ING;
/*   422 */                }
/*   423 */                else {}
/*   424 */             }
/*   425 */          }
/*   426 */          else
/*   427 */          if(key == KEY_CANCEL)
/*   428 */          {
/*   429 */             flagBreak = 1;
/*   430 */          }
/*   431 */          else
/*   432 */          if(key == KEY_COMM_ERROR)
/*   433 */          {
/*   434 */             (void)printf("COMM Error!! gStatusSendEnd=%d, statusSendStep=%d\n",gStatusSendEnd,statusSendStep);
/*   435 */             if(StatusRecvErrorProcess() == STATUS_SEND_ING)
/*   436 */             {
/*   437 */                nSendStep = 0;
/*   438 */             }
/*   439 */             else
/*   440 */             {
/*   441 */                gStatusSendEnd = STATUS_SEND_ING;
/*   442 */                statusSendStep = 0;
/*   443 */                nSendStep = 0;
/*   444 */                (void)StatusRecvErrorProcess();
/*   445 */             }
/*   446 */          }
/*   447 */          else
/*   448 */          if(key == COMM_STAT_ERROR)
/*   449 */          {
/*   450 */             MLinkOverview();
/*   451 */             gCommOldStatus[gDeviceIndex] = -1;
/*   452 */             gStatusSendEnd = STATUS_SEND_ING;
/*   453 */          }
/*   454 */          else {}
/*   456 */          if(flagBreak == 1)
/*   457 */          {
...
/*   482 */    else {}
/*   483 */ }
/*   490 */ GUI_HWIN CreateMenu(E_DEVICE_TYPE DeviceType)
/*   491 */ {
/*   492 */    int flagBreak = 0;
/*   493 */    GUI_HWIN hWin;
/*   494 */    int nMainMenuPos = 0;
/*   495 */    static const GUI_WIDGET_CREATE_INFO _aDialogCreate[] =
/*   496 */    {
/*   499 */       { WINDOW_CreateIndirect, "AcbMccbMenu", (0x800 + 0x00), 0, 0, 480, 286, 0, 0x0, 0 },
/*   500 */       { BUTTON_CreateIndirect, "HWSet", (0x800 + 0x01), 10, 10, 150, 130, 0, 0x0, 0 },
/*   501 */       { BUTTON_CreateIndirect, "Measurement", (0x800 + 0x02), 165, 9, 150, 130, 0, 0x0, 0 },
/*   502 */       { BUTTON_CreateIndirect, "SystemInfo", (0x800 + 0x03), 320, 10, 150, 130, 0, 0x0, 0 },
/*   503 */       { BUTTON_CreateIndirect, "RelaySet", (0x800 + 0x04), 10, 145, 150, 130, 0, 0x0, 0 },
/*   504 */       { BUTTON_CreateIndirect, "Event", (0x800 + 0x05), 165, 146, 150, 130, 0, 0x0, 0 },
/*   505 */       { BUTTON_CreateIndirect, "Control", (0x800 + 0x06), 320, 146, 150, 130, 0, 0x0, 0 },
/*   510 */    };
/*   512 */    hWin = GUI_CreateDialogBox(_aDialogCreate, (sizeof(_aDialogCreate) / sizeof(_aDialogCreate[0])), &_cbDialog, WM_GetDesktopWindow(), 0, 34);
/*   514 */    gStatusSendEnd = STATUS_SEND_ING;
/*   515 */    statusSendStep = 0;
/*   516 */    (void)StatusSend();
/*   517 */    unsigned short language;
/*   518 */    while (1)
/*   519 */    {
/*   520 */       E_KEY key = GetKey();
/*   522 */       if(key == TIME_OUT)
/*   523 */       {
/*   524 */          gStatusSendEnd = STATUS_SEND_ING;
/*   525 */          statusSendStep = 0;
/*   526 */          (void)StatusSend();
/*   527 */       }
/*   528 */       else
/*   529 */       if(key == KEY_SETUP)
/*   530 */       {
/*   531 */          WM_HideWindow(hWin);
/*   532 */          language = SettingValue[SETUP_LANGUAGE];
/*   533 */          if(Setup() == SETUP_CHANGED)
/*   534 */          {
/*   535 */             flagBreak = 1;
/*   536 */          }
/*   537 */          (void)printf("\n\n\n\n\n\n old=%d, new=%d\n\n\n\n\n\n", language,SettingValue[SETUP_LANGUAGE]);
/*   538 */          if(language != SettingValue[SETUP_LANGUAGE])
/*   539 */          {
/*   540 */             (void)printf("language changed!!!!\n");
/*   541 */             if(SettingValue[SETUP_LANGUAGE] == CHINESE)
/*   542 */             {
/*   543 */                ChineseInitButton(hWin);
/*   544 */             }
/*   545 */             else
/*   546 */             if(SettingValue[SETUP_LANGUAGE] == RUSSIAN)
/*   547 */             {
/*   548 */                RussianInitButton(hWin);
/*   549 */             }
/*   550 */             else
/*   551 */             {
/*   552 */                EnglishInitButton(hWin);
/*   553 */             }
/*   554 */          }
/*   555 */          WM_ShowWindow(hWin);
/*   556 */       }
/*   557 */       else
/*   558 */       if(key == KEY_UP)
/*   559 */       {
/*   560 */          MenuDisp(nMainMenuPos, 0);
/*   561 */          if(nMainMenuPos > 0)
/*   562 */          {
/*   563 */             nMainMenuPos--;
/*   564 */          }
/*   565 */          else
/*   566 */          {
/*   567 */             nMainMenuPos = 6 - 1;
/*   568 */          }
/*   569 */          MenuDisp(nMainMenuPos, 1);
/*   570 */       }
/*   571 */       else
/*   572 */       if(key == KEY_DOWN)
/*   573 */       {
/*   574 */          MenuDisp(nMainMenuPos, 0);
/*   575 */          if(nMainMenuPos < (6-1))
/*   576 */          {
/*   577 */             nMainMenuPos++;
/*   578 */          }
/*   579 */          else
...
/*   581 */             nMainMenuPos = 0;
/*   582 */          }
/*   583 */          MenuDisp(nMainMenuPos, 1);
/*   584 */       }
/*   585 */       else
/*   586 */       if(key == KEY_ENTER)
/*   587 */       {
/*   588 */          WM_HideWindow(hWin);
/*   589 */          language = SettingValue[SETUP_LANGUAGE];
/*   590 */          gStatusSendEnd = STATUS_SEND_ING;
/*   591 */          statusSendStep = 0;
/*   592 */          nSendStep = 0;
/*   593 */          if((DeviceType == DEVICE_ACB) || (DeviceType == DEVICE_MCCB))
/*   594 */          {
/*   595 */             AcbMccbMenu(nMainMenuPos);
/*   596 */          }
/*   597 */          else
/*   598 */          if(DeviceType == DEVICE_MLINK)
/*   599 */          {
/*   600 */             MlinkMenu(nMainMenuPos);
/*   601 */          }
/*   602 */          else {}
/*   603 */          (void)printf("InMainMenu.....\n");
/*   604 */          gCommOldStatus[gDeviceIndex] = -1;
/*   605 */          (void)printf("\n\n\n\n\n\n old=%d, new=%d\n\n\n\n\n\n", language,SettingValue[SETUP_LANGUAGE]);
/*   606 */          if(language != SettingValue[SETUP_LANGUAGE])
/*   607 */          {
/*   608 */             (void)printf("language changed!!!!\n");
/*   609 */             if(SettingValue[SETUP_LANGUAGE] == CHINESE)
/*   610 */             {
/*   611 */                ChineseInitButton(hWin);
/*   612 */             }
/*   613 */             else
/*   614 */             if(SettingValue[SETUP_LANGUAGE] == RUSSIAN)
/*   615 */             {
/*   616 */                RussianInitButton(hWin);
/*   617 */             }
/*   618 */             else
/*   619 */             {
/*   620 */                EnglishInitButton(hWin);
/*   621 */             }
/*   622 */          }
/*   623 */          WM_ShowWindow(hWin);
/*   624 */       }
/*   625 */       else
/*   626 */       if(key == DATA_RECV)
/*   627 */       {
/*   628 */          StatusRecv();
/*   629 */          if(gStatusSendEnd == STATUS_SEND_ING)
/*   630 */          {
/*   631 */             (void)StatusSend();
/*   632 */          }
/*   633 */          else
/*   634 */          {
/*   635 */             g_bRecvAllDone = 1;
/*   636 */             (void)printf("g_bRecvAllDone=0\n");
/*   637 */          }
/*   638 */       }
/*   639 */       else
/*   640 */       if(key == KEY_CANCEL)
/*   641 */       {
/*   642 */          flagBreak = 1;
/*   643 */       }
/*   644 */       else
/*   645 */       if(key == KEY_COMM_ERROR)
/*   646 */       {
/*   647 */          (void)printf("COMM Error!! gStatusSendEnd=%d, statusSendStep=%d\n",gStatusSendEnd,statusSendStep);
/*   648 */          if(StatusRecvErrorProcess() == STATUS_SEND_ING)
/*   649 */          {
/*   650 */             nSendStep = 0;
/*   651 */          }
/*   652 */          else
/*   653 */          {
/*   654 */             g_bRecvAllDone = 1;
/*   656 */             gStatusSendEnd = STATUS_SEND_ING;
/*   657 */             statusSendStep = 0;
/*   659 */          }
/*   660 */       }
/*   661 */       else {}
/*   663 */       if(flagBreak == 1)
