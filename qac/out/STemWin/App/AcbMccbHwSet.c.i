...
/*
 * C:/CodeInspection/DisplayUnit/STemWin/App/AcbMccbHwSet.c
 */
/*    35 */ static void AcbMccbHwSetSend(void);
/*    36 */ static void RecvHwSetDisp(void);
/*    37 */ static void AcbMccbHwSetDisp(void);
/*    58 */ static void AcbMccbHwSetSend(void)
/*    59 */ {
/*    60 */    if(StatusSend() == STATUS_SEND_ING)
/*    61 */    {
/*    62 */       return;
/*    63 */    }
/*    70 */    if(ConnectSetting[gDeviceIndex].DeviceType == DEVICE_ACB)
/*    71 */    {
/*    72 */       ModbusSendFrame(ConnectSetting[gDeviceIndex].Address, HOLDING_REGISTER, 19, 28);
/*    73 */    }
/*    74 */    else
/*    75 */    if(ConnectSetting[gDeviceIndex].DeviceType == DEVICE_MCCB)
/*    76 */    {
/*    77 */       ModbusSendFrame(ConnectSetting[gDeviceIndex].Address, HOLDING_REGISTER, 19, 11);
/*    78 */    }
/*    79 */    else {}
/*    80 */ }
/*    82 */ static void RecvHwSetDisp(void)
/*    83 */ {
/*    84 */    char buf[INDEX_6][20];
/*    86 */    bEventSend = 0;
/*    87 */    if(g_functionCode == HOLDING_REGISTER)
/*    88 */    {
/*    89 */       unsigned short value;
/*    90 */       if(ConnectSetting[gDeviceIndex].DeviceType == DEVICE_ACB)
/*    91 */       {
/*    92 */          unsigned char poll = (ModbusGetUint8_U(19));
/*    93 */          if(poll == INDEX_4)
/*    94 */          {
/*    95 */             (void)sprintf(buf[0], "4P");
/*    96 */          }
/*    97 */          else
/*    98 */          {
/*    99 */             (void)sprintf(buf[0], "3P");
/*   100 */          }
/*   101 */          value = ModbusGetUint16(39);
/*   102 */          (void)sprintf(buf[INDEX_1], "%4dV", value);
/*   103 */          value = ModbusGetUint16(24);
/*   104 */          (void)sprintf(buf[INDEX_2], "%4dA", value);
/*   105 */          value = ModbusGetUint16(41);
/*   106 */          (void)sprintf(buf[INDEX_3], "%4d", value);
/*   107 */          value = ModbusGetUint16(42) - 1;
/*   108 */          if(value > (4-1))
/*   109 */          {
/*   110 */             value = 0;
/*   111 */          }
/*   112 */          (void)sprintf(buf[INDEX_4], "%s", _acsetup_speed[value]);
/*   113 */          value = ModbusGetUint16(46) - 1;
/*   114 */          if(value > INDEX_1)
/*   115 */          {
/*   116 */             value = 0;
/*   117 */          }
/*   118 */          (void)sprintf(buf[INDEX_5], "%s", _aclocal_remote[SettingValue[SETUP_LANGUAGE]][value]);
/*   119 */       }
/*   120 */       else
/*   121 */       if(ConnectSetting[gDeviceIndex].DeviceType == DEVICE_MCCB)
/*   122 */       {
/*   123 */          unsigned char poll = (ModbusGetUint8_U(19));
/*   124 */          if(poll == INDEX_4)
/*   125 */          {
/*   126 */             (void)sprintf(buf[0], "4P");
/*   127 */          }
/*   128 */          else
/*   129 */          {
/*   130 */             (void)sprintf(buf[0], "3P");
/*   131 */          }
/*   132 */          value = ModbusGetUint16(28);
/*   133 */          (void)sprintf(buf[INDEX_1], "%dV", value);
/*   134 */          value = ModbusGetUint16(21);
/*   136 */          (void)sprintf(buf[INDEX_2], "%dA", value);
/*   137 */          value = ModbusGetUint16(25);
/*   138 */          (void)sprintf(buf[INDEX_3], "%4d", value);
/*   139 */          value = ModbusGetUint16(26) - 1;
/*   140 */          if(value > (4-1))
/*   141 */          {
/*   142 */             value = 0;
/*   143 */          }
/*   144 */          (void)sprintf(buf[INDEX_4], "%s", _acsetup_speed[value]);
/*   145 */          value = ModbusGetUint16(29) - 1;
/*   146 */          if(value > 1)
/*   147 */          {
/*   148 */             value = 0;
/*   149 */          }
/*   150 */          (void)sprintf(buf[INDEX_5], "%s", _aclocal_remote[SettingValue[SETUP_LANGUAGE]][value]);
/*   151 */       }
/*   152 */       else {}
/*   153 */    }
/*   154 */    GUI_SetBkColor(0x1c1b1a);
/*   155 */    GUI_SetColor(0x00FFFFFF);
/*   156 */    GUI_RECT rect;
/*   157 */    rect.x0 = 340;
/*   158 */    rect.y0 = 46;
/*   159 */    rect.x1 = (340 + 100) - 1;
/*   160 */    rect.y1 = (46 + 44) - 1;
...
/*   165 */       if(i == INDEX_5)
/*   166 */       {
/*   167 */          LanguageSelect(FONT20B);
/*   168 */       }
/*   169 */       GUI_DispStringInRect(buf[i], &rect, (1<<0) | (3<<2));
/*   170 */       rect.y0 += 44;
/*   171 */       rect.y1 += 44;
/*   172 */    }
/*   173 */ }
/*   174 */ static void AcbMccbHwSetDisp(void)
/*   175 */ {
/*   176 */    GUI_SetBkColor(0x1c1b1a);
/*   178 */    LanguageSelect(FONT20);
/*   180 */    (void)GUI_SetPenSize(2);
/*   181 */    GUI_SetColor(0x494440);
/*   183 */    GUI_ClearRect(0, 34, 480-1, 320-1);
/*   184 */    GUI_DrawRect(10, 45, (10 + 460)-1, (45 + 264)-1);
/*   186 */    for(int i = 0; i < (6-1); i++)
/*   187 */    {
/*   188 */       int y0 = 45 + ((i + 1) * 44);
/*   189 */       GUI_DrawHLine(y0, 10+INDEX_2, (10 + 460)-1);
/*   190 */    }
/*   192 */    GUI_SetColor(0xc8c8c8);
/*   193 */    GUI_RECT rect;
/*   194 */    rect.x0 = 41;
/*   195 */    rect.y0 = 46;
/*   196 */    rect.x1 = (41 + 150) - 1;
/*   197 */    rect.y1 = (46 + 44)- 1;
/*   199 */    for(int i = 0 ; i < 6; i++)
/*   200 */    {
/*   201 */       GUI_DispStringInRect(_achwset_label_text[SettingValue[SETUP_LANGUAGE]][i], &rect, (0) | (3<<2));
/*   202 */       rect.y0 += 44;
/*   203 */       rect.y1 += 44;
/*   204 */    }
/*   205 */ }
/*   212 */ void AcbMccbHwSet(void)
/*   213 */ {
/*   214 */    int flagBreak = 0;
/*   215 */    AcbMccbHwSetDisp();
/*   216 */    bEventSend = 1;
/*   217 */    nSendStep = 1;
/*   218 */    AcbMccbHwSetSend();
/*   219 */    while (1)
/*   220 */    {
/*   221 */       E_KEY key = GetKey();
/*   223 */       if(key == TIME_OUT)
/*   224 */       {
/*   225 */          gStatusSendEnd = STATUS_SEND_ING;
/*   226 */          nSendStep = 0;
/*   227 */          AcbMccbHwSetSend();
/*   228 */       }
/*   229 */       else
/*   230 */       if(key == KEY_SETUP)
/*   231 */       {
/*   232 */          if(Setup() == SETUP_CHANGED)
/*   233 */          {
/*   234 */             flagBreak = 1;
/*   235 */          }
/*   236 */          AcbMccbHwSetDisp();
/*   237 */          gCommOldStatus[gDeviceIndex] = -1;
/*   238 */       }
/*   239 */       else
/*   240 */       if(key == DATA_RECV)
/*   241 */       {
/*   242 */          if(gStatusSendEnd == STATUS_SEND_ING)
/*   243 */          {
/*   244 */             StatusRecv();
/*   245 */             AcbMccbHwSetSend();
/*   246 */          }
/*   247 */          else
/*   248 */          {
/*   249 */             RecvHwSetDisp();
/*   250 */             g_bRecvAllDone = 1;
/*   251 */             (void)printf("g_bRecvAllDone=0\n");
/*   252 */          }
/*   253 */       }
/*   254 */       else
/*   255 */       if(key == KEY_CANCEL)
/*   256 */       {
/*   257 */          flagBreak = 1;
/*   258 */       }
/*   259 */       else
/*   260 */       if(key == KEY_COMM_ERROR)
/*   261 */       {
/*   262 */          (void)printf("COMM Error!! gStatusSendEnd=%d, statusSendStep=%d\n",gStatusSendEnd,statusSendStep);
/*   265 */          if(StatusRecvErrorProcess() == STATUS_SEND_ING)
/*   266 */          {
/*   267 */             nSendStep = 0;
/*   268 */          }
/*   269 */          else
/*   270 */          {
/*   271 */             if(nSendStep < INDEX_1)
/*   272 */             {
/*   273 */                AcbMccbHwSetSend();
/*   274 */             }
/*   275 */             else
/*   276 */             {
/*   277 */                g_bRecvAllDone = 1;
/*   279 */                (void)printf("All done!!!\n");
/*   280 */                gStatusSendEnd = STATUS_SEND_ING;
/*   281 */                statusSendStep = 0;
/*   282 */                nSendStep = 0;
/*   283 */             }
/*   284 */          }
/*   285 */       }
/*   286 */       else
/*   287 */       if(key == COMM_STAT_ERROR)
/*   288 */       {
/*   289 */          (void)printf("key == COMM_STAT_ERROR\n");
/*   290 */          AcbMccbHwSetDisp();
/*   291 */       }
/*   292 */       else {}
/*   293 */       if(flagBreak == 1)
/*   294 */       {
