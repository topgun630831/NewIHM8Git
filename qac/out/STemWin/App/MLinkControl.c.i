...
/*
 * C:/CodeInspection/DisplayUnit/STemWin/App/MLinkControl.c
 */
/*    29 */ static void ControlSucceededMessage(void);
/*    30 */ static void InitDisp(int pos, int cur_status, const char* msg);
/*    31 */ static void MLinkControlValueDisp(int pos);
/*    32 */ static void MLinkControlDisp(int pos, int flag);
/*    34 */ static unsigned char ControlDoStatus[4];
/*    37 */ void ControlErrorMessage(const char* message)
/*    38 */ {
/*    39 */    int flagBreak = 0;
/*    40 */    GUI_RECT rect;
/*    42 */    GUI_SetBkColor(0x2f2c2a);
/*    44 */    (void)GUI_SetPenSize(2);
/*    45 */    GUI_SetColor(0xd07b18);
/*    47 */    GUI_ClearRect(25, 18, ((430 + 25) - 1), ((280 + 18) - 1));
/*    48 */    GUI_DrawRect(25, 18, ((430 + 25) - 1), ((280 + 18) - 1));
/*    50 */    GUI_SetColor(0x00FFFFFF);
/*    51 */    (void)GUI_SetFont(&GUI_Font32_ASCII);
/*    52 */    LanguageSelect(FONT32);
/*    53 */    rect.x0 = 50;
/*    54 */    rect.y0 = 50;
/*    55 */    rect.x1 = ((50 + 380) - 1);
/*    56 */    rect.y1 = ((133 + 60) - 1);
/*    57 */    GUI_DispStringInRect(message, &rect, (2<<0) | (3<<2));
/*    59 */    rect.x0 = 169;
/*    60 */    rect.y0 = 219;
/*    61 */    rect.x1 = (169 + 142) - 1;
/*    62 */    rect.y1 = (219 + 55) - 1;
/*    63 */    GUI_SetColor(0xd07b18);
/*    64 */    GUI_SetBkColor(0xd07b18);
/*    65 */    (void)GUI_SetFont(&GUI_Font24B_ASCII);
/*    66 */    GUI_FillRoundedRect(rect.x0, rect.y0, rect.x1, rect.y1, INDEX_2);
/*    67 */    GUI_SetColor(0x00FFFFFF);
/*    69 */    GUI_DispStringInRect(_accontrol_button_text[SettingValue[SETUP_LANGUAGE]][0], &rect, (2<<0) | (3<<2));
/*    71 */    while (1)
/*    72 */    {
/*    73 */       E_KEY key = GetKey();
/*    75 */       if(key == KEY_ENTER)
...
/*    90 */    }
/*    91 */ }
/*    93 */ static void ControlSucceededMessage(void)
/*    94 */ {
/*    95 */    int flagBreak = 0;
/*    96 */    GUI_RECT rect;
/*    98 */    GUI_SetBkColor(0x2f2c2a);
/*   100 */    (void)GUI_SetPenSize(2);
/*   101 */    GUI_SetColor(0xd07b18);
/*   103 */    GUI_ClearRect(25, 18, ((430 + 25) - 1), ((280 + 18) - 1));
/*   104 */    GUI_DrawRect(25, 18, ((430 + 25) - 1), ((280 + 18) - 1));
/*   106 */    GUI_SetColor(0x00FFFFFF);
/*   107 */    LanguageSelect(FONT32);
/*   108 */    rect.x0 = 25;
/*   109 */    rect.y0 = 178;
/*   110 */    rect.x1 = ((430 + 25) - 1);
/*   111 */    rect.y1 = (178 + 66);
/*   112 */    GUI_DispStringInRect(_accontrol_succeeded_text[SettingValue[SETUP_LANGUAGE]], &rect, (2<<0) | (3<<2));
/*   114 */    GUI_DrawBitmap(&bmicon_succeeded, 200, 78);
/*   116 */    int count = 5;
/*   117 */    while (1)
/*   118 */    {
/*   119 */       E_KEY key = GetKey();
/*   121 */       if(key == SECOND_TIMER)
/*   122 */       {
/*   123 */          if(--count <= 0)
/*   124 */          {
/*   125 */             flagBreak = 1;
...
/*   127 */       }
/*   128 */       else
/*   129 */       if(key == KEY_ENTER)
/*   130 */       {
/*   131 */          flagBreak = 1;
/*   132 */       }
/*   133 */       else
/*   134 */       if(key == KEY_CANCEL)
/*   135 */       {
/*   136 */          flagBreak = 1;
/*   137 */       }
/*   138 */       else {}
...
/*   144 */    }
/*   145 */ }
/*   148 */ void PasswordDisp(int pos, char password)
/*   149 */ {
/*   150 */    GUI_RECT rect;
/*   151 */    GUI_SetBkColor(0x2f2c2a);
/*   152 */    GUI_ClearRect(140,
/*   153 */        116,
/*   154 */        (140 + (50 * 4)) - 1,
/*   155 */        (((133 + 60) + 17) - 1));
/*   157 */    rect.x0 = 140;
/*   158 */    rect.y0 = 133;
/*   159 */    rect.x1 = (140 + 50) - 1;
/*   160 */    rect.y1 = ((133 + 60) - 1);
/*   161 */    (void)GUI_SetFont(&GUI_Font32B_ASCII);
/*   162 */    for(int i = 0; i < 4; i++)
/*   163 */    {
/*   164 */       GUI_DispStringInRect(_acpassword_input_text, &rect, (2<<0) | (3<<2));
/*   165 */       rect.x0 += 50;
/*   166 */       rect.x1 += 50;
/*   167 */    }
/*   169 */    if(pos >= 4)
...
/*   171 */       return;
/*   172 */    }
/*   174 */    int x = 140 + (50 * pos);
/*   175 */    (void)GUI_BMP_Draw(_acUp, x, 116);
/*   176 */    (void)GUI_BMP_Draw(_acDown, x, (133 + 60));
/*   178 */    char buf[2];
/*   179 */    buf[0] = password;
/*   180 */    buf[1] = 0;
/*   181 */    rect.x0 = 140 + (50 * pos);
/*   182 */    rect.y0 = 133;
/*   183 */    rect.x1 = (140 + (50 * pos) + 50) - 1;
/*   184 */    rect.y1 = ((133 + 60) - 1);
/*   185 */    GUI_SetColor(0x00FFFFFF);
/*   186 */    GUI_SetBkColor(0x00000000);
/*   187 */    GUI_ClearRect(rect.x0, rect.y0, rect.x1, rect.y1);
/*   188 */    GUI_DispStringInRect(buf, &rect, (2<<0) | (3<<2));
/*   190 */ }
/*   193 */ void MLinkButtonDisp(int button)
/*   194 */ {
/*   195 */    GUI_RECT rect;
/*   196 */    rect.x0 = 88;
/*   197 */    rect.y0 = 218;
/*   198 */    rect.x1 = (88 + 142) - 1;
/*   199 */    rect.y1 = (218 + 55) - 1;
/*   200 */    for(int i = 0; i < 2; i++)
/*   201 */    {
/*   202 */       if(i == button)
/*   203 */       {
/*   204 */          GUI_SetColor(0xd07b18);
/*   205 */          GUI_SetBkColor(0xd07b18);
/*   206 */       }
/*   207 */       else
/*   208 */       {
/*   209 */          GUI_SetColor(0x4c4945);
/*   210 */          GUI_SetBkColor(0x4c4945);
/*   211 */       }
/*   212 */       LanguageSelect(FONT24B);
/*   213 */       GUI_FillRoundedRect(rect.x0, rect.y0, rect.x1, rect.y1, INDEX_2);
/*   214 */       if(i == button)
/*   215 */       {
/*   216 */          GUI_SetColor(0x00FFFFFF);
/*   217 */       }
/*   218 */       else
/*   219 */       {
/*   220 */          GUI_SetColor(0xa1a1a1);
/*   221 */       }
/*   223 */       GUI_DispStringInRect(_accontrol_button_text[SettingValue[SETUP_LANGUAGE]][i], &rect, (2<<0) | (3<<2));
/*   224 */       rect.x0 += 142 + 20;
/*   225 */       rect.x1 += 142 + 20;
/*   226 */    }
/*   227 */ }
/*   229 */ static void InitDisp(int pos, int cur_status, const char* msg)
/*   230 */ {
/*   231 */    GUI_RECT rect;
/*   233 */    (void)GUI_SetPenSize(2);
/*   234 */    GUI_SetColor(0xd07b18);
/*   235 */    GUI_SetBkColor(0x2f2c2a);
/*   237 */    GUI_ClearRect(25, 18, ((430 + 25) - 1), ((280 + 18) - 1));
/*   238 */    GUI_DrawRect(25, 18, ((430 + 25) - 1), ((280 + 18) - 1));
/*   240 */    GUI_SetColor(0x00FFFFFF);
/*   241 */    LanguageSelect(FONT24);
/*   242 */    rect.x0 = 107;
/*   243 */    rect.y0 = 50;
/*   244 */    rect.x1 = ((107 + 266) - 1);
/*   245 */    rect.y1 = ((50 + 60) - 1);
/*   246 */    GUI_DispStringInRect(msg, &rect, (2<<0) | (3<<2));
/*   248 */    MLinkButtonDisp(2);
/*   249 */ }
/*   253 */ void ControlSet(const int pos, const int offset, const int cur_status, const char* msg, const unsigned char nSBO)
/*   254 */ {
/*   255 */    int flagBreak = 0;
/*   256 */    int nPos = 0;
/*   257 */    char password[4+1];
/*   259 */    (void)sprintf(password, "0000");
/*   260 */    InitDisp(pos, cur_status, msg);
/*   261 */    PasswordDisp(nPos, password[nPos]);
/*   263 */    while (1)
/*   264 */    {
/*   265 */       E_KEY key = GetKey();
/*   267 */       if(key == KEY_UP)
/*   268 */       {
/*   269 */          if(nPos < 4)
/*   270 */          {
/*   271 */             if(password[nPos] < '9')
/*   272 */             {
/*   273 */                password[nPos]++;
/*   274 */             }
/*   275 */             else
...
/*   277 */                password[nPos] = '0';
/*   278 */             }
/*   279 */             PasswordDisp(nPos, password[nPos]);
/*   280 */          }
/*   281 */          else
/*   282 */          if(nPos == (4 + 1))
/*   283 */          {
/*   284 */             MLinkButtonDisp(0);
/*   285 */             nPos = 4;
/*   286 */          }
/*   287 */          else {}
/*   288 */       }
...
/*   300 */                password[nPos] = '9';
/*   301 */             }
/*   302 */             PasswordDisp(nPos, password[nPos]);
/*   303 */          }
/*   304 */          else
/*   305 */          if(nPos == 4)
/*   306 */          {
/*   307 */             MLinkButtonDisp(1);
/*   308 */             nPos = 4 + 1;
/*   309 */          }
/*   310 */          else {}
/*   311 */       }
/*   312 */       else
/*   313 */       if(key == KEY_ENTER)
/*   314 */       {
/*   315 */          if(nPos < 4)
/*   316 */          {
/*   317 */             nPos++;
/*   318 */             PasswordDisp(nPos, password[nPos]);
/*   319 */             if(nPos == 4)
/*   320 */             {
/*   321 */                MLinkButtonDisp(0);
/*   322 */             }
/*   323 */          }
/*   324 */          else
/*   325 */          if(nPos == 4)
/*   326 */          {
/*   327 */             unsigned short iPassword = atoi(password);
/*   328 */             if(iPassword != SettingValue[SETUP_PASSWORD])
/*   329 */             {
/*   330 */                if(QuestionMessage() == 0)
/*   331 */                {
/*   332 */                   flagBreak = 1;
/*   333 */                }
/*   334 */                nPos = 0;
/*   335 */                InitDisp(pos, cur_status, msg);
/*   336 */                PasswordDisp(nPos, password[nPos]);
/*   337 */                MLinkButtonDisp(2);
/*   338 */             }
/*   339 */             else
/*   340 */             {
/*   341 */                unsigned char controlStatus = ModbusControl(ConnectSetting[gDeviceIndex].Address, offset, pos, cur_status, nSBO);
/*   342 */                if(controlStatus == CONTROL_OK)
/*   343 */                {
/*   344 */                   ControlSucceededMessage();
/*   345 */                }
/*   346 */                else
/*   347 */                {
/*   348 */                   ControlErrorMessage(_accontrol_failed_text[SettingValue[SETUP_LANGUAGE]]);
/*   349 */                }
/*   350 */                flagBreak = 1;
/*   351 */             }
/*   352 */          }
...
/*   371 */    }
/*   372 */ }
/*   374 */ static void MLinkControlValueDisp(int pos)
/*   375 */ {
/*   376 */    GUI_SetBkColor(0x1c1b1a);
/*   378 */    (void)GUI_SetPenSize(2);
/*   379 */    GUI_SetColor(0x494440);
/*   381 */    GUI_RECT rect;
/*   382 */    rect.x0 = 10;
/*   383 */    rect.x1 = (10 + 460) - 1;
/*   384 */    rect.y0 = 44;
/*   385 */    rect.y1 = (44 + 66) - 1;
/*   387 */    GUI_RECT rectDescLocal;
/*   388 */    rectDescLocal.x0 = 45;
/*   389 */    rectDescLocal.x1 = (45 + 85) - 1;
/*   390 */    rectDescLocal.y0 = 44;
/*   391 */    rectDescLocal.y1 = (44 + 66) - 1;
/*   393 */    GUI_RECT rectOn;
/*   394 */    rectOn.x0 = 308;
/*   395 */    rectOn.x1 = (308 + 80) - 1;
/*   396 */    rectOn.y0 = 48;
/*   397 */    rectOn.y1 = (48 + 58) - 1;
/*   399 */    GUI_RECT rectOff;
/*   400 */    rectOff.x0 = 386;
/*   401 */    rectOff.x1 = (386 + 80) - 1;
/*   402 */    rectOff.y0 = 48;
/*   403 */    rectOff.y1 = (48 + 58) - 1;
/*   405 */    for(int i = 0; i < 4; i++)
/*   406 */    {
/*   407 */       if(((mLinkMode[gDeviceIndex] != INDEX_4) && (mLinkMode[gDeviceIndex] != INDEX_5)) && (i == pos))
/*   408 */       {
/*   409 */          GUI_SetColor(0xd07b18);
/*   410 */       }
/*   411 */       else
/*   412 */       {
/*   413 */          GUI_SetColor(0x2f2c2a);
/*   414 */       }
/*   415 */       GUI_FillRectEx(&rect);
/*   417 */       GUI_COLOR onTextColor;
/*   418 */       GUI_COLOR offTextColor;
/*   419 */       GUI_COLOR onFillColor;
/*   420 */       GUI_COLOR offFillColor;
/*   422 */       if(((mLinkMode[gDeviceIndex] == INDEX_4) || (mLinkMode[gDeviceIndex] == INDEX_5)) || ((mLinkMode[gDeviceIndex] == INDEX_3) && (i >= INDEX_2)))
/*   423 */       {
/*   424 */          LanguageSelect(FONT24);
/*   425 */          GUI_SetColor(0x504f4f);
/*   426 */          GUI_SetBkColor(0x2f2c2a);
/*   427 */       }
/*   428 */       else
/*   429 */       if(i == pos)
/*   430 */       {
/*   431 */          LanguageSelect(FONT24B);
/*   432 */          GUI_SetColor(0x00FFFFFF);
/*   433 */          GUI_SetBkColor(0xd07b18);
/*   434 */       }
/*   435 */       else
/*   436 */       {
/*   437 */          LanguageSelect(FONT24);
/*   438 */          GUI_SetColor(0xc8c8c8);
/*   439 */          GUI_SetBkColor(0x2f2c2a);
/*   440 */       }
/*   441 */       GUI_DispStringInRect(_acmlink_control_text[i], &rectDescLocal, (0) | (3<<2));
/*   443 */       if(((mLinkMode[gDeviceIndex] == INDEX_4) || (mLinkMode[gDeviceIndex] == INDEX_5)) || ((mLinkMode[gDeviceIndex] == INDEX_3) && (i >= INDEX_2)))
/*   444 */       {
/*   445 */          onTextColor = 0x636261;
/*   446 */          offTextColor = 0x636261;
/*   447 */          onFillColor = 0x2a4324;
/*   448 */          offFillColor = 0x373533;
/*   449 */       }
/*   450 */       else
/*   451 */       if(doStatus[gDeviceIndex][i] == 1)
/*   452 */       {
/*   453 */          onTextColor = 0x00FFFFFF;
/*   454 */          offTextColor = 0x636261;
/*   455 */          onFillColor = 0x0fc901;
/*   456 */          offFillColor = 0x373533;
/*   457 */       }
/*   458 */       else
/*   459 */       {
/*   460 */          onTextColor = 0x636261;
/*   461 */          offTextColor = 0x00FFFFFF;
/*   462 */          onFillColor = 0x2a4324;
/*   463 */          offFillColor = 0x494949;
/*   464 */       }
/*   465 */       LanguageSelect(FONT24B);
/*   466 */       GUI_SetColor(onFillColor);
/*   467 */       GUI_FillRectEx(&rectOn);
/*   468 */       GUI_SetBkColor(onFillColor);
/*   469 */       GUI_SetColor(onTextColor);
/*   470 */       GUI_DispStringInRect(_aconoff_text[SettingValue[SETUP_LANGUAGE]][1], &rectOn, (2<<0) | (3<<2));
/*   472 */       GUI_SetColor(offFillColor);
/*   473 */       GUI_FillRectEx(&rectOff);
/*   474 */       GUI_SetBkColor(offFillColor);
/*   475 */       GUI_SetColor(offTextColor);
/*   476 */       GUI_DispStringInRect(_aconoff_text[SettingValue[SETUP_LANGUAGE]][0], &rectOff, (2<<0) | (3<<2));
/*   478 */       GUI_SetColor(0x1c1b1a);
/*   479 */       GUI_DrawRectEx(&rectOn);
/*   480 */       GUI_DrawRectEx(&rectOff);
/*   483 */       rect.y0 += 67;
/*   484 */       rect.y1 += 67;
/*   486 */       rectDescLocal.y0 += 67;
/*   487 */       rectDescLocal.y1 += 67;
/*   489 */       rectOn.y0 += 67;
/*   490 */       rectOn.y1 += 67;
/*   492 */       rectOff.y0 += 67;
/*   493 */       rectOff.y1 += 67;
...
/*   497 */    {
/*   498 */       ControlDoStatus[i] = doStatus[gDeviceIndex][i];
/*   499 */    }
/*   500 */ }
/*   502 */ static void MLinkControlDisp(int pos, int flag)
/*   503 */ {
/*   504 */    GUI_SetBkColor(0x1c1b1a);
/*   505 */    if(flag)
/*   506 */    {
/*   507 */       GUI_ClearRect(0, 34, 480-1, 320-1);
/*   508 */    }
/*   510 */    (void)GUI_SetPenSize(2);
/*   511 */    GUI_SetColor(0x494440);
/*   513 */    GUI_RECT rect;
/*   514 */    rect.x0 = 10;
/*   515 */    rect.x1 = (10 + 460) - 1;
/*   516 */    rect.y0 = 44;
/*   517 */    rect.y1 = (44 + 66) - 1;
/*   519 */    GUI_RECT rectDescLocal;
/*   520 */    rectDescLocal.x0 = 45;
/*   521 */    rectDescLocal.x1 = (45 + 85) - 1;
/*   522 */    rectDescLocal.y0 = 44;
/*   523 */    rectDescLocal.y1 = (44 + 66) - 1;
/*   525 */    GUI_RECT rectOn;
/*   526 */    rectOn.x0 = 308;
/*   527 */    rectOn.x1 = (308 + 80) - 1;
/*   528 */    rectOn.y0 = 48;
/*   529 */    rectOn.y1 = (48 + 58) - 1;
/*   531 */    GUI_RECT rectOff;
/*   532 */    rectOff.x0 = 386;
/*   533 */    rectOff.x1 = (386 + 80) - 1;
/*   534 */    rectOff.y0 = 48;
/*   535 */    rectOff.y1 = (48 + 58) - 1;
/*   537 */    for(int i = 0; i < 4; i++)
/*   538 */    {
/*   542 */       GUI_SetColor(0x2f2c2a);
/*   543 */       GUI_FillRectEx(&rect);
/*   545 */       GUI_COLOR onTextColor;
/*   546 */       GUI_COLOR offTextColor;
/*   547 */       GUI_COLOR onFillColor;
/*   548 */       GUI_COLOR offFillColor;
/*   551 */       {
/*   553 */          LanguageSelect(FONT24);
/*   554 */          GUI_SetColor(0x504f4f);
/*   555 */          GUI_SetBkColor(0x2f2c2a);
/*   556 */       }
/*   570 */       GUI_DispStringInRect(_acmlink_control_text[i], &rectDescLocal, (0) | (3<<2));
/*   573 */       {
/*   574 */          onTextColor = 0x636261;
/*   575 */          offTextColor = 0x636261;
/*   576 */          onFillColor = 0x2a4324;
/*   577 */          offFillColor = 0x373533;
/*   578 */       }
/*   594 */       GUI_SetColor(onFillColor);
/*   595 */       GUI_FillRectEx(&rectOn);
/*   596 */       GUI_SetBkColor(onFillColor);
/*   597 */       GUI_SetColor(onTextColor);
/*   598 */       GUI_DispStringInRect(_aconoff_text[SettingValue[SETUP_LANGUAGE]][1], &rectOn, (2<<0) | (3<<2));
/*   600 */       GUI_SetColor(offFillColor);
/*   601 */       GUI_FillRectEx(&rectOff);
/*   602 */       GUI_SetBkColor(offFillColor);
/*   603 */       GUI_SetColor(offTextColor);
/*   604 */       GUI_DispStringInRect(_aconoff_text[SettingValue[SETUP_LANGUAGE]][0], &rectOff, (2<<0) | (3<<2));
/*   606 */       GUI_SetColor(0x1c1b1a);
/*   607 */       GUI_DrawRectEx(&rectOn);
/*   608 */       GUI_DrawRectEx(&rectOff);
/*   611 */       rect.y0 += 67;
/*   612 */       rect.y1 += 67;
/*   614 */       rectDescLocal.y0 += 67;
/*   615 */       rectDescLocal.y1 += 67;
/*   617 */       rectOn.y0 += 67;
/*   618 */       rectOn.y1 += 67;
/*   620 */       rectOff.y0 += 67;
/*   621 */       rectOff.y1 += 67;
/*   623 */    }
/*   624 */ }
/*   639 */ void MLinkControl(void)
/*   640 */ {
/*   641 */    int nPointPos = 0;
/*   643 */    unsigned char nSBO = 0;
/*   645 */    unsigned short mOldLinkMode = mLinkMode[gDeviceIndex];
/*   646 */    MLinkControlDisp(nPointPos, 1);
/*   648 */    nSendStep = 0;
/*   652 */    int nPointMax;
/*   653 */    if(mLinkMode[gDeviceIndex] == INDEX_3)
/*   654 */    {
/*   655 */       nPointMax =INDEX_2;
/*   656 */    }
/*   657 */    else
/*   658 */    if((mLinkMode[gDeviceIndex] == INDEX_4) || (mLinkMode[gDeviceIndex] == INDEX_5))
/*   659 */    {
/*   660 */       nPointMax = 0;
/*   661 */    }
/*   662 */    else
...
/*   664 */       nPointMax = 4;
/*   665 */    }
/*   666 */    int commStat = gCommStatus[gDeviceIndex];
/*   667 */    if(gCommStatus[gDeviceIndex] == COMM_OK)
/*   668 */    {
/*   669 */       MLinkControlValueDisp(nPointPos);
/*   670 */    }
/*   671 */    (void)StatusSend();
/*   672 */    while (1)
/*   673 */    {
/*   674 */       E_KEY key = GetKey();
/*   676 */       if(key == SECOND_TIMER)
/*   677 */       {
/*   678 */          unsigned char changed = 0;
/*   679 */          for(int i = 0; i < 4; i++)
/*   680 */          {
/*   681 */             if(ControlDoStatus[i] != doStatus[gDeviceIndex][i])
/*   682 */             {
/*   683 */                changed = 1;
/*   684 */             }
/*   685 */          }
/*   686 */          nSBO = mLinkSBO[gDeviceIndex];
/*   687 */          if(mLinkMode[gDeviceIndex] != mOldLinkMode)
/*   688 */          {
/*   689 */             if(mLinkMode[gDeviceIndex] == INDEX_3)
/*   690 */             {
/*   691 */                nPointMax = INDEX_2;
/*   692 */             }
/*   693 */             else
/*   694 */             if((mLinkMode[gDeviceIndex] == INDEX_4) || (mLinkMode[gDeviceIndex] == INDEX_5))
/*   695 */             {
/*   696 */                nPointMax = 0;
/*   697 */             }
/*   698 */             else
...
/*   700 */                nPointMax = 4;
/*   701 */             }
/*   702 */             if((mLinkMode[gDeviceIndex] == INDEX_3) && (nPointPos >= INDEX_2))
/*   703 */             {
/*   704 */                nPointPos = 1;
/*   705 */             }
/*   706 */             changed = 1;
/*   707 */             mOldLinkMode = mLinkMode[gDeviceIndex];
/*   708 */          }
/*   709 */          if(changed == 1)
/*   710 */          {
/*   711 */             MLinkControlValueDisp(nPointPos);
/*   712 */          }
/*   713 */       }
/*   714 */       else
/*   715 */       if(key == TIME_OUT)
/*   716 */       {
/*   717 */          gStatusSendEnd = STATUS_SEND_ING;
/*   718 */          nSendStep = 0;
/*   719 */          statusSendStep = 0;
/*   720 */          (void)StatusSend();
/*   721 */       }
/*   722 */       else
/*   723 */       if(key == KEY_SETUP)
/*   724 */       {
/*   725 */          (void)Setup();
/*   726 */          MLinkControlDisp(nPointPos, 1);
/*   727 */          MLinkControlValueDisp(nPointPos);
/*   728 */          gCommOldStatus[gDeviceIndex] = -1;
/*   729 */       }
/*   730 */       else
/*   731 */       if(key == KEY_UP)
/*   732 */       {
...
/*   741 */          else
/*   742 */          {
/*   743 */             nPointPos = nPointMax - 1;
/*   744 */          }
/*   745 */          MLinkControlDisp(nPointPos, 0);
/*   746 */          MLinkControlValueDisp(nPointPos);
/*   747 */       }
/*   748 */       else
/*   749 */       if(key == KEY_DOWN)
/*   750 */       {
...
/*   761 */             nPointPos = 0;
/*   762 */          }
/*   763 */          MLinkControlDisp(nPointPos, 0);
/*   764 */          MLinkControlValueDisp(nPointPos);
/*   765 */       }
/*   766 */       else
/*   767 */       if(key == KEY_ENTER)
/*   768 */       {
/*   769 */          if(nPointMax == 0)
/*   770 */          {
/*   771 */             continue;
/*   772 */          }
/*   773 */          if(mLinkMode[gDeviceIndex] >= INDEX_4)
/*   774 */          {
/*   775 */             ControlErrorMessage(_acmode_invalid_text[SettingValue[SETUP_LANGUAGE]]);
/*   776 */             DispMLinkStatus();
/*   777 */             MLinkControlDisp(nPointPos, 1);
/*   778 */          }
/*   779 */          else
/*   780 */          {
/*   781 */             unsigned short address;
/*   782 */             unsigned char status = doStatus[gDeviceIndex][nPointPos];
/*   783 */             unsigned char dostatus = status;
/*   784 */             int nPoint = nPointPos;
/*   785 */             if((mLinkMode[gDeviceIndex] == 1) )
/*   786 */             {
/*   787 */                nPoint = 0;
/*   788 */                if(nSBO == 1)
/*   789 */                {
/*   790 */                   address = 5000;
/*   791 */                   address += (nPointPos * INDEX_4);
/*   792 */                   if(status == 1)
/*   793 */                   {
/*   794 */                      address += INDEX_2;
/*   795 */                   }
...
/*   807 */             }
/*   808 */             else
/*   809 */             if(mLinkMode[gDeviceIndex] == INDEX_2)
/*   810 */             {
/*   811 */                nPoint = 0;
/*   812 */                if(nSBO == 1)
/*   813 */                {
/*   814 */                   address = 5020;
/*   815 */                   if(nPointPos >= INDEX_2)
/*   816 */                   {
/*   817 */                      address += INDEX_4;
/*   818 */                   }
/*   819 */                   if(status == 1)
...
/*   837 */             }
/*   838 */             else
/*   839 */             if(mLinkMode[gDeviceIndex] == INDEX_3)
/*   840 */             {
/*   841 */                nPoint = 0;
/*   842 */                if(nSBO == 1)
/*   843 */                {
/*   844 */                   address = 5020;
/*   845 */                   if(nPointPos == INDEX_1)
/*   846 */                   {
/*   847 */                      address += INDEX_2;
/*   848 */                   }
/*   849 */                   if(status == 1)
...
/*   867 */             }
/*   868 */             else {}
/*   869 */             ControlSet(nPoint, address, status, _accontrol_confirm_text[SettingValue[SETUP_LANGUAGE]][dostatus], nSBO);
/*   870 */             DispMLinkStatus();
/*   871 */             gCommOldStatus[gDeviceIndex] = -1;
/*   872 */             MLinkControlDisp(nPointPos, 1);
/*   873 */             MLinkControlValueDisp(nPointPos);
/*   874 */             g_bRecvAllDone = 1;
/*   875 */             nSendStep = 0;
/*   876 */             statusSendStep = 0;
/*   877 */             gStatusSendEnd = STATUS_SEND_ING;
/*   878 */          }
/*   879 */          CommTimerInit();
/*   880 */       }
/*   881 */       else
/*   882 */       if(key == DATA_RECV)
/*   883 */       {
/*   884 */          if(commStat == COMM_ERROR)
/*   885 */          {
/*   886 */             commStat = COMM_OK;
/*   887 */             MLinkControlValueDisp(nPointPos);
/*   888 */          }
/*   889 */          StatusRecv();
/*   890 */          nSendStep = 0;
/*   891 */          if(gStatusSendEnd == STATUS_SEND_ING)
/*   892 */          {
/*   893 */             (void)StatusSend();
/*   894 */          }
/*   895 */          else
/*   896 */          {
/*   897 */             g_bRecvAllDone = 1;
/*   898 */             nSendStep = 0;
/*   899 */             statusSendStep = 0;
/*   900 */             gStatusSendEnd = STATUS_SEND_ING;
/*   901 */          }
/*   902 */       }
/*   903 */       else
/*   904 */       if(key == KEY_CANCEL)
/*   905 */       {
/*   906 */          break;
/*   907 */       }
/*   908 */       else
/*   909 */       if(key == KEY_COMM_ERROR)
/*   910 */       {
/*   911 */          (void)printf("COMM Error!!! gStatusSendEnd=%d, statusSendStep=%d, nSendStep=%d\n",gStatusSendEnd,statusSendStep,nSendStep);
/*   912 */          if(StatusRecvErrorProcess() == STATUS_SEND_ING)
/*   913 */          {
/*   914 */             nSendStep = 0;
/*   915 */          }
/*   920 */          else
/*   921 */          {
/*   922 */             g_bRecvAllDone = 1;
/*   923 */             (void)printf("All done!!!\n");
/*   924 */             gStatusSendEnd = STATUS_SEND_ING;
/*   925 */             statusSendStep = 0;
/*   926 */             nSendStep = 0;
/*   927 */          }
/*   928 */       }
/*   929 */       else
/*   930 */       if(key == COMM_STAT_ERROR)
/*   931 */       {
/*   932 */          commStat = COMM_ERROR;
/*   933 */          MLinkControlDisp(nPointPos, 1);
/*   934 */       }
/*   935 */       else {}
/*   936 */    }
/*   937 */ }
