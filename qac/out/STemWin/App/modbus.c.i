...
/*
 * C:/CodeInspection/DisplayUnit/STemWin/App/modbus.c
 */
/*    20 */ static unsigned short CRC16(const unsigned char *puchMsg, const unsigned short usDataLen);
/*    21 */ static void ReadAll(void);
/*    22 */ static unsigned char ModbusRecvCheck(void);
/*    33 */ static unsigned short CRC16(const unsigned char puchMsg[], const unsigned short usDataLen)
/*    34 */ {
/*    35 */    unsigned char uchCRCHi = 0xff ;
/*    36 */    unsigned char uchCRCLo = 0xff ;
/*    37 */    unsigned short uIndex;
/*    38 */    for(unsigned char i = 0; i < usDataLen; i++)
/*    39 */    {
/*    40 */       uIndex = uchCRCHi ^ puchMsg[i] ;
/*    41 */       uchCRCHi = uchCRCLo ^ auchCRCHi[uIndex];
/*    42 */       uchCRCLo = auchCRCLo[uIndex];
/*    43 */    }
/*    44 */    unsigned short ret;
/*    45 */    ret = (unsigned short)(uchCRCHi << INDEX_8) | (unsigned short)uchCRCLo;
/*    46 */    return (ret) ;
/*    47 */ }
/*    49 */ static void ReadAll(void)
/*    50 */ {
/*    51 */    g_bRecvVariable = 0;
/*    52 */    unsigned char buf;
/*    53 */    while(1)
/*    54 */    {
/*    55 */       HAL_StatusTypeDef stat;
/*    56 */       stat = HAL_UART_Receive(&huart2, &buf, 1, INDEX_10);
/*    57 */       (void)printf("[%02X %02X]", (int)stat, buf);
/*    58 */       if(stat != HAL_OK)
/*    59 */       {
/*    60 */          break;
/*    61 */       }
/*    62 */    }
/*    63 */ }
/*    65 */ void ModbusSendFrame(const unsigned char address, const unsigned char functionCode, const unsigned short start, const unsigned short no)
/*    66 */ {
/*    67 */    g_modbusRxIndex = 0;
/*    68 */    g_modbusRxDone = 0;
/*    69 */    g_modbusRxError = 0;
/*    71 */    g_modbusAddress = address;
/*    72 */    g_functionCode = functionCode;
/*    73 */    g_startAddr = start;
/*    74 */    if((functionCode == COIL) || (functionCode == INPUT_STATUS))
/*    75 */    {
/*    76 */       g_waitReceiveLen = no / INDEX_8;
/*    77 */       if(no % INDEX_8)
/*    78 */       {
/*    79 */          g_waitReceiveLen++;
/*    80 */       }
/*    81 */    }
/*    82 */    else
/*    83 */    if((functionCode == HOLDING_REGISTER) || (functionCode == INPUT_REGISTER))
/*    84 */    {
/*    85 */       g_waitReceiveLen = no * INDEX_2;
/*    86 */    }
/*    87 */    else {}
/*    88 */    g_wModbusWaitLen = g_waitReceiveLen + INDEX_5;
/*    91 */    unsigned char frame[8];
/*    92 */    unsigned short startAddr = start - 1;
/*    93 */    frame[INDEX_0] = address;
/*    94 */    frame[INDEX_1] = functionCode;
/*    95 */    frame[INDEX_2] = (unsigned char)(startAddr >> INDEX_8);
/*    96 */    frame[INDEX_3] = (unsigned char)(startAddr & 0xff);
/*    97 */    frame[INDEX_4] = (unsigned char)(no << INDEX_8);
/*    98 */    frame[INDEX_5] = (unsigned char)(no & 0xff);
/*   100 */    unsigned short crc = CRC16(frame, INDEX_6);
/*   102 */    frame[INDEX_6] = (unsigned char) (crc >> INDEX_8);
/*   103 */    frame[INDEX_7] = (unsigned char)(crc & 0xff);
/*   105 */    (void)printf("Send Frame!!!\n");
/*   106 */    for(int i = 0; i < INDEX_8; i++)
/*   107 */    {
/*   108 */       (void)printf("%02X ", frame[i]);
/*   109 */    }
/*   110 */    (void)printf("\n");
/*   112 */    g_subFunction = 0;
/*   114 */    ReadAll();
/*   116 */    (void)HAL_UART_Transmit(&huart2, frame, INDEX_8, 0xFFFF);
/*   117 */    g_AddressRecv = 0;
/*   118 */    sendFlag = 1;
/*   122 */ }
/*   124 */ void ModbusSendFrameReadTime(const unsigned char address)
/*   125 */ {
/*   126 */    g_modbusRxIndex = 0;
/*   127 */    g_modbusRxDone = 0;
/*   128 */    g_modbusRxError = 0;
/*   130 */    g_modbusAddress = address;
/*   131 */    g_functionCode = 0x2b;
/*   132 */    g_subFunction = 0x0f;
/*   133 */    g_wModbusWaitLen = INDEX_14;
/*   135 */    unsigned char frame[8];
/*   136 */    frame[INDEX_0] = address;
/*   137 */    frame[INDEX_1] = 0x2b;
/*   138 */    frame[INDEX_2] = 0x0f;
/*   139 */    frame[INDEX_3] = 0;
/*   141 */    unsigned short crc = CRC16(frame, INDEX_4);
/*   143 */    frame[INDEX_4] = (unsigned char) (crc >> INDEX_8);
/*   144 */    frame[INDEX_5] = (unsigned char)(crc & 0xff);
/*   146 */    (void)printf("Send Frame ReadTime!!!\n");
/*   147 */    for(int i = 0; i < INDEX_6; i++)
/*   148 */    {
/*   149 */       (void)printf("%02X ", frame[i]);
/*   150 */    }
/*   151 */    (void)printf("\n");
/*   154 */    ReadAll();
/*   155 */    (void)HAL_UART_Transmit(&huart2, frame, INDEX_6, 0xFFFF);
/*   156 */    g_AddressRecv = 0;
/*   157 */    sendFlag = 1;
/*   160 */ }
/*   162 */ void ModbusSendFrameDeviceIdentofocation(const unsigned char address)
/*   163 */ {
/*   164 */    g_modbusRxIndex = 0;
/*   165 */    g_modbusRxDone = 0;
/*   166 */    g_modbusRxError = 0;
/*   168 */    g_modbusAddress = address;
/*   169 */    g_functionCode = 0x2b;
/*   170 */    g_subFunction = 0x0e;
/*   172 */    if(ConnectSetting[gDeviceIndex].DeviceType == DEVICE_ACB)
/*   173 */    {
/*   174 */       g_wModbusWaitLen = (10+(4*2)+0x13+0x0f+0x7+0x10);;
/*   175 */    }
/*   176 */    else
/*   177 */    {
/*   178 */       g_wModbusWaitLen = (10+(4*2)+0x13+0x4+0x14+0x14);;
/*   179 */    }
/*   184 */    unsigned char frame[8];
/*   185 */    frame[INDEX_0] = address;
/*   186 */    frame[INDEX_1] = 0x2b;
/*   187 */    frame[INDEX_2] = 0x0e;
/*   188 */    frame[INDEX_3] = INDEX_2;
/*   189 */    frame[INDEX_4] = INDEX_4;
/*   191 */    unsigned short crc = CRC16(frame, INDEX_5);
/*   193 */    frame[INDEX_5] = (unsigned char) (crc >> INDEX_8);
/*   194 */    frame[INDEX_6] = (unsigned char)(crc & 0xff);
/*   196 */    (void)printf("Send Frame DeviceIdentofocation!!!\n");
/*   197 */    for(int i = 0; i < INDEX_7; i++)
/*   198 */    {
/*   199 */       (void)printf("%02X ", frame[i]);
/*   200 */    }
/*   201 */    (void)printf("\n");
/*   204 */    ReadAll();
/*   205 */    (void)HAL_UART_Transmit(&huart2, frame, INDEX_7, 0xFFFF);
/*   206 */    g_AddressRecv = 0;
/*   207 */    sendFlag = 1;
/*   210 */ }
/*   212 */ void ModbusSendFrameDeviceIdentofocation3(const unsigned char address, unsigned char deviceID, unsigned char objectID)
/*   213 */ {
/*   214 */    g_modbusRxIndex = 0;
/*   215 */    g_modbusRxDone = 0;
/*   216 */    g_modbusRxError = 0;
/*   218 */    g_modbusAddress = address;
/*   219 */    g_functionCode = 0x2b;
/*   220 */    g_subFunction = 0x0e;
/*   222 */    g_wModbusWaitLen = 8;
/*   227 */    unsigned char frame[8];
/*   228 */    frame[INDEX_0] = address;
/*   229 */    frame[INDEX_1] = 0x2b;
/*   230 */    frame[INDEX_2] = 0x0e;
/*   231 */    frame[INDEX_3] = deviceID;
/*   232 */    frame[INDEX_4] = objectID;
/*   234 */    unsigned short crc = CRC16(frame, INDEX_5);
/*   236 */    frame[INDEX_5] = (unsigned char) (crc >> INDEX_8);
/*   237 */    frame[INDEX_6] = (unsigned char)(crc & 0xff);
/*   239 */    (void)printf("Send Frame DeviceIdentofocation3!!!\n");
/*   240 */    for(int i = 0; i < INDEX_7; i++)
/*   241 */    {
/*   242 */       (void)printf("%02X ", frame[i]);
/*   243 */    }
/*   244 */    (void)printf("\n");
/*   247 */    ReadAll();
/*   248 */    g_bRecvVariable = 1;
/*   249 */    (void)HAL_UART_Transmit(&huart2, frame, INDEX_7, 0xFFFF);
/*   250 */    g_AddressRecv = 0;
/*   251 */    sendFlag = 1;
/*   254 */ }
/*   257 */ void ModbusSendFrameEvent(const unsigned char address, const unsigned char fileNo, const unsigned short recordNumber)
/*   258 */ {
/*   259 */    g_modbusRxIndex = 0;
/*   260 */    g_modbusRxDone = 0;
/*   261 */    g_modbusRxError = 0;
/*   263 */    g_modbusAddress = address;
/*   264 */    g_functionCode = 0x64;
/*   265 */    g_subFunction = 0x06;
/*   266 */    g_wModbusWaitLen = 23;
/*   268 */    if(fileNo == 0x65)
/*   269 */    {
/*   270 */       g_wModbusWaitLen = (52+5);
/*   271 */    }
/*   272 */    unsigned char frame[20];
/*   273 */    frame[INDEX_0] = address;
/*   274 */    frame[INDEX_1] = 0x64;
/*   275 */    frame[INDEX_2] = INDEX_7;
/*   276 */    frame[INDEX_3] = 0x06;
/*   277 */    frame[INDEX_4] = 0;
/*   278 */    frame[INDEX_5] = fileNo;
/*   279 */    frame[INDEX_6] = (unsigned char)(recordNumber >> INDEX_8);
/*   280 */    frame[INDEX_7] = (unsigned char)(recordNumber & 0xff);
/*   281 */    frame[INDEX_8] = 0;
/*   282 */    frame[INDEX_9] = 1;
/*   284 */    unsigned short crc = CRC16(frame, INDEX_10);
/*   286 */    frame[INDEX_10] = (unsigned char) (crc >> INDEX_8);
/*   287 */    frame[INDEX_11] = (unsigned char)(crc & 0xff);
/*   289 */    (void)printf("Send Frame ModbusSendFrameEvent!!!\n");
/*   290 */    for(int i = 0; i < INDEX_12; i++)
/*   291 */    {
/*   292 */       (void)printf("%02X ", frame[i]);
/*   293 */    }
/*   294 */    (void)printf("\n");
/*   296 */    ReadAll();
/*   297 */    (void)HAL_UART_Transmit(&huart2, frame, INDEX_12, 0xFFFF);
/*   298 */    g_AddressRecv = 0;
/*   299 */    sendFlag = 1;
/*   302 */ }
/*   304 */ void ModbusSendFrameFromUsb(unsigned char* sendBuf, uint32_t length)
/*   305 */ {
/*   307 */    g_modbusRxIndex = 0;
/*   308 */    g_modbusRxDone = 0;
/*   309 */    g_modbusRxError = 0;
/*   311 */    g_subFunction = 0;
/*   313 */    ReadAll();
/*   314 */    (void)HAL_UART_Transmit(&huart2, sendBuf, (unsigned char)length, 0xFFFF);
/*   315 */    g_AddressRecv = 0;
/*   317 */ }
/*   319 */ unsigned char ModbusCRCCheck(void)
/*   320 */ {
/*   321 */    (void)printf("Recv Frame!!!\n");
/*   322 */    for(int i = 0; i < g_modbusRxIndex; i++)
/*   323 */    {
/*   324 */       (void)printf("%02X ", g_modbusRxBuff[i]);
/*   325 */    }
/*   326 */    (void)printf("\n");
/*   329 */    unsigned char ret = MODBUS_OK;
/*   333 */    if(g_modbusRxBuff[1] & 0x80)
/*   334 */    {
/*   335 */       (void)printf("-----------------\nModbus Error[%02x]\n", g_modbusRxBuff[INDEX_2]);
/*   336 */    }
/*   337 */    unsigned short p = (unsigned short)(g_modbusRxBuff[g_modbusRxIndex-INDEX_2] << INDEX_8) | (unsigned short)g_modbusRxBuff[g_modbusRxIndex-1];
/*   338 */    unsigned short crc = CRC16(g_modbusRxBuff, g_modbusRxIndex-INDEX_2);
/*   340 */    if(crc != p)
/*   341 */    {
/*   342 */       (void)printf("-----------------\nModbus CRC Error[%04x, %04x]\n", crc, p);
/*   343 */       ret = MODBUS_CRC_ERROR;
/*   344 */    }
/*   345 */    return ret;
/*   346 */ }
/*   348 */ unsigned char ModbusGetUint8_U(const unsigned short address)
/*   349 */ {
/*   350 */    if(address < g_startAddr)
/*   351 */    {
/*   352 */       return 0;
/*   353 */    }
/*   354 */    unsigned short offset = ((address - g_startAddr) * INDEX_2) + INDEX_3;
/*   355 */    unsigned char bValue = g_modbusRxBuff[offset];
/*   356 */    return bValue;
/*   357 */ }
/*   359 */ unsigned char ModbusGetUint8_L(const unsigned short address)
/*   360 */ {
/*   361 */    if(address < g_startAddr)
/*   362 */    {
/*   363 */       return 0;
/*   364 */    }
/*   365 */    unsigned short offset = ((address - g_startAddr) * INDEX_2) + INDEX_3;
/*   366 */    unsigned char bValue = g_modbusRxBuff[offset+1];
/*   367 */    return bValue;
/*   368 */ }
/*   370 */ unsigned short ModbusGetUint16(const unsigned short address)
/*   371 */ {
/*   372 */    if(address < g_startAddr)
/*   373 */    {
/*   374 */       return 0;
/*   375 */    }
/*   376 */    unsigned short offset = ((address - g_startAddr) * INDEX_2) + INDEX_3;
/*   377 */    unsigned short wValue = (unsigned short)(((unsigned short)(g_modbusRxBuff[offset]) << INDEX_8) | g_modbusRxBuff[offset+1]);
/*   378 */    return wValue;
/*   379 */ }
/*   381 */ int16_t ModbusGetInt16(const unsigned short address)
/*   382 */ {
/*   383 */    if(address < g_startAddr)
/*   384 */    {
/*   385 */       return 0;
/*   386 */    }
/*   387 */    unsigned short offset = ((address - g_startAddr) * INDEX_2) + INDEX_3;
/*   388 */    int16_t sValue = (int16_t)(((unsigned short)(g_modbusRxBuff[offset]) << INDEX_8) | g_modbusRxBuff[offset+1]);
/*   389 */    return sValue;
/*   390 */ }
/*   392 */ float ModbusGetFloat(const unsigned short address)
/*   393 */ {
/*   394 */    if(address < g_startAddr)
/*   395 */    {
/*   396 */       return 0;
/*   397 */    }
/*   398 */    unsigned short offset = ((address - g_startAddr) * INDEX_2) + INDEX_3;
/*   399 */    unsigned char val[INDEX_4];
/*   401 */    float *fValue = (float *)val;
/*   408 */    val[INDEX_3] = g_modbusRxBuff[offset++];
/*   409 */    val[INDEX_2] = g_modbusRxBuff[offset++];
/*   410 */    val[INDEX_1] = g_modbusRxBuff[offset++];
/*   411 */    val[INDEX_0] = g_modbusRxBuff[offset];
/*   412 */    return *fValue;
/*   413 */ }
/*   415 */ uint32_t ModbusGetUint32(const unsigned short address)
/*   416 */ {
/*   417 */    if(address < g_startAddr)
/*   418 */    {
/*   419 */       return 0;
/*   420 */    }
/*   421 */    unsigned short offset = ((address - g_startAddr) * INDEX_2) + INDEX_3;
/*   422 */    unsigned char val[INDEX_4];
/*   424 */    uint32_t *Value = (uint32_t *)val;
/*   430 */    val[INDEX_3] = g_modbusRxBuff[offset++];
/*   431 */    val[INDEX_2] = g_modbusRxBuff[offset++];
/*   432 */    val[INDEX_1] = g_modbusRxBuff[offset++];
/*   433 */    val[INDEX_0] = g_modbusRxBuff[offset];
/*   435 */    return *Value;
/*   436 */ }
/*   438 */ int32_t ModbusGetInt32(const unsigned short address)
/*   439 */ {
/*   440 */    if(address < g_startAddr)
/*   441 */    {
/*   442 */       return 0;
/*   443 */    }
/*   444 */    unsigned short offset = ((address - g_startAddr) * INDEX_2) + INDEX_3;
/*   445 */    int8_t val[INDEX_4];
/*   447 */    int32_t *Value = (int32_t *)val;
/*   449 */    val[INDEX_3] = g_modbusRxBuff[offset++];
/*   450 */    val[INDEX_2] = g_modbusRxBuff[offset++];
/*   451 */    val[INDEX_1] = g_modbusRxBuff[offset++];
/*   452 */    val[INDEX_0] = g_modbusRxBuff[offset];
/*   454 */    return *Value;
/*   455 */ }
/*   457 */ unsigned char ModbusGetBit(const unsigned short address, const unsigned short bit)
/*   458 */ {
/*   459 */    if(address < g_startAddr)
/*   460 */    {
/*   461 */       return 0;
/*   462 */    }
/*   463 */    unsigned short offset = ((address - g_startAddr) * INDEX_2) +INDEX_3;
/*   464 */    unsigned short Value = (unsigned short)(((unsigned short)(g_modbusRxBuff[offset]) << INDEX_8) | g_modbusRxBuff[offset+1]);
/*   465 */    unsigned short mask = 1;
/*   466 */    mask = mask << bit;
...
/*   474 */    return ret;
/*   475 */ }
/*   499 */ void ModbusGetString(const unsigned short address, const unsigned short len, char buf[])
/*   500 */ {
/*   501 */    buf[0] = 0;
/*   502 */    if(address < g_startAddr)
/*   503 */    {
/*   504 */       return;
/*   505 */    }
/*   506 */    unsigned short offset = ((address - g_startAddr) * INDEX_2) + INDEX_3;
/*   508 */    (void)memcpy(buf, &g_modbusRxBuff[offset], len);
/*   509 */    buf[len] = 0;
/*   510 */ }
/*   512 */ void ModbusGetDateTime(S_DATE_TIME *dateTime)
/*   513 */ {
/*   514 */    unsigned short mSec;
/*   515 */    unsigned short offset = INDEX_4;
/*   517 */    dateTime->Invalid = g_modbusRxBuff[offset++];
/*   518 */    unsigned short Year = (unsigned short) g_modbusRxBuff[offset++];
/*   522 */    dateTime->Year = Year+2000;
/*   523 */    dateTime->Month = g_modbusRxBuff[offset++];
/*   524 */    dateTime->Day = g_modbusRxBuff[offset++];
/*   525 */    dateTime->Hour = g_modbusRxBuff[offset++];
/*   526 */    dateTime->Min = g_modbusRxBuff[offset++];
/*   527 */    mSec = (unsigned short)(((unsigned short)(g_modbusRxBuff[offset]) << INDEX_8) | g_modbusRxBuff[offset]);
/*   528 */    dateTime->Sec = (unsigned short)(mSec / 1000);
/*   529 */    dateTime->mSec = (unsigned short)(mSec % 1000);
/*   530 */ }
/*   532 */ void ModbusGetProductName(char *buf)
/*   533 */ {
/*   534 */    unsigned short offset;
/*   535 */    int len;
/*   537 */    if(ConnectSetting[gDeviceIndex].DeviceType == DEVICE_ACB)
/*   538 */    {
/*   539 */       offset = 31;
/*   540 */       len = 15;
/*   541 */    }
...
/*   545 */       len = INDEX_4;
/*   546 */    }
/*   549 */    (void)memcpy(gProductInfo[gDeviceIndex].ProductName, (char*)&g_modbusRxBuff[offset], len);
/*   550 */    gProductInfo[gDeviceIndex].ProductName[len] = 0;
/*   556 */ }
/*   558 */ void ModbusGetId1(void)
/*   559 */ {
/*   560 */    int index = INDEX_9;
/*   563 */    (void)memcpy(VendorName, &g_modbusRxBuff[index+1], g_modbusRxBuff[index]);
/*   564 */    VendorName[g_modbusRxBuff[index]] = 0;
/*   565 */    (void)printf("[%d,%x]", index, g_modbusRxBuff[index]);
/*   566 */    index += (g_modbusRxBuff[index] + INDEX_2);
/*   567 */    (void)printf("[%d,%x]", index, g_modbusRxBuff[index]);
/*   568 */    index += (g_modbusRxBuff[index] + INDEX_2);
/*   569 */    (void)printf("[%d,%x]", index, g_modbusRxBuff[index]);
/*   570 */    (void)memcpy(ModbusVersion, &g_modbusRxBuff[index+1], g_modbusRxBuff[index]);
/*   571 */    ModbusVersion[g_modbusRxBuff[index]] = 0;
/*   572 */    (void)printf("\n\n\nVendor=%s, Ver=%s\n", VendorName, ModbusVersion);
/*   574 */ }
/*   576 */ void ModbusGetId2(char productName[60])
/*   577 */ {
/*   578 */    int index = INDEX_9;
/*   579 */    index += (g_modbusRxBuff[index] + INDEX_2);
/*   581 */    (void)memcpy(productName, &g_modbusRxBuff[index+1], g_modbusRxBuff[index]);
/*   582 */    productName[g_modbusRxBuff[index]] = 0;
/*   583 */    index += (g_modbusRxBuff[index] + INDEX_2);
/*   584 */ }
/*   587 */ void ModbusGetId3(void)
/*   588 */ {
/*   589 */    int index = INDEX_9;
/*   591 */    (void)memcpy(serialNo, &g_modbusRxBuff[index+1], g_modbusRxBuff[index]);
/*   592 */    serialNo[g_modbusRxBuff[index]] = 0;
/*   593 */    index += (g_modbusRxBuff[index] + INDEX_2);
/*   595 */    (void)memcpy(productCode, &g_modbusRxBuff[index+1], g_modbusRxBuff[index]);
/*   596 */    productCode[g_modbusRxBuff[index]] = 0;
/*   597 */    index += (g_modbusRxBuff[index] + INDEX_2);
/*   599 */    (void)memcpy(hardwarVersion, &g_modbusRxBuff[index+1], g_modbusRxBuff[index]);
/*   600 */    hardwarVersion[g_modbusRxBuff[index]] = 0;
/*   601 */    index += (g_modbusRxBuff[index] + INDEX_2);
/*   603 */    (void)memcpy(softwareVersion, &g_modbusRxBuff[index+1], g_modbusRxBuff[index]);
/*   604 */    softwareVersion[g_modbusRxBuff[index]] = 0;
/*   606 */    (void)printf("serial=%s, code=%s, hVer=%s, sVer=%s\n", serialNo, productCode, hardwarVersion, softwareVersion);
/*   607 */ }
/*   644 */ static unsigned char ModbusRecvCheck(void)
/*   645 */ {
/*   647 */    OS_Delay(1);
/*   648 */    uint32_t startTimer = HAL_GetTick();
/*   649 */    while(1)
/*   650 */    {
/*   651 */       if (g_modbusRxDone)
/*   652 */       {
/*   653 */          unsigned char ret = ModbusCRCCheck();
/*   654 */          g_modbusRxDone = 0;
/*   655 */          g_modbusRxError = 0;
/*   656 */          if(ret == MODBUS_OK)
/*   657 */          {
/*   658 */             (void)printf("CRC OK\n");
/*   659 */             return CONTROL_OK;
/*   660 */          }
/*   661 */          else
/*   662 */          if(ret == MODBUS_ERROR)
/*   663 */          {
/*   664 */             (void)printf("Modbus Error\n");
/*   665 */          }
/*   666 */          else
/*   667 */          if(ret == MODBUS_CRC_ERROR)
/*   668 */          {
/*   669 */             (void)printf("CRC BAD\n");
/*   670 */          }
/*   671 */          else {}
/*   672 */          return CONTROL_FAIL;
/*   673 */       }
/*   674 */       uint32_t timer = HAL_GetTick();
/*   675 */       uint32_t diff = timer-startTimer;
/*   676 */       if(diff >= 1000)
/*   677 */       {
/*   678 */          (void)printf("Time Out....\n");
/*   679 */          break;
/*   680 */       }
/*   681 */       OS_Delay(1);
/*   683 */    }
/*   684 */    return CONTROL_FAIL;
/*   685 */ }
/*   688 */ unsigned char ModbusControl(const unsigned char address, const int offset, const int pos, const unsigned char onoffStatus, unsigned char bSBO)
/*   689 */ {
/*   690 */    unsigned char frame[8];
/*   691 */    unsigned short startAddr;
/*   692 */    unsigned char ret;
/*   694 */    g_functionCode = INDEX_5;
/*   696 */    if(mLinkMode[gDeviceIndex] == 1)
/*   697 */    {
/*   698 */       if(bSBO == 1)
/*   699 */       {
/*   700 */          startAddr = (pos * INDEX_4) + offset;
/*   701 */          if(onoffStatus == 1)
/*   702 */          {
/*   703 */             startAddr += INDEX_2;
/*   704 */          }
/*   705 */       }
/*   706 */       else
/*   707 */       {
/*   708 */          startAddr = (pos * INDEX_2) + offset;
/*   709 */          if(onoffStatus == 1)
/*   710 */          {
/*   711 */             startAddr++;
/*   712 */          }
/*   713 */       }
...
/*   717 */       if(bSBO == 1)
/*   718 */       {
/*   719 */          startAddr = (pos * INDEX_2) + offset;
/*   720 */       }
/*   721 */       else
/*   722 */       {
/*   723 */          startAddr = pos + offset;
/*   724 */       }
/*   725 */    }
/*   726 */    (void)printf("ModbusControl : address:%d, offset:%d, pos=%d, onoffStatus = %d, bSBO=%d\n", address, offset, pos, onoffStatus, bSBO);
/*   727 */    frame[INDEX_0] = address;
/*   728 */    frame[INDEX_1] = INDEX_5;
/*   729 */    frame[INDEX_2] = (unsigned char)(startAddr >> INDEX_8);
/*   730 */    frame[INDEX_3] = (unsigned char)(startAddr & 0xff);
/*   731 */    frame[INDEX_4] = 0xff;
/*   732 */    frame[INDEX_5] = 0x00;
/*   734 */    unsigned short crc = CRC16(frame, INDEX_6);
/*   736 */    frame[INDEX_6] = (unsigned char) (crc >> INDEX_8);
/*   737 */    frame[INDEX_7] = (unsigned char)(crc & 0xff);
/*   739 */    (void)printf("Send Frame!!!\n");
/*   740 */    for(int i = 0; i < INDEX_8; i++)
/*   741 */    {
/*   742 */       (void)printf("%02X ", frame[i]);
/*   743 */    }
/*   744 */    (void)printf("\n");
/*   746 */    g_subFunction = 0;
/*   747 */    g_wModbusWaitLen = 8;
/*   748 */    g_bRecvVariable = 0;
/*   749 */    (void)HAL_UART_Transmit(&huart2, frame, INDEX_8, 0xFFFF);
/*   750 */    sendFlag = 1;
/*   752 */    ret = ModbusRecvCheck();
/*   753 */    if(ret == CONTROL_FAIL)
/*   754 */    {
/*   755 */       return ret;
/*   756 */    }
/*   757 */    (void)printf("control ok...\n");
/*   758 */    if(bSBO == 1)
/*   759 */    {
/*   760 */       startAddr++;
/*   762 */       frame[INDEX_0] = address;
/*   763 */       frame[INDEX_1] = INDEX_5;
/*   764 */       frame[INDEX_2] = (unsigned char)(startAddr >> INDEX_8);
/*   765 */       frame[INDEX_3] = (unsigned char)(startAddr & 0xff);
/*   766 */       frame[INDEX_4] = 0xff;
/*   767 */       frame[INDEX_5] = 0x00;
/*   769 */       crc = CRC16(frame, INDEX_6);
/*   771 */       frame[INDEX_6] = (unsigned char) (crc >> INDEX_8);
/*   772 */       frame[INDEX_7] = (unsigned char)(crc & 0xff);
/*   774 */       (void)printf("Send Frame!!!\n");
/*   775 */       for(int i = 0; i < INDEX_8; i++)
/*   776 */       {
/*   777 */          (void)printf("%02X ", frame[i]);
/*   778 */       }
/*   779 */       (void)printf("\n");
/*   781 */       g_subFunction = 0;
/*   782 */       g_wModbusWaitLen = INDEX_8;
/*   783 */       g_bRecvVariable = 0;
/*   784 */       (void)HAL_UART_Transmit(&huart2, frame, INDEX_8, 0xFFFF);
/*   785 */       sendFlag = 1;
/*   787 */       ret = ModbusRecvCheck();
/*   788 */       if(ret == CONTROL_FAIL)
/*   789 */       {
/*   790 */          return ret;
/*   791 */       }
/*   792 */    }
/*   793 */    (void)printf("control ok...\n");
/*   794 */    return CONTROL_OK;
/*   795 */ }
/*   797 */ void ModbusSetTime(const unsigned char address, const S_DATE_TIME *dateTime)
/*   798 */ {
/*   799 */    unsigned char frame[20];
/*   800 */    unsigned short mSec = (unsigned short)dateTime->Sec * 1000;
/*   801 */    frame[INDEX_0] = address;
/*   802 */    frame[INDEX_1] = 0x2b;
/*   803 */    frame[INDEX_2] = 0x10;
/*   804 */    frame[INDEX_3] = 0;
/*   805 */    frame[INDEX_4] = 0;
/*   806 */    frame[INDEX_5] = (unsigned char)(dateTime->Year-2000);
/*   807 */    frame[INDEX_6] = dateTime->Month;
/*   808 */    frame[INDEX_7] = dateTime->Day;
/*   809 */    frame[INDEX_8] = dateTime->Hour;
/*   810 */    frame[INDEX_9] = dateTime->Min;
/*   811 */    frame[INDEX_10] = (unsigned char)(mSec >> INDEX_8);
/*   812 */    frame[INDEX_11] = (unsigned char)(mSec & 0xff);
/*   814 */    unsigned short crc = CRC16(frame, INDEX_12);
/*   816 */    frame[INDEX_12] = (unsigned char) (crc >> INDEX_8);
/*   817 */    frame[INDEX_13] = (unsigned char)(crc & 0xff);
/*   819 */    (void)printf("ModbusSetTime Send Frame!!!\n");
/*   820 */    for(int i = 0; i < INDEX_14; i++)
/*   821 */    {
/*   822 */       (void)printf("%02X ", frame[i]);
/*   823 */    }
/*   824 */    (void)printf("\n");
/*   826 */    g_bRecvVariable = 0;
/*   827 */    (void)HAL_UART_Transmit(&huart2, frame, INDEX_14, 0xFFFF);
/*   828 */    g_subFunction = 0;
/*   829 */    sendFlag = 1;
/*   831 */ }
/*   833 */ void ModbusSetTimeAndWait(const unsigned char address, const S_DATE_TIME *dateTime)
/*   834 */ {
/*   835 */    ModbusSetTime(address, dateTime);
/*   836 */    g_wModbusWaitLen = INDEX_14;
/*   837 */    (void)ModbusRecvCheck();
/*   838 */ }
/*   844 */ void ModbusAcbSystemEventGet(S_DATE_TIME *dateTime, unsigned short *mainCategory, unsigned short *middleCategory, unsigned short *smallCategory, unsigned short *Status, float *Value)
/*   845 */ {
/*   846 */    unsigned short mSec;
/*   848 */    unsigned short offset = INDEX_5;
/*   850 */    *mainCategory = (g_modbusRxBuff[offset] & 0xf0) >> INDEX_4;
/*   855 */    *middleCategory = ((g_modbusRxBuff[offset] & 0x0f) << INDEX_2) | ((g_modbusRxBuff[offset+1] & 0xc0) >> INDEX_6);
/*   856 */    *smallCategory = (g_modbusRxBuff[offset+1] & 0x3f);
/*   858 */    offset += INDEX_2;
/*   859 */    gReadIndex = (unsigned short)((g_modbusRxBuff[offset] & 0x07) << INDEX_8) | g_modbusRxBuff[offset+1];
/*   861 */    offset += INDEX_3;
/*   863 */    dateTime->Year = (unsigned short)g_modbusRxBuff[offset++] + 2000;
/*   864 */    dateTime->Month = g_modbusRxBuff[offset++];
/*   865 */    dateTime->Day = g_modbusRxBuff[offset++];
/*   866 */    dateTime->Hour = g_modbusRxBuff[offset++];
/*   867 */    dateTime->Min = g_modbusRxBuff[offset++];
/*   868 */    mSec = (unsigned short)(((unsigned short)(g_modbusRxBuff[offset]) << INDEX_8) | g_modbusRxBuff[offset+1]);
/*   869 */    dateTime->Sec = (unsigned short)(mSec / 1000);
/*   870 */    dateTime->mSec = (unsigned short)(mSec % 1000);
/*   872 */    offset += INDEX_2;
/*   874 */    *Status = ((unsigned short)g_modbusRxBuff[offset] << INDEX_8) | g_modbusRxBuff[offset+1];
/*   876 */    offset += INDEX_2;
/*   880 */    unsigned char val[INDEX_4];
/*   881 */    float *fValue;
/*   883 */    fValue = (float *)val;
/*   892 */    val[INDEX_3] = g_modbusRxBuff[offset++];
/*   893 */    val[INDEX_2] = g_modbusRxBuff[offset++];
/*   894 */    val[INDEX_1] = g_modbusRxBuff[offset++];
/*   895 */    val[INDEX_0] = g_modbusRxBuff[offset];
/*   897 */    *Value = *fValue;
/*   898 */    (void)printf("mSec=%d,(%d, %d)(%04x, %f)\n\n\n\n\n", mSec, dateTime->Sec, dateTime->mSec, *Status, *Value);
/*   900 */ } 
