...
/*
 * C:/CodeInspection/DisplayUnit/STemWin/App/AcbMccbEvent.c
 */
/*    34 */ static void BaseDisp2(float value, char* mks, const char*baseUnit, char result[100]);
/*    35 */ static void DispFormat2(float value, const char* baseUnit, char result[100]);
/*    36 */ static void EventMenuDisp(int pos);
/*    37 */ static void EventMenu(int pos);
/*    39 */ static void BaseDisp2(float value, char* mks, const char*baseUnit, char result[100])
/*    40 */ {
/*    41 */    int point;
/*    42 */    char format[20];
/*    43 */    float v = fabs(value);
/*    45 */    if(v < 10)
/*    46 */    {
/*    47 */       point = INDEX_3;
/*    48 */    }
...
/*    61 */       point = INDEX_0;
/*    62 */    }
/*    63 */    (void)sprintf(format, "%%5.%df %s%s", point, mks, baseUnit);
/*    64 */    (void)sprintf(result, format, value);
/*    65 */ }
/*    67 */ static void DispFormat2(float value, const char* baseUnit, char result[100])
/*    68 */ {
/*    69 */    float v = fabs(value);
/*    70 */    if(v < 1000)
/*    71 */    {
/*    72 */       BaseDisp2(value, "", baseUnit, result);
/*    73 */       return;
/*    74 */    }
/*    75 */    value = value / 1000;
/*    76 */    v = v / 1000;
/*    77 */    if(v < 1000)
/*    78 */    {
/*    79 */       BaseDisp2(value, "k", baseUnit, result);
/*    80 */       return;
/*    81 */    }
/*    82 */    value = value / 1000;
/*    83 */    v = v / 1000;
/*    84 */    if(v < 1000)
/*    85 */    {
/*    86 */       BaseDisp2(value, "M", baseUnit, result);
/*    87 */       return;
/*    88 */    }
/*    89 */    value = value / 1000;
/*    90 */    v = v / 1000;
/*    91 */    if(v < 1000)
/*    92 */    {
/*    93 */       BaseDisp2(value, "G", baseUnit, result);
/*    94 */       return;
/*    95 */    }
/*    96 */ }
/*    99 */ void EventSend(int bEvent)
/*   100 */ {
/*   101 */    unsigned short SendIndex;
/*   103 */    if(bEvent == 1)
/*   104 */    {
/*   105 */       (void)printf("Event Send.....\n");
/*   106 */       unsigned char fileNo = 0x64;
/*   107 */       if(nMenuPos)
/*   108 */       {
/*   109 */          fileNo = 0x65;
/*   110 */       }
/*   111 */       if(nCurrIndex <= nEventIndex)
/*   112 */       {
/*   113 */          SendIndex = (nEventIndex - nCurrIndex) + 1;
/*   114 */       }
/*   115 */       else
/*   116 */       {
/*   117 */          SendIndex = nEventTotal - (nCurrIndex - nEventIndex - 1);
/*   118 */       }
/*   119 */       CommTimerClear();
/*   120 */       (void)printf("\n\n\n\n\n\nIndex=%d=> Send=%d\n\n\n\n\n\n\n\n", nCurrIndex, SendIndex);
/*   121 */       ModbusSendFrameEvent(ConnectSetting[gDeviceIndex].Address, fileNo, SendIndex);
/*   122 */       gStatusSendEnd = STATUS_SEND_END;
/*   123 */    }
/*   124 */    else
/*   125 */    if(StatusSend() == STATUS_SEND_ING)
/*   126 */    {
/*   127 */       return;
/*   128 */    }
/*   129 */    else
...
/*   131 */    }
/*   132 */ }
/*   135 */ void EventDataRecv(void)
/*   136 */ {
/*   137 */    (void)printf("EventDataRecv\n");
/*   138 */    gStatusSendEnd = STATUS_SEND_ING;
/*   139 */    char buf[4][100];
/*   141 */    unsigned short mainCategory;
/*   142 */    unsigned short middleCategory;
/*   143 */    unsigned short smallCategory;
/*   144 */    S_DATE_TIME dateTime;
/*   145 */    unsigned short Status;
/*   146 */    float Value;
/*   148 */    GUI_SetBkColor(0x1c1b1a);
/*   149 */    GUI_ClearRect(10+1, 88+1, (10 + 460)-INDEX_2, ((88 + 222) - 1)-1);
/*   151 */    ModbusAcbSystemEventGet(&dateTime, &mainCategory, &middleCategory, &smallCategory, &Status, &Value);
/*   152 */    (void)printf("\n\n\n Event(%d, %d, %d,  =>%d\n\n\n", mainCategory, middleCategory, smallCategory, Status);
/*   153 */    (void)sprintf(buf[0], "%04d-%02d-%02d %02d:%02d:%02d.%03d", dateTime.Year, dateTime.Month, dateTime.Day, dateTime.Hour, dateTime.Min, dateTime.Sec, dateTime.mSec);
/*   154 */    if(nMenuPos == 0)
/*   155 */    {
/*   156 */       (void)strcpy(buf[1], acSystemEventMainMsg[SettingValue[SETUP_LANGUAGE]][mainCategory]);
/*   157 */       if(mainCategory == 2)
/*   158 */       {
/*   159 */          if((middleCategory >= 5) || (smallCategory >= 36))
/*   160 */          {
/*   161 */             return;
/*   162 */          }
/*   163 */          (void)strcpy(buf[INDEX_2], acSystemEventStatusChange[SettingValue[SETUP_LANGUAGE]][middleCategory]);
/*   164 */          (void)strcpy(buf[INDEX_3], acSystemEventStatusChangeSmall[SettingValue[SETUP_LANGUAGE]][middleCategory][smallCategory]);
/*   165 */       }
/*   166 */       else
/*   167 */       if(mainCategory == 3)
/*   168 */       {
/*   169 */          if((middleCategory >= 4) || (smallCategory >= 32))
/*   170 */          {
/*   171 */             return;
/*   172 */          }
/*   173 */          (void)strcpy(buf[INDEX_2], acSystemEventSettingChange[SettingValue[SETUP_LANGUAGE]][middleCategory]);
/*   174 */          (void)strcpy(buf[INDEX_3], acSystemEventSettingChangeSmall[SettingValue[SETUP_LANGUAGE]][middleCategory][smallCategory]);
/*   175 */       }
/*   176 */       else
/*   177 */       if(mainCategory == 6)
/*   178 */       {
/*   179 */          if(smallCategory >= 28)
/*   180 */          {
/*   181 */             return;
/*   182 */          }
/*   183 */          (void)strcpy(buf[INDEX_2], acSystemEventSystemChange[SettingValue[SETUP_LANGUAGE]][middleCategory]);
/*   184 */          (void)strcpy(buf[INDEX_3], acSystemEventSystemChangeSmall[SettingValue[SETUP_LANGUAGE]][middleCategory][smallCategory]);
/*   185 */       }
/*   186 */       else
/*   187 */       {
/*   188 */          return;
...
/*   192 */    if(nMenuPos == 1)
/*   193 */    {
/*   194 */       (void)printf("%d, %d, %s, %x, %f\n", middleCategory, 30, acFaultMiddleMsg[SettingValue[SETUP_LANGUAGE]][middleCategory], Status, Value);
/*   195 */       if(middleCategory < 30)
/*   196 */       {
/*   197 */          (void)strcpy(buf[1], acFaultMiddleMsg[SettingValue[SETUP_LANGUAGE]][middleCategory]);
/*   198 */       }
/*   199 */       else
/*   200 */       {
/*   201 */          return;
...
/*   204 */       int source=0;
/*   205 */       int phase=0;
/*   207 */       source = (Status & 0x000f);
/*   232 */       phase = (Status & 0x0f00) >> INDEX_8;
/*   233 */       if(phase > INDEX_8)
/*   234 */       {
/*   235 */          phase = 0;
/*   236 */       }
/*   237 */       if((phase ==0) || (phase == INDEX_7))
/*   238 */       {
/*   239 */          (void)sprintf(buf[INDEX_2], "%s", acFaultSource[source]);
/*   240 */       }
/*   241 */       else
/*   242 */       {
/*   243 */          (void)sprintf(buf[INDEX_2], "%s - %s", acFaultPhase[SettingValue[SETUP_LANGUAGE]][phase], acFaultSource[source]);
/*   244 */       }
/*   245 */       DispFormat2(Value, acFaultUnit[source], buf[INDEX_3]);
/*   246 */    }
/*   247 */    else {}
/*   249 */    LanguageSelect(FONT24B);
/*   250 */    GUI_SetColor(0x00FFFFFF);
/*   251 */    GUI_RECT rect;
/*   252 */    rect.x0 = 36;
/*   253 */    rect.y0 = 106;
/*   254 */    rect.x1 = (10 + 460) - 1;
/*   255 */    rect.y1 = (106 + 44) - 1;
/*   256 */    for(int i = 0 ; i < 4; i++)
/*   257 */    {
/*   258 */       GUI_DispStringInRect(buf[i], &rect, (0) | (3<<2));
/*   259 */       rect.y0 += 44;
/*   260 */       rect.y1 += 44;
/*   261 */    }
/*   262 */    if(gReadIndex <= nEventIndex)
/*   263 */    {
/*   264 */       nCurrIndex = (nEventIndex - gReadIndex) + 1;
/*   265 */    }
/*   266 */    else
/*   267 */    {
/*   268 */       nCurrIndex = nEventTotal - (gReadIndex - nEventIndex - 1);
/*   269 */    }
/*   270 */    CountDisp(nEventTotal, nCurrIndex);
/*   283 */ }
/*   285 */ static void EventMenuDisp(int pos)
/*   286 */ {
/*   287 */    GUI_SetBkColor(0x1c1b1a);
/*   289 */    (void)GUI_SetPenSize(2);
/*   290 */    GUI_SetColor(0x494440);
/*   292 */    GUI_ClearRect(0, 34, 480-1, 320-1);
/*   293 */    GUI_DrawRect(10, 88, (10 + 460)-1, ((88 + 222) - 1));
/*   295 */    if(pos == 0)
/*   296 */    {
/*   297 */       nEventIndex = gSystemEventIndex[gDeviceIndex];
/*   298 */       nEventTotal = gSystemEventTotalCount[gDeviceIndex];
/*   299 */    }
/*   300 */    else
/*   301 */    if(pos == 1)
/*   302 */    {
/*   303 */       nEventIndex = gFaultEventIndex[gDeviceIndex];
/*   304 */       nEventTotal = gFaultEventTotalCount[gDeviceIndex];
/*   305 */    }
/*   306 */    else {}
/*   312 */    if(gCommStatus[gDeviceIndex])
/*   313 */    {
/*   314 */       if(nEventTotal == 0)
/*   315 */       {
/*   316 */          nCurrIndex = 0;
/*   317 */       }
/*   318 */       CountDisp(nEventTotal, nCurrIndex);
/*   319 */    }
/*   321 */    GUI_SetColor(0xc8c8c8);
/*   322 */    GUI_RECT rect;
/*   323 */    rect.x0 = 36;
/*   324 */    rect.y0 = 57;
/*   325 */    rect.x1 = ((36 + 154) - 1);
/*   326 */    rect.y1 = ((57 + 24) - 1);
/*   327 */    LanguageSelect(FONT24);
/*   328 */    GUI_DispStringInRect(_acinfo_menu_text[SettingValue[SETUP_LANGUAGE]][1][pos], &rect, (0) | (3<<2));
/*   340 */ }
/*   342 */ static void EventMenu(int pos)
/*   343 */ {
/*   344 */    int bCommError = gCommStatus[gDeviceIndex];
/*   345 */    int flagBreak = 0;
/*   346 */    nCurrIndex = 1;
/*   347 */    EventMenuDisp(pos);
/*   349 */    (void)printf("\n\n\n EventMenu\n\n\n\n");
/*   350 */    if(nEventTotal != 0)
/*   351 */    {
/*   353 */       (void)EventSend(1);
/*   354 */    }
/*   356 */    while (1)
/*   357 */    {
/*   358 */       E_KEY key = GetKey();
/*   360 */       if(key == TIME_OUT)
/*   361 */       {
/*   362 */          if(gOldFaultEventIndex[gDeviceIndex] != gFaultEventIndex[gDeviceIndex])
/*   363 */          {
/*   364 */             if(pos == 1)
/*   365 */             {
/*   366 */                nEventIndex = gFaultEventIndex[gDeviceIndex];
/*   367 */                nEventTotal = gFaultEventTotalCount[gDeviceIndex];
/*   368 */                EventMenuDisp(pos);
/*   369 */                gOldFaultEventIndex[gDeviceIndex] = gFaultEventIndex[gDeviceIndex];
/*   370 */                nCurrIndex = 1;
/*   371 */                bEventSend = 1;
/*   372 */                FaultCountWrite();
/*   373 */             }
/*   374 */          }
/*   375 */          (void)printf("TIME_OUT......\n");
/*   376 */          nSendStep = 0;
/*   377 */          statusSendStep = 0;
/*   378 */          gStatusSendEnd = STATUS_SEND_ING;
/*   379 */          (void)EventSend(0);
/*   380 */       }
/*   381 */       else
/*   382 */       if(key == KEY_SETUP)
/*   383 */       {
/*   384 */          if(Setup() == SETUP_CHANGED)
/*   385 */          {
/*   386 */             flagBreak = 1;
/*   387 */          }
/*   388 */          EventMenuDisp(pos);
/*   389 */          (void)EventSend(1);
/*   390 */       }
/*   391 */       else
/*   392 */       if(key == KEY_UP)
/*   393 */       {
/*   394 */          if(nEventTotal == 0)
/*   395 */          {
/*   396 */             continue;
/*   397 */          }
/*   398 */          if(nCurrIndex < nEventTotal)
/*   399 */          {
/*   400 */             nCurrIndex++;
/*   401 */          }
/*   402 */          else
...
/*   404 */             nCurrIndex = 1;
/*   405 */          }
/*   406 */          (void)EventSend(1);
/*   407 */          CountDisp(nEventTotal, nCurrIndex);
/*   408 */       }
/*   409 */       else
/*   410 */       if(key == KEY_DOWN)
/*   411 */       {
/*   412 */          if(nEventTotal == 0)
/*   413 */          {
/*   414 */             continue;
/*   415 */          }
/*   416 */          if(nCurrIndex > 1)
...
/*   420 */          else
/*   421 */          {
/*   422 */             nCurrIndex = nEventTotal;
/*   423 */          }
/*   424 */          (void)EventSend(1);
/*   425 */          CountDisp(nEventTotal, nCurrIndex);
/*   426 */       }
/*   427 */       else
/*   428 */       if(key == DATA_RECV)
/*   429 */       {
/*   430 */          if(bCommError == COMM_ERROR)
/*   431 */          {
/*   432 */             if(pos == 0)
/*   433 */             {
/*   434 */                nEventTotal = gSystemEventTotalCount[gDeviceIndex];
/*   435 */             }
/*   436 */             else
/*   437 */             {
/*   438 */                nEventTotal = gFaultEventTotalCount[gDeviceIndex];
/*   439 */             }
/*   440 */             nCurrIndex = 1;
/*   441 */             bCommError = COMM_OK;
/*   442 */             if(nEventTotal != 0)
/*   443 */             {
/*   444 */                gStatusSendEnd = STATUS_SEND_END;
/*   445 */                (void)EventSend(1);
/*   446 */                continue;
/*   447 */             }
/*   448 */             else
/*   449 */             {
/*   450 */                EventMenuDisp(pos);
/*   451 */             }
/*   452 */          }
/*   453 */          if(gStatusSendEnd == STATUS_SEND_ING)
/*   454 */          {
/*   455 */             StatusRecv();
/*   456 */             if(gStatusSendEnd == STATUS_SEND_ING)
/*   457 */             {
/*   458 */                (void)EventSend(0);
/*   459 */             }
/*   460 */             else
/*   461 */             {
/*   462 */                (void)printf("All done!!!\n");
/*   463 */                g_bRecvAllDone = 1;
/*   464 */                nSendStep = 0;
/*   465 */                statusSendStep = 0;
/*   466 */                gStatusSendEnd = STATUS_SEND_ING;
/*   467 */             }
/*   468 */          }
/*   469 */          else
/*   470 */          {
/*   471 */             (void)printf("All done!!!\n");
/*   472 */             EventDataRecv();
/*   473 */             g_bRecvAllDone = 1;
/*   474 */             nSendStep = 0;
/*   475 */             statusSendStep = 0;
/*   476 */             gStatusSendEnd = STATUS_SEND_ING;
/*   477 */          }
/*   478 */       }
/*   479 */       else
/*   480 */       if(key == KEY_CANCEL)
/*   481 */       {
/*   482 */          flagBreak = 1;
/*   483 */       }
/*   484 */       else
/*   485 */       if(key == KEY_COMM_ERROR)
/*   486 */       {
/*   487 */          (void)printf("COMM Error!!! gStatusSendEnd=%d, statusSendStep=%d, nSendStep=%d\n",gStatusSendEnd,statusSendStep,nSendStep);
/*   488 */          if(StatusRecvErrorProcess() == STATUS_SEND_ING)
/*   489 */          {
/*   490 */             nSendStep = 0;
/*   491 */          }
/*   492 */          else
/*   493 */          {
/*   494 */             g_bRecvAllDone = 1;
/*   495 */             (void)printf("All done!!!\n");
/*   496 */             gStatusSendEnd = STATUS_SEND_ING;
/*   497 */             statusSendStep = 0;
/*   498 */             nSendStep = 0;
/*   499 */          }
/*   500 */       }
/*   501 */       else
/*   502 */       if(key == COMM_STAT_ERROR)
/*   503 */       {
/*   504 */          bCommError = COMM_ERROR;
/*   505 */          nEventTotal = 0;
/*   506 */          EventMenuDisp(pos);
/*   507 */          gStatusSendEnd = STATUS_SEND_ING;
/*   508 */          statusSendStep = 0;
/*   509 */          nSendStep = 0;
/*   510 */       }
/*   511 */       else {}
/*   512 */       if(flagBreak == 1)
...
/*   516 */    }
/*   517 */ }
/*   533 */ void AcbMccbEvent(void)
/*   534 */ {
/*   535 */    int flagBreak = 0;
/*   536 */    nMenuPos = 0;
/*   538 */    GUI_ClearRect(0, 34, 480-1, 320-1);
/*   539 */    InfoMenu(1, nMenuPos, 2);
/*   543 */    nSendStep = 0;
/*   545 */    while (1)
/*   546 */    {
/*   547 */       E_KEY key = GetKey();
/*   549 */       if(key == TIME_OUT)
/*   550 */       {
/*   551 */          nSendStep = 0;
/*   552 */          statusSendStep = 0;
/*   553 */          gStatusSendEnd = STATUS_SEND_ING;
/*   554 */          (void)StatusSend();
/*   555 */       }
/*   556 */       else
/*   557 */       if(key == KEY_SETUP)
/*   558 */       {
/*   559 */          if(Setup() == SETUP_CHANGED)
/*   560 */          {
/*   561 */             flagBreak = 1;
/*   562 */          }
/*   563 */          GUI_ClearRect(0, 34, 480-1, 320-1);
/*   564 */          InfoMenu(1, nMenuPos, 2);
/*   565 */          gCommOldStatus[gDeviceIndex] = -1;
/*   566 */       }
/*   567 */       else
/*   568 */       if(key == KEY_UP)
/*   569 */       {
...
/*   589 */             nMenuPos = 0;
/*   590 */          }
/*   591 */          InfoMenu(1, nMenuPos, 2);
/*   592 */       }
/*   593 */       else
/*   594 */       if(key == KEY_ENTER)
/*   595 */       {
/*   596 */          if((nMenuPos == 1) && (gOldFaultEventIndex[gDeviceIndex] != gFaultEventIndex[gDeviceIndex]))
/*   597 */          {
/*   598 */             gOldFaultEventIndex[gDeviceIndex] = gFaultEventIndex[gDeviceIndex];
/*   599 */             FaultCountWrite();
/*   600 */          }
/*   601 */          EventMenu(nMenuPos);
/*   602 */          InfoMenu(1, nMenuPos, 2);
/*   603 */       }
/*   604 */       else
/*   605 */       if(key == DATA_RECV)
/*   606 */       {
/*   607 */          (void)printf("DATA_RECV\n");
/*   608 */          StatusRecv();
/*   609 */          if(gStatusSendEnd == STATUS_SEND_ING)
/*   610 */          {
/*   611 */             (void)EventSend(0);
/*   612 */          }
/*   613 */          else
/*   614 */          {
/*   615 */             g_bRecvAllDone = 1;
/*   616 */             (void)printf("All done!!!\n");
/*   617 */             nSendStep = 0;
/*   618 */             statusSendStep = 0;
/*   619 */             gStatusSendEnd = STATUS_SEND_ING;
/*   620 */          }
/*   621 */       }
/*   622 */       else
/*   623 */       if(key == KEY_CANCEL)
/*   624 */       {
/*   625 */          flagBreak = 1;
/*   626 */       }
/*   627 */       else
/*   628 */       if(key == KEY_COMM_ERROR)
/*   629 */       {
/*   630 */          (void)printf("COMM Error!!! gStatusSendEnd=%d, statusSendStep=%d, nSendStep=%d\n",gStatusSendEnd,statusSendStep,nSendStep);
/*   631 */          if(StatusRecvErrorProcess() == STATUS_SEND_ING)
/*   632 */          {
/*   633 */             nSendStep = 0;
/*   634 */          }
/*   635 */          else
/*   636 */          {
/*   637 */             g_bRecvAllDone = 1;
/*   638 */             (void)printf("All done!!!\n");
/*   639 */             gStatusSendEnd = STATUS_SEND_ING;
/*   640 */             statusSendStep = 0;
/*   641 */             nSendStep = 0;
/*   642 */          }
/*   643 */       }
/*   644 */       else {}
