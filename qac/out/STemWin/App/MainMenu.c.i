...
/*
 * C:/PRQA/QAC-8.1.2-R/include/ansi/math.h
 */
/*     6 */ extern double acos(double x),
/*     7 */ asin(double x),
/*     8 */ atan(double x),
/*     9 */ atan2(double y, double x),
/*    10 */ cos(double x),
/*    11 */ sin(double x),
/*    12 */ tan(double x),
/*    13 */ cosh(double x),
...
/*    15 */ tanh(double x),
/*    16 */ exp(double x),
/*    17 */ frexp(double value, int *exp),
/*    18 */ ldexp(double x, int exp),
/*    19 */ log(double x),
/*    20 */ log10(double x),
/*    21 */ modf(double value, double *iptr),
/*    22 */ pow(double x, double y),
/*    23 */ sqrt(double x),
/*    24 */ ceil(double x),
/*    25 */ fabs(double x),
/*    26 */ floor(double x),
...
/*
 * C:/CodeInspection/DisplayUnit/STemWin/App/MainMenu.c
 */
/*    37 */ static void AcbMccbOverView(void);
/*    38 */ static void AcbMccbOverViewValue(int flag);
/*    39 */ static void PageDisp(int page);
/*    40 */ static void CommStatusDisp(void);
/*    41 */ static void Overview(int newDisp);
/*    42 */ static void ScreenTimerInit(void);
/*    43 */ static uint32_t GetTimerDiff(void);
/*    46 */ static unsigned char gTimeSyncDay;
/*    48 */ static unsigned char KeyChanged[5];
/*    67 */ static float gLrValue[8];
/*    68 */ static float gLnrValue[8];
/*    69 */ static float gLnValue[8];
/*    70 */ static float gNPHASE_PROTECTION_Value[8];
/*    72 */ int gAmpareFrame[8];
/*    73 */ static uint32_t commTimer;
/*    74 */ static uint32_t readTimeTimer;
/*    82 */ void
/*    83 */ LanguageSelect(E_FONT_SIZE size)
/*    84 */ {
/*    85 */    if(SettingValue[SETUP_LANGUAGE] == CHINESE)
/*    86 */    {
/*    88 */       if((size == FONT16) || (size == FONT16B))
/*    89 */       {
/*    90 */          (void)GUI_SetFont(&GUI_FontLSfont16_);
/*    91 */       }
/*    92 */       else
/*    93 */       if(size == FONT20)
/*    94 */       {
/*    95 */          (void)GUI_SetFont(&GUI_FontLSFont20n_);
/*    96 */       }
/*    97 */       else
/*    98 */       if(size == FONT20B)
/*    99 */       {
/*   100 */          (void)GUI_SetFont(&GUI_FontLSFont20b_);
/*   101 */       }
/*   102 */       else
/*   103 */       if((size == FONT24) || (size == FONT24B))
/*   104 */       {
/*   105 */          (void)GUI_SetFont(&GUI_FontLSfont24_);
/*   106 */       }
/*   107 */       else
/*   108 */       if((size == FONT32) || (size == FONT32B))
/*   109 */       {
/*   110 */          (void)GUI_SetFont(&GUI_FontLSfont24_);
/*   111 */       }
/*   112 */       else {}
/*   113 */    }
/*   114 */    else
/*   115 */    if(SettingValue[SETUP_LANGUAGE] == RUSSIAN)
/*   116 */    {
/*   117 */       if((size == FONT16) || (size == FONT16B))
/*   118 */       {
/*   119 */          (void)GUI_SetFont(&GUI_Fontcyrillic16_16x16);
/*   120 */       }
/*   121 */       else
/*   122 */       if((size == FONT20) || (size == FONT20B))
/*   123 */       {
/*   124 */          (void)GUI_SetFont(&GUI_Fontcyrillic20_20x20);
/*   125 */       }
/*   126 */       else
/*   127 */       if((size == FONT24) || (size == FONT24B))
/*   128 */       {
/*   129 */          (void)GUI_SetFont(&GUI_Fontcyrillic_24x24);
/*   130 */       }
/*   131 */       else
/*   132 */       if((size == FONT32) || (size == FONT32B))
/*   133 */       {
/*   134 */          (void)GUI_SetFont(&GUI_Fontcyrillic_24x24);
/*   135 */       }
/*   136 */       else {}
/*   137 */    }
/*   138 */    else
...
/*   140 */       if(size == FONT16)
/*   141 */       {
/*   142 */          (void)GUI_SetFont(&GUI_Font16_ASCII);
/*   143 */       }
/*   144 */       else
/*   145 */       if(size == FONT16B)
/*   146 */       {
/*   147 */          (void)GUI_SetFont(&GUI_Font16B_ASCII);
/*   148 */       }
/*   149 */       else
/*   150 */       if(size == FONT20)
/*   151 */       {
/*   152 */          (void)GUI_SetFont(&GUI_Font20_ASCII);
/*   153 */       }
/*   154 */       else
/*   155 */       if(size == FONT20B)
/*   156 */       {
/*   157 */          (void)GUI_SetFont(&GUI_Font20B_ASCII);
/*   158 */       }
/*   159 */       else
/*   160 */       if(size == FONT24)
/*   161 */       {
/*   162 */          (void)GUI_SetFont(&GUI_Font24_ASCII);
/*   163 */       }
/*   164 */       else
/*   165 */       if(size == FONT24B)
/*   166 */       {
/*   167 */          (void)GUI_SetFont(&GUI_Font24B_ASCII);
/*   168 */       }
/*   169 */       else
/*   170 */       if(size == FONT32)
/*   171 */       {
/*   172 */          (void)GUI_SetFont(&GUI_Font32_ASCII);
/*   173 */       }
/*   174 */       else
/*   175 */       if(size == FONT32B)
/*   176 */       {
/*   177 */          (void)GUI_SetFont(&GUI_Font32B_ASCII);
/*   178 */       }
/*   179 */       else {}
/*   180 */    }
/*   181 */ }
/*   184 */ void BaseDisp(float value, char* mks, const char*baseUnit, char unit[10], char result[20])
/*   185 */ {
/*   186 */    (void)sprintf(unit, "%s%s", mks, baseUnit);
/*   187 */    (void)sprintf(result, "%5.1f", value);
/*   188 */ }
/*   191 */ void DispFormat(float value, const char* baseUnit, char unit[10], char result[20])
/*   192 */ {
/*   193 */    float v = fabs(value);
/*   194 */    if(v < 10000)
/*   195 */    {
/*   196 */       BaseDisp(value, "", baseUnit, unit, result);
/*   197 */       return;
/*   198 */    }
/*   199 */    value = value / 1000;
/*   200 */    v = (v / 1000);
/*   203 */    if(round(v) < 10000)
/*   206 */    {
/*   207 */       BaseDisp(value, "k", baseUnit, unit, result);
/*   208 */       return;
/*   209 */    }
/*   210 */    value = value / 1000;
/*   211 */    v = (v / 1000);
/*   212 */    if(round(v) < 10000)
/*   213 */    {
/*   214 */       BaseDisp(value, "M", baseUnit, unit, result);
/*   215 */       return;
/*   216 */    }
/*   217 */    value = value / 1000;
/*   218 */    v = (v / 1000);
/*   219 */    if(round(v) < 10000)
/*   220 */    {
/*   221 */       BaseDisp(value, "G", baseUnit, unit, result);
/*   222 */       return;
/*   223 */    }
/*   224 */    value = value / 1000;
/*   225 */    v = (v / 1000);
/*   226 */    if(round(v) < 10000)
/*   227 */    {
/*   228 */       BaseDisp(value, "T", baseUnit, unit, result);
/*   229 */       return;
/*   230 */    }
/*   231 */    value = value / 1000;
/*   232 */    v = (v / 1000);
/*   233 */    if(round(v) < 10000)
/*   234 */    {
/*   235 */       BaseDisp(value, "P", baseUnit, unit, result);
/*   236 */       return;
/*   237 */    }
/*   238 */    (void)sprintf(unit,"");
/*   239 */    (void)sprintf(result,"ERROR");
/*   240 */ }
/*   243 */ void DispStatus(void)
/*   244 */ {
/*   246 */    (void)GUI_SetPenSize(1);
/*   247 */    GUI_SetColor(0x2f2c2a);
/*   248 */    GUI_SetBkColor(0x2f2c2a);
/*   249 */    GUI_ClearRect(0, 0, 480-1, 34);
/*   250 */    GUI_SetColor(0x605a54);
/*   251 */    for(int i = 0; i < INDEX_3; i++)
/*   252 */    {
/*   253 */       GUI_DrawVLine(_ichstatus_line_x[i], 0, 34);
/*   254 */    }
/*   255 */ }
/*   257 */ static void AcbMccbOverView(void)
/*   258 */ {
/*   259 */    GUI_SetBkColor(0x1c1b1a);
/*   260 */    GUI_ClearRect(0, 34, 480-1, 320-1);
/*   261 */    (void)GUI_SetFont(&GUI_Font16_ASCII);
/*   262 */    if(gCommStatus[gDeviceIndex] == COMM_OK)
/*   263 */    {
/*   264 */       GUI_SetColor(0x00FFFFFF);
/*   265 */    }
/*   266 */    else
/*   267 */    {
/*   268 */       GUI_SetColor(0x494440);
/*   269 */    }
/*   271 */    GUI_RECT rect;
/*   272 */    rect.x0 = (161 - 10);
/*   273 */    rect.x1 = (((161 - 10) + 20) - 1);
/*   274 */    rect.y0 = 54;
/*   275 */    rect.y1 = ((54 + 13) - 1);
/*   276 */    GUI_DispStringInRect("50", &rect, ((2<<0) | (3<<2)));
/*   277 */    rect.x0 = (264 - 10);
/*   278 */    rect.x1 = (((264 - 10) + 20) - 1);
/*   279 */    GUI_DispStringInRect("100", &rect, ((2<<0) | (3<<2)));
/*   280 */    rect.x0 = (307 - 10);
/*   281 */    rect.x1 = (((307 - 10) + 30) - 1);
/*   282 */    GUI_DispStringInRect("120%", &rect, ((2<<0) | (3<<2)));
/*   284 */    GUI_SetColor(0x494440);
/*   285 */    (void)GUI_SetPenSize(2);
/*   286 */    GUI_DrawVLine(57, 75, ((75 + 226) - 1));
/*   287 */    GUI_DrawVLine(161, 75, ((75 + 226) - 1));
/*   288 */    GUI_DrawVLine(264, 75, ((75 + 226) - 1));
/*   289 */    GUI_DrawVLine(307, 75, ((75 + 226) - 1));
/*   291 */    (void)GUI_SetFont(&GUI_Font32B_ASCII);
/*   292 */    GUI_SetColor(0xc8c8c8);
/*   293 */    GUI_SetColor(0xc8c8c8);
/*   294 */    rect.x0 = 28;
/*   295 */    rect.y0 = 90;
/*   296 */    rect.x1 = ((28 + 20) - 1);
/*   297 */    rect.y1 = ((90 + 21) - 1);
...
/*   301 */       if(i == INDEX_3)
/*   302 */       {
/*   303 */          GUI_SetColor(0x2b2a2a);
/*   304 */       }
/*   305 */       GUI_DispStringInRect(_acPhase_Label[i], &rect, (2<<0) | (3<<2));
/*   306 */       rect.y0 += 58;
/*   307 */       rect.y1 += 58;
/*   308 */    }
/*   310 */    (void)GUI_SetFont(&GUI_Font16B_1);
/*   311 */    int y0 = 84;
/*   312 */    int y1 = ((84 + 35) - 1);
...
/*   315 */       int x0 = 61;
/*   316 */       int x1 = ((61 + 18) - 1);
/*   317 */       for(int j = 0; j < INDEX_12; j++)
/*   318 */       {
/*   319 */          GUI_FillRect(x0, y0, x1, y1);
/*   320 */          x0 += 20;
/*   321 */          x1 += 20;
/*   322 */          if((j == INDEX_4) || (j ==INDEX_9))
/*   323 */          {
/*   324 */             x0 += INDEX_3;
/*   325 */             x1 += INDEX_3;
/*   326 */          }
...
/*   330 */    }
/*   331 */ }
/*   333 */ static void AcbMccbOverViewValue(int flag)
/*   334 */ {
/*   335 */    static const GUI_COLOR _BarColor[4+1] = {
/*   336 */       0x0000ff, 0x00deff, 0x2dbe31, 0x2dbe31, 0x3a3939
/*   337 */    };
/*   338 */    static float Ampare[8][4];
/*   341 */    (void)printf("AcbMccbOverViewValue(%d) gDeviceIndex=%d, gPols[gDeviceIndex]=%d, gLrValue[gDeviceIndex]=%f \n", flag, gDeviceIndex, gPols[gDeviceIndex], gLrValue[gDeviceIndex]);
/*   342 */    if((int)gLrValue[gDeviceIndex] == 0)
/*   343 */    {
/*   344 */       return;
/*   345 */    }
/*   346 */    char buf[4][20];
/*   347 */    char unit[4][10];
/*   348 */    unsigned short barGraph[4];
/*   349 */    unsigned short barGraphPer[4];
/*   351 */    if(flag)
/*   352 */    {
/*   353 */       Ampare[gDeviceIndex][INDEX_0] = ModbusGetFloat(215);
/*   354 */       Ampare[gDeviceIndex][INDEX_1] = ModbusGetFloat(217);
/*   355 */       Ampare[gDeviceIndex][INDEX_2] = ModbusGetFloat(219);
/*   356 */       Ampare[gDeviceIndex][INDEX_3] = ModbusGetFloat(221);
/*   357 */       for(int i = 0; i < INDEX_4; i++)
/*   358 */       {
/*   359 */          (void)printf("Value %d => %f\n", i, Ampare[gDeviceIndex][i]);
/*   360 */       }
/*   361 */    }
/*   363 */    for(int i = 0; i < gPols[gDeviceIndex]; i++)
/*   364 */    {
/*   365 */       double v;
/*   366 */       {
/*   369 */          v = round((double)Ampare[gDeviceIndex][i]*10.0);
/*   372 */          Ampare[gDeviceIndex][i] = (float)(v / 10.0);
/*   373 */       }
/*   374 */       DispFormat(Ampare[gDeviceIndex][i], "A",unit[i], buf[i]);
/*   376 */       float value = (Ampare[gDeviceIndex][i] * 10);
/*   378 */       if(value < 0)
/*   379 */       {
/*   380 */          value = 0;
/*   381 */       }
/*   383 */       float compare = gLrValue[gDeviceIndex];
/*   384 */       if(i == INDEX_3)
/*   385 */       {
/*   386 */          if(ConnectSetting[gDeviceIndex].DeviceType == DEVICE_ACB)
/*   387 */          {
/*   388 */             compare = gLrValue[gDeviceIndex] * (gLnrValue[gDeviceIndex] / 100);
/*   389 */          }
/*   390 */          else
/*   391 */          {
/*   392 */             if((unsigned short)gNPHASE_PROTECTION_Value[gDeviceIndex] == INDEX_3)
/*   393 */             {
/*   394 */                compare = gLrValue[gDeviceIndex] * 0.5;
/*   395 */             }
/*   396 */             else
/*   397 */             if((unsigned short)gNPHASE_PROTECTION_Value[gDeviceIndex] == INDEX_4)
/*   398 */             {
/*   399 */                (void)printf("OSN  lr=%f, ln=%f\n", gLrValue[gDeviceIndex], gLnValue[gDeviceIndex]);
/*   400 */                if(gLrValue[gDeviceIndex] < (0.63 * gLnValue[gDeviceIndex]))
/*   401 */                {
/*   402 */                   (void)printf("Ir < 0.63In\n");
/*   403 */                   compare = gLrValue[gDeviceIndex] * 1.6;
/*   404 */                }
/*   405 */                else
/*   406 */                {
/*   407 */                }
...
/*   412 */          }
/*   413 */       }
/*   414 */       if((int)Ampare[gDeviceIndex][i] == 0)
/*   415 */       {
/*   416 */          barGraph[i] = 0;
/*   417 */       }
/*   418 */       else
/*   420 */       if(value < compare)
/*   421 */       {
/*   422 */          barGraph[i] = 1;
/*   423 */       }
/*   424 */       else
/*   425 */       {
/*   427 */          barGraph[i] = (int)(value / compare) + 1;
/*   428 */       }
/*   430 */       if((i == INDEX_3) && ((unsigned short)gNPHASE_PROTECTION_Value[gDeviceIndex] == 1))
/*   431 */       {
/*   432 */          barGraphPer[i] = 0;
/*   433 */       }
/*   453 */       else
/*   454 */       {
/*   455 */          barGraphPer[i] = (unsigned short)((Ampare[gDeviceIndex][i] * 100) / compare);
/*   456 */       }
/*   457 */    }
/*   459 */    GUI_SetBkColor(0x1c1b1a);
/*   461 */    GUI_RECT rect;
/*   462 */    GUI_RECT rect2;
/*   463 */    GUI_SetColor(0xc8c8c8);
/*   464 */    (void)GUI_SetFont(&GUI_Font32B_ASCII);
/*   465 */    rect.x0 = 28;
/*   466 */    rect.y0 = 90;
/*   467 */    rect.x1 = ((28 + 20) - 1);
/*   468 */    rect.y1 = ((90 + 21) - 1);
...
/*   471 */    {
/*   472 */       int pol = gPols[gDeviceIndex];
/*   473 */       if(pol < INDEX_3)
/*   474 */       {
/*   475 */          pol = INDEX_3;
/*   476 */       }
/*   477 */       if(i >= pol)
/*   478 */       {
/*   479 */          GUI_SetColor(0x2b2a2a);
/*   480 */       }
/*   481 */       GUI_DispStringInRect(_acPhase_Label[i], &rect, (2<<0) | (3<<2));
/*   482 */       rect.y0 += 58;
/*   483 */       rect.y1 += 58;
/*   484 */    }
/*   486 */    GUI_SetColor(0x00FFFFFF);
/*   487 */    rect.x0 = 320;
/*   488 */    rect.y0 = 90;
/*   489 */    rect.x1 = (((320 + 110) - 20) - 1);
/*   490 */    rect.y1 = ((90 + 21) - 1);
/*   492 */    rect2.x0 = ((((320 + 110) - 20) - 1) + 5);
/*   493 */    rect2.y0 = 90;
/*   494 */    rect2.x1 = ((((((320 + 110) - 20) - 1) + 5) + 40) - 1);
/*   495 */    rect2.y1 = ((90 + 21) - 1);
/*   496 */    for(int i = 0; i < gPols[gDeviceIndex]; i++)
/*   497 */    {
/*   498 */       GUI_ClearRect(rect.x0, rect.y0, rect.x1, rect.y1);
/*   499 */       (void)GUI_SetFont(&GUI_Font32B_ASCII);
/*   500 */       GUI_DispStringInRect(buf[i], &rect, (1<<0) | (3<<2));
/*   501 */       GUI_ClearRect(rect2.x0, rect2.y0, rect2.x1, rect2.y1);
/*   502 */       (void)GUI_SetFont(&GUI_Font20_ASCII);
/*   503 */       GUI_DispStringInRect(unit[i], &rect2, (0) | (2<<2));
/*   504 */       rect.y0 += 58;
/*   505 */       rect.y1 += 58;
/*   506 */       rect2.y0 += 58;
/*   507 */       rect2.y1 += 58;
...
/*   510 */    int y0 = 84;
/*   511 */    int y1 = ((84 + 35) - 1);
/*   512 */    for(int i = 0; i < gPols[gDeviceIndex]; i++)
/*   513 */    {
/*   514 */       if(barGraphPer[i] >= 105)
/*   515 */       {
/*   516 */          GUI_SetColor(_BarColor[INDEX_0]);
/*   517 */       }
/*   518 */       else
/*   519 */       if(barGraphPer[i] >= 90)
/*   520 */       {
/*   521 */          GUI_SetColor(_BarColor[INDEX_1]);
/*   522 */       }
/*   523 */       else
/*   524 */       {
/*   525 */          GUI_SetColor(_BarColor[INDEX_2]);
/*   526 */       }
/*   527 */       int x0 = 61;
/*   528 */       int x1 = ((61 + 18) - 1);
/*   529 */       for(int j = 0; j < INDEX_12; j++)
/*   530 */       {
/*   531 */          if(barGraph[i] <= j)
/*   532 */          {
/*   533 */             GUI_SetColor(_BarColor[4]);
/*   534 */          }
/*   535 */          GUI_FillRect(x0, y0, x1, y1);
/*   536 */          x0 += 20;
/*   537 */          x1 += 20;
/*   538 */          if((j == INDEX_4) || (j == INDEX_9))
/*   539 */          {
/*   540 */             x0 += INDEX_3;
/*   541 */             x1 += INDEX_3;
/*   542 */          }
...
/*   546 */    }
/*   547 */ }
/*   550 */ void OverViewValue(int flag)
/*   551 */ {
/*   552 */    if((ConnectSetting[gDeviceIndex].DeviceType == DEVICE_ACB) || (ConnectSetting[gDeviceIndex].DeviceType == DEVICE_MCCB))
/*   553 */    {
/*   554 */       AcbMccbOverViewValue(flag);
/*   555 */    }
/*   556 */    else
/*   557 */    if(ConnectSetting[gDeviceIndex].DeviceType == DEVICE_MLINK)
/*   558 */    {
/*   559 */       MLinkOverviewValue(flag);
/*   560 */    }
/*   561 */    else {}
/*   562 */ }
/*   564 */ static void PageDisp(int page)
/*   565 */ {
/*   566 */    int x = 465;
/*   567 */    int y = 121;
/*   569 */    for(int i = 0; i < gDeviceCount; i++)
/*   570 */    {
/*   571 */       if( i == page)
/*   572 */       {
/*   573 */          GUI_SetColor(0x00FFFFFF);
/*   574 */       }
/*   575 */       else
/*   576 */       {
/*   577 */          GUI_SetColor(0x494440);
/*   578 */       }
/*   579 */       GUI_FillCircle(x, y, 5);
/*   580 */       y += 16;
/*   581 */    }
/*   582 */ }
/*   584 */ static void CommStatusDisp(void)
/*   585 */ {
/*   586 */    if(g_nStatusNoUpdate == 0)
/*   587 */    {
/*   588 */       if(gCommStatus[gDeviceIndex] != gCommOldStatus[gDeviceIndex])
/*   589 */       {
/*   590 */          if(gCommStatus[gDeviceIndex] == COMM_ERROR)
/*   591 */          {
/*   592 */             DispStatus();
/*   593 */          }
/*   594 */          (void)GUI_BMP_Draw(_acImage[gCommStatus[gDeviceIndex]], _acXyPos[0], _acXyPos[1]);
/*   595 */          gCommOldStatus[gDeviceIndex] = gCommStatus[gDeviceIndex];
/*   596 */       }
/*   597 */    }
/*   598 */ }
/*   601 */ void CommTimerClear(void)
/*   602 */ {
/*   603 */    (void)printf("CommTimerClear\n");
/*   604 */    g_bRecvAllDone = 0;
/*   605 */    commTimer = HAL_GetTick();
/*   606 */ }
/*   609 */ void CommTimerInit(void)
/*   610 */ {
/*   611 */    (void)printf("CommTimerInit\n");
/*   612 */    commTimer = 0;
/*   613 */ }
/*   615 */ static void Overview(int newDisp)
/*   616 */ {
/*   617 */    if(newDisp)
/*   618 */    {
/*   619 */       DispStatus();
/*   620 */    }
/*   621 */    if((ConnectSetting[gDeviceIndex].DeviceType == DEVICE_ACB) || (ConnectSetting[gDeviceIndex].DeviceType == DEVICE_MCCB))
/*   622 */    {
/*   623 */       AcbMccbOverView();
/*   624 */    }
/*   625 */    else
/*   626 */    if(ConnectSetting[gDeviceIndex].DeviceType == DEVICE_MLINK)
/*   627 */    {
/*   628 */       MLinkOverview();
/*   629 */    }
/*   630 */    else
/*   631 */    {
/*   632 */       GUI_SetBkColor(0x1c1b1a);
/*   633 */       GUI_ClearRect(0, 34, 480-1, 320-1);
/*   634 */    }
/*   635 */    PageDisp(gDeviceIndex);
/*   636 */    gCommOldStatus[gDeviceIndex] = -1;
/*   637 */ }
/*   640 */ unsigned short StatusSend(void)
/*   641 */ {
/*   642 */    if(gStatusSendEnd == STATUS_SEND_ING)
/*   643 */    {
/*   644 */       (void)printf("\n\n\nStatusSend() statusSendStep = %d\n", statusSendStep);
/*   645 */       if(ConnectSetting[gDeviceIndex].DeviceType == DEVICE_MLINK)
/*   646 */       {
/*   647 */          if(statusSendStep == INDEX_0)
/*   648 */          {
/*   649 */             CommTimerClear();
/*   650 */             ModbusSendFrameReadTime(ConnectSetting[gDeviceIndex].Address);
/*   651 */          }
/*   652 */          else
/*   653 */          if(statusSendStep == INDEX_1)
/*   654 */          {
/*   655 */             ModbusSendFrame(ConnectSetting[gDeviceIndex].Address, INPUT_REGISTER, 1335, INDEX_16);
/*   656 */          }
/*   657 */          else
/*   658 */          if(statusSendStep == INDEX_2)
/*   659 */          {
/*   660 */             ModbusSendFrame(ConnectSetting[gDeviceIndex].Address, HOLDING_REGISTER, 2501, INDEX_16);
/*   661 */          }
/*   662 */          else
/*   663 */          if(statusSendStep == INDEX_3)
/*   664 */          {
/*   665 */             ModbusSendFrame(ConnectSetting[gDeviceIndex].Address, INPUT_REGISTER, 1004, INDEX_1);
/*   666 */          }
/*   667 */          else
/*   668 */          if(statusSendStep == INDEX_4)
/*   669 */          {
/*   670 */             ModbusSendFrame(ConnectSetting[gDeviceIndex].Address, INPUT_REGISTER, 201, INDEX_17);
/*   671 */          }
/*   672 */          else {}
/*   673 */       }
/*   674 */       else
/*   675 */       if((ConnectSetting[gDeviceIndex].DeviceType == DEVICE_ACB) || (ConnectSetting[gDeviceIndex].DeviceType == DEVICE_MCCB))
/*   676 */       {
/*   677 */          if(statusSendStep == INDEX_0)
/*   678 */          {
/*   679 */             CommTimerClear();
/*   680 */             ModbusSendFrameReadTime(ConnectSetting[gDeviceIndex].Address);
/*   681 */          }
/*   682 */          else
/*   683 */          if(statusSendStep == INDEX_1)
/*   684 */          {
/*   686 */             ModbusSendFrameDeviceIdentofocation3(ConnectSetting[gDeviceIndex].Address, INDEX_2, INDEX_3);
/*   687 */          }
/*   688 */          else
/*   689 */          if(statusSendStep == INDEX_2)
/*   690 */          {
/*   691 */             unsigned short len = 21;
/*   692 */             if(ConnectSetting[gDeviceIndex].DeviceType == DEVICE_ACB)
/*   693 */             {
/*   694 */                len = 50;
/*   695 */             }
/*   696 */             ModbusSendFrame(ConnectSetting[gDeviceIndex].Address, HOLDING_REGISTER, INDEX_1, len);
/*   697 */          }
/*   698 */          else
/*   699 */          if(statusSendStep == INDEX_3)
/*   700 */          {
/*   701 */             ModbusSendFrame(ConnectSetting[gDeviceIndex].Address, HOLDING_REGISTER, 467, INDEX_2);
/*   702 */          }
/*   703 */          else
/*   704 */          if(statusSendStep == INDEX_4)
/*   705 */          {
/*   706 */             ModbusSendFrame(ConnectSetting[gDeviceIndex].Address, INPUT_REGISTER, 194, INDEX_15);
/*   707 */          }
/*   708 */          else
/*   709 */          {
/*   710 */             statusSendStep = 0;
/*   711 */          }
/*   712 */       }
/*   713 */       else {}
/*   714 */    }
/*   715 */    return gStatusSendEnd;
/*   716 */ }
/*   719 */ unsigned short StatusRecvErrorProcess(void)
/*   720 */ {
/*   721 */    if(gStatusSendEnd == STATUS_SEND_ING)
/*   722 */    {
/*   723 */       (void)printf("StatusRecvErrorProcess()  statusSendStep = %d\n", statusSendStep);
/*   724 */       int nMaxStep;
/*   725 */       if(ConnectSetting[gDeviceIndex].DeviceType == DEVICE_MLINK)
/*   726 */       {
/*   727 */          nMaxStep = INDEX_4;
/*   728 */       }
/*   729 */       else
/*   730 */       {
/*   731 */          nMaxStep = INDEX_4;
/*   732 */       }
/*   733 */       if(statusSendStep < nMaxStep)
/*   734 */       {
/*   735 */          statusSendStep++;
/*   736 */          (void)StatusSend();
/*   737 */       }
/*   738 */       else
/*   739 */       {
/*   740 */          statusSendStep = 0;
/*   741 */          gStatusSendEnd = STATUS_SEND_END;
/*   742 */       }
/*   743 */    }
/*   744 */    return gStatusSendEnd;
/*   745 */ }
/*   748 */ void StatusRecv(void)
/*   749 */ {
/*   750 */    static unsigned short gEventMax[8];
/*   751 */    static unsigned short gFaultMax[8];
/*   753 */    char buf[60];
/*   754 */    GUI_SetBkColor(0x2f2c2a);
/*   755 */    (void)GUI_SetFont(&GUI_Font16B_ASCII);
/*   756 */    (void)printf("StatusRecv(statusSendStep=%d)\n", statusSendStep);
/*   758 */    if(ConnectSetting[gDeviceIndex].DeviceType == DEVICE_MLINK)
/*   759 */    {
/*   760 */       if(statusSendStep > INDEX_4)
/*   761 */       {
/*   762 */          statusSendStep = 0;
/*   763 */          return;
/*   764 */       }
/*   765 */       if(statusSendStep == INDEX_0)
/*   766 */       {
/*   767 */          GUI_SetColor(0x605a54);
/*   768 */          GUI_SetColor(0x00FFFFFF);
/*   770 */          S_DATE_TIME dateTime;
/*   771 */          ModbusGetDateTime(&dateTime);
/*   772 */          (void)sprintf(buf, "'%02d-%02d-%02d %02d:%02d:%02d", dateTime.Year-2000,
/*   773 */              dateTime.Month,
/*   774 */              dateTime.Day,
/*   775 */              dateTime.Hour,
/*   776 */              dateTime.Min,
/*   777 */              dateTime.Sec);
/*   778 */          GUI_ClearRectEx(&rectDate);
/*   779 */          GUI_DispStringInRect(buf, &rectDate, (2<<0) | (3<<2));
/*   780 */          statusSendStep = 1;
/*   781 */       }
/*   782 */       else
/*   783 */       if(statusSendStep == INDEX_1)
/*   784 */       {
/*   785 */          ModbusGetString(1335, INDEX_32, gProductName[gDeviceIndex]);
/*   786 */          (void)printf("gProductName = %s\n", gProductName[gDeviceIndex]);
/*   787 */          statusSendStep = INDEX_2;
/*   788 */       }
/*   789 */       else
/*   790 */       if(statusSendStep == INDEX_2)
/*   791 */       {
/*   792 */          GUI_SetColor(0x00FFFFFF);
/*   793 */          ModbusGetString(2501, INDEX_32, buf);
/*   795 */          (void)printf("device description = %s\n", buf);
/*   796 */          if(strlen(buf) > INDEX_20)
/*   797 */          {
/*   798 */             buf[INDEX_20] = '.';
/*   799 */             buf[INDEX_21] = '.';
/*   800 */             buf[INDEX_22] = '.';
...
/*   803 */          if(buf[0] != 0)
/*   804 */          {
/*   805 */             (void)strcpy(gDescription[gDeviceIndex], buf);
/*   806 */          }
/*   807 */          else
/*   808 */          {
/*   809 */             (void)sprintf(buf, "%s #%d", gProductName[gDeviceIndex], ConnectSetting[gDeviceIndex].Address);
/*   810 */          }
/*   811 */          GUI_ClearRectEx(&rectDesc);
/*   812 */          GUI_DispStringInRect(buf, &rectDesc, (2<<0) | (3<<2));
/*   813 */          statusSendStep = INDEX_3;
/*   814 */       }
/*   815 */       else
/*   816 */       if(statusSendStep == INDEX_3)
/*   817 */       {
/*   818 */          gEventMax[gDeviceIndex] = ModbusGetUint16(1004);
/*   819 */          statusSendStep = INDEX_4;
/*   820 */       }
/*   821 */       else
/*   822 */       if(statusSendStep == INDEX_4)
/*   823 */       {
/*   824 */          GUI_SetColor(0x00FFFFFF);
/*   825 */          mLinkMode[gDeviceIndex] = ModbusGetUint16(216) & 0x0f;
/*   826 */          mLinkSBO[gDeviceIndex] = ModbusGetUint16(217);
/*   827 */          int pos = 0;
/*   828 */          if((mLinkMode[gDeviceIndex] >= INDEX_1) && (mLinkMode[gDeviceIndex] <= INDEX_3))
/*   829 */          {
/*   830 */             pos = INDEX_1;
/*   831 */          }
/*   832 */          GUI_ClearRectEx(&rectLocal);
/*   833 */          LanguageSelect(FONT16B);
/*   834 */          GUI_DispStringInRect(_aclocal_remote[SettingValue[SETUP_LANGUAGE]][pos], &rectLocal, (2<<0) | (3<<2));
/*   835 */          (void)sprintf(buf, "M%d", mLinkMode[gDeviceIndex]);
/*   836 */          GUI_ClearRectEx(&rectMode);
/*   837 */          (void)GUI_SetFont(&GUI_Font16B_ASCII);
/*   838 */          GUI_DispStringInRect(buf, &rectMode, (2<<0) | (3<<2));
/*   840 */          GUI_SetColor(0x00FFFFFF);
/*   841 */          unsigned short rolloverCount = ModbusGetUint16(201);
/*   842 */          unsigned short SystemEventRolloverCount = (rolloverCount >> INDEX_8) & 0x00ff;
/*   843 */          gSystemEventIndex[gDeviceIndex] = ModbusGetUint16(202);
/*   844 */          (void)printf("\n\n\nEvent\n (%d,%d)\n\n\n", SystemEventRolloverCount, gSystemEventIndex[gDeviceIndex]);
/*   845 */          if(SystemEventRolloverCount)
/*   846 */          {
/*   847 */             gSystemEventTotalCount[gDeviceIndex] = gEventMax[gDeviceIndex];
/*   848 */          }
/*   849 */          else
/*   850 */          {
/*   851 */             gSystemEventTotalCount[gDeviceIndex] = gSystemEventIndex[gDeviceIndex];
/*   852 */          }
/*   853 */          if(ModbusGetUint16(208) & 0x0008)
/*   854 */          {
/*   855 */             (void)printf("M-LINK Time Invalid................\n\n\n\n");
/*   856 */             PCF2127_readTime(1);
/*   857 */             ModbusSetTimeAndWait(ConnectSetting[gDeviceIndex].Address, &gDateTime);
/*   858 */          }
/*   860 */          for(unsigned short i = 0; i < 4; i++)
/*   861 */          {
/*   862 */             doStatus[gDeviceIndex][i] = ModbusGetBit(210, i);
/*   863 */          }
/*   864 */          for(unsigned short i = 0; i < 6; i++)
/*   865 */          {
/*   866 */             diStatus[gDeviceIndex][i] = ModbusGetBit(209, i);
/*   867 */          }
/*   869 */          statusSendStep = 0;
/*   870 */          gStatusSendEnd = STATUS_SEND_END;
/*   871 */       }
/*   872 */       else {}
/*   873 */    }
/*   874 */    else
/*   875 */    {
/*   876 */       if(statusSendStep > INDEX_4)
/*   877 */       {
/*   878 */          statusSendStep = 0;
/*   879 */          return;
/*   880 */       }
/*   881 */       GUI_SetColor(0x00FFFFFF);
/*   882 */       if(statusSendStep == 0)
/*   883 */       {
/*   884 */          GUI_SetColor(0x605a54);
/*   885 */          GUI_SetColor(0x00FFFFFF);
/*   887 */          S_DATE_TIME dateTime;
/*   888 */          ModbusGetDateTime(&dateTime);
/*   889 */          (void)sprintf(buf, "'%02d-%02d-%02d %02d:%02d:%02d", dateTime.Year-2000,
/*   890 */              dateTime.Month,
/*   891 */              dateTime.Day,
/*   892 */              dateTime.Hour,
/*   893 */              dateTime.Min,
/*   894 */              dateTime.Sec);
/*   896 */          GUI_ClearRectEx(&rectDate);
/*   897 */          GUI_DispStringInRect(buf, &rectDate, (2<<0) | (3<<2));
/*   898 */          statusSendStep = 1;
/*   899 */       }
/*   900 */       else
/*   901 */       if(statusSendStep == INDEX_1)
/*   902 */       {
/*   904 */          ModbusGetId2(gProductName[gDeviceIndex]);
/*   906 */          (void)printf("gProductName = %s\n", gProductName[gDeviceIndex]);
/*   907 */          statusSendStep = INDEX_2;
/*   908 */       }
/*   909 */       else
/*   910 */       if(statusSendStep == INDEX_2)
/*   911 */       {
/*   912 */          GUI_SetColor(0x00FFFFFF);
/*   913 */          ModbusGetString(1, INDEX_32, buf);
/*   915 */          if(strlen(buf) > INDEX_20)
/*   916 */          {
/*   917 */             buf[INDEX_20] = '.';
/*   918 */             buf[INDEX_21] = '.';
/*   919 */             buf[INDEX_22] = '.';
...
/*   923 */          if(buf[0] != 0)
/*   924 */          {
/*   925 */             (void)strcpy(gDescription[gDeviceIndex], buf);
/*   926 */          }
/*   927 */          else
/*   928 */          {
/*   929 */             (void)sprintf(buf, "%s #%d", gProductName[gDeviceIndex], ConnectSetting[gDeviceIndex].Address);
/*   930 */          }
/*   932 */          GUI_ClearRectEx(&rectDesc);
/*   933 */          GUI_DispStringInRect(buf, &rectDesc, (2<<0) | (3<<2));
/*   934 */          unsigned short pols;
/*   935 */          if(ConnectSetting[gDeviceIndex].DeviceType == DEVICE_ACB)
/*   936 */          {
/*   937 */             unsigned char acbDeviceType = ModbusGetUint8_U(18);
/*   938 */             if((acbDeviceType == INDEX_0) || (acbDeviceType == INDEX_1))
/*   939 */             {
/*   940 */                gDeviceTypeAll[gDeviceIndex] = 1;
/*   941 */             }
/*   942 */             else
/*   943 */             {
/*   944 */                gDeviceTypeAll[gDeviceIndex] = 0;
/*   945 */             }
/*   946 */             (void)printf("acb device type = %d, gDeviceTypeAll = %d\n", acbDeviceType, gDeviceTypeAll[gDeviceIndex]);
/*   948 */             pols = (ModbusGetUint16(19) >> INDEX_8) & 0xff;
/*   949 */             (void)printf("ACB pols=%d\n", pols);
/*   950 */             if(pols != 4)
/*   951 */             {
/*   952 */                pols = 3;
/*   953 */             }
/*   954 */             if(pols != gPols[gDeviceIndex])
/*   955 */             {
/*   956 */                gPols[gDeviceIndex] = pols;
/*   957 */             }
/*   958 */             unsigned short group = ModbusGetUint16(50);
/*   959 */             (void)printf("ACB group=%d\n", group);
/*   960 */             if(group == 1)
/*   961 */             {
/*   962 */                gGroupOffset[gDeviceIndex] = 200;
/*   963 */             }
/*   964 */             else
/*   965 */             {
/*   966 */                gGroupOffset[gDeviceIndex] = 0;
/*   967 */             }
/*   968 */          }
/*   969 */          else
/*   970 */          if(ConnectSetting[gDeviceIndex].DeviceType == DEVICE_MCCB)
/*   971 */          {
/*   972 */             unsigned char mccbDeviceType = ModbusGetUint8_U(18);
/*   973 */             if((mccbDeviceType == INDEX_2) || (mccbDeviceType == INDEX_3))
/*   974 */             {
/*   975 */                gDeviceTypeAll[gDeviceIndex] = 1;
/*   976 */             }
/*   977 */             else
/*   978 */             {
/*   979 */                gDeviceTypeAll[gDeviceIndex] = 0;
/*   980 */             }
/*   981 */             (void)printf("mccb device type = %d, gDeviceTypeAll = %d\n", mccbDeviceType, gDeviceTypeAll[gDeviceIndex]);
/*   982 */             gAmpareFrame[gDeviceIndex] = ModbusGetUint16(20);
/*   983 */             pols = ModbusGetUint16(19) & 0xff;
/*   984 */             (void)printf("MCCB pols=%d, gPols[gDeviceIndex]=%d\n", pols, gPols[gDeviceIndex]);
/*   985 */             if(pols != 4)
/*   986 */             {
/*   987 */                pols = 3;
/*   988 */             }
/*   989 */             if(pols != gPols[gDeviceIndex])
/*   990 */             {
/*   991 */                gPols[gDeviceIndex] = pols;
/*   992 */             }
/*   993 */             gLnValue[gDeviceIndex] = ModbusGetUint16(21);
/*   994 */             gGroupOffset[gDeviceIndex] = 0;
/*   995 */          }
/*   996 */          else
/*   997 */          {
/*   998 */          }
/*   999 */          statusSendStep = INDEX_3;
/*  1000 */       }
/*  1001 */       else
/*  1002 */       if(statusSendStep == INDEX_3)
/*  1003 */       {
/*  1004 */          gEventMax[gDeviceIndex] = ModbusGetUint16(467);
/*  1005 */          gFaultMax[gDeviceIndex] = ModbusGetUint16(468);
/*  1006 */          (void)printf("Event Max: %d, Fault Max:%d\n", gEventMax[gDeviceIndex], gFaultMax[gDeviceIndex]);
/*  1007 */          statusSendStep = INDEX_4;
/*  1008 */       }
/*  1009 */       else
/*  1010 */       if(statusSendStep == INDEX_4)
/*  1011 */       {
/*  1012 */          GUI_SetColor(0x00FFFFFF);
/*  1013 */          unsigned short rolloverCount = ModbusGetUint16(194);
/*  1014 */          (void)printf("rolloverCount = 0x%x\n", rolloverCount);
/*  1015 */          unsigned short SystemEventRolloverCount = (rolloverCount >> INDEX_8) & 0x00ff;
/*  1016 */          unsigned short FaultEventRolloverCount = rolloverCount & 0x00ff;
/*  1017 */          gSystemEventIndex[gDeviceIndex] = ModbusGetUint16(195);
/*  1018 */          unsigned short faultCount = ModbusGetUint16(196);
/*  1020 */          if((faultCount == 0))
/*  1021 */          {
/*  1022 */             int flag = 0;
/*  1023 */             if(gFaultEventIndex[gDeviceIndex] != 0)
/*  1024 */             {
/*  1025 */                flag = 1;
/*  1026 */             }
/*  1027 */             gOldFaultEventIndex[gDeviceIndex] = 0;
/*  1028 */             if(flag == 1)
/*  1029 */             {
/*  1030 */                FaultCountWrite();
/*  1031 */             }
/*  1032 */          }
/*  1033 */          gFaultEventIndex[gDeviceIndex] = faultCount;
/*  1034 */          (void)printf("\n\n\nEvent\n (%d,%d) (%d,%d)\n\n\n", SystemEventRolloverCount, FaultEventRolloverCount, gSystemEventIndex[gDeviceIndex], gFaultEventIndex[gDeviceIndex]);
/*  1035 */          if(ConnectSetting[gDeviceIndex].DeviceType == DEVICE_ACB)
/*  1036 */          {
/*  1037 */             if(SystemEventRolloverCount)
/*  1038 */             {
/*  1039 */                gSystemEventTotalCount[gDeviceIndex] = gEventMax[gDeviceIndex];
/*  1040 */             }
/*  1041 */             else
/*  1042 */             {
/*  1043 */                gSystemEventTotalCount[gDeviceIndex] = gSystemEventIndex[gDeviceIndex];
/*  1044 */             }
/*  1045 */             if(FaultEventRolloverCount)
/*  1046 */             {
/*  1047 */                gFaultEventTotalCount[gDeviceIndex] = gFaultMax[gDeviceIndex];
/*  1048 */             }
/*  1049 */             else
/*  1050 */             {
/*  1051 */                gFaultEventTotalCount[gDeviceIndex] = gFaultEventIndex[gDeviceIndex];
/*  1052 */             }
/*  1053 */          }
/*  1054 */          else
/*  1055 */          if(ConnectSetting[gDeviceIndex].DeviceType == DEVICE_MCCB)
/*  1056 */          {
/*  1057 */             if(SystemEventRolloverCount)
/*  1058 */             {
/*  1059 */                gSystemEventTotalCount[gDeviceIndex] = gEventMax[gDeviceIndex];
/*  1060 */             }
/*  1061 */             else
/*  1062 */             {
/*  1063 */                gSystemEventTotalCount[gDeviceIndex] = gSystemEventIndex[gDeviceIndex];
/*  1064 */             }
/*  1065 */             if(FaultEventRolloverCount)
/*  1066 */             {
/*  1067 */                gFaultEventTotalCount[gDeviceIndex] = gFaultMax[gDeviceIndex];
/*  1068 */             }
/*  1069 */             else
/*  1070 */             {
/*  1071 */                gFaultEventTotalCount[gDeviceIndex] = gFaultEventIndex[gDeviceIndex];
/*  1072 */             }
/*  1073 */          }
/*  1074 */          else {}
/*  1075 */          GUI_ClearRectEx(&rectLocal);
/*  1077 */          if(gFaultEventIndex[gDeviceIndex] == gOldFaultEventIndex[gDeviceIndex])
/*  1078 */          {
/*  1079 */             GUI_SetColor(0x605a54);
/*  1080 */          }
/*  1081 */          LanguageSelect(FONT16B);
/*  1082 */          GUI_DispStringInRect(_acalarm_text[SettingValue[SETUP_LANGUAGE]], &rectLocal, (2<<0) | (3<<2));
/*  1084 */          unsigned short value;
/*  1085 */          if(ConnectSetting[gDeviceIndex].DeviceType == DEVICE_ACB)
/*  1086 */          {
/*  1087 */             value = ModbusGetUint16(205);
/*  1088 */             gAcbType[gDeviceIndex] = (E_ACB_TYPE)(value & 0x000f);
/*  1089 */          }
/*  1091 */          value = ModbusGetUint16(206);
/*  1092 */          if(value & 0x0008)
/*  1093 */          {
/*  1094 */             (void)printf("ACB/MCCB Time Invalid................\n\n\n\n");
/*  1095 */             PCF2127_readTime(1);
/*  1096 */             ModbusSetTimeAndWait(ConnectSetting[gDeviceIndex].Address, &gDateTime);
/*  1097 */          }
/*  1098 */          value = ModbusGetUint16(208);
/*  1099 */          unsigned char cbStatus;
/*  1100 */          if(value & 0x0400)
/*  1101 */          {
/*  1102 */             cbStatus = (value >> INDEX_8) & 0x003;
/*  1103 */          }
/*  1104 */          else
/*  1105 */          {
/*  1106 */             cbStatus = CB_NOTUSED;
/*  1107 */          }
/*  1109 */          GUI_COLOR cbStatusColor = 0x00FFFFFF;
/*  1110 */          if(cbStatus == INDEX_2)
/*  1111 */          {
/*  1112 */             cbStatusColor = 0x000000FF;
/*  1113 */          }
/*  1115 */          GUI_SetColor(cbStatusColor);
/*  1116 */          GUI_ClearRectEx(&rectMode);
/*  1117 */          LanguageSelect(FONT16B);
/*  1118 */          GUI_DispStringInRect(_accb_status[SettingValue[SETUP_LANGUAGE]][cbStatus], &rectMode, (2<<0) | (3<<2));
/*  1119 */          statusSendStep = INDEX_2;
/*  1121 */          gLrValue[gDeviceIndex] = ModbusGetUint16(203);
/*  1122 */          (void)printf("ACB/MCCB lr=%f, groupoffset=%d\n", gLrValue[gDeviceIndex], gGroupOffset[gDeviceIndex]);
/*  1124 */          statusSendStep = 0;
/*  1125 */          gStatusSendEnd = STATUS_SEND_END;
/*  1126 */       }
/*  1127 */       else {}
/*  1128 */    }
/*  1129 */ }
/*  1132 */ void OverviewSend(void)
/*  1133 */ {
/*  1134 */    if(StatusSend() == STATUS_SEND_ING)
/*  1135 */    {
/*  1136 */       return;
/*  1137 */    }
/*  1138 */    (void)printf("\n\n\nOverviewSend() nSendStep=%d\n", nSendStep);
/*  1139 */    if(ConnectSetting[gDeviceIndex].DeviceType == DEVICE_ACB)
/*  1140 */    {
/*  1141 */       if(nSendStep == 0)
/*  1142 */       {
/*  1143 */          ModbusSendFrame(ConnectSetting[gDeviceIndex].Address, HOLDING_REGISTER, 119+gGroupOffset[gDeviceIndex], INDEX_6);
/*  1144 */       }
/*  1145 */       else
/*  1146 */       {
/*  1147 */          ModbusSendFrame(ConnectSetting[gDeviceIndex].Address, INPUT_REGISTER, 215, INDEX_8);
/*  1148 */       }
/*  1149 */    }
/*  1150 */    else
/*  1151 */    if(ConnectSetting[gDeviceIndex].DeviceType == DEVICE_MCCB)
/*  1152 */    {
/*  1153 */       if(nSendStep == 0)
/*  1154 */       {
/*  1155 */          ModbusSendFrame(ConnectSetting[gDeviceIndex].Address, HOLDING_REGISTER, 104, INDEX_1);
/*  1156 */       }
/*  1157 */       else
/*  1158 */       {
/*  1159 */          ModbusSendFrame(ConnectSetting[gDeviceIndex].Address, INPUT_REGISTER, 215, INDEX_8);
/*  1160 */       }
/*  1161 */    }
/*  1162 */    else
/*  1163 */    if(ConnectSetting[gDeviceIndex].DeviceType == DEVICE_MLINK)
/*  1164 */    {
/*  1165 */       if(nSendStep == 0)
/*  1166 */       {
/*  1167 */          ModbusSendFrame(ConnectSetting[gDeviceIndex].Address, INPUT_REGISTER, 219, INDEX_2);
/*  1168 */       }
/*  1169 */       else
/*  1170 */       {
/*  1171 */          ModbusSendFrame(ConnectSetting[gDeviceIndex].Address, HOLDING_REGISTER, 2031, INDEX_6);
/*  1172 */       }
/*  1173 */    }
/*  1174 */    else {}
/*  1175 */ }
/*  1176 */ static unsigned short gbSavingMode;
/*  1178 */ static void ScreenTimerInit(void)
/*  1179 */ {
/*  1180 */    uint32_t timer = HAL_GetTick();
/*  1181 */    gSavingModeCounter = timer + (SettingValue[SETUP_SAVING_MODE] * 1000);
/*  1182 */    gScreenSwitchingCounter = timer + (SettingValue[SETUP_SCREEN_SWITCHING] * 1000);
/*  1183 */    gReturnToScreen = timer + (SettingValue[SETUP_RETURN_TO_SCREEN] * 1000);
/*  1184 */ }
/*  1187 */ void GuiMain(void)
/*  1188 */ {
/*  1189 */    static float gPTAValue[8];
/*  1191 */    commTimer = HAL_GetTick();
/*  1192 */    readTimeTimer = HAL_GetTick();
/*  1193 */    g_bRecvAllDone = 0;
/*  1194 */    for(int i = 0; i < 5; i++)
/*  1195 */    {
/*  1196 */       KeyStatus[i] = GPIO_PIN_SET;
/*  1197 */    }
/*  1198 */    for(int d = 0; d < 8; d++)
/*  1199 */    {
/*  1200 */       for(unsigned short i = 0; i < 4; i++)
/*  1201 */       {
/*  1202 */          doStatus[d][i] = 0;
/*  1203 */       }
/*  1204 */       for(unsigned short i = 0; i < 6; i++)
/*  1205 */       {
/*  1206 */          diStatus[d][i] = 0;
/*  1207 */       }
/*  1208 */       gCommOldStatus[d] = -1;
/*  1209 */    }
/*  1211 */    _acImage[COMM_ERROR] = (const unsigned char *)_acImageStatusDisconnected;
/*  1212 */    _acImage[COMM_OK] = (const unsigned char *)_acImageStatusConnected;
/*  1214 */    g_nStatusNoUpdate = 0;
/*  1215 */    nSendStep = 0;
/*  1216 */    Overview(1);
/*  1217 */    OverviewSend();
/*  1219 */    gbInMainMenu = 1;
/*  1220 */    gbSavingMode = 0;
/*  1222 */    PCF2127_readTime(1);
/*  1223 */    gTimeSyncDay = gDateTime.Day;
/*  1224 */    gbSettingTime = 0;
/*  1226 */    ScreenTimerInit();
/*  1229 */    int curCommStat = gCommStatus[gDeviceIndex];
/*  1231 */    while (1)
/*  1232 */    {
/*  1233 */       E_KEY key = GetKey();
/*  1235 */       if(curCommStat != gCommStatus[gDeviceIndex])
/*  1236 */       {
/*  1238 */          {
/*  1239 */             Overview(0);
/*  1240 */          }
/*  1241 */          curCommStat = gCommStatus[gDeviceIndex];
/*  1242 */       }
/*  1243 */       if(key == TIME_OUT)
/*  1244 */       {
/*  1245 */          (void)printf("TIME_OUT\n");
/*  1246 */          statusSendStep = 0;
/*  1247 */          gStatusSendEnd = STATUS_SEND_ING;
/*  1248 */          OverviewSend();
/*  1249 */       }
/*  1250 */       else
/*  1251 */       if(key == KEY_SETUP)
/*  1252 */       {
/*  1253 */          gbInMainMenu = 0;
/*  1254 */          (void)Setup();
/*  1255 */          gbInMainMenu = 1;
...
/*  1262 */       if(key == KEY_UP)
/*  1263 */       {
/*  1264 */          if(gDeviceIndex > 0)
/*  1265 */          {
/*  1266 */             gDeviceIndex--;
/*  1267 */          }
/*  1268 */          else
/*  1269 */          {
/*  1270 */             gDeviceIndex = gDeviceCount - 1;
/*  1271 */          }
/*  1272 */          gStatusSendEnd = STATUS_SEND_ING;
/*  1273 */          statusSendStep = 0;
/*  1274 */          nSendStep = 0;
/*  1275 */          OverviewSend();
/*  1276 */          Overview(1);
/*  1277 */          curCommStat = gCommStatus[gDeviceIndex];
/*  1279 */       }
/*  1280 */       else
/*  1281 */       if(key == KEY_DOWN)
/*  1282 */       {
/*  1283 */          if(gDeviceIndex < (gDeviceCount-1))
/*  1284 */          {
/*  1285 */             gDeviceIndex++;
/*  1286 */          }
/*  1287 */          else
...
/*  1289 */             gDeviceIndex = 0;
/*  1290 */          }
/*  1291 */          gStatusSendEnd = STATUS_SEND_ING;
/*  1292 */          statusSendStep = 0;
/*  1293 */          nSendStep = 0;
/*  1294 */          OverviewSend();
/*  1295 */          Overview(1);
/*  1296 */          curCommStat = gCommStatus[gDeviceIndex];
/*  1298 */       }
/*  1299 */       else
/*  1300 */       if(key == KEY_ENTER)
/*  1301 */       {
/*  1302 */          if(ConnectSetting[gDeviceIndex].DeviceType != DEVICE_NO)
/*  1303 */          {
/*  1304 */             gbInMainMenu = 0;
/*  1305 */             GUI_HWIN hWin = CreateMenu(ConnectSetting[gDeviceIndex].DeviceType);
/*  1306 */             WM_ShowWindow(hWin);
/*  1307 */             WM_DeleteWindow(hWin);
/*  1308 */             gbInMainMenu = 1;
/*  1310 */             OverviewSend();
/*  1311 */             Overview(0);
/*  1312 */             CommTimerInit();
...
/*  1315 */       }
/*  1316 */       else
/*  1317 */       if(key == DATA_RECV)
/*  1318 */       {
/*  1319 */          if(gStatusSendEnd == STATUS_SEND_ING)
/*  1320 */          {
/*  1321 */             StatusRecv();
/*  1322 */             nSendStep = 0;
/*  1323 */             OverviewSend();
...
/*  1327 */             if(nSendStep == 0)
/*  1328 */             {
/*  1329 */                if(ConnectSetting[gDeviceIndex].DeviceType == DEVICE_MLINK)
/*  1330 */                {
/*  1331 */                   OverViewValue(1);
/*  1332 */                }
/*  1333 */                else
/*  1334 */                {
/*  1335 */                   if(ConnectSetting[gDeviceIndex].DeviceType == DEVICE_ACB)
/*  1336 */                   {
/*  1337 */                      gLnrValue[gDeviceIndex] = ModbusGetUint16(119+gGroupOffset[gDeviceIndex]);
/*  1338 */                      (void)printf("ACB ln=%f, groupoffset=%d\n", gLnrValue[gDeviceIndex], gGroupOffset[gDeviceIndex]);
/*  1339 */                      gPTAValue[gDeviceIndex] = ModbusGetUint16(124);
/*  1340 */                      (void)printf("ACB PTA=%f\n", gPTAValue[gDeviceIndex]);
/*  1341 */                   }
/*  1342 */                   else
/*  1343 */                   {
/*  1344 */                      gNPHASE_PROTECTION_Value[gDeviceIndex] = ModbusGetUint16(104);
/*  1345 */                      (void)printf("MCCB gNPHASE_PROTECTION_Value=%f\n", gNPHASE_PROTECTION_Value[gDeviceIndex]);
/*  1346 */                   }
/*  1347 */                }
/*  1348 */                nSendStep = 1;
/*  1349 */                OverviewSend();
...
/*  1352 */             if(nSendStep == 1)
/*  1353 */             {
/*  1354 */                OverViewValue(1);
/*  1355 */                nSendStep = 0;
/*  1356 */                g_bRecvAllDone = 1;
/*  1357 */                (void)printf("g_bRecvAllDone=0\n");
/*  1358 */             }
/*  1359 */             else {}
/*  1360 */          }
/*  1361 */       }
/*  1362 */       else
/*  1363 */       if(key == KEY_COMM_ERROR)
/*  1364 */       {
/*  1365 */          (void)printf("COMM Error!!! gStatusSendEnd=%d, statusSendStep=%d, nSendStep=%d\n",gStatusSendEnd,statusSendStep,nSendStep);
/*  1366 */          if(gStatusSendEnd == STATUS_SEND_END)
/*  1367 */          {
/*  1368 */             nSendStep++;
/*  1369 */          }
/*  1370 */          if(StatusRecvErrorProcess() == STATUS_SEND_ING)
/*  1371 */          {
/*  1372 */             nSendStep = 0;
/*  1373 */          }
/*  1374 */          else
/*  1375 */          {
/*  1376 */             int nStepMax;
/*  1377 */             if(ConnectSetting[gDeviceIndex].DeviceType == DEVICE_MLINK)
/*  1378 */             {
/*  1379 */                nStepMax = INDEX_2;
/*  1380 */             }
/*  1381 */             else
/*  1382 */             {
/*  1383 */                nStepMax = INDEX_2;
/*  1384 */             }
/*  1386 */             if(nSendStep < nStepMax)
/*  1387 */             {
/*  1388 */                OverviewSend();
/*  1389 */             }
/*  1390 */             else
/*  1391 */             {
/*  1392 */                g_bRecvAllDone = 1;
/*  1394 */                (void)printf("All done!!!\n");
/*  1395 */                gStatusSendEnd = STATUS_SEND_ING;
/*  1396 */                statusSendStep = 0;
/*  1397 */                nSendStep = 0;
/*  1399 */             }
/*  1400 */          }
/*  1401 */       }
...
/*  1404 */    }
/*  1405 */ }
/*  1407 */ static uint32_t GetTimerDiff(void)
/*  1408 */ {
/*  1409 */    if(SettingValue[SETUP_GATEWAY_USE] == 1)
/*  1410 */    {
/*  1411 */       return (10000);
/*  1412 */    }
/*  1413 */    else
...
/*  1416 */    }
/*  1417 */ }
/*  1420 */ E_KEY GetKey(void)
/*  1421 */ {
/*  1422 */    static int gCommCheckStatus[8];
/*  1424 */    while (1)
/*  1425 */    {
/*  1432 */       CommStatusDisp();
/*  1433 */       uint32_t timer = HAL_GetTick();
/*  1434 */       uint32_t diff;
/*  1435 */       diff = timer-commTimer;
/*  1436 */       if(diff >= GetTimerDiff())
/*  1437 */       {
/*  1438 */          if((g_bRecvAllDone == 1) || (diff >= 10000))
/*  1439 */          {
/*  1440 */             (void)printf("commTimer-1=%d, Tick=%d, Diff=%d\n", commTimer, timer, diff);
/*  1441 */             CommTimerClear();
/*  1442 */             return TIME_OUT;
/*  1443 */          }
/*  1444 */       }
/*  1445 */       diff = timer-readTimeTimer;
/*  1446 */       if(diff >= 1000)
/*  1447 */       {
/*  1450 */          if(gbSettingTime == 0)
/*  1451 */          {
/*  1452 */             PCF2127_readTime(1);
/*  1454 */             if((gDateTime.Day != gTimeSyncDay) && (gDateTime.Hour == 0) && (gDateTime.Min == 20))
/*  1455 */             {
/*  1456 */                (void)printf("TimeSync.....\n\n\n\n\n\n\n\n\n\n");
/*  1457 */                gTimeSyncDay = gDateTime.Day;
/*  1458 */                for(int i = 0; i < gDeviceCount; i++)
/*  1459 */                {
/*  1460 */                   OS_Delay(10);
/*  1461 */                   ModbusSetTime(ConnectSetting[i].Address, &gDateTime);
/*  1465 */                }
/*  1466 */             }
/*  1467 */          }
/*  1468 */          readTimeTimer = timer;
/*  1469 */          (void)printf("SECOND_TIMER return(%d)\n", SECOND_TIMER);
/*  1470 */          return SECOND_TIMER;
/*  1471 */       }
/*  1472 */       if(gCommStatus[gDeviceIndex] != gCommCheckStatus[gDeviceIndex])
/*  1473 */       {
/*  1474 */          if(gCommStatus[gDeviceIndex] == COMM_ERROR)
/*  1475 */          {
/*  1476 */             gCommCheckStatus[gDeviceIndex] = gCommStatus[gDeviceIndex];
/*  1477 */             (void)printf("\n\n\n\n\n gCommStatus[gDeviceIndex] == COMM_ERROR\n\n\n\n\n\n");
/*  1478 */             return COMM_STAT_ERROR;
/*  1479 */          }
/*  1480 */          gCommCheckStatus[gDeviceIndex] = gCommStatus[gDeviceIndex];
/*  1481 */       }
/*  1482 */       if(gbSavingMode == 0)
/*  1483 */       {
/*  1484 */          if((SettingValue[SETUP_SAVING_MODE] != 0) && (timer >= gSavingModeCounter))
/*  1485 */          {
/*  1486 */             BacklightBrghtness(SettingValue[SETUP_BRIGHTNESS], 1);
/*  1487 */             LCD_OnOff(0);
/*  1488 */             gbSavingMode = 1;
/*  1489 */          }
/*  1490 */       }
/*  1491 */       if(gbInMainMenu == 1)
/*  1492 */       {
/*  1493 */          if((SettingValue[SETUP_DEVICE_COUNT] != 1) && (SettingValue[SETUP_SCREEN_SWITCHING] != 0) && (timer >= gScreenSwitchingCounter))
/*  1494 */          {
/*  1495 */             gScreenSwitchingCounter = timer + (SettingValue[SETUP_SCREEN_SWITCHING] * 1000);
/*  1496 */             return KEY_DOWN;
/*  1497 */          }
/*  1498 */       }
/*  1499 */       else
/*  1500 */       {
/*  1501 */          if((SettingValue[SETUP_RETURN_TO_SCREEN] != 0) && (timer >= gReturnToScreen))
/*  1502 */          {
/*  1504 */             return KEY_CANCEL;
/*  1505 */          }
/*  1506 */       }
/*  1507 */       for(E_KEY i = KEY_SETUP; i < 5; i++)
/*  1508 */       {
/*  1509 */          if(KeyChanged[i] == 1)
/*  1510 */          {
/*  1511 */             KeyChanged[i] = 0;
/*  1512 */             unsigned char bContinue = 0;
/*  1513 */             if(gbSavingMode == 1)
/*  1514 */             {
/*  1515 */                BacklightBrghtness(SettingValue[SETUP_BRIGHTNESS], 0);
/*  1516 */                LCD_OnOff(1);
/*  1517 */                bContinue = 1;
/*  1518 */                gbSavingMode = 0;
/*  1519 */             }
/*  1520 */             ScreenTimerInit();
/*  1521 */             if(bContinue == 1)
/*  1522 */             {
/*  1523 */                continue;
/*  1524 */             }
...
/*  1526 */          }
/*  1527 */       }
/*  1556 */       if (g_modbusRxDone)
/*  1557 */       {
/*  1558 */          CommStatusDisp();
/*  1559 */          unsigned char ret = ModbusCRCCheck();
/*  1560 */          g_modbusRxDone = 0;
/*  1561 */          if(ret == MODBUS_OK)
/*  1562 */          {
/*  1563 */             (void)printf("CRC OK\n");
/*  1564 */             return DATA_RECV;
/*  1565 */          }
/*  1566 */          else
/*  1567 */          if(ret == MODBUS_ERROR)
/*  1568 */          {
/*  1569 */             (void)printf("Modbus Error\n");
/*  1570 */             return KEY_COMM_ERROR;
/*  1571 */          }
/*  1572 */          else
/*  1573 */          if(ret == MODBUS_CRC_ERROR)
/*  1574 */          {
/*  1575 */             (void)printf("CRC BAD\n");
/*  1576 */             return KEY_COMM_ERROR;
/*  1577 */          }
/*  1578 */          else {}
/*  1579 */       }
/*  1580 */       if(g_modbusRxError)
/*  1581 */       {
/*  1582 */          (void)printf("g_modbusRxError\n");
/*  1583 */          g_modbusRxError = 0;
/*  1584 */          return KEY_COMM_ERROR;
/*  1585 */       }
/*  1586 */       GUI_Delay(INDEX_10);
/*  1587 */    }
/*  1588 */ }
/*  1591 */ void KeyCheck(void)
/*  1592 */ {
/*  1593 */    static unsigned short KeyChangeOnCount[5];
/*  1594 */    static unsigned short KeyChangeOffCount[5];
/*  1596 */    for(E_KEY i = KEY_SETUP; i < 5; i++)
/*  1597 */    {
/*  1598 */       if(KeyChanged[i] == 1)
/*  1599 */       {
/*  1600 */          return;
/*  1601 */       }
/*  1602 */       GPIO_PinState status = HAL_GPIO_ReadPin(((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x0000U)), KeyPin[i]);
/*  1603 */       if(KeyStatus[i] != status)
/*  1604 */       {
/*  1605 */          if((status == GPIO_PIN_SET))
/*  1606 */          {
/*  1607 */             if(++KeyChangeOffCount[i] >= 100)
/*  1608 */             {
/*  1609 */                KeyChangeOffCount[i] = 0;
/*  1610 */                KeyChangeOnCount[i] = 0;
/*  1611 */                KeyStatus[i] = status;
/*  1612 */             }
/*  1613 */          }
/*  1614 */          else
/*  1615 */          if((status == GPIO_PIN_RESET))
/*  1616 */          {
/*  1617 */             if(++KeyChangeOnCount[i] >= 100)
/*  1618 */             {
/*  1619 */                KeyChanged[i] = 1;
/*  1620 */                KeyStatus[i] = status;
/*  1621 */                return;
/*  1622 */             }
/*  1623 */          }
/*  1624 */          else
