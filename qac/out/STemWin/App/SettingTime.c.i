...
/*
 * C:/CodeInspection/DisplayUnit/STemWin/App/SettingTime.c
 */
/*    29 */ static void DateTimeDisp(int pos);
/*    30 */ static int LeapYear(unsigned short year);
/*    31 */ static unsigned short GetDaysInMonth(unsigned short year, unsigned short month);
/*    33 */ static int LeapYear(unsigned short year)
/*    34 */ {
/*    35 */    if((((year % INDEX_4) == 0) && ((year % 100) != 0)) || ((year % INDEX_400) == 0))
/*    36 */    {
/*    37 */       return(1);
/*    38 */    }
/*    39 */    else
...
/*    42 */    }
/*    43 */ }
/*    45 */ static unsigned short GetDaysInMonth(unsigned short year, unsigned short month)
/*    46 */ {
/*    47 */    static unsigned short g_DaysInMonth[] = {
/*    48 */       INDEX_31, INDEX_28, INDEX_31, INDEX_30, INDEX_31, INDEX_30, INDEX_31, INDEX_31, INDEX_30, INDEX_31, INDEX_30, INDEX_31
/*    49 */    };
/*    51 */    unsigned short nDays;
/*    53 */    nDays = g_DaysInMonth[month-1];
/*    54 */    if((LeapYear(year) == 1) && (month == INDEX_2))
/*    55 */    {
/*    56 */       nDays++;
/*    57 */    }
/*    58 */    return nDays;
/*    59 */ }
/*    61 */ static void DateTimeDisp(int pos)
/*    62 */ {
/*    64 */    GUI_RECT rect;
/*    65 */    GUI_SetBkColor(0x2f2c2a);
/*    66 */    GUI_ClearRect(25+1, 96 - INDEX_17, ((430 + 25) - 1)-1, ((96 + 50) - 2) + INDEX_17);
/*    68 */    (void)GUI_SetFont(&GUI_Font32B_ASCII);
/*    69 */    GUI_SetColor(0x00FFFFFF);
/*    71 */    rect.x0 = 25;
/*    72 */    rect.y0 = 96;
/*    73 */    rect.x1 = ((430 + 25) - 1);
/*    74 */    rect.y1 = ((96 + 50) - 2);
/*    76 */    char buf[60];
/*    77 */    (void)sprintf(buf, "%04d - %02d - %02d  %02d : %02d : %02d", gDateTime.Year, gDateTime.Month, gDateTime.Day, gDateTime.Hour, gDateTime.Min, gDateTime.Sec);
/*    78 */    GUI_DispStringInRect(buf, &rect, (2<<0) | (3<<2));
/*    80 */    if(pos >= 6)
/*    81 */    {
/*    82 */       return;
/*    83 */    }
/*    85 */    rect.x0 = date_set_pos[pos][0];
/*    86 */    rect.y0 = 96;
/*    87 */    rect.x1 = date_set_pos[pos][1];
/*    88 */    rect.y1 = ((96 + 50) - 2);
/*    89 */    GUI_SetBkColor(0x00000000);
/*    90 */    GUI_ClearRect(rect.x0, rect.y0, rect.x1, rect.y1);
/*    91 */    if(pos == INDEX_0)
/*    92 */    {
/*    93 */       (void)sprintf(buf, "%04d", gDateTime.Year);
/*    94 */    }
/*    95 */    else
/*    96 */    if(pos == INDEX_1)
/*    97 */    {
/*    98 */       (void)sprintf(buf, "%02d", gDateTime.Month);
/*    99 */    }
/*   100 */    else
/*   101 */    if(pos == INDEX_2)
/*   102 */    {
/*   103 */       (void)sprintf(buf, "%02d", gDateTime.Day);
/*   104 */    }
/*   105 */    else
/*   106 */    if(pos == INDEX_3)
/*   107 */    {
/*   108 */       (void)sprintf(buf, "%02d", gDateTime.Hour);
/*   109 */    }
/*   110 */    else
/*   111 */    if(pos == INDEX_4)
/*   112 */    {
/*   113 */       (void)sprintf(buf, "%02d", gDateTime.Min);
/*   114 */    }
/*   115 */    else
/*   116 */    if(pos == INDEX_5)
/*   117 */    {
/*   118 */       (void)sprintf(buf, "%02d", gDateTime.Sec);
/*   119 */    }
/*   120 */    else {}
/*   122 */    GUI_DispStringInRect(buf, &rect, (2<<0) | (3<<2));
/*   124 */    (void)GUI_BMP_Draw(_acUp, date_set_updown_pos[pos], 96 - INDEX_17);
/*   125 */    (void)GUI_BMP_Draw(_acDown, date_set_updown_pos[pos], ((96 + 50) - 2));
/*   126 */ }
/*   129 */ void ButtonDisp(int button)
/*   130 */ {
/*   131 */    GUI_RECT rect;
/*   132 */    rect.x0 = 88;
/*   133 */    rect.y0 = 218;
/*   134 */    rect.x1 = (88 + 142) - 1;
/*   135 */    rect.y1 = (218 + 55) - 1;
/*   136 */    LanguageSelect(FONT24B);
/*   137 */    for(int i = 0; i < 2; i++)
/*   138 */    {
/*   139 */       if(i == button)
/*   140 */       {
/*   141 */          GUI_SetColor(0xd07b18);
/*   142 */          GUI_SetBkColor(0xd07b18);
/*   143 */       }
/*   144 */       else
/*   145 */       {
/*   146 */          GUI_SetColor(0x4c4945);
/*   147 */          GUI_SetBkColor(0x4c4945);
/*   148 */       }
/*   149 */       GUI_FillRoundedRect(rect.x0, rect.y0, rect.x1, rect.y1, INDEX_2);
/*   150 */       if(i == button)
/*   151 */       {
/*   152 */          GUI_SetColor(0x00FFFFFF);
/*   153 */       }
/*   154 */       else
/*   155 */       {
/*   156 */          GUI_SetColor(0xa1a1a1);
/*   157 */       }
/*   158 */       GUI_DispStringInRect(_accontrol_button_text[SettingValue[SETUP_LANGUAGE]][i], &rect, (2<<0) | (3<<2));
/*   159 */       rect.x0 += 142 + 20;
/*   160 */       rect.x1 += 142 + 20;
/*   161 */    }
/*   162 */ }
/*   165 */ void SettingTime(void)
/*   166 */ {
/*   167 */    int flagBreak = 0;
/*   168 */    int nPos = 0;
/*   170 */    GUI_SetBkColor(0x2f2c2a);
/*   172 */    (void)GUI_SetPenSize(2);
/*   173 */    GUI_SetColor(0xd07b18);
/*   175 */    GUI_ClearRect(25, 18, ((430 + 25) - 1), ((280 + 18) - 1));
/*   176 */    GUI_DrawRect(25, 18, ((430 + 25) - 1), ((280 + 18) - 1));
/*   178 */    GUI_SetColor(0x00FFFFFF);
/*   179 */    (void)GUI_SetFont(&GUI_Font32B_ASCII);
/*   181 */    DateTimeDisp(nPos);
/*   182 */    ButtonDisp(2);
/*   184 */    unsigned short year = (unsigned short)gDateTime.Year;
/*   185 */    unsigned short days;
/*   186 */    while (1)
/*   187 */    {
/*   188 */       E_KEY key = GetKey();
/*   190 */       if(key == KEY_UP)
/*   191 */       {
/*   192 */          if(nPos < 6)
/*   193 */          {
...
/*   202 */             if(nPos == INDEX_1)
/*   203 */             {
/*   204 */                if(gDateTime.Month < 12)
/*   205 */                {
/*   206 */                   gDateTime.Month++;
/*   207 */                }
/*   208 */                else
/*   209 */                {
/*   210 */                   gDateTime.Month = 1;
/*   211 */                }
/*   212 */                days = GetDaysInMonth(year, gDateTime.Month);
/*   213 */                if(gDateTime.Day > days)
/*   214 */                {
/*   215 */                   gDateTime.Day = days;
/*   216 */                }
/*   217 */             }
/*   218 */             else
/*   219 */             if(nPos == INDEX_2)
/*   220 */             {
/*   221 */                days = 31;
/*   222 */                days = GetDaysInMonth(year, gDateTime.Month);
/*   223 */                if(gDateTime.Day < days)
/*   224 */                {
/*   225 */                   gDateTime.Day++;
/*   226 */                }
/*   227 */                else
...
/*   233 */             if(nPos == INDEX_3)
/*   234 */             {
/*   235 */                if(gDateTime.Hour < (24 - 1))
/*   236 */                {
/*   237 */                   gDateTime.Hour++;
/*   238 */                }
/*   239 */                else
/*   240 */                {
/*   241 */                   gDateTime.Hour = 0;
/*   242 */                }
/*   243 */             }
/*   244 */             else
/*   245 */             if(nPos == INDEX_4)
/*   246 */             {
/*   247 */                if(gDateTime.Min < (60 - 1))
/*   248 */                {
/*   249 */                   gDateTime.Min++;
/*   250 */                }
/*   251 */                else
...
/*   267 */             }
/*   268 */             else {}
/*   269 */             gDateTime.Year = year;
/*   270 */             DateTimeDisp(nPos);
/*   271 */          }
/*   272 */          else
/*   273 */          if(nPos == (6 + 1))
/*   274 */          {
...
/*   293 */             if(nPos == INDEX_1)
/*   294 */             {
/*   295 */                if(gDateTime.Month > 1)
/*   296 */                {
/*   297 */                   gDateTime.Month--;
/*   298 */                }
/*   299 */                else
/*   300 */                {
/*   301 */                   gDateTime.Month = 12;
/*   302 */                }
/*   303 */                days = GetDaysInMonth(year, gDateTime.Month);
/*   304 */                if(gDateTime.Day > days)
/*   305 */                {
/*   306 */                   gDateTime.Day = days;
/*   307 */                }
/*   308 */             }
/*   309 */             else
/*   310 */             if(nPos == INDEX_2)
/*   311 */             {
/*   312 */                days = 31;
/*   313 */                days = GetDaysInMonth(year, gDateTime.Month);
/*   314 */                if(gDateTime.Day > 1)
/*   315 */                {
/*   316 */                   gDateTime.Day--;
/*   317 */                }
/*   318 */                else
/*   319 */                {
/*   320 */                   gDateTime.Day = days;
/*   321 */                }
/*   322 */             }
/*   323 */             else
/*   324 */             if(nPos == INDEX_3)
/*   325 */             {
/*   326 */                if(gDateTime.Hour > 0)
/*   327 */                {
/*   328 */                   gDateTime.Hour--;
/*   329 */                }
/*   330 */                else
/*   331 */                {
/*   332 */                   gDateTime.Hour = 24 - 1;
/*   333 */                }
/*   334 */             }
/*   335 */             else
/*   336 */             if(nPos == INDEX_4)
/*   337 */             {
/*   338 */                if(gDateTime.Min > 0)
/*   339 */                {
/*   340 */                   gDateTime.Min--;
/*   341 */                }
/*   342 */                else
/*   343 */                {
/*   344 */                   gDateTime.Min = 60 - 1;
/*   345 */                }
/*   346 */             }
/*   347 */             else
/*   348 */             if(nPos == INDEX_5)
/*   349 */             {
/*   350 */                if(gDateTime.Sec > 0)
/*   351 */                {
/*   352 */                   gDateTime.Sec--;
/*   353 */                }
/*   354 */                else
/*   355 */                {
/*   356 */                   gDateTime.Sec = 60 - 1;
/*   357 */                }
/*   358 */             }
/*   359 */             else {}
/*   360 */             gDateTime.Year = year;
/*   361 */             DateTimeDisp(nPos);
/*   362 */          }
/*   363 */          else
/*   364 */          if(nPos == 6)
/*   365 */          {
...
/*   370 */       }
/*   371 */       else
/*   372 */       if(key == KEY_ENTER)
/*   373 */       {
/*   374 */          if(nPos < 6)
/*   375 */          {
/*   376 */             nPos++;
/*   377 */             gDateTime.Year = year;
/*   378 */             DateTimeDisp(nPos);
/*   379 */             if(nPos == 6)
/*   380 */             {
/*   381 */                ButtonDisp(0);
/*   382 */             }
...
/*   386 */          {
/*   387 */             (void)printf("===============\nOK\n");
/*   388 */             (void)PCF2127_set_time();
/*   389 */             for(int i = 0; i < gDeviceCount; i++)
/*   390 */             {
/*   391 */                ModbusSetTime(ConnectSetting[i].Address, &gDateTime);
/*   392 */                OS_Delay(INDEX_10);
/*   393 */             }
/*   394 */             flagBreak = 1;
/*   395 */          }
/*   396 */          else
