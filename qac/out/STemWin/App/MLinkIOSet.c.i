...
/*
 * C:/CodeInspection/DisplayUnit/STemWin/App/MLinkIOSet.c
 */
/*    37 */ static void MLinkIOSetMenu(int pos);
/*    38 */ static void MLinkIOSetSend(int nPos);
/*    39 */ static void MLinkIOSetAppValue(void);
/*    40 */ static void MLinkIOSetApp(void);
/*    41 */ static void MLinkDiMakeString(unsigned short value, char result[30]);
/*    42 */ static void MLinkIOSetDIValue(void);
/*    43 */ static void MLinkIOSetDI(void);
/*    44 */ static void MLinkDoMakeString(const unsigned short value, char result[20]);
/*    45 */ static void MLinkIOSetDOValue(void);
/*    46 */ static void MLinkIOSetDO(void);
/*    47 */ static void MLinkIOSetDisp(int pos);
/*    48 */ static void MLinkIOSetValueDisp(int pos);
/*    65 */ static void MLinkIOSetMenu(int pos)
/*    66 */ {
/*    67 */    GUI_SetBkColor(0x1c1b1a);
/*    68 */    GUI_RECT rect;
/*    69 */    rect.x0 = 30;
/*    70 */    rect.x1 = 105;
/*    71 */    rect.y0 = 45;
/*    72 */    rect.y1 = (45 + 66) - 1;
/*    74 */    int y0 = 45;
/*    75 */    for(int i = 0; i < (4-1); i++)
/*    76 */    {
/*    84 */       if(i == pos)
/*    85 */       {
/*    86 */          GUI_SetColor(0xd07b18);
/*    87 */       }
/*    88 */       else
/*    89 */       {
/*    90 */          GUI_SetColor(0x2f2c2a);
/*    91 */       }
/*    93 */       GUI_FillRect(10, y0, (10 + 120) - 1, (y0 + 66) - 1);
/*    95 */       if(i == pos)
/*    96 */       {
/*    97 */          GUI_SetColor(0x00FFFFFF);
/*    98 */          GUI_SetBkColor(0xd07b18);
/*   100 */          LanguageSelect(FONT20B);
/*   101 */       }
/*   102 */       else
/*   103 */       {
/*   104 */          GUI_SetColor(0xc8c8c8);
/*   105 */          GUI_SetBkColor(0x2f2c2a);
/*   107 */          LanguageSelect(FONT20);
/*   108 */       }
/*   110 */       GUI_DispStringInRect(_acmlink_iostatus_menu_text[SettingValue[SETUP_LANGUAGE]][i], &rect, (0) | (3<<2));
/*   111 */       rect.y0 += 66 + 1;
/*   112 */       rect.y1 += 66 + 1;
/*   113 */       y0 += 66 + 1;;
/*   114 */    }
/*   115 */ }
/*   117 */ static void MLinkIOSetSend(int nPos)
/*   118 */ {
/*   119 */    if(StatusSend() == STATUS_SEND_ING)
/*   120 */    {
/*   121 */       return;
/*   122 */    }
/*   123 */    if(nPos == INDEX_0)
/*   124 */    {
/*   125 */       ModbusSendFrame(ConnectSetting[gDeviceIndex].Address, INPUT_REGISTER, 216, INDEX_1);
/*   126 */    }
/*   127 */    else
/*   128 */    if(nPos == INDEX_1)
/*   129 */    {
/*   130 */       ModbusSendFrame(ConnectSetting[gDeviceIndex].Address, HOLDING_REGISTER, 2031, 6);
/*   131 */    }
/*   132 */    else
/*   133 */    if(nPos == INDEX_2)
/*   134 */    {
/*   135 */       ModbusSendFrame(ConnectSetting[gDeviceIndex].Address, HOLDING_REGISTER, 2021, 7);
/*   136 */    }
/*   137 */    else {}
/*   138 */ }
/*   140 */ static void MLinkIOSetAppValue(void)
/*   141 */ {
/*   142 */    char buf[INDEX_2][20];
/*   144 */    unsigned short value = ModbusGetUint16(216) & 0x000f;
/*   145 */    if((value >= INDEX_1) && (value <= INDEX_3))
/*   146 */    {
/*   147 */       (void)sprintf(buf[INDEX_0], _aclocal_remote[SettingValue[SETUP_LANGUAGE]][INDEX_1]);
/*   148 */    }
/*   149 */    else
/*   150 */    {
/*   151 */       (void)sprintf(buf[INDEX_0], _aclocal_remote[SettingValue[SETUP_LANGUAGE]][INDEX_0]);
/*   152 */    }
/*   153 */    (void)sprintf(buf[INDEX_1], "M%d", value);
/*   155 */    GUI_SetColor(0x00FFFFFF);
/*   156 */    (void)GUI_SetFont(&GUI_Font20B_ASCII);
/*   158 */    GUI_RECT rect;
/*   159 */    rect.x0 = ((350 - 110) + 50);
/*   160 */    rect.y0 = 45;
/*   161 */    rect.x1 = (350 + 110) - 1;
/*   162 */    rect.y1 = (45 + 44) - 1;
/*   163 */    GUI_SetBkColor(0x1c1b1a);
/*   164 */    LanguageSelect(FONT20B);
/*   165 */    for(int i = 0 ; i < (6-INDEX_4); i++)
/*   166 */    {
/*   167 */       GUI_ClearRect(rect.x0, rect.y0+1, rect.x1, rect.y1-INDEX_2);
/*   168 */       GUI_DispStringInRect(buf[i], &rect, (1<<0) | (3<<2));
...
/*   174 */    rect.x1 = 154 + 300;
/*   175 */    rect.y0 = 154;
/*   176 */    rect.y1 = rect.y0 + 30;
/*   178 */    LanguageSelect(FONT16B);
/*   179 */    if((value >= 1) && (value <= INDEX_5))
/*   180 */    {
/*   181 */       for(int i = 0 ; i < INDEX_4; i++)
/*   182 */       {
/*   183 */          GUI_ClearRect(rect.x0, rect.y0+1, rect.x1, rect.y1-INDEX_2);
/*   184 */          GUI_DispStringInRect(_acappdesc_label_text[SettingValue[SETUP_LANGUAGE]][value-1][i], &rect, (0) | (3<<2));
/*   185 */          GUI_SetColor(0xc8c8c8);
/*   187 */          rect.y0 += 30;
/*   188 */          rect.y1 += 30;
/*   189 */          rect.x0 = 190;
/*   190 */          rect.x1 = 190 + 250;
...
/*   192 */    }
/*   193 */ }
/*   195 */ static void MLinkIOSetApp(void)
/*   196 */ {
/*   197 */    GUI_DrawRect(130, 45, ((130+340)-1), 300);
/*   200 */    {
/*   202 */       int y0 = 45 + ((0 + 1) * 44);
/*   203 */       GUI_DrawHLine(y0, 130, ((130+340)-1));
/*   204 */    }
/*   206 */    GUI_SetColor(0xc8c8c8);
/*   208 */    LanguageSelect(FONT20);
/*   210 */    GUI_RECT rect;
/*   211 */    rect.x0 = 150;
/*   212 */    rect.x1 = 320;
/*   213 */    rect.y0 = 45;
/*   214 */    rect.y1 = (45 + 44) - 1;
/*   216 */    for(int j= 0 ; j < (6-INDEX_4); j++)
/*   217 */    {
/*   218 */       GUI_DispStringInRect(_acmlink_iostatusAPP_value_text[SettingValue[SETUP_LANGUAGE]][0][j], &rect, (0) | (3<<2));
/*   219 */       rect.y0 += 44;
/*   220 */       rect.y1 += 44;
/*   221 */    }
/*   223 */ }
/*   225 */ static void MLinkDiMakeString(unsigned short value, char result[30])
/*   226 */ {
/*   227 */    if(value == NotUsed)
/*   228 */    {
/*   229 */       (void)sprintf(result, _acmlinkiostatusDI_value_text[SettingValue[SETUP_LANGUAGE]][INDEX_0]);
/*   230 */    }
/*   231 */    else
/*   232 */    if(value == ContactAx)
/*   233 */    {
/*   234 */       (void)sprintf(result, _acmlinkiostatusDI_value_text[SettingValue[SETUP_LANGUAGE]][INDEX_1]);
/*   235 */    }
/*   236 */    else
/*   237 */    if(value == ContactAl)
/*   238 */    {
/*   239 */       (void)sprintf(result, _acmlinkiostatusDI_value_text[SettingValue[SETUP_LANGUAGE]][INDEX_2]);
/*   240 */    }
/*   241 */    else
/*   242 */    if(value == Contact)
/*   243 */    {
/*   244 */       (void)sprintf(result, _acmlinkiostatusDI_value_text[SettingValue[SETUP_LANGUAGE]][INDEX_3]);
/*   245 */    }
/*   246 */    else
/*   247 */    if(value == ContactAx2)
/*   248 */    {
/*   249 */       (void)sprintf(result, _acmlinkiostatusDI_value_text[SettingValue[SETUP_LANGUAGE]][INDEX_4]);
/*   250 */    }
/*   251 */    else
/*   252 */    if(value == ContactAl2)
/*   253 */    {
/*   254 */       (void)sprintf(result, _acmlinkiostatusDI_value_text[SettingValue[SETUP_LANGUAGE]][INDEX_5]);
/*   255 */    }
/*   256 */    else
/*   257 */    if(value == PulseWh)
/*   258 */    {
/*   259 */       (void)sprintf(result, _acmlinkiostatusDI_value_text[SettingValue[SETUP_LANGUAGE]][INDEX_6]);
/*   260 */    }
/*   261 */    else
/*   262 */    if(value == PulseVarh)
/*   263 */    {
/*   264 */       (void)sprintf(result, _acmlinkiostatusDI_value_text[SettingValue[SETUP_LANGUAGE]][INDEX_7]);
/*   265 */    }
/*   266 */    else
/*   267 */    if(value == PulseVAh)
/*   268 */    {
/*   269 */       (void)sprintf(result, _acmlinkiostatusDI_value_text[SettingValue[SETUP_LANGUAGE]][INDEX_8]);
/*   270 */    }
/*   271 */    else
/*   272 */    if(value == Pulse)
/*   273 */    {
/*   274 */       (void)sprintf(result, _acmlinkiostatusDI_value_text[SettingValue[SETUP_LANGUAGE]][INDEX_9]);
/*   275 */    }
/*   276 */    else
/*   277 */    if(value == ContactLI)
/*   278 */    {
/*   279 */       (void)sprintf(result, _acmlinkiostatusDI_value_text[SettingValue[SETUP_LANGUAGE]][INDEX_10]);
/*   280 */    }
/*   281 */    else
/*   282 */    {
/*   283 */       (void)sprintf(result, "(%02x)", value);
/*   284 */    }
/*   285 */ }
/*   287 */ static void MLinkIOSetDIValue(void)
/*   288 */ {
/*   289 */    char buf[30];
/*   291 */    GUI_SetColor(0x00FFFFFF);
/*   293 */    LanguageSelect(FONT20B);
/*   296 */    GUI_RECT rect;
/*   297 */    rect.x0 = 200;
/*   298 */    rect.y0 = 45;
/*   299 */    rect.x1 = (350 + 110) - 1;
/*   300 */    rect.y1 = (45 + 44) - 1;
/*   301 */    unsigned short index = 2031;
/*   302 */    GUI_SetBkColor(0x1c1b1a);
/*   303 */    for(int i = 0 ; i < 6; i++, index++)
/*   304 */    {
/*   305 */       MLinkDiMakeString(ModbusGetUint16(index), buf);
/*   306 */       GUI_ClearRect(rect.x0, rect.y0+1, rect.x1, rect.y1-INDEX_2);
/*   307 */       GUI_DispStringInRect(buf, &rect, (1<<0) | (3<<2));
/*   308 */       rect.y0 += 44;
/*   309 */       rect.y1 += 44;
/*   310 */    }
/*   311 */ }
/*   313 */ static void MLinkIOSetDI(void)
/*   314 */ {
/*   316 */    GUI_DrawRect(130, 45, ((130+340)-1), 45 + (INDEX_6 * 44));
/*   318 */    for(int i = 0; i < (6-1); i++)
/*   319 */    {
/*   320 */       int y0 = 45 + ((i + 1) * 44);
/*   321 */       GUI_DrawHLine(y0, 130, ((130+340)-1));
/*   322 */    }
/*   325 */    GUI_SetColor(0xc8c8c8);
/*   326 */    (void)GUI_SetFont(&GUI_Font20_ASCII);
/*   328 */    GUI_RECT rect;
/*   329 */    rect.x0 = 150;
/*   330 */    rect.x1 = 320;
/*   332 */    rect.y0 = 45;
...
/*   337 */    {
/*   338 */       GUI_DispStringInRect(_acmlinkiostatusDI_label_text[j], &rect, (0) | (3<<2));
/*   339 */       rect.y0 += 44;
/*   340 */       rect.y1 += 44;
/*   341 */    }
/*   342 */ }
/*   344 */ static void MLinkDoMakeString(const unsigned short value, char result[20])
/*   345 */ {
/*   346 */    if(value == INDEX_2)
/*   347 */    {
/*   348 */       (void)sprintf(result, _acmlink_iostatusDO_value[SettingValue[SETUP_LANGUAGE]][INDEX_2]);
/*   349 */    }
/*   350 */    else
/*   351 */    if(value == INDEX_1)
/*   352 */    {
/*   353 */       (void)sprintf(result, _acmlink_iostatusDO_value[SettingValue[SETUP_LANGUAGE]][INDEX_1]);
/*   354 */    }
/*   355 */    else
/*   356 */    {
/*   357 */       (void)sprintf(result, _acmlink_iostatusDO_value[SettingValue[SETUP_LANGUAGE]][INDEX_0]);
/*   358 */    }
/*   359 */ }
/*   361 */ static void MLinkIOSetDOValue(void)
/*   362 */ {
/*   363 */    char buf[20];
/*   365 */    GUI_SetColor(0x00FFFFFF);
/*   366 */    (void)GUI_SetFont(&GUI_Font20B_ASCII);
/*   368 */    GUI_RECT rect;
/*   369 */    rect.x0 = ((350 - 110) + INDEX_50);
/*   370 */    rect.y0 = 45;
/*   371 */    rect.x1 = (((350 + 110) - 1) - INDEX_50);
/*   372 */    rect.y1 = (45 + 44) - 1;
/*   373 */    unsigned short val = ModbusGetUint16(2021);
/*   374 */    if(val == INDEX_2)
/*   375 */    {
/*   376 */       (void)sprintf(buf, "Not SBO");
/*   377 */    }
/*   378 */    else
/*   379 */    {
/*   380 */       (void)sprintf(buf, "SBO");
/*   381 */    }
/*   382 */    GUI_SetBkColor(0x1c1b1a);
/*   383 */    GUI_ClearRect(rect.x0, rect.y0+1, rect.x1, rect.y1-INDEX_2);
/*   384 */    GUI_DispStringInRect(buf, &rect, (1<<0) | (3<<2));
/*   385 */    rect.y0 += 44;
/*   386 */    rect.y1 += 44;
/*   387 */    LanguageSelect(FONT20B);
/*   389 */    unsigned short doSetting[INDEX_4];
/*   390 */    for(int i = 0 ; i < INDEX_4; i++)
/*   391 */    {
/*   392 */       doSetting[i] = ModbusGetUint16(2024+i);
/*   393 */       if((mLinkMode[gDeviceIndex] == INDEX_3) && (i >= INDEX_2))
/*   394 */       {
/*   395 */          doSetting[i] = INDEX_2;
/*   396 */       }
/*   397 */       if(mLinkMode[gDeviceIndex] == INDEX_5)
/*   398 */       {
/*   399 */          doSetting[i] = INDEX_2;
/*   400 */       }
/*   401 */    }
/*   403 */    for(int i = 0 ; i < (6-INDEX_2); i++)
/*   404 */    {
/*   405 */       MLinkDoMakeString(doSetting[i], buf);
/*   406 */       GUI_ClearRect(rect.x0, rect.y0+1, rect.x1, rect.y1-INDEX_2);
/*   407 */       GUI_DispStringInRect(buf, &rect, (1<<0) | (3<<2));
/*   408 */       rect.y0 += 44;
/*   409 */       rect.y1 += 44;
/*   410 */    }
/*   411 */ }
/*   413 */ static void MLinkIOSetDO(void)
/*   414 */ {
/*   415 */    GUI_DrawRect(130, 45, ((130+340)-1), 45 + (INDEX_5 * 44));
/*   417 */    for(int i = 0; i < (6-INDEX_2); i++)
/*   418 */    {
/*   419 */       int y0 = 45 + ((i + 1) * 44);
/*   420 */       GUI_DrawHLine(y0, 130, ((130+340)-1));
/*   421 */    }
/*   423 */    GUI_SetColor(0xc8c8c8);
/*   424 */    (void)GUI_SetFont(&GUI_Font20_ASCII);
/*   426 */    GUI_RECT rect;
/*   427 */    rect.x0 = 150;
/*   428 */    rect.x1 = 320;
/*   429 */    rect.y0 = 45;
/*   430 */    rect.y1 = (45 + 44) - 1;
/*   432 */    for(int j= 0 ; j < (6-1); j++)
/*   433 */    {
/*   434 */       GUI_DispStringInRect(_acmlink_iostatusDO_value_text[j], &rect, (0) | (3<<2));
/*   435 */       rect.y0 += 44;
/*   436 */       rect.y1 += 44;
/*   437 */    }
/*   438 */ }
/*   440 */ static void MLinkIOSetDisp(int pos)
/*   441 */ {
/*   442 */    GUI_SetBkColor(0x1c1b1a);
/*   443 */    GUI_ClearRect(0, 34, 480-1, 320-1);
/*   444 */    (void)GUI_SetPenSize(2);
/*   446 */    MLinkIOSetMenu(pos);
/*   448 */    GUI_SetBkColor(0x1c1b1a);
/*   449 */    GUI_SetColor(0x494440);
/*   451 */    GUI_ClearRect(130, 45, ((130+340)-1), 320-1);
/*   453 */    if(pos == INDEX_0)
/*   454 */    {
/*   455 */       MLinkIOSetApp();
/*   456 */    }
...
/*   467 */    else {}
/*   468 */ }
/*   470 */ static void MLinkIOSetValueDisp(int pos)
/*   471 */ {
/*   472 */    if(pos == INDEX_0)
/*   473 */    {
/*   474 */       MLinkIOSetAppValue();
/*   475 */    }
/*   476 */    else
/*   477 */    if(pos == INDEX_1)
/*   478 */    {
/*   479 */       MLinkIOSetDIValue();
/*   480 */    }
/*   481 */    else
/*   482 */    if(pos == INDEX_2)
/*   483 */    {
/*   484 */       MLinkIOSetDOValue();
/*   485 */    }
/*   486 */    else {}
/*   487 */ }
/*   501 */ void MLinkIOSet(void)
/*   502 */ {
/*   503 */    int flagBreak = 0;
/*   504 */    nMenuPos = 0;
/*   506 */    (void)GUI_SetFont(&GUI_Font20_ASCII);
/*   507 */    GUI_ClearRect(0, 34, 480-1, 320-1);
/*   509 */    MLinkIOSetDisp(nMenuPos);
/*   510 */    MLinkIOSetSend(nMenuPos);
/*   512 */    while (1)
/*   513 */    {
/*   514 */       E_KEY key = GetKey();
/*   516 */       if(key == TIME_OUT)
/*   517 */       {
/*   518 */          gStatusSendEnd = STATUS_SEND_ING;
/*   519 */          nSendStep = 0;
/*   520 */          statusSendStep = 0;
/*   521 */          MLinkIOSetSend(nMenuPos);
/*   522 */       }
/*   523 */       else
/*   524 */       if(key == KEY_SETUP)
/*   525 */       {
/*   526 */          if(Setup() == SETUP_CHANGED)
/*   527 */          {
/*   528 */             flagBreak = 1;
/*   529 */          }
/*   530 */          GUI_ClearRect(0, 34, 480-1, 320-1);
/*   531 */          MLinkIOSetDisp(nMenuPos);
/*   532 */          gCommOldStatus[gDeviceIndex] = -1;
/*   533 */       }
/*   534 */       else
/*   535 */       if(key == KEY_UP)
/*   536 */       {
...
/*   541 */          else
/*   542 */          {
/*   543 */             nMenuPos = 4 - INDEX_2;
/*   544 */          }
/*   545 */          MLinkIOSetDisp(nMenuPos);
/*   546 */          MLinkIOSetSend(nMenuPos);
/*   547 */       }
/*   548 */       else
/*   549 */       if(key == KEY_DOWN)
/*   550 */       {
/*   551 */          if(nMenuPos < (4-INDEX_2))
/*   552 */          {
/*   553 */             nMenuPos++;
/*   554 */          }
/*   555 */          else
...
/*   557 */             nMenuPos = 0;
/*   558 */          }
/*   559 */          MLinkIOSetDisp(nMenuPos);
/*   560 */          MLinkIOSetSend(nMenuPos);
/*   561 */       }
/*   562 */       else
/*   563 */       if(key == DATA_RECV)
/*   564 */       {
/*   565 */          if(gStatusSendEnd == STATUS_SEND_ING)
/*   566 */          {
/*   567 */             StatusRecv();
/*   568 */             MLinkIOSetSend(nMenuPos);
/*   569 */          }
/*   570 */          else
/*   571 */          {
/*   572 */             MLinkIOSetValueDisp(nMenuPos);
/*   573 */             g_bRecvAllDone = 1;
/*   574 */             (void)printf("All done!!!\n");
/*   575 */          }
/*   576 */       }
/*   577 */       else
/*   578 */       if(key == KEY_CANCEL)
/*   579 */       {
/*   580 */          flagBreak = 1;
/*   581 */       }
/*   582 */       else
/*   583 */       if(key == KEY_COMM_ERROR)
/*   584 */       {
/*   585 */          (void)printf("COMM Error!! gStatusSendEnd=%d, statusSendStep=%d\n",gStatusSendEnd,statusSendStep);
/*   586 */          if(StatusRecvErrorProcess() == STATUS_SEND_ING)
/*   587 */          {
/*   588 */             nSendStep = 0;
/*   589 */          }
/*   590 */          else
/*   591 */          {
/*   592 */             MLinkIOSetSend(nMenuPos);
/*   593 */             g_bRecvAllDone = 1;
/*   595 */             (void)printf("All done!!!\n");
/*   596 */             gStatusSendEnd = STATUS_SEND_ING;
/*   597 */             statusSendStep = 0;
/*   598 */             nSendStep = 0;
/*   599 */          }
/*   600 */       }
/*   601 */       else
/*   602 */       if(key == COMM_STAT_ERROR)
/*   603 */       {
/*   604 */          GUI_ClearRect(0, 34, 480-1, 320-1);
/*   605 */          MLinkIOSetDisp(nMenuPos);
/*   606 */       }
/*   607 */       else {}
/*   608 */       if(flagBreak == 1)
/*   609 */       {
