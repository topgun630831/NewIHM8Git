...
/*   144 */ void HAL_CRC_MspInit(const CRC_HandleTypeDef *hcrc);
/*   145 */ void HAL_CRC_MspDeInit(const CRC_HandleTypeDef *hcrc);
...
/*   137 */ void HAL_SRAM_MspInit(const SRAM_HandleTypeDef *hsram);
/*   138 */ void HAL_SRAM_MspDeInit(const SRAM_HandleTypeDef *hsram);
...
/*   429 */ void HAL_SPI_MspInit(const SPI_HandleTypeDef *hspi);
/*   430 */ void HAL_SPI_MspDeInit(const SPI_HandleTypeDef *hspi);
...
/*  1346 */ void HAL_TIM_PWM_MspInit(const TIM_HandleTypeDef *htim);
/*  1347 */ void HAL_TIM_PWM_MspDeInit(const TIM_HandleTypeDef *htim);
...
/*  1466 */ void HAL_TIM_PeriodElapsedCallback(const TIM_HandleTypeDef *htim);
...
/*   635 */ void HAL_UART_MspInit(const UART_HandleTypeDef *huart);
/*   636 */ void HAL_UART_MspDeInit(const UART_HandleTypeDef *huart);
 ...
 */
/*    48 */ void HAL_TIM_MspPostInit(const TIM_HandleTypeDef *htim);
/*   194 */ HAL_StatusTypeDef HAL_Init(void);
/*   195 */ HAL_StatusTypeDef HAL_DeInit(void);
/*   196 */ void HAL_MspInit(void);
/*   197 */ void HAL_MspDeInit(void);
/*   198 */ HAL_StatusTypeDef HAL_InitTick (uint32_t TickPriority);
/*   207 */ void HAL_IncTick(void);
/*   208 */ void HAL_Delay(volatile uint32_t Delay);
/*   209 */ uint32_t HAL_GetTick(void);
/*   210 */ void HAL_SuspendTick(void);
/*   211 */ void HAL_ResumeTick(void);
/*   212 */ uint32_t HAL_GetHalVersion(void);
/*   213 */ uint32_t HAL_GetREVID(void);
/*   214 */ uint32_t HAL_GetDEVID(void);
/*   215 */ void HAL_DBGMCU_EnableDBGSleepMode(void);
/*   216 */ void HAL_DBGMCU_DisableDBGSleepMode(void);
/*   217 */ void HAL_DBGMCU_EnableDBGStopMode(void);
/*   218 */ void HAL_DBGMCU_DisableDBGStopMode(void);
/*   219 */ void HAL_DBGMCU_EnableDBGStandbyMode(void);
/*   220 */ void HAL_DBGMCU_DisableDBGStandbyMode(void);
/*   221 */ void HAL_EnableCompensationCell(void);
/*   222 */ void HAL_DisableCompensationCell(void);
/*   223 */ void HAL_GetUID(uint32_t *UID);
/*
 * C:/CodeInspection/DisplayUnit/Src/stm32f4xx_hal_msp.c
 */
/*    56 */ static void HAL_FSMC_MspInit(void);
/*    57 */ static void HAL_FSMC_MspDeInit(void);
/*    62 */ void HAL_MspInit(void)
/*    63 */ {
/*    68 */    HAL_NVIC_SetPriorityGrouping(0x00000003U);
...
/*    88 */    HAL_NVIC_SetPriority(RCC_IRQn, 0, 0);
/*    89 */    HAL_NVIC_EnableIRQ(RCC_IRQn);
/*   102 */ }
/*   192 */ void HAL_CRC_MspInit(const CRC_HandleTypeDef* hcrc)
/*   193 */ {
/*   195 */    if(hcrc->Instance==((CRC_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3000U)))
/*   196 */    {
/*   201 */       do { volatile uint32_t tmpreg = 0x00U; ((((RCC_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3800U))->AHB1ENR) |= ((0x1U << (12U)))); tmpreg = ((((RCC_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3800U))->AHB1ENR) & ((0x1U << (12U)))); ((void)(tmpreg)); } while(0U);
/*   205 */    }
/*   207 */ }
/*   209 */ void HAL_CRC_MspDeInit(const CRC_HandleTypeDef* hcrc)
/*   210 */ {
/*   212 */    if(hcrc->Instance==((CRC_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3000U)))
/*   213 */    {
/*   218 */       (((RCC_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3800U))->AHB1ENR &= ~((0x1U << (12U))));
/*   222 */    }
/*   224 */ }
/*   226 */ void HAL_SPI_MspInit(const SPI_HandleTypeDef* hspi)
/*   227 */ {
/*   229 */    GPIO_InitTypeDef GPIO_InitStruct;
/*   230 */    if(hspi->Instance==((SPI_TypeDef *) (0x40000000U + 0x3C00U)))
/*   231 */    {
/*   236 */       do { volatile uint32_t tmpreg = 0x00U; ((((RCC_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3800U))->APB1ENR) |= ((0x1U << (15U)))); tmpreg = ((((RCC_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3800U))->APB1ENR) & ((0x1U << (15U)))); ((void)(tmpreg)); } while(0U);
/*   243 */       GPIO_InitStruct.Pin = ((unsigned short)0x0400)|((unsigned short)0x0800)|((unsigned short)0x1000);
/*   244 */       GPIO_InitStruct.Mode = 0x00000002U;
/*   245 */       GPIO_InitStruct.Pull = 0x00000000U;
/*   246 */       GPIO_InitStruct.Speed = 0x00000003U;
/*   247 */       GPIO_InitStruct.Alternate = ((unsigned char)0x06);
/*   248 */       HAL_GPIO_Init(((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x0800U)), &GPIO_InitStruct);
/*   251 */       HAL_NVIC_SetPriority(SPI3_IRQn, 0, 0);
/*   252 */       HAL_NVIC_EnableIRQ(SPI3_IRQn);
/*   256 */    }
/*   258 */ }
/*   260 */ void HAL_SPI_MspDeInit(const SPI_HandleTypeDef* hspi)
/*   261 */ {
/*   263 */    if(hspi->Instance==((SPI_TypeDef *) (0x40000000U + 0x3C00U)))
/*   264 */    {
/*   269 */       (((RCC_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3800U))->APB1ENR &= ~((0x1U << (15U))));
/*   276 */       HAL_GPIO_DeInit(((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x0800U)), ((unsigned short)0x0400)|((unsigned short)0x0800)|((unsigned short)0x1000));
/*   279 */       HAL_NVIC_DisableIRQ(SPI3_IRQn);
/*   282 */       HAL_NVIC_DisableIRQ(USART2_IRQn);
/*   287 */    }
/*   289 */ }
/*   291 */ void HAL_TIM_PWM_MspInit(const TIM_HandleTypeDef* htim)
/*   292 */ {
/*   294 */    if(htim->Instance==((TIM_TypeDef *) (0x40000000U + 0x0800U)))
/*   295 */    {
/*   300 */       do { volatile uint32_t tmpreg = 0x00U; ((((RCC_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3800U))->APB1ENR) |= ((0x1U << (2U)))); tmpreg = ((((RCC_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3800U))->APB1ENR) & ((0x1U << (2U)))); ((void)(tmpreg)); } while(0U);
/*   304 */    }
/*   306 */ }
/*   307 */ void HAL_TIM_MspPostInit(const TIM_HandleTypeDef* htim)
/*   308 */ {
/*   310 */    GPIO_InitTypeDef GPIO_InitStruct;
/*   311 */    if(htim->Instance==((TIM_TypeDef *) (0x40000000U + 0x0800U)))
/*   312 */    {
/*   320 */       GPIO_InitStruct.Pin = ((unsigned short)0x0100);
/*   321 */       GPIO_InitStruct.Mode = 0x00000012U;
/*   322 */       GPIO_InitStruct.Pull = 0x00000000U;
/*   323 */       GPIO_InitStruct.Speed = 0x00000000U;
/*   324 */       GPIO_InitStruct.Alternate = ((unsigned char)0x02);
/*   325 */       HAL_GPIO_Init(((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x0400U)), &GPIO_InitStruct);
/*   327 */       HAL_GPIO_WritePin(((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x0400U)), ((unsigned short)0x0100), GPIO_PIN_SET);
/*   332 */    }
/*   334 */ }
/*   335 */ void HAL_TIM_PWM_MspDeInit(const TIM_HandleTypeDef* htim)
/*   336 */ {
/*   338 */    if(htim->Instance==((TIM_TypeDef *) (0x40000000U + 0x0800U)))
/*   339 */    {
/*   344 */       (((RCC_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3800U))->APB1ENR &= ~((0x1U << (2U))));
/*   348 */    }
/*   350 */ }
/*   352 */ void HAL_UART_MspInit(const UART_HandleTypeDef* huart)
/*   353 */ {
/*   355 */    GPIO_InitTypeDef GPIO_InitStruct;
/*   356 */    if(huart->Instance==((USART_TypeDef *) ((0x40000000U + 0x00010000U) + 0x1000U)))
/*   357 */    {
/*   362 */       do { volatile uint32_t tmpreg = 0x00U; ((((RCC_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3800U))->APB2ENR) |= ((0x1U << (4U)))); tmpreg = ((((RCC_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3800U))->APB2ENR) & ((0x1U << (4U)))); ((void)(tmpreg)); } while(0U);
/*   367 */       GPIO_InitStruct.Pin = ((unsigned short)0x0200)|((unsigned short)0x0400);
/*   368 */       GPIO_InitStruct.Mode = 0x00000002U;
/*   369 */       GPIO_InitStruct.Pull = 0x00000001U;
/*   370 */       GPIO_InitStruct.Speed = 0x00000003U;
/*   371 */       GPIO_InitStruct.Alternate = ((unsigned char)0x07);
/*   372 */       HAL_GPIO_Init(((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x0000U)), &GPIO_InitStruct);
/*   380 */    }
/*   381 */    else
/*   382 */    if(huart->Instance==((USART_TypeDef *) (0x40000000U + 0x4400U)))
/*   383 */    {
/*   388 */       do { volatile uint32_t tmpreg = 0x00U; ((((RCC_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3800U))->APB1ENR) |= ((0x1U << (17U)))); tmpreg = ((((RCC_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3800U))->APB1ENR) & ((0x1U << (17U)))); ((void)(tmpreg)); } while(0U);
/*   393 */       GPIO_InitStruct.Pin = ((unsigned short)0x0004)|((unsigned short)0x0008);
/*   394 */       GPIO_InitStruct.Mode = 0x00000002U;
/*   395 */       GPIO_InitStruct.Pull = 0x00000001U;
/*   396 */       GPIO_InitStruct.Speed = 0x00000003U;
/*   397 */       GPIO_InitStruct.Alternate = ((unsigned char)0x07);
/*   398 */       HAL_GPIO_Init(((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x0000U)), &GPIO_InitStruct);
/*   406 */    }
/*   407 */    else
/*   408 */    if(huart->Instance==((USART_TypeDef *) ((0x40000000U + 0x00010000U) + 0x1400U)))
/*   409 */    {
/*   414 */       do { volatile uint32_t tmpreg = 0x00U; ((((RCC_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3800U))->APB2ENR) |= ((0x1U << (5U)))); tmpreg = ((((RCC_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3800U))->APB2ENR) & ((0x1U << (5U)))); ((void)(tmpreg)); } while(0U);
/*   420 */       GPIO_InitStruct.Pin = ((unsigned short)0x0040)|((unsigned short)0x0080);
/*   421 */       GPIO_InitStruct.Mode = 0x00000002U;
/*   422 */       GPIO_InitStruct.Pull = 0x00000001U;
/*   423 */       GPIO_InitStruct.Speed = 0x00000001U;
/*   424 */       GPIO_InitStruct.Alternate = ((unsigned char)0x08);
/*   425 */       HAL_GPIO_Init(((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x0800U)), &GPIO_InitStruct);
/*   430 */    }
/*   431 */    else {}
/*   433 */ }
/*   435 */ void HAL_UART_MspDeInit(const UART_HandleTypeDef* huart)
/*   436 */ {
/*   438 */    if(huart->Instance==((USART_TypeDef *) ((0x40000000U + 0x00010000U) + 0x1000U)))
/*   439 */    {
/*   444 */       (((RCC_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3800U))->APB2ENR &= ~((0x1U << (4U))));
/*   450 */       HAL_GPIO_DeInit(((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x0000U)), ((unsigned short)0x0200)|((unsigned short)0x0400));
/*   457 */    }
/*   458 */    else
/*   459 */    if(huart->Instance==((USART_TypeDef *) (0x40000000U + 0x4400U)))
/*   460 */    {
/*   465 */       (((RCC_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3800U))->APB1ENR &= ~((0x1U << (17U))));
/*   474 */       HAL_NVIC_DisableIRQ(USART2_IRQn);
/*   478 */    }
/*   479 */    else if(huart->Instance==((USART_TypeDef *) ((0x40000000U + 0x00010000U) + 0x1400U)))
/*   480 */    {
/*   485 */       (((RCC_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3800U))->APB2ENR &= ~((0x1U << (5U))));
/*   491 */       HAL_GPIO_DeInit(((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x0800U)), ((unsigned short)0x0040)|((unsigned short)0x0080));
/*   496 */    }
/*   497 */    else {}
/*   499 */ }
/*   501 */ static void HAL_FSMC_MspInit(void)
/*   502 */ {
/*   503 */    static uint32_t FSMC_Initialized = 0;
/*   508 */    GPIO_InitTypeDef GPIO_InitStruct;
/*   509 */    if (FSMC_Initialized) {
/*   510 */       return;
/*   511 */    }
/*   512 */    FSMC_Initialized = 1;
/*   514 */    do { volatile uint32_t tmpreg = 0x00U; ((((RCC_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3800U))->AHB3ENR) |= ((0x1U << (0U)))); tmpreg = ((((RCC_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3800U))->AHB3ENR) & ((0x1U << (0U)))); ((void)(tmpreg)); } while(0U);
/*   538 */    GPIO_InitStruct.Pin = ((unsigned short)0x0080)|((unsigned short)0x0100)|((unsigned short)0x0200)|((unsigned short)0x0400)
/*   539 */    |((unsigned short)0x0800)|((unsigned short)0x1000)|((unsigned short)0x2000)|((unsigned short)0x4000)
/*   540 */    |((unsigned short)0x8000);
/*   541 */    GPIO_InitStruct.Mode = 0x00000002U;
/*   542 */    GPIO_InitStruct.Pull = 0x00000000U;
/*   543 */    GPIO_InitStruct.Speed = 0x00000003U;
/*   544 */    GPIO_InitStruct.Alternate = ((unsigned char)0x0C);
/*   545 */    HAL_GPIO_Init(((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x1000U)), &GPIO_InitStruct);
/*   547 */    GPIO_InitStruct.Pin = ((unsigned short)0x0100)|((unsigned short)0x0200)|((unsigned short)0x0400)|((unsigned short)0x0800)
/*   548 */    |((unsigned short)0x4000)|((unsigned short)0x8000)|((unsigned short)0x0001)|((unsigned short)0x0002)
/*   549 */    |((unsigned short)0x0010)|((unsigned short)0x0020)|((unsigned short)0x0080);
/*   550 */    GPIO_InitStruct.Mode = 0x00000002U;
/*   551 */    GPIO_InitStruct.Pull = 0x00000000U;
/*   552 */    GPIO_InitStruct.Speed = 0x00000003U;
/*   553 */    GPIO_InitStruct.Alternate = ((unsigned char)0x0C);
/*   554 */    HAL_GPIO_Init(((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x0C00U)), &GPIO_InitStruct);
/*   559 */ }
/*   561 */ void HAL_SRAM_MspInit(const SRAM_HandleTypeDef* hsram){
/*   565 */    HAL_FSMC_MspInit();
/*   569 */ }
/*   571 */ static void HAL_FSMC_MspDeInit(void)
/*   572 */ {
/*   573 */    static uint32_t FSMC_DeInitialized = 0;
/*   577 */    if (FSMC_DeInitialized) {
/*   578 */       return;
/*   579 */    }
/*   580 */    FSMC_DeInitialized = 1;
/*   582 */    (((RCC_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3800U))->AHB3ENR &= ~((0x1U << (0U))));
/*   606 */    HAL_GPIO_DeInit(((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x1000U)), ((unsigned short)0x0080)|((unsigned short)0x0100)|((unsigned short)0x0200)|((unsigned short)0x0400)
/*   607 */        |((unsigned short)0x0800)|((unsigned short)0x1000)|((unsigned short)0x2000)|((unsigned short)0x4000)
/*   608 */        |((unsigned short)0x8000));
/*   610 */    HAL_GPIO_DeInit(((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x0C00U)), ((unsigned short)0x0100)|((unsigned short)0x0200)|((unsigned short)0x0400)|((unsigned short)0x0800)
/*   611 */        |((unsigned short)0x4000)|((unsigned short)0x8000)|((unsigned short)0x0001)|((unsigned short)0x0002)
/*   612 */        |((unsigned short)0x0010)|((unsigned short)0x0020)|((unsigned short)0x0080));
/*   617 */ }
/*   619 */ void HAL_SRAM_MspDeInit(const SRAM_HandleTypeDef* hsram){
/*   623 */    HAL_FSMC_MspDeInit();
/*   627 */ }
/*   642 */ 
