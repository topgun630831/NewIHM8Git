...
/*
 * C:/CodeInspection/DisplayUnit/Src/usbh_conf.c
 */
/*    52 */ HCD_HandleTypeDef hhcd_USB_OTG_HS;
/*    53 */ void _Error_Handler(char * file, int line);
/*    57 */ int nLine=0;
/*    66 */ void HAL_HCD_MspInit(HCD_HandleTypeDef* hcdHandle)
/*    67 */ {
/*    68 */    GPIO_InitTypeDef GPIO_InitStruct;
/*    69 */    if(hcdHandle->Instance==((USB_OTG_GlobalTypeDef *) 0x40040000U))
/*    70 */    {
/*    80 */       GPIO_InitStruct.Pin = ((unsigned short)0x2000);
/*    81 */       GPIO_InitStruct.Mode = 0x00000000U;
/*    82 */       GPIO_InitStruct.Pull = 0x00000000U;
/*    83 */       HAL_GPIO_Init(((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x0400U)), &GPIO_InitStruct);
/*    85 */       GPIO_InitStruct.Pin = ((unsigned short)0x4000)|((unsigned short)0x8000);
/*    86 */       GPIO_InitStruct.Mode = 0x00000002U;
/*    87 */       GPIO_InitStruct.Pull = 0x00000000U;
/*    88 */       GPIO_InitStruct.Speed = 0x00000002U;
/*    89 */       GPIO_InitStruct.Alternate = ((unsigned char)0x0C);
/*    90 */       HAL_GPIO_Init(((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x0400U)), &GPIO_InitStruct);
/*    93 */       do { volatile uint32_t tmpreg = 0x00U; ((((RCC_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3800U))->AHB1ENR) |= ((0x1U << (29U)))); tmpreg = ((((RCC_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3800U))->AHB1ENR) & ((0x1U << (29U)))); ((void)(tmpreg)); } while(0U);
/*    96 */       HAL_NVIC_SetPriority(OTG_HS_IRQn, 0, 0);
/*    97 */       HAL_NVIC_EnableIRQ(OTG_HS_IRQn);
/*   101 */    }
/*   102 */ }
/*   104 */ void HAL_HCD_MspDeInit(HCD_HandleTypeDef* hcdHandle)
/*   105 */ {
/*   106 */    if(hcdHandle->Instance==((USB_OTG_GlobalTypeDef *) 0x40040000U))
/*   107 */    {
/*   112 */       (((RCC_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3800U))->AHB1ENR &= ~((0x1U << (29U))));
/*   119 */       HAL_GPIO_DeInit(((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x0400U)), ((unsigned short)0x2000)|((unsigned short)0x4000)|((unsigned short)0x8000));
/*   122 */       HAL_NVIC_DisableIRQ(OTG_HS_IRQn);
/*   127 */    }
/*   128 */ }
/*   135 */ void HAL_HCD_SOF_Callback(HCD_HandleTypeDef *hhcd)
/*   136 */ {
/*   137 */    USBH_LL_IncTimer (hhcd->pData);
/*   138 */ }
/*   145 */ void HAL_HCD_Connect_Callback(HCD_HandleTypeDef *hhcd)
/*   146 */ {
/*   147 */    USBH_LL_Connect(hhcd->pData);
/*   148 */ }
/*   155 */ void HAL_HCD_Disconnect_Callback(HCD_HandleTypeDef *hhcd)
/*   156 */ {
/*   157 */    USBH_LL_Disconnect(hhcd->pData);
/*   158 */ }
/*   165 */ void HAL_HCD_HC_NotifyURBChange_Callback(HCD_HandleTypeDef *hhcd, unsigned char chnum, HCD_URBStateTypeDef urb_state)
/*   166 */ {
/*   171 */ }
/*   181 */ USBH_StatusTypeDef USBH_LL_Init (USBH_HandleTypeDef *phost)
/*   182 */ {
/*   184 */    if (phost->id == 0) {
/*   186 */       hhcd_USB_OTG_HS.pData = phost;
/*   187 */       phost->pData = &hhcd_USB_OTG_HS;
/*   189 */       hhcd_USB_OTG_HS.Instance = ((USB_OTG_GlobalTypeDef *) 0x40040000U);
/*   190 */       hhcd_USB_OTG_HS.Init.Host_channels = 12;
/*   191 */       hhcd_USB_OTG_HS.Init.speed = 3U;
/*   192 */       hhcd_USB_OTG_HS.Init.dma_enable = ENABLE;
/*   193 */       hhcd_USB_OTG_HS.Init.phy_itface = 2U;
/*   194 */       hhcd_USB_OTG_HS.Init.Sof_enable = DISABLE;
/*   195 */       hhcd_USB_OTG_HS.Init.low_power_enable = DISABLE;
/*   196 */       hhcd_USB_OTG_HS.Init.vbus_sensing_enable = DISABLE;
/*   197 */       hhcd_USB_OTG_HS.Init.use_external_vbus = DISABLE;
/*   198 */       if (HAL_HCD_Init(&hhcd_USB_OTG_HS) != HAL_OK)
/*   199 */       {
/*   200 */          _Error_Handler("C:/CodeInspection/DisplayUnit/Src/usbh_conf.c", 200);
/*   201 */       }
/*   203 */       USBH_LL_SetTimer (phost, HAL_HCD_GetCurrentFrame(&hhcd_USB_OTG_HS));
/*   204 */    }
/*   205 */    return USBH_OK;
/*   206 */ }
/*   214 */ USBH_StatusTypeDef USBH_LL_DeInit (USBH_HandleTypeDef *phost)
/*   215 */ {
/*   216 */    HAL_StatusTypeDef hal_status = HAL_OK;
/*   217 */    USBH_StatusTypeDef usb_status = USBH_OK;
/*   219 */    hal_status = HAL_HCD_DeInit(phost->pData);
/*   221 */    switch (hal_status) {
/*   222 */    case HAL_OK :
/*   223 */       usb_status = USBH_OK;
/*   224 */       break;
/*   225 */    case HAL_ERROR :
/*   226 */       usb_status = USBH_FAIL;
/*   227 */       break;
/*   228 */    case HAL_BUSY :
/*   229 */       usb_status = USBH_BUSY;
/*   230 */       break;
/*   231 */    case HAL_TIMEOUT :
/*   232 */       usb_status = USBH_FAIL;
/*   233 */       break;
/*   234 */    default :
/*   235 */       usb_status = USBH_FAIL;
/*   236 */       break;
/*   237 */    }
/*   238 */    return usb_status;
/*   239 */ }
/*   247 */ USBH_StatusTypeDef USBH_LL_Start(USBH_HandleTypeDef *phost)
/*   248 */ {
/*   249 */    HAL_StatusTypeDef hal_status = HAL_OK;
/*   250 */    USBH_StatusTypeDef usb_status = USBH_OK;
/*   252 */    hal_status = HAL_HCD_Start(phost->pData);
/*   254 */    switch (hal_status) {
/*   255 */    case HAL_OK :
/*   256 */       usb_status = USBH_OK;
/*   257 */       break;
/*   258 */    case HAL_ERROR :
/*   259 */       usb_status = USBH_FAIL;
/*   260 */       break;
/*   261 */    case HAL_BUSY :
/*   262 */       usb_status = USBH_BUSY;
/*   263 */       break;
/*   264 */    case HAL_TIMEOUT :
/*   265 */       usb_status = USBH_FAIL;
/*   266 */       break;
/*   267 */    default :
/*   268 */       usb_status = USBH_FAIL;
/*   269 */       break;
/*   270 */    }
/*   271 */    return usb_status;
/*   272 */ }
/*   280 */ USBH_StatusTypeDef USBH_LL_Stop (USBH_HandleTypeDef *phost)
/*   281 */ {
/*   282 */    HAL_StatusTypeDef hal_status = HAL_OK;
/*   283 */    USBH_StatusTypeDef usb_status = USBH_OK;
/*   285 */    hal_status = HAL_HCD_Stop(phost->pData);
/*   287 */    switch (hal_status) {
/*   288 */    case HAL_OK :
/*   289 */       usb_status = USBH_OK;
/*   290 */       break;
/*   291 */    case HAL_ERROR :
/*   292 */       usb_status = USBH_FAIL;
/*   293 */       break;
/*   294 */    case HAL_BUSY :
/*   295 */       usb_status = USBH_BUSY;
/*   296 */       break;
/*   297 */    case HAL_TIMEOUT :
/*   298 */       usb_status = USBH_FAIL;
/*   299 */       break;
/*   300 */    default :
/*   301 */       usb_status = USBH_FAIL;
/*   302 */       break;
/*   303 */    }
/*   304 */    return usb_status;
/*   305 */ }
/*   313 */ USBH_SpeedTypeDef USBH_LL_GetSpeed (USBH_HandleTypeDef *phost)
/*   314 */ {
/*   315 */    USBH_SpeedTypeDef speed = USBH_SPEED_FULL;
/*   317 */    switch (HAL_HCD_GetCurrentSpeed(phost->pData))
/*   318 */    {
/*   319 */    case 0 :
...
/*   335 */    return speed;
/*   336 */ }
/*   344 */ USBH_StatusTypeDef USBH_LL_ResetPort (USBH_HandleTypeDef *phost)
/*   345 */ {
/*   346 */    HAL_StatusTypeDef hal_status = HAL_OK;
/*   347 */    USBH_StatusTypeDef usb_status = USBH_OK;
/*   349 */    hal_status = HAL_HCD_ResetPort(phost->pData);
/*   350 */    switch (hal_status) {
/*   351 */    case HAL_OK :
/*   352 */       usb_status = USBH_OK;
/*   353 */       break;
/*   354 */    case HAL_ERROR :
/*   355 */       usb_status = USBH_FAIL;
/*   356 */       break;
/*   357 */    case HAL_BUSY :
/*   358 */       usb_status = USBH_BUSY;
/*   359 */       break;
/*   360 */    case HAL_TIMEOUT :
/*   361 */       usb_status = USBH_FAIL;
/*   362 */       break;
/*   363 */    default :
/*   364 */       usb_status = USBH_FAIL;
/*   365 */       break;
/*   366 */    }
/*   367 */    return usb_status;
/*   368 */ }
/*   377 */ uint32_t USBH_LL_GetLastXferSize (USBH_HandleTypeDef *phost, unsigned char pipe)
/*   378 */ {
/*   379 */    return HAL_HCD_HC_GetXferCount(phost->pData, pipe);
/*   380 */ }
/*   394 */ USBH_StatusTypeDef USBH_LL_OpenPipe (USBH_HandleTypeDef *phost,
/*   395 */     unsigned char pipe_num,
/*   396 */     unsigned char epnum,
/*   397 */     unsigned char dev_address,
/*   398 */     unsigned char speed,
/*   399 */     unsigned char ep_type,
/*   400 */     unsigned short mps)
/*   401 */ {
/*   402 */    HAL_StatusTypeDef hal_status = HAL_OK;
/*   403 */    USBH_StatusTypeDef usb_status = USBH_OK;
/*   405 */    hal_status = HAL_HCD_HC_Init(phost->pData,
/*   406 */        pipe_num,
/*   407 */        epnum,
/*   408 */        dev_address,
/*   409 */        speed,
/*   410 */        ep_type,
/*   411 */        mps);
/*   412 */    switch (hal_status) {
/*   413 */    case HAL_OK :
/*   414 */       usb_status = USBH_OK;
/*   415 */       break;
/*   416 */    case HAL_ERROR :
/*   417 */       usb_status = USBH_FAIL;
/*   418 */       break;
/*   419 */    case HAL_BUSY :
/*   420 */       usb_status = USBH_BUSY;
/*   421 */       break;
/*   422 */    case HAL_TIMEOUT :
/*   423 */       usb_status = USBH_FAIL;
/*   424 */       break;
/*   425 */    default :
/*   426 */       usb_status = USBH_FAIL;
/*   427 */       break;
/*   428 */    }
/*   429 */    return usb_status;
/*   430 */ }
/*   439 */ USBH_StatusTypeDef USBH_LL_ClosePipe (USBH_HandleTypeDef *phost, unsigned char pipe)
/*   440 */ {
/*   441 */    HAL_StatusTypeDef hal_status = HAL_OK;
/*   442 */    USBH_StatusTypeDef usb_status = USBH_OK;
/*   444 */    hal_status = HAL_HCD_HC_Halt(phost->pData, pipe);
/*   445 */    switch (hal_status) {
/*   446 */    case HAL_OK :
/*   447 */       usb_status = USBH_OK;
/*   448 */       break;
/*   449 */    case HAL_ERROR :
/*   450 */       usb_status = USBH_FAIL;
/*   451 */       break;
/*   452 */    case HAL_BUSY :
/*   453 */       usb_status = USBH_BUSY;
/*   454 */       break;
/*   455 */    case HAL_TIMEOUT :
/*   456 */       usb_status = USBH_FAIL;
/*   457 */       break;
/*   458 */    default :
/*   459 */       usb_status = USBH_FAIL;
/*   460 */       break;
/*   461 */    }
/*   462 */    return usb_status;
/*   463 */ }
/*   494 */ USBH_StatusTypeDef USBH_LL_SubmitURB (USBH_HandleTypeDef *phost,
/*   495 */     unsigned char pipe,
/*   496 */     unsigned char direction ,
/*   497 */     unsigned char ep_type,
/*   498 */     unsigned char token,
/*   499 */     unsigned char* pbuff,
/*   500 */     unsigned short length,
/*   501 */     unsigned char do_ping )
/*   502 */ {
/*   503 */    HAL_StatusTypeDef hal_status = HAL_OK;
/*   504 */    USBH_StatusTypeDef usb_status = USBH_OK;
/*   506 */    hal_status = HAL_HCD_HC_SubmitRequest (phost->pData,
/*   507 */        pipe,
/*   508 */        direction ,
/*   509 */        ep_type,
/*   510 */        token,
...
/*   515 */    case HAL_OK :
/*   516 */       usb_status = USBH_OK;
/*   517 */       break;
/*   518 */    case HAL_ERROR :
/*   519 */       usb_status = USBH_FAIL;
/*   520 */       break;
/*   521 */    case HAL_BUSY :
/*   522 */       usb_status = USBH_BUSY;
/*   523 */       break;
/*   524 */    case HAL_TIMEOUT :
/*   525 */       usb_status = USBH_FAIL;
/*   526 */       break;
/*   527 */    default :
/*   528 */       usb_status = USBH_FAIL;
/*   529 */       break;
/*   530 */    }
/*   531 */    return usb_status;
/*   532 */ }
/*   549 */ USBH_URBStateTypeDef USBH_LL_GetURBState (USBH_HandleTypeDef *phost, unsigned char pipe)
/*   550 */ {
/*   551 */    return (USBH_URBStateTypeDef)HAL_HCD_HC_GetURBState (phost->pData, pipe);
/*   552 */ }
/*   564 */ USBH_StatusTypeDef USBH_LL_DriverVBUS (USBH_HandleTypeDef *phost, unsigned char state)
/*   565 */ {
/*   569 */    if (phost->id == 0)
/*   570 */    {
/*   571 */       if (state == 0)
...
/*   601 */    return USBH_OK;
/*   602 */ }
/*   613 */ USBH_StatusTypeDef USBH_LL_SetToggle (USBH_HandleTypeDef *phost, unsigned char pipe, unsigned char toggle)
/*   614 */ {
/*   615 */    HCD_HandleTypeDef *pHandle;
/*   616 */    pHandle = phost->pData;
/*   618 */    if(pHandle->hc[pipe].ep_is_in)
/*   619 */    {
/*   620 */       pHandle->hc[pipe].toggle_in = toggle;
/*   621 */    }
/*   622 */    else
/*   623 */    {
/*   624 */       pHandle->hc[pipe].toggle_out = toggle;
/*   625 */    }
/*   627 */    return USBH_OK;
/*   628 */ }
/*   637 */ unsigned char USBH_LL_GetToggle (USBH_HandleTypeDef *phost, unsigned char pipe)
/*   638 */ {
/*   639 */    unsigned char toggle = 0;
/*   640 */    HCD_HandleTypeDef *pHandle;
/*   641 */    pHandle = phost->pData;
/*   643 */    if(pHandle->hc[pipe].ep_is_in)
/*   644 */    {
/*   645 */       toggle = pHandle->hc[pipe].toggle_in;
/*   646 */    }
/*   647 */    else
/*   648 */    {
/*   649 */       toggle = pHandle->hc[pipe].toggle_out;
/*   650 */    }
/*   651 */    return toggle;
/*   652 */ }
/*   660 */ void USBH_Delay (uint32_t Delay)
/*   661 */ {
/*   662 */    HAL_Delay(Delay);
/*   663 */ }
/*   664 */ 
