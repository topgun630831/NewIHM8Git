...
/*
 * C:/CodeInspection/DisplayUnit/Src/system_stm32f4xx.c
 */
/*   140 */ uint32_t SystemCoreClock = 16000000;
/*   141 */ const unsigned char AHBPrescTable[16] = {0, 0, 0, 0, 0, 0, 0, 0, 1, 2, 3, 4, 6, 7, 8, 9};
/*   142 */ const unsigned char APBPrescTable[8] = {0, 0, 0, 0, 1, 2, 3, 4};
/*   170 */ void SystemInit(void)
/*   171 */ {
/*   178 */    ((RCC_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3800U))->CR |= (uint32_t)0x00000001;
/*   181 */    ((RCC_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3800U))->CFGR = 0x00000000;
/*   184 */    ((RCC_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3800U))->CR &= (uint32_t)0xFEF6FFFF;
/*   187 */    ((RCC_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3800U))->PLLCFGR = 0x24003010;
/*   190 */    ((RCC_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3800U))->CR &= (uint32_t)0xFFFBFFFF;
/*   193 */    ((RCC_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3800U))->CIR = 0x00000000;
/*   203 */    ((SCB_Type *) ((0xE000E000UL) + 0x0D00UL) )->VTOR = 0x08000000U | 0x00;
/*   205 */ }
/*   243 */ void SystemCoreClockUpdate(void)
/*   244 */ {
/*   245 */    uint32_t tmp = 0, pllvco = 0, pllp = 2, pllsource = 0, pllm = 2;
/*   248 */    tmp = ((RCC_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3800U))->CFGR & (0x3U << (2U));
/*   250 */    switch (tmp)
/*   251 */    {
/*   252 */    case 0x00:
/*   253 */       SystemCoreClock = ((uint32_t)16000000U);
/*   254 */       break;
/*   255 */    case 0x04:
/*   256 */       SystemCoreClock = ((uint32_t)8000000U);
/*   257 */       break;
/*   258 */    case 0x08:
/*   263 */       pllsource = (((RCC_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3800U))->PLLCFGR & (0x1U << (22U))) >> 22;
/*   264 */       pllm = ((RCC_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3800U))->PLLCFGR & (0x3FU << (0U));
/*   266 */       if (pllsource != 0)
/*   267 */       {
/*   269 */          pllvco = (((uint32_t)8000000U) / pllm) * ((((RCC_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3800U))->PLLCFGR & (0x1FFU << (6U))) >> 6);
/*   270 */       }
/*   271 */       else
/*   272 */       {
/*   274 */          pllvco = (((uint32_t)16000000U) / pllm) * ((((RCC_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3800U))->PLLCFGR & (0x1FFU << (6U))) >> 6);
/*   275 */       }
/*   277 */       pllp = (((((RCC_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3800U))->PLLCFGR & (0x3U << (16U))) >>16) + 1 ) *2;
/*   278 */       SystemCoreClock = pllvco/pllp;
/*   279 */       break;
/*   280 */    default:
/*   281 */       SystemCoreClock = ((uint32_t)16000000U);
/*   282 */       break;
/*   283 */    }
/*   286 */    tmp = AHBPrescTable[((((RCC_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3800U))->CFGR & (0xFU << (4U))) >> 4)];
