...
/*    72 */ void LCD_OnOff(int nOnOff);
/*    74 */ void LCD_init();
/*    75 */ void LCD_Clear(unsigned int X0, unsigned int Y0, unsigned int width, unsigned int height, unsigned long Fill_Color);
/*    76 */ void Display_String (unsigned int X0, unsigned int Y0, unsigned long Font_Color, unsigned char *Print_String);
/*    77 */ void Display_String_2X (unsigned int X0, unsigned int Y0, unsigned long Font_Color, unsigned char *Print_String);
/*    78 */ void Draw_Rectangle(unsigned int X0, unsigned int Y0, unsigned int X1, unsigned int Y1, unsigned long color);
/*    80 */ extern void CPU_Command_Write(unsigned short nData);
/*    81 */ extern void CPU_Data_Write(unsigned short nData);
/*    82 */ extern unsigned short CPU_Data_Read(void);
/*    84 */ void GUI_Text(unsigned short Xpos, unsigned short Ypos, unsigned char *str,unsigned short Color, unsigned short bkColor);
/*    86 */ extern const unsigned char ASCII_TABLE[];
/*
 * C:/CodeInspection/DisplayUnit/STemWin/Board/Inc/ads7843_ts.h
 */
...
/*    25 */ typedef struct
/*    26 */ {
/*    27 */    unsigned short TouchDetected;
/*    28 */    unsigned short X;
/*    29 */    unsigned short Y;
/*    30 */    unsigned short Z;
/*    31 */ }TS_StateTypeDef;
/*    36 */ extern Coordinate ScreenSample[3];
/*    37 */ extern Coordinate DisplaySample[3];
/*    38 */ extern Matrix matrix ;
/*    39 */ extern Coordinate display ;
/*    41 */ extern SPI_HandleTypeDef hspi3;
/*    52 */ Coordinate *Read_Ads7843(void);
/*    53 */ void TouchPanel_Calibrate(void);
/*    54 */ void DrawCross(unsigned short Xpos,unsigned short Ypos);
/*    55 */ void TP_DrawPoint(unsigned short Xpos,unsigned short Ypos);
/*    56 */ FunctionalState setCalibrationMatrix( Coordinate * displayPtr,Coordinate * screenPtr,Matrix * matrixPtr);
/*    57 */ FunctionalState getDisplayPoint(Coordinate * displayPtr,Coordinate * screenPtr,Matrix * matrixPtr );
/*    58 */ void TS_Get_Coordinate_Display();
/*    60 */ void BSP_Pointer_Update(void);
/*    61 */ void BSP_TS_GetState(TS_StateTypeDef* TsState);
/*
 * C:/CodeInspection/DisplayUnit/STemWin/Board/Inc/backlight.h
 */
/*     5 */ extern TIM_HandleTypeDef htim4;
/*     7 */ extern void HAL_TIM_MspPostInit(TIM_HandleTypeDef *htim);
/*     8 */ extern void User_Pwm_Setup();
/*
...
/*   174 */ unsigned char g_UartRx[1];
/*   176 */ unsigned char g_modbusRxIndex;
/*   177 */ unsigned char g_modbusRxBuff[500];
/*   178 */ unsigned char g_modbusRxDone;
/*   179 */ unsigned char g_modbusRxError;
/*   181 */ unsigned short g_wModbusWaitLen;
/*   182 */ unsigned char g_modbusAddress;
/*   183 */ unsigned char g_functionCode;
/*   184 */ unsigned char g_subFunction;
/*   185 */ unsigned short g_startAddr;
/*   186 */ unsigned short g_waitReceiveLen;
/*   187 */ unsigned char g_AddressRecv;
/*   188 */ unsigned char sendFlag;
/*   189 */ unsigned short gSystemEventIndex[8];
/*   190 */ unsigned short gFaultEventIndex[8];
/*   191 */ unsigned short gOldSystemEventIndex[8];
/*   192 */ unsigned short gOldFaultEventIndex[8];
/*   193 */ unsigned short gSystemEventTotalCount[8];
/*   194 */ unsigned short gFaultEventTotalCount[8];
/*   195 */ unsigned short gFaultEventReaded[8];
/*   196 */ S_PRODUCT_INFO gProductInfo[8];
/*   197 */ int nSendStep;
/*   198 */ int gCommStatus[8];
/*   199 */ int gCommOldStatus[8];
/*   200 */ int gCommErrorCount[8];
/*   202 */ int g_nStatusNoUpdate;
/*   204 */ int g_bRecvVariable;
/*   205 */ int g_bRecvAllDone;
/*   207 */ char VendorName[20];
/*   208 */ char ModbusVersion[20];
/*   209 */ char serialNo[20];
/*   210 */ char productCode[20];
/*   211 */ char hardwarVersion[20];
/*   212 */ char softwareVersion[20];
/*   213 */ unsigned short gGroupOffset[8];
/*   215 */ int gDeviceTypeAll[8];
/*   216 */ int gbSettingTime;
/*   218 */ char gProductName[8][60];
/*   219 */ unsigned short mLinkMode[8];
/*   220 */ unsigned short mLinkSBO[8];
...
/*
 * C:/CodeInspection/DisplayUnit/Src/main.c
 */
/*    72 */ static void ReceiveTask(void);
/*    73 */ static void EmWinTask(void);
/*    74 */ static void EmWinTask(void);
/*    75 */ static void OS_HAL_Init(void);
/*    76 */ static void OS_Sysclock_Config(void);
/*    77 */ static void Board_Init(void);
/*    78 */ static uint32_t GetSector(uint32_t Address);
/*    79 */ static unsigned short PCF2129_set_register( unsigned char addr, unsigned char data );
/*    80 */ static unsigned short PCF2129_read_register( unsigned char addr );
/*    81 */ static unsigned char i2bcd( unsigned char n );
/*    82 */ static unsigned char bcd2i( unsigned char bcd );
/*    86 */ static I2C_HandleTypeDef hi2c2;
/*    92 */ SPI_HandleTypeDef hspi3;
/*    93 */ TIM_HandleTypeDef htim4;
/*    94 */ UART_HandleTypeDef huart1;
/*    96 */ UART_HandleTypeDef huart2;
/*    98 */ static UART_HandleTypeDef huart6;
/*    99 */ IWDG_HandleTypeDef hiwdg;
/*   105 */ static FLASH_EraseInitTypeDef EraseInitStruct;
/*   142 */ int fputc(int ch, FILE *f)
/*   143 */ {
/*   148 */    (void)HAL_UART_Transmit(&huart6, (unsigned char *)&ch, 1, 0xFFFF);
/*   149 */    return ch;
/*   150 */ }
/*   167 */ static void MX_GPIO_Init(void);
/*   168 */ static void MX_USART1_UART_Init(void);
/*   169 */ static void MX_USART6_UART_Init(void);
/*   170 */ static void MX_FSMC_Init(void);
/*   171 */ static void MX_TIM4_Init(void);
/*   172 */ static void MX_SPI3_Init(void);
/*   173 */ static void MX_CRC_Init(void);
/*   194 */ static void Pcf2129AT_init(void);
/*   228 */ static void ReceiveTask(void)
/*   229 */ {
/*   230 */    int time_cnt_led=0;
/*   231 */    sendFlag = 0;
/*   232 */    while (1)
/*   233 */    {
/*   234 */       if(time_cnt_led++ >= 500)
/*   235 */       {
/*   236 */          time_cnt_led = 0;
/*   237 */          HAL_GPIO_TogglePin(((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x0800U)), ((unsigned short)0x0001));
/*   238 */       }
/*   239 */       if(sendFlag == 1)
/*   240 */       {
/*   241 */          HAL_StatusTypeDef stat;
/*   242 */          int nTimeOut = 1000;
/*   243 */          if(SettingValue[SETUP_GATEWAY_USE] == 0)
/*   244 */          {
/*   245 */             nTimeOut = 100;
/*   246 */          }
/*   247 */          int bRecvOk = 0;
/*   248 */          if(huart2.RxState == HAL_UART_STATE_READY)
/*   249 */          {
/*   250 */             unsigned short readExceptionLen = 5;
/*   251 */             if(g_functionCode == 0x2b)
/*   252 */             {
/*   253 */                readExceptionLen = 6;
/*   254 */             }
/*   255 */             stat = HAL_UART_Receive(&huart2, g_modbusRxBuff, readExceptionLen, nTimeOut);
/*   256 */             if(stat != HAL_OK)
/*   257 */             {
/*   258 */                if(++gCommErrorCount[gDeviceIndex] >= 5)
/*   259 */                {
/*   260 */                   gCommStatus[gDeviceIndex] = COMM_ERROR;
/*   261 */                   gCommErrorCount[gDeviceIndex] = 0;
/*   262 */                }
/*   263 */                g_modbusRxError = 1;
/*   264 */                (void)printf("Exception Read Error(%x)!!!!\n", (int)stat);
/*   265 */                sendFlag = 0;
/*   266 */                continue;
/*   267 */             }
/*   268 */             if((((g_modbusRxBuff[1] & INDEX_0x80) == INDEX_0x80) || (g_modbusRxBuff[0] != g_modbusAddress)) || (g_functionCode != g_modbusRxBuff[1]))
/*   269 */             {
/*   270 */                (void)printf("Exception Frame Read!!!\n");
/*   271 */                for(int i = 0; i < readExceptionLen; i++)
/*   272 */                {
/*   273 */                   (void)printf("%02X ", g_modbusRxBuff[i]);
/*   274 */                }
/*   275 */                (void)printf("\n");
/*   276 */                if(++gCommErrorCount[gDeviceIndex] >= 5)
/*   277 */                {
/*   278 */                   gCommStatus[gDeviceIndex] = COMM_ERROR;
/*   279 */                   gCommErrorCount[gDeviceIndex] = 0;
/*   280 */                }
/*   281 */                g_modbusRxError = 1;
/*   282 */                if(g_modbusRxBuff[1] & INDEX_0x80)
/*   283 */                {
/*   284 */                   (void)printf("Header Exception Error!!!!\n");
/*   285 */                }
/*   286 */                else
/*   287 */                {
/*   288 */                   (void)printf("Header Comm Error!!!!\n");
/*   289 */                }
/*   290 */                sendFlag = 0;
/*   291 */                continue;
/*   292 */             }
/*   293 */             unsigned short readLen = g_wModbusWaitLen - readExceptionLen;
/*   294 */             stat = HAL_UART_Receive(&huart2, &g_modbusRxBuff[readExceptionLen], readLen, 1000);
/*   296 */             if(stat == HAL_OK)
/*   297 */             {
/*   298 */                if(g_bRecvVariable == 0)
/*   299 */                {
/*   300 */                   g_modbusRxIndex = g_wModbusWaitLen;
/*   301 */                   g_modbusRxDone=1;
/*   302 */                   gCommStatus[gDeviceIndex] = COMM_OK;
/*   303 */                   gCommErrorCount[gDeviceIndex] = 0;
/*   304 */                   (void)printf("Recv Done!!!!\n");
/*   305 */                   bRecvOk = 1;
/*   306 */                }
/*   307 */                else
/*   308 */                {
/*   309 */                   unsigned short index = g_wModbusWaitLen;
/*   310 */                   unsigned char cnt = g_modbusRxBuff[INDEX_7];
/*   311 */                   bRecvOk = 1;
/*   312 */                   for(unsigned char i = 0; i < cnt; i++)
/*   313 */                   {
/*   314 */                      stat = HAL_UART_Receive(&huart2, &g_modbusRxBuff[index], INDEX_2, 1000);
/*   315 */                      if(stat == HAL_OK)
/*   316 */                      {
/*   317 */                         index += INDEX_2;
/*   318 */                         stat = HAL_UART_Receive(&huart2, &g_modbusRxBuff[index], g_modbusRxBuff[index-1], 1000);
/*   319 */                         if(stat == HAL_OK)
/*   320 */                         {
/*   321 */                            unsigned char len = g_modbusRxBuff[index-1];
/*   322 */                            index += len;
/*   323 */                         }
/*   324 */                         else
/*   325 */                         {
...
/*   338 */                   if(bRecvOk == 1)
/*   339 */                   {
/*   340 */                      stat = HAL_UART_Receive(&huart2, &g_modbusRxBuff[index], INDEX_2, 1000);
/*   341 */                      if(stat == HAL_OK)
/*   342 */                      {
/*   343 */                         index += INDEX_2;
/*   344 */                      }
...
/*   349 */                      if(bRecvOk == 1)
/*   350 */                      {
/*   351 */                         g_modbusRxIndex = index;
/*   352 */                         g_modbusRxDone=1;
/*   353 */                         gCommStatus[gDeviceIndex] = COMM_OK;
/*   354 */                         gCommErrorCount[gDeviceIndex] = 0;
/*   355 */                         (void)printf("[g_bRecvVariable]Recv Done!!!!\n");
/*   356 */                         bRecvOk = 1;
/*   357 */                      }
/*   358 */                   }
/*   359 */                }
...
/*   362 */             if(bRecvOk == 0)
/*   363 */             {
/*   364 */                if(++gCommErrorCount[gDeviceIndex] >= 5)
/*   365 */                {
/*   366 */                   gCommStatus[gDeviceIndex] = COMM_ERROR;
/*   367 */                   gCommErrorCount[gDeviceIndex] = 0;
/*   368 */                   (void)printf("Comm Error!!!!\n");
/*   369 */                }
/*   370 */                g_modbusRxError = 1;
/*   371 */                (void)printf("Error(%x)!!!!\n", (int)stat);
/*   372 */             }
/*   373 */          }
/*   374 */          sendFlag = 0;
/*   375 */       }
...
/*   388 */    }
/*   390 */ }
/*   477 */ static void EmWinTask(void)
/*   478 */ {
/*   480 */    (void)GUI_Init();
/*   483 */    (void)WM_SetCreateFlags((1UL << 2));
/*   503 */    GUI_UC_SetEncodeUTF8();
/*   505 */    KeyCheck();
/*   506 */    GuiMain();
/*   508 */ }
/*   512 */ static void OS_HAL_Init(void)
/*   513 */ {
/*   514 */    ((SCB_Type *) ((0xE000E000UL) + 0x0D00UL) )->VTOR = 0x0800c000;
/*   517 */    (((FLASH_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3C00U))->ACR |= (0x1U << (9U)));
/*   521 */    (((FLASH_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3C00U))->ACR |= (0x1U << (10U)));
/*   525 */    (((FLASH_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3C00U))->ACR |= (0x1U << (8U)));
/*   529 */    HAL_NVIC_SetPriorityGrouping(0x00000003U);
/*   532 */    (void)HAL_InitTick(((uint32_t)0U));
/*   540 */ }
/*   542 */ static void OS_Sysclock_Config(void)
/*   543 */ {
/*   545 */    RCC_OscInitTypeDef RCC_OscInitStruct;
/*   546 */    RCC_ClkInitTypeDef RCC_ClkInitStruct;
/*   550 */    do { volatile uint32_t tmpreg = 0x00U; ((((RCC_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3800U))->APB1ENR) |= ((0x1U << (28U)))); tmpreg = ((((RCC_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3800U))->APB1ENR) & ((0x1U << (28U)))); ((void)(tmpreg)); } while(0U);
/*   551 */    do { volatile uint32_t tmpreg = 0x00U; (((((PWR_TypeDef *) (0x40000000U + 0x7000U))->CR)) = ((((((((PWR_TypeDef *) (0x40000000U + 0x7000U))->CR))) & (~((0x1U << (14U))))) | (((0x1U << (14U))))))); tmpreg = ((((PWR_TypeDef *) (0x40000000U + 0x7000U))->CR) & ((0x1U << (14U)))); ((void)(tmpreg)); } while(0U);
/*   556 */    RCC_OscInitStruct.OscillatorType = 0x00000001U;
/*   557 */    RCC_OscInitStruct.HSEState = (0x1U << (16U));
/*   558 */    RCC_OscInitStruct.PLL.PLLState = ((unsigned char)0x02);
/*   559 */    RCC_OscInitStruct.PLL.PLLSource = (0x1U << (22U));
/*   560 */    RCC_OscInitStruct.PLL.PLLM = INDEX_4;
/*   561 */    RCC_OscInitStruct.PLL.PLLN = 168;
/*   562 */    RCC_OscInitStruct.PLL.PLLP = 0x00000002U;
/*   563 */    RCC_OscInitStruct.PLL.PLLQ = INDEX_7;
/*   564 */    if (HAL_RCC_OscConfig(&RCC_OscInitStruct) != HAL_OK)
/*   565 */    {
/*   566 */       _Error_Handler("C:/CodeInspection/DisplayUnit/Src/main.c", 566);
/*   567 */    }
/*   571 */    RCC_ClkInitStruct.ClockType = 0x00000002U|0x00000001U
/*   572 */    |0x00000004U|0x00000008U;
/*   573 */    RCC_ClkInitStruct.SYSCLKSource = 0x00000002U;
/*   574 */    RCC_ClkInitStruct.AHBCLKDivider = 0x00000000U;
/*   575 */    RCC_ClkInitStruct.APB1CLKDivider = 0x00001400U;
/*   576 */    RCC_ClkInitStruct.APB2CLKDivider = 0x00001000U;
/*   578 */    if (HAL_RCC_ClockConfig(&RCC_ClkInitStruct, 0x00000005U) != HAL_OK)
/*   579 */    {
/*   580 */       _Error_Handler("C:/CodeInspection/DisplayUnit/Src/main.c", 580);
/*   581 */    }
/*   585 */ }
/*   587 */ static void Board_Init(void)
/*   588 */ {
/*   591 */    HAL_GPIO_WritePin(((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x0000U)), ((unsigned short)0x8000), GPIO_PIN_SET);
/*   594 */    if( HAL_GPIO_ReadPin(((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x1000U)), ((unsigned short)0x0002)) == GPIO_PIN_SET){
/*   595 */       ;
/*   596 */    }
/*   597 */    else{
/*   598 */       ;
/*   599 */    }
/*   604 */    HAL_GPIO_WritePin(((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x1000U)), ((unsigned short)0x0001), GPIO_PIN_SET);
/*   605 */    HAL_Delay(10);
/*   606 */    HAL_GPIO_WritePin(((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x1000U)), ((unsigned short)0x0001), GPIO_PIN_RESET);
/*   607 */    HAL_Delay(100);
/*   608 */    HAL_GPIO_WritePin(((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x1000U)), ((unsigned short)0x0001), GPIO_PIN_SET);
/*   609 */    HAL_Delay(10);
/*   613 */    LCD_init();
/*   614 */    LCD_Clear(0, 0, 320, 480, 0x000000);
/*   615 */ }
/*   620 */ int main(void)
/*   621 */ {
/*   622 */    static int StackEmWin[4096];
/*   623 */    static OS_TASK TCBEMWIN;
/*   625 */    static int StackReceive[1024];
/*   626 */    static OS_TASK TCBRECEIVE;
/*   629 */    OS_HAL_Init();
/*   630 */    OS_Sysclock_Config();
/*   635 */    MX_GPIO_Init();
/*   636 */    HAL_GPIO_TogglePin(((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x0800U)), ((unsigned short)0x0001));
/*   638 */    MX_CRC_Init();
/*   639 */    MX_FSMC_Init();
/*   641 */    MX_TIM4_Init();
/*   642 */    MX_SPI3_Init();
/*   644 */    MX_USART6_UART_Init();
/*   648 */    MX_I2C2_Init();
/*   651 */    Board_Init();
/*   652 */    User_Pwm_Setup();
/*   654 */    FlashRead();
/*   655 */    FaultCountRead();
/*   657 */    MX_USART1_UART_Init();
/*   658 */    MX_USART2_UART_Init();
/*   661 */    BacklightBrghtness(SettingValue[SETUP_BRIGHTNESS], 0);
/*   680 */    OS_InitKern_STD();
/*   681 */    OS_InitHW();
/*   683 */    Pcf2129AT_init();
/*   684 */    (void)printf("\n\r");
/*   685 */    (void)printf("\n\r*************************");
/*   686 */    (void)printf("\n\r Smart LV Panel Display Unit");
/*   687 */    (void)printf("\n\r Modbus Version\n\r%s\n\r", _acinfo_modebus_version);
/*   688 */    (void)printf("\n\r Devie Count : %d", SettingValue[SETUP_DEVICE_COUNT]);
/*   689 */    (void)printf("\n\r starting..");
/*   690 */    (void)printf("\n\r*************************");
/*   691 */    (void)printf("\n\r");
/*   693 */    OS_CreateTask_XR ((&TCBRECEIVE), (unsigned long) (60), (&ReceiveTask), (void *)(StackReceive), sizeof(StackReceive) );
/*   694 */    OS_CreateTask_XR ((&TCBEMWIN), (unsigned long) (50), (&EmWinTask), (void *)(StackEmWin), sizeof(StackEmWin) );
/*   697 */    { __disable_interrupt(); __set_BASEPRI(128); __enable_interrupt(); __no_operation(); __no_operation(); }; OS_Running = 1u; OS_StartASM();
/*   701 */    return 0;
/*   708 */ }
/*   779 */ static void MX_I2C2_Init(void)
/*   780 */ {
/*   782 */    hi2c2.Instance = ((I2C_TypeDef *) (0x40000000U + 0x5800U));
/*   783 */    hi2c2.Init.ClockSpeed = 100000;
/*   784 */    hi2c2.Init.DutyCycle = 0x00000000U;
/*   785 */    hi2c2.Init.OwnAddress1 = 0;
/*   786 */    hi2c2.Init.AddressingMode = 0x00004000U;
/*   787 */    hi2c2.Init.DualAddressMode = 0x00000000U;
/*   788 */    hi2c2.Init.OwnAddress2 = 0;
/*   789 */    hi2c2.Init.GeneralCallMode = 0x00000000U;
/*   790 */    hi2c2.Init.NoStretchMode = 0x00000000U;
/*   791 */    if (HAL_I2C_Init(&hi2c2) != HAL_OK)
/*   792 */    {
/*   793 */       _Error_Handler("C:/CodeInspection/DisplayUnit/Src/main.c", 793);
/*   794 */    }
/*   796 */ }
/*   836 */ static void MX_CRC_Init(void)
/*   837 */ {
/*   838 */    static CRC_HandleTypeDef hcrc;
/*   840 */    hcrc.Instance = ((CRC_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3000U));
/*   841 */    if (HAL_CRC_Init(&hcrc) != HAL_OK)
/*   842 */    {
/*   843 */       _Error_Handler("C:/CodeInspection/DisplayUnit/Src/main.c", 843);
/*   844 */    }
/*   846 */ }
/*   849 */ static void MX_SPI3_Init(void)
/*   850 */ {
/*   853 */    hspi3.Instance = ((SPI_TypeDef *) (0x40000000U + 0x3C00U));
/*   854 */    hspi3.Init.Mode = ((0x1U << (2U)) | (0x1U << (8U)));
/*   855 */    hspi3.Init.Direction = 0x00000000U;
/*   856 */    hspi3.Init.DataSize = 0x00000000U;
/*   857 */    hspi3.Init.CLKPolarity = 0x00000000U;
/*   858 */    hspi3.Init.CLKPhase = 0x00000000U;
/*   859 */    hspi3.Init.NSS = (0x1U << (9U));
/*   860 */    hspi3.Init.BaudRatePrescaler = 0x00000020U;
/*   861 */    hspi3.Init.FirstBit = 0x00000000U;
/*   862 */    hspi3.Init.TIMode = 0x00000000U;
/*   863 */    hspi3.Init.CRCCalculation = 0x00000000U;
/*   864 */    hspi3.Init.CRCPolynomial = INDEX_10;
/*   865 */    if (HAL_SPI_Init(&hspi3) != HAL_OK)
/*   866 */    {
/*   867 */       _Error_Handler("C:/CodeInspection/DisplayUnit/Src/main.c", 867);
/*   868 */    }
/*   870 */ }
/*   873 */ static void MX_TIM4_Init(void)
/*   874 */ {
/*   876 */    TIM_MasterConfigTypeDef sMasterConfig;
/*   877 */    TIM_OC_InitTypeDef sConfigOC;
/*   879 */    htim4.Instance = ((TIM_TypeDef *) (0x40000000U + 0x0800U));
/*   880 */    htim4.Init.Prescaler = 0;
/*   881 */    htim4.Init.CounterMode = 0x00000000U;
/*   882 */    htim4.Init.Period = 0;
/*   883 */    htim4.Init.ClockDivision = 0x00000000U;
/*   884 */    if (HAL_TIM_PWM_Init(&htim4) != HAL_OK)
/*   885 */    {
/*   886 */       _Error_Handler("C:/CodeInspection/DisplayUnit/Src/main.c", 886);
/*   887 */    }
/*   889 */    sMasterConfig.MasterOutputTrigger = 0x00000000U;
/*   890 */    sMasterConfig.MasterSlaveMode = 0x00000000U;
/*   891 */    if (HAL_TIMEx_MasterConfigSynchronization(&htim4, &sMasterConfig) != HAL_OK)
/*   892 */    {
/*   893 */       _Error_Handler("C:/CodeInspection/DisplayUnit/Src/main.c", 893);
/*   894 */    }
/*   896 */    sConfigOC.OCMode = ((0x2U << (4U)) | (0x4U << (4U)));
/*   897 */    sConfigOC.Pulse = 0;
/*   898 */    sConfigOC.OCPolarity = 0x00000000U;
/*   899 */    sConfigOC.OCFastMode = 0x00000000U;
/*   900 */    if (HAL_TIM_PWM_ConfigChannel(&htim4, &sConfigOC, 0x00000008U) != HAL_OK)
/*   901 */    {
/*   902 */       _Error_Handler("C:/CodeInspection/DisplayUnit/Src/main.c", 902);
/*   903 */    }
/*   905 */    HAL_TIM_MspPostInit(&htim4);
/*   907 */ }
/*   910 */ static void MX_USART1_UART_Init(void)
/*   911 */ {
/*   913 */    huart1.Instance = ((USART_TypeDef *) ((0x40000000U + 0x00010000U) + 0x1000U));
/*   914 */    huart1.Init.BaudRate = 9600;
/*   915 */    huart1.Init.WordLength = 0x00000000U;
/*   916 */    huart1.Init.StopBits = 0x00000000U;
/*   917 */    huart1.Init.Parity = 0x00000000U;
/*   918 */    huart1.Init.Mode = ((uint32_t)((0x1U << (3U)) |(0x1U << (2U))));
/*   919 */    huart1.Init.HwFlowCtl = 0x00000000U;
/*   920 */    huart1.Init.OverSampling = 0x00000000U;
/*   921 */    if (HAL_UART_Init(&huart1) != HAL_OK)
/*   922 */    {
/*   923 */       _Error_Handler("C:/CodeInspection/DisplayUnit/Src/main.c", 923);
/*   924 */    }
/*   925 */ }
/*   929 */ void MX_USART2_UART_Init(void)
/*   930 */ {
/*   931 */    huart2.Instance = ((USART_TypeDef *) (0x40000000U + 0x4400U));
/*   935 */    huart2.Init.BaudRate = setup_speed[SettingValue[SETUP_SPEED]];
/*   937 */    huart2.Init.WordLength = 0x00000000U;
/*   938 */    huart2.Init.StopBits = 0x00000000U;
/*   939 */    huart2.Init.Parity = 0x00000000U;
/*   940 */    huart2.Init.Mode = ((uint32_t)((0x1U << (3U)) |(0x1U << (2U))));
/*   941 */    huart2.Init.HwFlowCtl = 0x00000000U;
/*   942 */    huart2.Init.OverSampling = 0x00000000U;
/*   943 */    if (HAL_UART_Init(&huart2) != HAL_OK)
/*   944 */    {
/*   945 */       _Error_Handler("C:/CodeInspection/DisplayUnit/Src/main.c", 945);
/*   946 */    }
/*   948 */ }
/*   953 */ static void MX_USART6_UART_Init(void)
/*   954 */ {
/*   956 */    huart6.Instance = ((USART_TypeDef *) ((0x40000000U + 0x00010000U) + 0x1400U));
/*   957 */    huart6.Init.BaudRate = 115200;
/*   958 */    huart6.Init.WordLength = 0x00000000U;
/*   959 */    huart6.Init.StopBits = 0x00000000U;
/*   960 */    huart6.Init.Parity = 0x00000000U;
/*   961 */    huart6.Init.Mode = ((uint32_t)((0x1U << (3U)) |(0x1U << (2U))));
/*   962 */    huart6.Init.HwFlowCtl = 0x00000000U;
/*   963 */    huart6.Init.OverSampling = 0x00000000U;
/*   964 */    if (HAL_UART_Init(&huart6) != HAL_OK)
/*   965 */    {
/*   966 */       _Error_Handler("C:/CodeInspection/DisplayUnit/Src/main.c", 966);
/*   967 */    }
/*   969 */ }
/*   978 */ static void MX_GPIO_Init(void)
/*   979 */ {
/*   981 */    GPIO_InitTypeDef GPIO_InitStruct;
/*   984 */    do { volatile uint32_t tmpreg = 0x00U; ((((RCC_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3800U))->AHB1ENR) |= ((0x1U << (0U)))); tmpreg = ((((RCC_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3800U))->AHB1ENR) & ((0x1U << (0U)))); ((void)(tmpreg)); } while(0U);
/*   985 */    do { volatile uint32_t tmpreg = 0x00U; ((((RCC_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3800U))->AHB1ENR) |= ((0x1U << (1U)))); tmpreg = ((((RCC_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3800U))->AHB1ENR) & ((0x1U << (1U)))); ((void)(tmpreg)); } while(0U);
/*   986 */    do { volatile uint32_t tmpreg = 0x00U; ((((RCC_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3800U))->AHB1ENR) |= ((0x1U << (2U)))); tmpreg = ((((RCC_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3800U))->AHB1ENR) & ((0x1U << (2U)))); ((void)(tmpreg)); } while(0U);
/*   987 */    do { volatile uint32_t tmpreg = 0x00U; ((((RCC_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3800U))->AHB1ENR) |= ((0x1U << (3U)))); tmpreg = ((((RCC_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3800U))->AHB1ENR) & ((0x1U << (3U)))); ((void)(tmpreg)); } while(0U);
/*   988 */    do { volatile uint32_t tmpreg = 0x00U; ((((RCC_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3800U))->AHB1ENR) |= ((0x1U << (4U)))); tmpreg = ((((RCC_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3800U))->AHB1ENR) & ((0x1U << (4U)))); ((void)(tmpreg)); } while(0U);
/*   989 */    do { volatile uint32_t tmpreg = 0x00U; ((((RCC_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3800U))->AHB1ENR) |= ((0x1U << (7U)))); tmpreg = ((((RCC_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3800U))->AHB1ENR) & ((0x1U << (7U)))); ((void)(tmpreg)); } while(0U);
/*   999 */    GPIO_InitStruct.Pin = ((unsigned short)0x0008);
/*  1000 */    GPIO_InitStruct.Mode = 0x00000001U;
/*  1001 */    GPIO_InitStruct.Pull = 0x00000000U;
/*  1002 */    GPIO_InitStruct.Speed = 0x00000000U;
/*  1003 */    HAL_GPIO_Init(((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x1000U)), &GPIO_InitStruct);
/*  1006 */    HAL_GPIO_WritePin(((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x1000U)), ((unsigned short)0x0008)|((unsigned short)0x0004), GPIO_PIN_SET);
/*  1015 */    GPIO_InitStruct.Pin = ((unsigned short)0x0001);
/*  1016 */    GPIO_InitStruct.Mode = 0x00000001U;
/*  1017 */    GPIO_InitStruct.Pull = 0x00000000U;
/*  1018 */    GPIO_InitStruct.Speed = 0x00000000U;
/*  1019 */    HAL_GPIO_Init(((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x0800U)), &GPIO_InitStruct);
/*  1022 */    GPIO_InitStruct.Pin = ((unsigned short)0x0100) | ((unsigned short)0x0020) | ((unsigned short)0x0040) | ((unsigned short)0x0080) | ((unsigned short)0x0010) | ((unsigned short)0x0200);
/*  1023 */    GPIO_InitStruct.Mode = 0x00000000U;
/*  1024 */    GPIO_InitStruct.Pull = 0x00000000U;
/*  1025 */    HAL_GPIO_Init(((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x0000U)), &GPIO_InitStruct);
/*  1028 */    GPIO_InitStruct.Pin = ((unsigned short)0x8000);
/*  1029 */    GPIO_InitStruct.Mode = 0x00000001U;
/*  1030 */    GPIO_InitStruct.Pull = 0x00000000U;
/*  1031 */    GPIO_InitStruct.Speed = 0x00000002U;
/*  1032 */    HAL_GPIO_Init(((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x0000U)), &GPIO_InitStruct);
/*  1042 */    GPIO_InitStruct.Pin = ((unsigned short)0x0040);
/*  1043 */    GPIO_InitStruct.Mode = 0x00000001U;
/*  1044 */    GPIO_InitStruct.Pull = 0x00000001U;
/*  1045 */    GPIO_InitStruct.Speed = 0x00000000U;
/*  1046 */    HAL_GPIO_Init(((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x1000U)), &GPIO_InitStruct);
/*  1057 */    GPIO_InitStruct.Pin = ((unsigned short)0x4000);
/*  1058 */    GPIO_InitStruct.Mode = 0x00000001U;
/*  1059 */    GPIO_InitStruct.Pull = 0x00000000U;
/*  1060 */    GPIO_InitStruct.Speed = 0x00000000U;
/*  1061 */    HAL_GPIO_Init(((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x0400U)), &GPIO_InitStruct);
/*  1063 */    HAL_GPIO_WritePin(((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x0400U)), ((unsigned short)0x4000), GPIO_PIN_RESET);
/*  1065 */ }
/*  1068 */ static void MX_FSMC_Init(void)
/*  1069 */ {
/*  1070 */    FSMC_NORSRAM_TimingTypeDef Timing;
/*  1071 */    static SRAM_HandleTypeDef hsram1;
/*  1075 */    hsram1.Instance = ((FSMC_Bank1_TypeDef *) (0xA0000000U + 0x0000U));
/*  1076 */    hsram1.Extended = ((FSMC_Bank1E_TypeDef *) (0xA0000000U + 0x0104U));
/*  1078 */    hsram1.Init.NSBank = 0x00000000U;
/*  1079 */    hsram1.Init.DataAddressMux = 0x00000000U;
/*  1080 */    hsram1.Init.MemoryType = 0x00000000U;
/*  1081 */    hsram1.Init.MemoryDataWidth = 0x00000010U;
/*  1082 */    hsram1.Init.BurstAccessMode = 0x00000000U;
/*  1083 */    hsram1.Init.WaitSignalPolarity = 0x00000000U;
/*  1084 */    hsram1.Init.WrapMode = 0x00000000U;
/*  1085 */    hsram1.Init.WaitSignalActive = 0x00000000U;
/*  1086 */    hsram1.Init.WriteOperation = 0x00001000U;
/*  1087 */    hsram1.Init.WaitSignal = 0x00000000U;
/*  1088 */    hsram1.Init.ExtendedMode = 0x00000000U;
/*  1089 */    hsram1.Init.AsynchronousWait = 0x00000000U;
/*  1090 */    hsram1.Init.WriteBurst = 0x00000000U;
/*  1091 */    hsram1.Init.PageSize = 0x00000000U;
/*  1093 */    Timing.AddressSetupTime = 4;
/*  1094 */    Timing.AddressHoldTime = 15;
/*  1095 */    Timing.DataSetupTime = 40;
/*  1096 */    Timing.BusTurnAroundDuration = 0;
/*  1097 */    Timing.CLKDivision = 16;
/*  1098 */    Timing.DataLatency = 17;
/*  1099 */    Timing.AccessMode = 0x00000000U;
/*  1102 */    if (HAL_SRAM_Init(&hsram1, &Timing, ((void *) 0)) != HAL_OK)
/*  1103 */    {
/*  1104 */       _Error_Handler("C:/CodeInspection/DisplayUnit/Src/main.c", 1104);
/*  1105 */    }
/*  1107 */ }
/*  1121 */ void HAL_TIM_PeriodElapsedCallback(TIM_HandleTypeDef *htim)
/*  1122 */ {
/*  1127 */    if (htim->Instance == ((TIM_TypeDef *) (0x40000000U + 0x0000U))) {
/*  1128 */       HAL_IncTick();
/*  1129 */    }
/*  1133 */ }
/*  1142 */ void _Error_Handler(char * file, int line)
/*  1143 */ {
/*  1144 */    (void)printf("Error file:%s Line:%d\n", file, line);
/*  1147 */    while(1)
/*  1148 */    {
/*  1149 */    }
/*  1151 */ }
/*  1181 */ static uint32_t GetSector(uint32_t Address)
/*  1182 */ {
/*  1183 */    uint32_t sector = 0;
/*  1185 */    if((Address < ((uint32_t)0x08004000)) && (Address >= ((uint32_t)0x08000000)))
/*  1186 */    {
/*  1187 */       sector = 0U;
/*  1188 */    }
/*  1189 */    else if((Address < ((uint32_t)0x08008000)) && (Address >= ((uint32_t)0x08004000)))
/*  1190 */    {
/*  1191 */       sector = 1U;
/*  1192 */    }
/*  1193 */    else if((Address < ((uint32_t)0x0800C000)) && (Address >= ((uint32_t)0x08008000)))
/*  1194 */    {
/*  1195 */       sector = 2U;
/*  1196 */    }
/*  1197 */    else if((Address < ((uint32_t)0x08010000)) && (Address >= ((uint32_t)0x0800C000)))
/*  1198 */    {
/*  1199 */       sector = 3U;
/*  1200 */    }
/*  1201 */    else if((Address < ((uint32_t)0x08020000)) && (Address >= ((uint32_t)0x08010000)))
/*  1202 */    {
/*  1203 */       sector = 4U;
/*  1204 */    }
/*  1205 */    else if((Address < ((uint32_t)0x08040000)) && (Address >= ((uint32_t)0x08020000)))
/*  1206 */    {
/*  1207 */       sector = 5U;
/*  1208 */    }
/*  1209 */    else if((Address < ((uint32_t)0x08060000)) && (Address >= ((uint32_t)0x08040000)))
/*  1210 */    {
/*  1211 */       sector = 6U;
/*  1212 */    }
/*  1213 */    else if((Address < ((uint32_t)0x08080000)) && (Address >= ((uint32_t)0x08060000)))
/*  1214 */    {
/*  1215 */       sector = 7U;
/*  1216 */    }
/*  1217 */    else if((Address < ((uint32_t)0x080A0000)) && (Address >= ((uint32_t)0x08080000)))
/*  1218 */    {
/*  1219 */       sector = 8U;
/*  1220 */    }
/*  1221 */    else if((Address < ((uint32_t)0x080C0000)) && (Address >= ((uint32_t)0x080A0000)))
/*  1222 */    {
/*  1223 */       sector = 9U;
/*  1224 */    }
/*  1225 */    else if((Address < ((uint32_t)0x080E0000)) && (Address >= ((uint32_t)0x080C0000)))
/*  1226 */    {
/*  1227 */       sector = 10U;
/*  1228 */    }
/*  1229 */    else
...
/*  1234 */    return sector;
/*  1235 */ }
/*  1330 */ void FlashRead(void)
/*  1331 */ {
/*  1332 */    uint32_t Address = ((uint32_t)0x080C0000);
/*  1333 */    Address = ((uint32_t)0x080C0000);
/*  1334 */    unsigned short data;
/*  1335 */    data = *(volatile unsigned short*)Address;
/*  1336 */    (void)printf(" Flash Read ID %04x\n", data);
/*  1338 */    if(data == 0x5599)
/*  1339 */    {
/*  1340 */       (void)printf("Read Falsh.............\n");
/*  1341 */       Address += INDEX_2;
/*  1342 */       for(int i = 0; i < (SETUP_COUNT-1); i++)
/*  1343 */       {
/*  1344 */          SettingValue[i] = *(volatile unsigned short*)Address;
/*  1345 */          Address += INDEX_2;
/*  1346 */       }
/*  1347 */       for(int i = 0; i < 8; i++)
/*  1348 */       {
/*  1349 */          ConnectSetting[i].DeviceType = (E_DEVICE_TYPE)(*(volatile unsigned short*)Address);
/*  1350 */          Address += INDEX_2;
/*  1351 */          ConnectSetting[i].Address = *(volatile unsigned short*)Address;
/*  1352 */          Address += INDEX_2;
/*  1353 */       }
/*  1354 */       SettingValue[SETUP_GATEWAY_USE] = *(volatile unsigned short*)Address;
/*  1355 */       gDeviceCount = SettingValue[SETUP_DEVICE_COUNT];
/*  1356 */    }
/*  1357 */ }
/*  1360 */ void FlashWrite(void)
/*  1361 */ {
/*  1362 */    uint32_t FirstSector = 0, NbOfSectors = 0, Address = 0;
/*  1363 */    uint32_t SectorError = 0;
/*  1365 */    (void)HAL_FLASH_Unlock();
/*  1371 */    FirstSector = GetSector(((uint32_t)0x080C0000));
/*  1373 */    NbOfSectors = (GetSector(((uint32_t)0x080C0000)) - FirstSector) + 1;
/*  1376 */    EraseInitStruct.TypeErase = 0x00000000U;
/*  1377 */    EraseInitStruct.VoltageRange = 0x00000002U;
/*  1378 */    EraseInitStruct.Sector = FirstSector;
/*  1379 */    EraseInitStruct.NbSectors = NbOfSectors;
/*  1380 */    if(HAL_FLASHEx_Erase(&EraseInitStruct, &SectorError) != HAL_OK)
/*  1381 */    {
/*  1391 */       _Error_Handler("C:/CodeInspection/DisplayUnit/Src/main.c", 1391);
/*  1393 */    }
/*  1399 */    (((FLASH_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3C00U))->ACR &= (~(0x1U << (10U))));
/*  1400 */    (((FLASH_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3C00U))->ACR &= (~(0x1U << (9U))));
/*  1402 */    do {((FLASH_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3C00U))->ACR |= (0x1U << (12U)); ((FLASH_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3C00U))->ACR &= ~(0x1U << (12U)); }while(0U);
/*  1403 */    do {((FLASH_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3C00U))->ACR |= (0x1U << (11U)); ((FLASH_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3C00U))->ACR &= ~(0x1U << (11U)); }while(0U);
/*  1405 */    (((FLASH_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3C00U))->ACR |= (0x1U << (9U)));
/*  1406 */    (((FLASH_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3C00U))->ACR |= (0x1U << (10U)));
/*  1413 */    Address = ((uint32_t)0x080C0000);
/*  1415 */    if (HAL_FLASH_Program(0x00000001U, Address, 0x5599) == HAL_OK)
/*  1416 */    {
/*  1417 */       Address += INDEX_2;
/*  1418 */       for(int i = 0; i < (SETUP_COUNT-1); i++)
/*  1419 */       {
/*  1420 */          if(HAL_FLASH_Program(0x00000001U, Address, SettingValue[i]) != HAL_OK)
/*  1421 */          {
/*  1422 */             (void)printf("Write Fail SettingValue[%d]\n", i);
/*  1423 */          }
/*  1424 */          Address += INDEX_2;
/*  1425 */       }
/*  1426 */       for(int i = 0; i < 8; i++)
/*  1427 */       {
/*  1428 */          if(HAL_FLASH_Program(0x00000001U, Address, ConnectSetting[i].DeviceType) != HAL_OK)
/*  1429 */          {
/*  1430 */             (void)printf("Write Fail ConnectSetting[%d].DeviceType\n", i);
/*  1431 */          }
/*  1432 */          Address += INDEX_2;
/*  1433 */          if(HAL_FLASH_Program(0x00000001U, Address, ConnectSetting[i].Address) != HAL_OK)
/*  1434 */          {
/*  1435 */             (void)printf("Write Fail ConnectSetting[%d].Address\n", i);
/*  1436 */          }
/*  1437 */          Address += INDEX_2;
/*  1438 */       }
/*  1439 */       if(HAL_FLASH_Program(0x00000001U, Address, SettingValue[SETUP_GATEWAY_USE]) != HAL_OK)
/*  1440 */       {
/*  1441 */          (void)printf("Write Fail SettingValue[SETUP_GATEWAY_USE]\n");
/*  1442 */       }
/*  1443 */    }
/*  1444 */    else
/*  1445 */    {
/*  1446 */       (void)printf("Write Fail SETUP_WRITE_ID\n");
/*  1447 */    }
/*  1450 */    (void)HAL_FLASH_Lock();
/*  1451 */ }
/*  1454 */ void FaultCountRead(void)
/*  1455 */ {
/*  1456 */    uint32_t Address = ((uint32_t)0x080E0000);
/*  1457 */    Address = ((uint32_t)0x080E0000);
/*  1458 */    unsigned short data;
/*  1459 */    data = *(volatile unsigned short*)Address;
/*  1460 */    (void)printf(" Flash Fault Read ID %04x\n", data);
/*  1462 */    if(data == 0x5599)
/*  1463 */    {
/*  1464 */       (void)printf("Read Falsh.............\n");
/*  1465 */       Address += INDEX_2;
/*  1466 */       for(int i = 0; i < 8; i++)
/*  1467 */       {
/*  1468 */          gOldFaultEventIndex[i] = (E_DEVICE_TYPE)(*(volatile unsigned short*)Address);
/*  1469 */          Address += INDEX_2;
/*  1470 */       }
/*  1471 */    }
/*  1472 */    Address = ((uint32_t)0x080E0000) + 0x30;
/*  1473 */    for(int i = 0; i < INDEX_8; i++, Address++)
/*  1474 */    {
/*  1475 */       _acHardwareVersion[i] = *(volatile char*)Address;
/*  1476 */    }
/*  1477 */    _acHardwareVersion[INDEX_8] = 0;
/*  1478 */ }
/*  1481 */ void FaultCountWrite(void)
/*  1482 */ {
/*  1483 */    (void)printf("FaultCountWrite();\n");
/*  1484 */    uint32_t FirstSector = 0, NbOfSectors = 0, Address = 0;
/*  1485 */    uint32_t SectorError = 0;
/*  1487 */    (void)HAL_FLASH_Unlock();
/*  1493 */    FirstSector = GetSector(((uint32_t)0x080E0000));
/*  1495 */    NbOfSectors = (GetSector(((uint32_t)0x080E0000)) - FirstSector) + 1;
/*  1498 */    EraseInitStruct.TypeErase = 0x00000000U;
/*  1499 */    EraseInitStruct.VoltageRange = 0x00000002U;
/*  1500 */    EraseInitStruct.Sector = FirstSector;
/*  1501 */    EraseInitStruct.NbSectors = NbOfSectors;
/*  1502 */    if(HAL_FLASHEx_Erase(&EraseInitStruct, &SectorError) != HAL_OK)
/*  1503 */    {
/*  1513 */       _Error_Handler("C:/CodeInspection/DisplayUnit/Src/main.c", 1513);
/*  1515 */    }
/*  1521 */    (((FLASH_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3C00U))->ACR &= (~(0x1U << (10U))));
/*  1522 */    (((FLASH_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3C00U))->ACR &= (~(0x1U << (9U))));
/*  1524 */    do {((FLASH_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3C00U))->ACR |= (0x1U << (12U)); ((FLASH_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3C00U))->ACR &= ~(0x1U << (12U)); }while(0U);
/*  1525 */    do {((FLASH_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3C00U))->ACR |= (0x1U << (11U)); ((FLASH_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3C00U))->ACR &= ~(0x1U << (11U)); }while(0U);
/*  1527 */    (((FLASH_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3C00U))->ACR |= (0x1U << (9U)));
/*  1528 */    (((FLASH_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3C00U))->ACR |= (0x1U << (10U)));
/*  1535 */    Address = ((uint32_t)0x080E0000);
/*  1537 */    if (HAL_FLASH_Program(0x00000001U, Address, 0x5599) == HAL_OK)
/*  1538 */    {
/*  1539 */       Address += INDEX_2;
/*  1540 */       for(int i = 0; i < 8; i++)
/*  1541 */       {
/*  1542 */          if(HAL_FLASH_Program(0x00000001U, Address, gOldFaultEventIndex[i]) != HAL_OK)
/*  1543 */          {
/*  1544 */             (void)printf("Write Fail gOldFaultEventIndex[%d]\n", i);
/*  1545 */          }
/*  1546 */          Address += INDEX_2;
/*  1547 */       }
/*  1548 */    }
/*  1549 */    else
/*  1550 */    {
/*  1551 */       (void)printf("Write Fail FAULT SETUP_WRITE_ID\n");
/*  1553 */    }
/*  1555 */    Address = ((uint32_t)0x080E0000)+0x30;
/*  1556 */    for(int i = 0; i < INDEX_8; i++, Address++)
/*  1557 */    {
/*  1558 */       if(HAL_FLASH_Program(0x00000000U, Address, (uint64_t)_acHardwareVersion[i]) != HAL_OK)
/*  1559 */       {
/*  1560 */          (void)printf("Write Fail _acHardwareVersion[%d]\n", i);
/*  1561 */       }
/*  1562 */    }
/*  1565 */    (void)HAL_FLASH_Lock();
/*  1566 */ }
/*  1568 */ static unsigned short PCF2129_set_register( unsigned char addr, unsigned char data )
/*  1569 */ {
/*  1570 */    unsigned char b[ INDEX_2 ];
/*  1572 */    b[ 0 ] = addr;
/*  1573 */    b[ 1 ] = data;
/*  1575 */    return (HAL_I2C_Master_Transmit(&hi2c2, 0xA2, b, sizeof(b), 50));
/*  1576 */ }
/*  1578 */ static unsigned short PCF2129_read_register( unsigned char addr )
/*  1579 */ {
/*  1580 */    unsigned char data;
/*  1582 */    data = addr;
/*  1583 */    (void)HAL_I2C_Master_Transmit(&hi2c2, 0xA2, &data, 1, 50);
/*  1584 */    (void)HAL_I2C_Master_Receive(&hi2c2, 0xA2, &data, 1, 50);
/*  1586 */    return ( data );
/*  1587 */ }
/*  1589 */ static unsigned char i2bcd( unsigned char n )
/*  1590 */ {
/*  1591 */    return ( ((n / INDEX_10) << INDEX_4) | (n % INDEX_10) );
/*  1592 */ }
/*  1594 */ static unsigned char bcd2i( unsigned char bcd )
/*  1595 */ {
/*  1596 */    return ( ((bcd >> INDEX_4) * INDEX_10) + (bcd & 0x0F) );
/*  1597 */ }
/*  1599 */ unsigned short PCF2127_set_time(void)
/*  1600 */ {
/*  1601 */    unsigned char data[INDEX_8];
/*  1602 */    unsigned char err;
/*  1604 */    data[0] = Seconds;
/*  1606 */    data[ INDEX_1 ] = i2bcd(gDateTime.Sec);
/*  1607 */    data[ INDEX_2 ] = i2bcd(gDateTime.Min);
/*  1608 */    data[ INDEX_3 ] = i2bcd(gDateTime.Hour);
/*  1609 */    data[ INDEX_4 ] = i2bcd(gDateTime.Day);
/*  1610 */    data[ INDEX_5 ] = 0;
/*  1611 */    data[ INDEX_6 ] = i2bcd(gDateTime.Month);
/*  1612 */    data[ INDEX_7 ] = i2bcd(gDateTime.Year-2000);
/*  1621 */    err = HAL_I2C_Master_Transmit(&hi2c2, 0xA2, data, INDEX_8, 50);
/*  1623 */    return ( err ? 2 : 0 );
/*  1624 */ }
/*  1626 */ static void Pcf2129AT_init(void)
/*  1627 */ {
/*  1628 */    unsigned char data[INDEX_4];
/*  1630 */    OS_Delay(INDEX_50);
/*  1632 */    data[ INDEX_0 ] = Control_1;
/*  1633 */    data[ INDEX_1 ] = 0x03;
/*  1634 */    data[ INDEX_2 ] = 0x00;
/*  1635 */    data[ INDEX_3 ] = 0x00;
/*  1637 */    (void)HAL_I2C_Master_Transmit(&hi2c2, 0xA2, data, sizeof(data), 50);
/*  1638 */    (void)PCF2129_set_register( CLKOUT_ctl, 0x46 );
/*  1640 */ }
/*  1643 */ void PCF2127_readTime(unsigned char flag)
/*  1644 */ {
/*  1645 */    unsigned char buf[ INDEX_8 ];
/*  1647 */    OS_Delay(INDEX_5);
/*  1649 */    buf[ 0 ] = Seconds;
/*  1651 */    (void)HAL_I2C_Master_Transmit(&hi2c2, 0xA2, buf, 1, 50);
/*  1653 */    unsigned char err = HAL_I2C_Master_Receive(&hi2c2, 0xA2, buf, INDEX_7, 50);
/*  1655 */    if((flag == 1) && (err == HAL_OK))
/*  1656 */    {
/*  1657 */       gDateTime.Year = bcd2i(buf[INDEX_6])+2000;
/*  1658 */       gDateTime.Month = bcd2i(buf[INDEX_5]);
/*  1659 */       gDateTime.Day = bcd2i(buf[INDEX_3]);
/*  1660 */       gDateTime.Hour = bcd2i(buf[INDEX_2]);
/*  1661 */       gDateTime.Min = bcd2i(buf[INDEX_1]);
/*  1662 */       gDateTime.Sec = bcd2i(buf[INDEX_0]);
/*  1663 */    }
/*  1664 */    if((gDateTime.Year > 2099) ||
/*  1665 */        (gDateTime.Year < 2001) ||
/*  1666 */        (gDateTime.Month < 1) ||
/*  1667 */        (gDateTime.Month > 12) ||
/*  1668 */        (gDateTime.Day < 1) ||
/*  1669 */        (gDateTime.Day > 31) ||
/*  1670 */        (gDateTime.Hour >= 24) ||
/*  1671 */        (gDateTime.Min >= 60) ||
/*  1672 */        (gDateTime.Sec >= 60))
/*  1673 */    {
/*  1674 */       gDateTime.Year = 2001;
/*  1675 */       gDateTime.Month = 1;
/*  1676 */       gDateTime.Day = 1;
/*  1677 */       gDateTime.Hour = 0;
/*  1678 */       gDateTime.Min = 0;
/*  1679 */       gDateTime.Sec = 1;
/*  1680 */       (void)PCF2127_set_time();
/*  1681 */       (void)printf("PCF2127_set_time....\n");
/*  1682 */    }
/*  1683 */    (void)printf("%d/%d/%d %d:%d:%d(%d)\n", gDateTime.Year, gDateTime.Month, gDateTime.Day, gDateTime.Hour, gDateTime.Min, gDateTime.Sec, HAL_GetTick());
/*  1684 */ }
/*  1686 */ unsigned short RTCBatteryStatus(void)
/*  1687 */ {
/*  1688 */    (void)printf("RTCBatteryStatus => ");
/*  1689 */    return(PCF2129_read_register(Control_3) & 0x04);
/*  1690 */ }
/*  1706 */ 
