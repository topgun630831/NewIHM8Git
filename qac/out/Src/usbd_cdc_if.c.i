...
/*
 * C:/CodeInspection/DisplayUnit/Src/usbd_cdc_if.c
 */
/*   106 */ unsigned char UserTxBufferFS[256];
/*   113 */ static struct
/*   114 */ {
/*   115 */    int EndPos, StartPos;
/*   116 */    unsigned char IsDataRcved;
/*   117 */    unsigned char userRxBuf[5][256];
/*   118 */    unsigned char CmdLenBuf[5];
/*   119 */ } user_RxBuf;
/*   132 */ extern USBD_HandleTypeDef hUsbDeviceFS;
/*   135 */ USBD_CDC_LineCodingTypeDef LineCoding =
/*   136 */ {
/*   137 */    115200,
/*   138 */    0x00,
/*   139 */    0x00,
...
/*   155 */ static int8_t CDC_Control_FS (unsigned char cmd, unsigned char* pbuf, unsigned short length);
/*   156 */ static int8_t CDC_Receive_FS (unsigned char* pbuf, uint32_t *Len);
/*   165 */ USBD_CDC_ItfTypeDef USBD_Interface_fops_FS =
/*   166 */ {
/*   167 */    CDC_Init_FS,
/*   168 */    CDC_DeInit_FS,
/*   169 */    CDC_Control_FS,
/*   170 */    CDC_Receive_FS
/*   171 */ };
/*   180 */ static int8_t CDC_Init_FS(void)
/*   181 */ {
/*   184 */    USBD_CDC_SetTxBuffer(&hUsbDeviceFS, UserTxBufferFS, 0);
/*   186 */    USBD_CDC_SetRxBuffer(&hUsbDeviceFS, user_RxBuf.userRxBuf[user_RxBuf.EndPos]);
/*   188 */    USBD_CDC_ReceivePacket(&hUsbDeviceFS);
/*   190 */    return (USBD_OK);
/*   192 */ }
/*   200 */ static int8_t CDC_DeInit_FS(void)
/*   201 */ {
/*   203 */    return (USBD_OK);
/*   205 */ }
/*   215 */ static int8_t CDC_Control_FS (unsigned char cmd, unsigned char* pbuf, unsigned short length)
/*   216 */ {
/*   218 */    switch (cmd)
/*   219 */    {
/*   220 */    case 0x00:
...
/*   238 */       break;
/*   257 */    case 0x20:
/*   258 */       LineCoding.bitrate = (uint32_t)(pbuf[0] | (pbuf[1] << 8) | (pbuf[2] << 16) | (pbuf[3] << 24));
/*   259 */       LineCoding.format = pbuf[4];
/*   260 */       LineCoding.paritytype = pbuf[5];
/*   261 */       LineCoding.datatype = pbuf[6];
/*   262 */       break;
/*   264 */    case 0x21:
/*   265 */       pbuf[0] = (unsigned char)(LineCoding.bitrate);
/*   266 */       pbuf[1] = (unsigned char)(LineCoding.bitrate >> 8);
/*   267 */       pbuf[2] = (unsigned char)(LineCoding.bitrate >> 16);
/*   268 */       pbuf[3] = (unsigned char)(LineCoding.bitrate>> 24);
/*   269 */       pbuf[4] = LineCoding.format;
/*   270 */       pbuf[5] = LineCoding.paritytype;
/*   271 */       pbuf[6] = LineCoding.datatype;
/*   273 */       break;
/*   275 */    case 0x22:
/*   277 */       break;
/*   279 */    case 0x23:
...
/*   287 */    return (USBD_OK);
/*   289 */ }
/*   306 */ static int8_t CDC_Receive_FS (unsigned char* Buf, uint32_t *Len)
/*   307 */ {
/*   320 */    user_RxBuf.IsDataRcved = 1;
/*   321 */    user_RxBuf.CmdLenBuf[user_RxBuf.EndPos] = *Len;
/*   331 */    user_RxBuf.EndPos++;
/*   332 */    if(user_RxBuf.EndPos >= 5)
/*   333 */    {
/*   334 */       user_RxBuf.EndPos = 0;
/*   335 */    }
/*   337 */    USBD_CDC_SetRxBuffer(&hUsbDeviceFS, user_RxBuf.userRxBuf[user_RxBuf.EndPos]);
/*   338 */    USBD_CDC_ReceivePacket(&hUsbDeviceFS);
/*   340 */    return USBD_OK;
/*   343 */ }
/*   356 */ unsigned char CDC_Transmit_FS(unsigned char* Buf, unsigned short Len)
/*   357 */ {
/*   358 */    unsigned char result = USBD_OK;
/*   360 */    USBD_CDC_HandleTypeDef *hcdc = (USBD_CDC_HandleTypeDef*)hUsbDeviceFS.pClassData;
/*   361 */    if (hcdc->TxState != 0){
/*   362 */       return USBD_BUSY;
/*   363 */    }
/*   364 */    USBD_CDC_SetTxBuffer(&hUsbDeviceFS, Buf, Len);
/*   365 */    result = USBD_CDC_TransmitPacket(&hUsbDeviceFS);
/*   367 */    return result;
/*   368 */ }
/*   380 */ int8_t USBD_PcRcv_Data(unsigned char* Buf, uint32_t *Len)
/*   381 */ {
/*   382 */    int index=0;
/*   384 */    if(user_RxBuf.IsDataRcved == 0)
/*   385 */    {
/*   386 */       return 0;
/*   387 */    }
/*   388 */    index = user_RxBuf.StartPos;
/*   390 */    *Len = user_RxBuf.CmdLenBuf[index];
/*   391 */    memcpy(Buf, user_RxBuf.userRxBuf[index], *Len);
/*   394 */    user_RxBuf.StartPos++;
/*   395 */    if(user_RxBuf.StartPos >= 5)
/*   396 */    {
/*   397 */       user_RxBuf.StartPos = 0;
/*   398 */    }
/*   399 */    if(user_RxBuf.StartPos == user_RxBuf.EndPos)
/*   400 */    {
/*   401 */       user_RxBuf.IsDataRcved = 0;
/*   402 */    }
/*   403 */    return 1;
/*   404 */ }
/*   419 */ 
