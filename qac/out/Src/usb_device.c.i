...
/*
 * C:/CodeInspection/DisplayUnit/Middlewares/ST/STM32_USB_Device_Library/Class/HID/Inc/usbd_hid.h
 */
/*    82 */ typedef enum
/*    83 */ {
/*    84 */    HID_IDLE = 0,
...
/*    96 */ }
/*    97 */ USBD_HID_HandleTypeDef;
/*   116 */ extern USBD_ClassTypeDef USBD_HID;
/*   125 */ unsigned char USBD_HID_SendReport (USBD_HandleTypeDef *pdev,
/*   126 */     unsigned char *report,
/*   127 */     unsigned short len);
/*   129 */ uint32_t USBD_HID_GetPollingInterval (USBD_HandleTypeDef *pdev);
/*
...
/*
 * C:/CodeInspection/DisplayUnit/Src/usb_device.c
 */
/*    59 */ extern int gDnFlag;
/*    62 */ USBD_HandleTypeDef hUsbDeviceFS;
/*    65 */ void MX_USB_DEVICE_Init(void)
/*    66 */ {
/*    72 */    USBD_Init(&hUsbDeviceFS, &FS_Desc, 0);
/*    73 */    USBD_RegisterClass(&hUsbDeviceFS, &USBD_CDC);
/*    74 */    USBD_CDC_RegisterInterface(&hUsbDeviceFS, &USBD_Interface_fops_FS);
/*    75 */    USBD_Start(&hUsbDeviceFS);
/*    80 */ }
/*    89 */ 
