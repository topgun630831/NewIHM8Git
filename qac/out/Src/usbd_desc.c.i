...
/*
 * C:/CodeInspection/DisplayUnit/Inc/usbd_desc.h
 */
/*    94 */ extern USBD_DescriptorsTypeDef FS_Desc;
/*
 * C:/CodeInspection/DisplayUnit/Src/usbd_desc.c
 */
/*   103 */ unsigned char * USBD_FS_DeviceDescriptor( USBD_SpeedTypeDef speed , unsigned short *length);
/*   104 */ unsigned char * USBD_FS_LangIDStrDescriptor( USBD_SpeedTypeDef speed , unsigned short *length);
/*   105 */ unsigned char * USBD_FS_ManufacturerStrDescriptor ( USBD_SpeedTypeDef speed , unsigned short *length);
/*   106 */ unsigned char * USBD_FS_ProductStrDescriptor ( USBD_SpeedTypeDef speed , unsigned short *length);
/*   107 */ unsigned char * USBD_FS_SerialStrDescriptor( USBD_SpeedTypeDef speed , unsigned short *length);
/*   108 */ unsigned char * USBD_FS_ConfigStrDescriptor( USBD_SpeedTypeDef speed , unsigned short *length);
/*   109 */ unsigned char * USBD_FS_InterfaceStrDescriptor( USBD_SpeedTypeDef speed , unsigned short *length);
/*   119 */ USBD_DescriptorsTypeDef FS_Desc =
/*   120 */ {
/*   121 */    USBD_FS_DeviceDescriptor,
/*   122 */    USBD_FS_LangIDStrDescriptor,
/*   123 */    USBD_FS_ManufacturerStrDescriptor,
/*   124 */    USBD_FS_ProductStrDescriptor,
/*   125 */    USBD_FS_SerialStrDescriptor,
/*   126 */    USBD_FS_ConfigStrDescriptor,
/*   127 */    USBD_FS_InterfaceStrDescriptor,
/*   131 */ };
/*   137 */ unsigned char USBD_FS_DeviceDesc[0x12] =
/*   138 */ {
/*   139 */    0x12,
/*   140 */    1,
/*   146 */    0x00,
...
/*   152 */    0x00,
/*   154 */    64,
/*   155 */    ((unsigned char)(1155 & 0x00FF)),
/*   156 */    ((unsigned char)((1155 & 0xFF00) >>8)),
/*   157 */    ((unsigned char)(22336 & 0x00FF)),
/*   158 */    ((unsigned char)((22336 & 0xFF00) >>8)),
/*   159 */    0x00,
/*   160 */    0x02,
/*   161 */    0x01,
/*   162 */    0x02,
...
/*   164 */    1
/*   165 */ } ;
/*   169 */ unsigned char USBD_FS_DeviceDesc_HID[0x12] =
/*   170 */ {
/*   171 */    0x12,
/*   172 */    1,
/*   178 */    0x00,
...
/*   184 */    0x00,
/*   187 */    64,
/*   188 */    ((unsigned char)(1155 & 0x00FF)),
/*   189 */    ((unsigned char)((1155 & 0xFF00) >>8)),
/*   190 */    ((unsigned char)(22336 & 0x00FF)),
/*   191 */    ((unsigned char)((22336 & 0xFF00) >>8)),
/*   192 */    0x00,
/*   193 */    0x02,
/*   194 */    0x01,
/*   195 */    0x02,
...
/*   197 */    1
/*   198 */ } ;
/*   229 */ unsigned char USBD_LangIDDesc[0x04] =
/*   230 */ {
/*   231 */    0x04,
/*   232 */    3,
/*   233 */    ((unsigned char)(1033 & 0x00FF)),
/*   234 */    ((unsigned char)((1033 & 0xFF00) >>8)),
/*   235 */ };
/*   240 */ unsigned char USBD_StrDesc[512] ;
/*   264 */ extern int gDnFlag;
/*   266 */ unsigned char * USBD_FS_DeviceDescriptor( USBD_SpeedTypeDef speed , unsigned short *length)
/*   267 */ {
/*   275 */    if(gDnFlag == 1){
/*   276 */       *length = sizeof(USBD_FS_DeviceDesc_HID);
/*   277 */       return USBD_FS_DeviceDesc_HID;
/*   278 */    }
/*   279 */    else{
...
/*   283 */    }
/*   284 */ }
/*   293 */ unsigned char * USBD_FS_LangIDStrDescriptor( USBD_SpeedTypeDef speed , unsigned short *length)
/*   294 */ {
/*   295 */    *length = sizeof(USBD_LangIDDesc);
/*   296 */    return USBD_LangIDDesc;
/*   297 */ }
/*   306 */ unsigned char * USBD_FS_ProductStrDescriptor( USBD_SpeedTypeDef speed , unsigned short *length)
/*   307 */ {
/*   308 */    if(speed == 0)
/*   309 */    {
/*   310 */       USBD_GetString ("STM32 Virtual ComPort", USBD_StrDesc, length);
/*   311 */    }
/*   312 */    else
/*   313 */    {
/*   314 */       USBD_GetString ("STM32 Virtual ComPort", USBD_StrDesc, length);
/*   315 */    }
/*   316 */    return USBD_StrDesc;
/*   317 */ }
/*   326 */ unsigned char * USBD_FS_ManufacturerStrDescriptor( USBD_SpeedTypeDef speed , unsigned short *length)
/*   327 */ {
/*   328 */    USBD_GetString ("STMicroelectronics", USBD_StrDesc, length);
/*   329 */    return USBD_StrDesc;
/*   330 */ }
/*   339 */ unsigned char * USBD_FS_SerialStrDescriptor( USBD_SpeedTypeDef speed , unsigned short *length)
/*   340 */ {
/*   341 */    if(speed == USBD_SPEED_HIGH)
/*   342 */    {
/*   343 */       USBD_GetString ("00000000001A", USBD_StrDesc, length);
/*   344 */    }
/*   345 */    else
/*   346 */    {
/*   347 */       USBD_GetString ("00000000001A", USBD_StrDesc, length);
/*   348 */    }
/*   349 */    return USBD_StrDesc;
/*   350 */ }
/*   359 */ unsigned char * USBD_FS_ConfigStrDescriptor( USBD_SpeedTypeDef speed , unsigned short *length)
/*   360 */ {
/*   361 */    if(speed == USBD_SPEED_HIGH)
/*   362 */    {
/*   363 */       USBD_GetString ("CDC Config", USBD_StrDesc, length);
/*   364 */    }
/*   365 */    else
/*   366 */    {
/*   367 */       USBD_GetString ("CDC Config", USBD_StrDesc, length);
/*   368 */    }
/*   369 */    return USBD_StrDesc;
/*   370 */ }
/*   379 */ unsigned char * USBD_FS_InterfaceStrDescriptor( USBD_SpeedTypeDef speed , unsigned short *length)
/*   380 */ {
/*   381 */    if(speed == 0)
/*   382 */    {
/*   383 */       USBD_GetString ("CDC Interface", USBD_StrDesc, length);
/*   384 */    }
/*   385 */    else
/*   386 */    {
/*   387 */       USBD_GetString ("CDC Interface", USBD_StrDesc, length);
/*   388 */    }
/*   389 */    return USBD_StrDesc;
/*   390 */ }
/*   417 */ 
