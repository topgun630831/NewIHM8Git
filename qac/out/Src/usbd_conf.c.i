...
/*
 * C:/CodeInspection/DisplayUnit/Src/usbd_conf.c
 */
/*    55 */ PCD_HandleTypeDef hpcd_USB_OTG_FS;
/*    56 */ void _Error_Handler(char * file, int line);
/*    59 */ void SystemClock_Config(void);
/*    74 */ void HAL_PCD_MspInit(PCD_HandleTypeDef* pcdHandle)
/*    75 */ {
/*    76 */    GPIO_InitTypeDef GPIO_InitStruct;
/*    77 */    if(pcdHandle->Instance==((USB_OTG_GlobalTypeDef *) 0x50000000U))
/*    78 */    {
/*    93 */       GPIO_InitStruct.Pin = ((unsigned short)0x0800)|((unsigned short)0x1000);
/*    94 */       GPIO_InitStruct.Mode = 0x00000002U;
/*    95 */       GPIO_InitStruct.Pull = 0x00000000U;
/*    96 */       GPIO_InitStruct.Speed = 0x00000003U;
/*    97 */       GPIO_InitStruct.Alternate = ((unsigned char)0x0A);
/*    98 */       HAL_GPIO_Init(((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x0000U)), &GPIO_InitStruct);
/*   101 */       do {(((RCC_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3800U))->AHB2ENR |= ((0x1U << (7U)))); do { volatile uint32_t tmpreg = 0x00U; ((((RCC_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3800U))->APB2ENR) |= ((0x1U << (14U)))); tmpreg = ((((RCC_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3800U))->APB2ENR) & ((0x1U << (14U)))); ((void)(tmpreg)); } while(0U); }while(0U);
/*   104 */       HAL_NVIC_SetPriority(OTG_FS_IRQn, 0, 0);
/*   105 */       HAL_NVIC_EnableIRQ(OTG_FS_IRQn);
/*   109 */    }
/*   110 */ }
/*   112 */ void HAL_PCD_MspDeInit(PCD_HandleTypeDef* pcdHandle)
/*   113 */ {
/*   114 */    if(pcdHandle->Instance==((USB_OTG_GlobalTypeDef *) 0x50000000U))
/*   115 */    {
/*   120 */       (((RCC_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3800U))->AHB2ENR &= ~((0x1U << (7U))));
/*   127 */       HAL_GPIO_DeInit(((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x0000U)), ((unsigned short)0x0800)|((unsigned short)0x1000));
/*   131 */       HAL_NVIC_DisableIRQ(OTG_FS_IRQn);
/*   136 */    }
/*   137 */ }
/*   144 */ void HAL_PCD_SetupStageCallback(PCD_HandleTypeDef *hpcd)
/*   145 */ {
/*   146 */    USBD_LL_SetupStage((USBD_HandleTypeDef*)hpcd->pData, (unsigned char *)hpcd->Setup);
/*   147 */ }
/*   155 */ void HAL_PCD_DataOutStageCallback(PCD_HandleTypeDef *hpcd, unsigned char epnum)
/*   156 */ {
/*   157 */    USBD_LL_DataOutStage((USBD_HandleTypeDef*)hpcd->pData, epnum, hpcd->OUT_ep[epnum].xfer_buff);
/*   158 */ }
/*   166 */ void HAL_PCD_DataInStageCallback(PCD_HandleTypeDef *hpcd, unsigned char epnum)
/*   167 */ {
/*   168 */    USBD_LL_DataInStage((USBD_HandleTypeDef*)hpcd->pData, epnum, hpcd->IN_ep[epnum].xfer_buff);
/*   169 */ }
/*   176 */ void HAL_PCD_SOFCallback(PCD_HandleTypeDef *hpcd)
/*   177 */ {
/*   178 */    USBD_LL_SOF((USBD_HandleTypeDef*)hpcd->pData);
/*   179 */ }
/*   186 */ void HAL_PCD_ResetCallback(PCD_HandleTypeDef *hpcd)
/*   187 */ {
/*   188 */    USBD_SpeedTypeDef speed = USBD_SPEED_FULL;
/*   191 */    switch (hpcd->Init.speed)
/*   192 */    {
/*   193 */    case 0U:
/*   194 */       speed = USBD_SPEED_HIGH;
/*   195 */       break;
/*   196 */    case 2U:
/*   197 */       speed = USBD_SPEED_FULL;
/*   198 */       break;
/*   200 */    default:
/*   201 */       speed = USBD_SPEED_FULL;
/*   202 */       break;
/*   203 */    }
/*   204 */    USBD_LL_SetSpeed((USBD_HandleTypeDef*)hpcd->pData, speed);
/*   207 */    USBD_LL_Reset((USBD_HandleTypeDef*)hpcd->pData);
/*   208 */ }
/*   216 */ void HAL_PCD_SuspendCallback(PCD_HandleTypeDef *hpcd)
/*   217 */ {
/*   219 */    USBD_LL_Suspend((USBD_HandleTypeDef*)hpcd->pData);
/*   220 */    *(volatile uint32_t *)((uint32_t)((hpcd)->Instance) + 0xE00U) |= (0x1U << (0U));
/*   223 */    if (hpcd->Init.low_power_enable)
/*   224 */    {
/*   226 */       ((SCB_Type *) ((0xE000E000UL) + 0x0D00UL) )->SCR |= (uint32_t)((uint32_t)((1UL << 2U) | (1UL << 1U)));
/*   227 */    }
/*   229 */ }
/*   237 */ void HAL_PCD_ResumeCallback(PCD_HandleTypeDef *hpcd)
/*   238 */ {
/*   241 */    USBD_LL_Resume((USBD_HandleTypeDef*)hpcd->pData);
/*   243 */ }
/*   251 */ void HAL_PCD_ISOOUTIncompleteCallback(PCD_HandleTypeDef *hpcd, unsigned char epnum)
/*   252 */ {
/*   253 */    USBD_LL_IsoOUTIncomplete((USBD_HandleTypeDef*)hpcd->pData, epnum);
/*   254 */ }
/*   262 */ void HAL_PCD_ISOINIncompleteCallback(PCD_HandleTypeDef *hpcd, unsigned char epnum)
/*   263 */ {
/*   264 */    USBD_LL_IsoINIncomplete((USBD_HandleTypeDef*)hpcd->pData, epnum);
/*   265 */ }
/*   272 */ void HAL_PCD_ConnectCallback(PCD_HandleTypeDef *hpcd)
/*   273 */ {
/*   274 */    USBD_LL_DevConnected((USBD_HandleTypeDef*)hpcd->pData);
/*   275 */ }
/*   282 */ void HAL_PCD_DisconnectCallback(PCD_HandleTypeDef *hpcd)
/*   283 */ {
/*   284 */    USBD_LL_DevDisconnected((USBD_HandleTypeDef*)hpcd->pData);
/*   285 */ }
/*   295 */ USBD_StatusTypeDef USBD_LL_Init (USBD_HandleTypeDef *pdev)
/*   296 */ {
/*   298 */    if (pdev->id == 0) {
/*   300 */       hpcd_USB_OTG_FS.pData = pdev;
/*   301 */       pdev->pData = &hpcd_USB_OTG_FS;
/*   303 */       hpcd_USB_OTG_FS.Instance = ((USB_OTG_GlobalTypeDef *) 0x50000000U);
/*   304 */       hpcd_USB_OTG_FS.Init.dev_endpoints = 4;
/*   305 */       hpcd_USB_OTG_FS.Init.speed = 2U;
/*   306 */       hpcd_USB_OTG_FS.Init.dma_enable = DISABLE;
/*   307 */       hpcd_USB_OTG_FS.Init.ep0_mps = 0U;
/*   308 */       hpcd_USB_OTG_FS.Init.phy_itface = 2U;
...
/*   312 */       hpcd_USB_OTG_FS.Init.vbus_sensing_enable = ENABLE;
/*   313 */       hpcd_USB_OTG_FS.Init.use_dedicated_ep1 = DISABLE;
/*   314 */       if (HAL_PCD_Init(&hpcd_USB_OTG_FS) != HAL_OK)
/*   315 */       {
/*   316 */          _Error_Handler("C:/CodeInspection/DisplayUnit/Src/usbd_conf.c", 316);
/*   317 */       }
/*   319 */       HAL_PCDEx_SetRxFiFo(&hpcd_USB_OTG_FS, 0x80);
/*   320 */       HAL_PCDEx_SetTxFiFo(&hpcd_USB_OTG_FS, 0, 0x40);
/*   321 */       HAL_PCDEx_SetTxFiFo(&hpcd_USB_OTG_FS, 1, 0x80);
/*   322 */    }
/*   323 */    return USBD_OK;
/*   324 */ }
...
/*   336 */    hal_status = HAL_PCD_DeInit(pdev->pData);
/*   338 */    switch (hal_status) {
/*   339 */    case HAL_OK :
...
/*   356 */ }
/*   363 */ USBD_StatusTypeDef USBD_LL_Start(USBD_HandleTypeDef *pdev)
/*   364 */ {
/*   365 */    HAL_StatusTypeDef hal_status = HAL_OK;
/*   366 */    USBD_StatusTypeDef usb_status = USBD_OK;
/*   368 */    hal_status = HAL_PCD_Start(pdev->pData);
/*   370 */    switch (hal_status) {
/*   371 */    case HAL_OK :
/*   372 */       usb_status = USBD_OK;
/*   373 */       break;
/*   374 */    case HAL_ERROR :
/*   375 */       usb_status = USBD_FAIL;
/*   376 */       break;
/*   377 */    case HAL_BUSY :
/*   378 */       usb_status = USBD_BUSY;
/*   379 */       break;
/*   380 */    case HAL_TIMEOUT :
/*   381 */       usb_status = USBD_FAIL;
/*   382 */       break;
/*   383 */    default :
...
/*   388 */ }
/*   395 */ USBD_StatusTypeDef USBD_LL_Stop (USBD_HandleTypeDef *pdev)
/*   396 */ {
/*   397 */    HAL_StatusTypeDef hal_status = HAL_OK;
/*   398 */    USBD_StatusTypeDef usb_status = USBD_OK;
/*   400 */    hal_status = HAL_PCD_Stop(pdev->pData);
/*   402 */    switch (hal_status) {
/*   403 */    case HAL_OK :
/*   404 */       usb_status = USBD_OK;
/*   405 */       break;
/*   406 */    case HAL_ERROR :
/*   407 */       usb_status = USBD_FAIL;
/*   408 */       break;
/*   409 */    case HAL_BUSY :
/*   410 */       usb_status = USBD_BUSY;
/*   411 */       break;
/*   412 */    case HAL_TIMEOUT :
/*   413 */       usb_status = USBD_FAIL;
/*   414 */       break;
/*   415 */    default :
/*   416 */       usb_status = USBD_FAIL;
/*   417 */       break;
/*   418 */    }
/*   419 */    return usb_status;
/*   420 */ }
/*   430 */ USBD_StatusTypeDef USBD_LL_OpenEP (USBD_HandleTypeDef *pdev,
/*   431 */     unsigned char ep_addr,
/*   432 */     unsigned char ep_type,
/*   433 */     unsigned short ep_mps)
/*   434 */ {
/*   435 */    HAL_StatusTypeDef hal_status = HAL_OK;
/*   436 */    USBD_StatusTypeDef usb_status = USBD_OK;
/*   438 */    hal_status = HAL_PCD_EP_Open(pdev->pData,
/*   439 */        ep_addr,
/*   440 */        ep_mps,
/*   441 */        ep_type);
/*   444 */    switch (hal_status) {
/*   445 */    case HAL_OK :
/*   446 */       usb_status = USBD_OK;
/*   447 */       break;
/*   448 */    case HAL_ERROR :
/*   449 */       usb_status = USBD_FAIL;
/*   450 */       break;
/*   451 */    case HAL_BUSY :
/*   452 */       usb_status = USBD_BUSY;
/*   453 */       break;
/*   454 */    case HAL_TIMEOUT :
...
/*   462 */ }
/*   470 */ USBD_StatusTypeDef USBD_LL_CloseEP (USBD_HandleTypeDef *pdev, unsigned char ep_addr)
/*   471 */ {
/*   472 */    HAL_StatusTypeDef hal_status = HAL_OK;
/*   473 */    USBD_StatusTypeDef usb_status = USBD_OK;
/*   475 */    hal_status = HAL_PCD_EP_Close(pdev->pData, ep_addr);
...
/*   495 */ }
/*   503 */ USBD_StatusTypeDef USBD_LL_FlushEP (USBD_HandleTypeDef *pdev, unsigned char ep_addr)
/*   504 */ {
/*   505 */    HAL_StatusTypeDef hal_status = HAL_OK;
/*   506 */    USBD_StatusTypeDef usb_status = USBD_OK;
/*   508 */    hal_status = HAL_PCD_EP_Flush(pdev->pData, ep_addr);
/*   510 */    switch (hal_status) {
/*   511 */    case HAL_OK :
/*   512 */       usb_status = USBD_OK;
/*   513 */       break;
/*   514 */    case HAL_ERROR :
/*   515 */       usb_status = USBD_FAIL;
/*   516 */       break;
/*   517 */    case HAL_BUSY :
/*   518 */       usb_status = USBD_BUSY;
/*   519 */       break;
/*   520 */    case HAL_TIMEOUT :
/*   521 */       usb_status = USBD_FAIL;
/*   522 */       break;
/*   523 */    default :
/*   524 */       usb_status = USBD_FAIL;
/*   525 */       break;
/*   526 */    }
/*   527 */    return usb_status;
/*   528 */ }
/*   536 */ USBD_StatusTypeDef USBD_LL_StallEP (USBD_HandleTypeDef *pdev, unsigned char ep_addr)
/*   537 */ {
/*   538 */    HAL_StatusTypeDef hal_status = HAL_OK;
/*   539 */    USBD_StatusTypeDef usb_status = USBD_OK;
/*   541 */    hal_status = HAL_PCD_EP_SetStall(pdev->pData, ep_addr);
/*   543 */    switch (hal_status) {
/*   544 */    case HAL_OK :
/*   545 */       usb_status = USBD_OK;
/*   546 */       break;
/*   547 */    case HAL_ERROR :
/*   548 */       usb_status = USBD_FAIL;
/*   549 */       break;
/*   550 */    case HAL_BUSY :
/*   551 */       usb_status = USBD_BUSY;
/*   552 */       break;
/*   553 */    case HAL_TIMEOUT :
/*   554 */       usb_status = USBD_FAIL;
/*   555 */       break;
/*   556 */    default :
/*   557 */       usb_status = USBD_FAIL;
/*   558 */       break;
/*   559 */    }
/*   560 */    return usb_status;
/*   561 */ }
/*   569 */ USBD_StatusTypeDef USBD_LL_ClearStallEP (USBD_HandleTypeDef *pdev, unsigned char ep_addr)
/*   570 */ {
/*   571 */    HAL_StatusTypeDef hal_status = HAL_OK;
/*   572 */    USBD_StatusTypeDef usb_status = USBD_OK;
/*   574 */    hal_status = HAL_PCD_EP_ClrStall(pdev->pData, ep_addr);
/*   576 */    switch (hal_status) {
/*   577 */    case HAL_OK :
/*   578 */       usb_status = USBD_OK;
/*   579 */       break;
/*   580 */    case HAL_ERROR :
/*   581 */       usb_status = USBD_FAIL;
/*   582 */       break;
/*   583 */    case HAL_BUSY :
/*   584 */       usb_status = USBD_BUSY;
/*   585 */       break;
/*   586 */    case HAL_TIMEOUT :
/*   587 */       usb_status = USBD_FAIL;
/*   588 */       break;
/*   589 */    default :
/*   590 */       usb_status = USBD_FAIL;
/*   591 */       break;
/*   592 */    }
/*   593 */    return usb_status;
/*   594 */ }
/*   602 */ unsigned char USBD_LL_IsStallEP (USBD_HandleTypeDef *pdev, unsigned char ep_addr)
/*   603 */ {
/*   604 */    PCD_HandleTypeDef *hpcd = (PCD_HandleTypeDef*) pdev->pData;
/*   606 */    if((ep_addr & 0x80) == 0x80)
/*   607 */    {
/*   608 */       return hpcd->IN_ep[ep_addr & 0x7F].is_stall;
/*   609 */    }
/*   610 */    else
/*   611 */    {
/*   612 */       return hpcd->OUT_ep[ep_addr & 0x7F].is_stall;
/*   613 */    }
/*   614 */ }
/*   621 */ USBD_StatusTypeDef USBD_LL_SetUSBAddress (USBD_HandleTypeDef *pdev, unsigned char dev_addr)
/*   622 */ {
/*   623 */    HAL_StatusTypeDef hal_status = HAL_OK;
/*   624 */    USBD_StatusTypeDef usb_status = USBD_OK;
/*   626 */    hal_status = HAL_PCD_SetAddress(pdev->pData, dev_addr);
/*   628 */    switch (hal_status) {
/*   629 */    case HAL_OK :
/*   630 */       usb_status = USBD_OK;
/*   631 */       break;
/*   632 */    case HAL_ERROR :
/*   633 */       usb_status = USBD_FAIL;
/*   634 */       break;
/*   635 */    case HAL_BUSY :
/*   636 */       usb_status = USBD_BUSY;
/*   637 */       break;
/*   638 */    case HAL_TIMEOUT :
/*   639 */       usb_status = USBD_FAIL;
/*   640 */       break;
/*   641 */    default :
/*   642 */       usb_status = USBD_FAIL;
/*   643 */       break;
/*   644 */    }
/*   645 */    return usb_status;
/*   646 */ }
/*   656 */ USBD_StatusTypeDef USBD_LL_Transmit (USBD_HandleTypeDef *pdev,
/*   657 */     unsigned char ep_addr,
/*   658 */     unsigned char *pbuf,
/*   659 */     unsigned short size)
/*   660 */ {
/*   661 */    HAL_StatusTypeDef hal_status = HAL_OK;
/*   662 */    USBD_StatusTypeDef usb_status = USBD_OK;
/*   664 */    hal_status = HAL_PCD_EP_Transmit(pdev->pData, ep_addr, pbuf, size);
/*   666 */    switch (hal_status) {
/*   667 */    case HAL_OK :
/*   668 */       usb_status = USBD_OK;
/*   669 */       break;
/*   670 */    case HAL_ERROR :
/*   671 */       usb_status = USBD_FAIL;
/*   672 */       break;
/*   673 */    case HAL_BUSY :
/*   674 */       usb_status = USBD_BUSY;
/*   675 */       break;
/*   676 */    case HAL_TIMEOUT :
/*   677 */       usb_status = USBD_FAIL;
/*   678 */       break;
/*   679 */    default :
/*   680 */       usb_status = USBD_FAIL;
/*   681 */       break;
/*   682 */    }
/*   683 */    return usb_status;
/*   684 */ }
/*   694 */ USBD_StatusTypeDef USBD_LL_PrepareReceive(USBD_HandleTypeDef *pdev,
/*   695 */     unsigned char ep_addr,
/*   696 */     unsigned char *pbuf,
/*   697 */     unsigned short size)
/*   698 */ {
/*   699 */    HAL_StatusTypeDef hal_status = HAL_OK;
/*   700 */    USBD_StatusTypeDef usb_status = USBD_OK;
/*   702 */    hal_status = HAL_PCD_EP_Receive(pdev->pData, ep_addr, pbuf, size);
/*   704 */    switch (hal_status) {
/*   705 */    case HAL_OK :
/*   706 */       usb_status = USBD_OK;
/*   707 */       break;
/*   708 */    case HAL_ERROR :
/*   709 */       usb_status = USBD_FAIL;
/*   710 */       break;
/*   711 */    case HAL_BUSY :
/*   712 */       usb_status = USBD_BUSY;
/*   713 */       break;
/*   714 */    case HAL_TIMEOUT :
/*   715 */       usb_status = USBD_FAIL;
/*   716 */       break;
/*   717 */    default :
/*   718 */       usb_status = USBD_FAIL;
/*   719 */       break;
/*   720 */    }
/*   721 */    return usb_status;
/*   722 */ }
/*   730 */ uint32_t USBD_LL_GetRxDataSize (USBD_HandleTypeDef *pdev, unsigned char ep_addr)
/*   731 */ {
/*   732 */    return HAL_PCD_EP_GetRxCount((PCD_HandleTypeDef*) pdev->pData, ep_addr);
/*   733 */ }
/*   777 */ void USBD_LL_Delay (uint32_t Delay)
/*   778 */ {
/*   779 */    HAL_Delay(Delay);
/*   780 */ }
/*   781 */ 
